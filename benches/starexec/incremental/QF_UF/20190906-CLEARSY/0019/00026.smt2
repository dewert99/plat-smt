...
; PO 1 in group 0
(push 1)
(assert (not (subset empty (interval e99 e242))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s225_249 BOOL))
(assert (and (|>=i| g_s226_250 e0) (|<=i| g_s226_250 e103)))
(assert (= g_s226_250 e103))
(define-fun lh_1 () Bool (= g_s220$1_251 (interval e99 g_s226_250)))
(define-fun lh_2 () Bool (= g_s221$1_252 empty))
(define-fun lh_3 () Bool (= g_s225$1_253 (bool (not (= g_s220$1_251 empty)))))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset g_s221$1_252 (interval e99 e242)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset g_s220$1_251 (interval e99 e242)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (= (binary_inter g_s220$1_251 g_s221$1_252) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s225_249 BOOL))
(assert (and (|>=i| g_s228_254 e0) (|<=i| g_s228_254 e103)))
(assert (not (= g_s220_247 empty)))
(define-fun lh_1 () Bool (mem g_s229_255 g_s220_247))
(define-fun lh_2 () Bool (= g_s225$1_253 (bool (not (= g_s220$1_251 empty)))))
(define-fun lh_3 () Bool (= g_s228$1_256 g_s229_255))
(define-fun lh_4 () Bool (= g_s220$1_251 (set_diff g_s220_247 (SET g_s229_255))))
(define-fun lh_5 () Bool (= g_s221$1_252 (binary_union g_s221_248 (SET g_s229_255))))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (subset g_s221$1_252 (interval e99 e242)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (subset g_s220$1_251 (interval e99 e242)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= (binary_inter g_s220$1_251 g_s221$1_252) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
