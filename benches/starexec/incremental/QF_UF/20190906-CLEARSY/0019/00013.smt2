...
; PO 1 in group 0
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 e121))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (=> (= g_s248_279 e0) (= g_s248$1_310 e0)))
(define-fun lh_2 () Bool (=> (not (= g_s248_279 e0)) (= g_s248$1_310 (apply g_s86_93 (mapplet g_s248_279 e73)))))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (and (|>=i| e0 e0) (|<=i| e0 e69)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (and (|>=i| e0 e0) (|<=i| e0 e71)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (and (|>=i| g_s248$1_310 e0) (|<=i| g_s248$1_310 e121)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (=> (= g_s248_279 e0) (= g_s248$1_310 e0)))
(define-fun lh_2 () Bool (not (= g_s248_279 e0)))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s86_93 (|+->| (dom g_s86_93) (ran g_s86_93))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (mapplet g_s248_279 e73) (dom g_s86_93)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
