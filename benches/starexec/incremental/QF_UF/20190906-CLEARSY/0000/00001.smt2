...
(declare-fun g_s898_1000 () U)
(declare-fun g_s898$1_1001 () U)
(declare-fun g_s899_1002 () U)
(declare-fun g_s9_10 () U)
(declare-fun g_s90_91 () U)
(declare-fun g_s900$1_1003 () U)
(declare-fun g_s902$1_1005 () U)
(declare-fun g_s904$1_1006 () U)
(declare-fun g_s905$1_1007 () U)
(declare-fun g_s906$1_1008 () U)
...
(define-fun lh_5 () Bool (mem g_s887$1_992 g_s336_428))
(define-fun lh_6 () Bool (= (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997)) TRUE))
(define-fun lh_7 () Bool (|>i| g_s876$1_983 g_s868_997))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997)) g_s336_428))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem (|-i| g_s876$1_983 g_s868_997) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem (|-i| g_s876$1_983 g_s868_997) g_s305_397))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (= (bool (|>i| g_s869_998 (|-i| g_s876$1_983 g_s868_997))) (apply g_s863_963 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (= g_s894$1_996 g_s894_995))
(assert (= g_s898$1_1001 g_s898_1000))
(define-fun lh_1 () Bool (mem g_s894_995 g_s336_428))
(define-fun lh_2 () Bool (mem g_s898_1000 g_s305_397))
(define-fun lh_3 () Bool (mem g_s868_997 g_s305_397))
(define-fun lh_4 () Bool (mem g_s899_1002 g_s305_397))
(define-fun lh_5 () Bool (mem g_s869_998 g_s305_397))
(define-fun lh_6 () Bool (mem g_s895_999 INTEGER))
(define-fun lh_7 () Bool (mem g_s900$1_1003 g_s305_397))
(define-fun lh_8 () Bool (mem g_s887$1_992 g_s336_428))
(define-fun lh_9 () Bool (= (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997)) TRUE))
(define-fun lh_10 () Bool (|>i| g_s876$1_983 g_s868_997))
(define-fun lh_11 () Bool (|>=i| g_s868_997 g_s899_1002))
(define-fun lh_12 () Bool (|>i| g_s869_998 (|-i| g_s876$1_983 g_s868_997)))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11) (mem (|-i| g_s876$1_983 g_s868_997) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (mem (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997)) g_s336_428))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (mem (apply g_s864_964 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s899_1002) g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985)) g_s336_428))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (mem (apply g_s866_966 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s899_1002) g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985) g_s894$2_1004)) g_s305_397))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (mem (|-i| g_s876$1_983 g_s868_997) g_s305_397))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (= TRUE (apply g_s864_964 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s899_1002) g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (= g_s868_997 (apply g_s866_966 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s899_1002) g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985) g_s894$2_1004))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (= (apply g_s866_966 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s899_1002) g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985) g_s894$2_1004)) (apply g_s866_966 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s899_1002) g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985) (apply g_s864_964 (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet (mapplet g_s868_997 g_s899_1002) g_s869_998) (apply g_s865_965 (mapplet g_s882$1_981 g_s868_997))) g_s876$1_983) g_s880$1_987) g_s878$1_986) g_s877$1_985))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_2 () Bool (mem g_s902$1_1005 g_s741_841))
(define-fun lh_3 () Bool (= g_s881$1_982 FALSE))
(define-fun lh_4 () Bool (= g_s806_906 e292))
(define-fun lh_5 () Bool (= g_s806_906 e293))
; PO 1 in group 4
(push 1)
...
; PO 7 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= e0 e368))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= e368 e0))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s895_999 INTEGER))
(define-fun lh_2 () Bool (mem g_s904$1_1006 g_s305_397))
(define-fun lh_3 () Bool (mem g_s905$1_1007 g_s305_397))
(define-fun lh_4 () Bool (mem g_s906$1_1008 g_s336_428))
(define-fun lh_5 () Bool (= g_s828_928 TRUE))
(define-fun lh_6 () Bool (|>i| g_s827_927 g_s879$1_984))
(define-fun lh_7 () Bool (|>i| g_s876$1_983 g_s827_927))
(define-fun lh_8 () Bool (mem g_s878$1_986 g_s305_397))
(define-fun lh_9 () Bool (|>=i| g_s878$1_986 e0))
(define-fun lh_10 () Bool (mem g_s884$1_989 g_s336_428))
(define-fun lh_11 () Bool (not (and (= g_s828_928 TRUE) (|>i| g_s827_927 g_s879$1_984) (|>i| g_s876$1_983 g_s827_927))))
; PO 1 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (|>=i| g_s878$1_986 e0))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem (|+i| g_s826_926 (|-i| g_s876$1_983 g_s827_927)) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem (|-i| g_s876$1_983 g_s827_927) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (mem TRUE g_s336_428))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (mem (bool (and (= g_s828_928 TRUE) (|>i| g_s827_927 g_s879$1_984) (|>i| g_s876$1_983 g_s827_927))) g_s336_428))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (mem (bool (and (= g_s828_928 TRUE) (|>i| g_s827_927 g_s879$1_984) (|>i| g_s876$1_983 g_s827_927) (= g_s822_922 TRUE))) g_s336_428))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (mem (|+i| g_s826_926 (|-i| g_s876$1_983 g_s827_927)) g_s305_397))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= TRUE (bool (or (= (bool (and (= g_s828_928 TRUE) (|>i| g_s827_927 g_s879$1_984) (|>i| g_s876$1_983 g_s827_927))) TRUE) (= TRUE TRUE)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= (bool (and (= g_s828_928 TRUE) (|>i| g_s827_927 g_s879$1_984) (|>i| g_s876$1_983 g_s827_927))) TRUE))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= (bool (and (= g_s828_928 TRUE) (|>i| g_s827_927 g_s879$1_984) (|>i| g_s876$1_983 g_s827_927) (= g_s822_922 TRUE))) g_s822_922))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= (|+i| g_s826_926 (|-i| g_s876$1_983 g_s827_927)) (|-i| (|+i| g_s826_926 g_s876$1_983) g_s827_927)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11) (= TRUE g_s880$1_987))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11) (= g_s826_926 g_s878$1_986))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11) (= g_s827_927 g_s879$1_984))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11) (= (|+i| g_s826_926 (|-i| g_s876$1_983 g_s827_927)) g_s877$1_985))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_4 () Bool (mem g_s902$1_1005 g_s741_841))
(define-fun lh_5 () Bool (= g_s882$1_981 e292))
(define-fun lh_6 () Bool (|>=i| g_s876$1_983 e371))
(define-fun lh_7 () Bool (= g_s880$1_987 TRUE))
(define-fun lh_8 () Bool (|>=i| g_s877$1_985 e366))
(define-fun lh_9 () Bool (|>=i| g_s878$1_986 e366))
(define-fun lh_10 () Bool (|<i| g_s876$1_983 e371))
(define-fun lh_11 () Bool (|<i| g_s877$1_985 e366))
(define-fun lh_12 () Bool (= g_s880$1_987 FALSE))
(define-fun lh_13 () Bool (|<i| g_s878$1_986 e366))
(define-fun lh_14 () Bool (= g_s882$1_981 e293))
(define-fun lh_15 () Bool (not (|<i| g_s876$1_983 e366)))
(define-fun lh_16 () Bool (not (|<i| g_s877$1_985 e371)))
(define-fun lh_17 () Bool (not (|<i| g_s878$1_986 e371)))
; PO 1 in group 6
(push 1)
...
; PO 6 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= e0 (|+i| g_s876$1_983 e292)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_12) (= e368 g_s877$1_985))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_12) (= e368 g_s878$1_986))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_11) (= e368 (|+i| g_s877$1_985 e292)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_13) (= e368 (|+i| g_s878$1_986 e292)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_14 lh_15) (= e0 e368))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_14 lh_16) (= e368 e0))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_14 lh_17) (= e368 e0))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_12 lh_14) (= e368 g_s877$1_985))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_12 lh_14) (= e368 g_s878$1_986))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 9
(push 1)
(assert (not (mem FALSE g_s336_428)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 9
(push 1)
(assert (not (mem e0 g_s305_397)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 9
(push 1)
(assert (not (= FALSE (bool (or (= FALSE TRUE) (= FALSE TRUE))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 9
