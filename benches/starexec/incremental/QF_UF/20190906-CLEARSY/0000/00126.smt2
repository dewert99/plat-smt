...
(define-fun |def_inv| () Bool (and (mem g_s802$1_899 g_s262_267) (mem g_s803$1_900 g_s262_267) (= g_s801_898 (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s24_25)))) g_s802$1_899) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s23_24)))) g_s803$1_900)))))
...
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem FALSE g_s262_267))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_4) (mem FALSE g_s262_267))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
