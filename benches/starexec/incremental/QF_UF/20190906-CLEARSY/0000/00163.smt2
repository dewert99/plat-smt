...
(declare-fun g_s810_903 () U)
(declare-fun g_s811_904 () U)
(declare-fun g_s812_905 () U)
(declare-fun g_s814_906 () U)
(declare-fun g_s814$1_907 () U)
...
(define-fun |def_abs| () Bool  (subset g_s801_898 g_s109_110))
(define-fun |def_inv| () Bool (and (mem g_s802$1_899 g_s262_267) (mem g_s803$1_900 g_s262_267) (mem g_s804$1_901 g_s262_267) (mem g_s805$1_902 g_s262_267) (= g_s801_898 (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) g_s802$1_899) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) g_s803$1_900)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) g_s804$1_901)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) g_s805$1_902)))))
...
; PO 1 in group 0
(push 1)
(assert (not (mem FALSE g_s262_267)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (= empty (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) FALSE) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) FALSE)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) FALSE)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) FALSE)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 1
(push 1)
(assert (not (mem TRUE g_s262_267)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (= g_s109_110 (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) TRUE) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) TRUE)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) TRUE)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) TRUE)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s810_903 g_s109_110))
(define-fun lh_2 () Bool (mem g_s811_904 g_s262_267))
(define-fun lh_3 () Bool (mem g_s812_905 INTEGER))
(define-fun lh_4 () Bool (= g_s810_903 g_s110_111))
(define-fun lh_5 () Bool (not (= g_s811_904 TRUE)))
(define-fun lh_6 () Bool (= g_s810_903 g_s111_112))
(define-fun lh_7 () Bool (= g_s810_903 g_s112_113))
(define-fun lh_8 () Bool (= g_s810_903 g_s113_114))
(define-fun lh_9 () Bool (not (= g_s810_903 g_s110_111)))
(define-fun lh_10 () Bool (not (= g_s810_903 g_s111_112)))
(define-fun lh_11 () Bool (not (= g_s810_903 g_s112_113)))
(define-fun lh_12 () Bool (not (= g_s810_903 g_s113_114)))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem (bool (and (= g_s802$1_899 TRUE) (= g_s811_904 TRUE))) g_s262_267))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_6) (mem (bool (and (= g_s803$1_900 TRUE) (= g_s811_904 TRUE))) g_s262_267))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_7) (mem (bool (and (= g_s804$1_901 TRUE) (= g_s811_904 TRUE))) g_s262_267))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_8) (mem (bool (and (= g_s805$1_902 TRUE) (= g_s811_904 TRUE))) g_s262_267))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_8) (= (set_diff g_s801_898 (SET g_s810_903)) (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) g_s802$1_899) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) g_s803$1_900)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) g_s804$1_901)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) (bool (and (= g_s805$1_902 TRUE) (= g_s811_904 TRUE)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_7) (= (set_diff g_s801_898 (SET g_s810_903)) (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) g_s802$1_899) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) g_s803$1_900)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) (bool (and (= g_s804$1_901 TRUE) (= g_s811_904 TRUE))))) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) g_s805$1_902))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_6) (= (set_diff g_s801_898 (SET g_s810_903)) (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) g_s802$1_899) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) (bool (and (= g_s803$1_900 TRUE) (= g_s811_904 TRUE))))) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) g_s804$1_901)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) g_s805$1_902))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= (set_diff g_s801_898 (SET g_s810_903)) (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) (bool (and (= g_s802$1_899 TRUE) (= g_s811_904 TRUE)))) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) g_s803$1_900)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) g_s804$1_901)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) g_s805$1_902))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_9 lh_10 lh_11 lh_12) (= (set_diff g_s801_898 (SET g_s810_903)) (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) g_s802$1_899) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) g_s803$1_900)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) g_s804$1_901)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) g_s805$1_902))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s814$1_907 g_s814_906))
(define-fun lh_1 () Bool (mem g_s814_906 g_s262_267))
; PO 1 in group 3
(assert (not (=> lh_1 (= g_s802$1_899 (bool (mem g_s110_111 g_s801_898))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(define-fun lh_1 () Bool (mem g_s814_906 g_s262_267))
; PO 1 in group 4
(assert (not (=> lh_1 (= g_s803$1_900 (bool (mem g_s111_112 g_s801_898))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(define-fun lh_1 () Bool (mem g_s814_906 g_s262_267))
; PO 1 in group 5
(assert (not (=> lh_1 (= g_s804$1_901 (bool (mem g_s112_113 g_s801_898))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(define-fun lh_1 () Bool (mem g_s814_906 g_s262_267))
; PO 1 in group 6
(assert (not (=> lh_1 (= g_s805$1_902 (bool (mem g_s113_114 g_s801_898))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(define-fun lh_2 () Bool (mem e908 INT))
(define-fun lh_3 () Bool (mem g_s803$1_900 g_s653_675))
(define-fun lh_4 () Bool (mem e909 INT))
(define-fun lh_5 () Bool (mem g_s804$1_901 g_s653_675))
(define-fun lh_6 () Bool (mem e910 INT))
; PO 1 in group 8
(push 1)
(assert (not (mem e908 INT)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 8
(push 1)
(assert (not (mem g_s802$1_899 g_s653_675)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem e909 INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s803$1_900 g_s653_675))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem e910 INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s804$1_901 g_s653_675))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem e911 INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem g_s805$1_902 g_s653_675))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (mem g_s802$1_899 g_s262_267))
(define-fun lh_2 () Bool (mem g_s803$1_900 g_s262_267))
(define-fun lh_3 () Bool (mem g_s804$1_901 g_s262_267))
(define-fun lh_4 () Bool (mem g_s805$1_902 g_s262_267))
; PO 1 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s802$1_899 (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s803$1_900 (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s804$1_901 (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s805$1_902 (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) (|+->| (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111))))) (ran (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) (|+->| (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112))))) (ran (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) (|+->| (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113))))) (ran (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 9
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) (|+->| (dom (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114))))) (ran (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
