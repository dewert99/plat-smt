...
(define-fun lh_2 () Bool (= g_s450$1_494 TRUE))
(define-fun lh_3 () Bool (mem g_s453$2_499 g_s285_321))
(define-fun lh_4 () Bool (mem g_s454$2_500 g_s285_321))
(define-fun lh_5 () Bool (= g_s453$2_499 (bool (or (and (= g_s458_501 TRUE) (= g_s459_502 g_s13_14)) (= g_s460_503 TRUE)))))
(define-fun lh_6 () Bool (= g_s454$2_500 (bool (or (and (= g_s458_501 TRUE) (= g_s459_502 g_s14_15)) (= g_s461_504 TRUE)))))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (bool (and (= g_s463_505 TRUE) (= g_s464_506 TRUE) (= g_s465_507 TRUE) (= g_s466_508 TRUE) (= g_s467_509 TRUE) (= g_s468_510 TRUE))) g_s285_321))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (bool (and (= g_s469_511 TRUE) (= g_s470_512 TRUE) (= g_s471_513 TRUE) (= g_s472_514 TRUE) (= g_s473_515 TRUE) (= g_s474_516 TRUE) (= g_s475_517 TRUE) (= g_s476_518 TRUE) (= g_s477_519 TRUE) (= g_s478_520 TRUE) (= g_s479_521 TRUE) (= g_s480_522 TRUE) (= g_s481_523 TRUE) (= g_s482_524 TRUE) (= g_s483_525 TRUE) (= g_s484_526 TRUE))) g_s285_321))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)