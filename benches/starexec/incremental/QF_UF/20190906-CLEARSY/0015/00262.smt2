...
(declare-fun g_s100_97 () U)
(declare-fun g_s102_99 () U)
(declare-fun g_s104_101 () U)
(declare-fun g_s107_104 () U)
(declare-fun g_s109_106 () U)
...
(declare-fun g_s95$1_105 () U)
(declare-fun g_s95$1_107 () U)
(declare-fun g_s95$1_103 () U)
(declare-fun g_s95$1_95 () U)
(declare-fun g_s95$1_98 () U)
(declare-fun g_s95$1_100 () U)
(declare-fun g_s95$1_102 () U)
(declare-fun g_s98_96 () U)
; Defines
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s94_94 g_s14_15))
(assert (mem g_s94_94 g_s59_60))
(define-fun lh_1 () Bool (mem g_s95$1_95 g_s4_5))
; PO 1 in group 0
(push 1)
...
; PO 2 in group 0
(push 1)
(assert (not (=> lh_1 (mem g_s94_94 (dom g_s85_86)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s98_96 g_s15_16))
(assert (mem g_s98_96 g_s62_63))
(define-fun lh_1 () Bool (mem g_s95$1_95 g_s4_5))
; PO 1 in group 1
(push 1)
...
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (mem g_s98_96 (dom g_s86_87)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s100_97 g_s17_18))
(assert (mem g_s100_97 g_s68_69))
(define-fun lh_1 () Bool (mem g_s95$1_98 g_s6_7))
; PO 1 in group 2
(push 1)
...
; PO 2 in group 2
(push 1)
(assert (not (=> lh_1 (mem g_s100_97 (dom g_s87_88)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s102_99 g_s1_2))
(assert (mem g_s102_99 g_s22_23))
(define-fun lh_1 () Bool (mem g_s95$1_100 g_s8_9))
; PO 1 in group 3
(push 1)
...
; PO 2 in group 3
(push 1)
(assert (not (=> lh_1 (mem g_s102_99 (dom g_s88_89)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s104_101 g_s3_4))
(assert (mem g_s104_101 g_s28_29))
(define-fun lh_1 () Bool (mem g_s95$1_102 g_s9_10))
; PO 1 in group 4
(push 1)
...
; PO 2 in group 4
(push 1)
(assert (not (=> lh_1 (mem g_s104_101 (dom g_s89_90)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s104_101 g_s3_4))
(assert (mem g_s104_101 g_s28_29))
(define-fun lh_1 () Bool (mem g_s95$1_103 g_s13_14))
; PO 1 in group 5
(push 1)
...
; PO 2 in group 5
(push 1)
(assert (not (=> lh_1 (mem g_s104_101 (dom g_s90_91)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s107_104 g_s2_3))
(assert (mem g_s107_104 g_s25_26))
(define-fun lh_1 () Bool (mem g_s95$1_105 g_s10_11))
; PO 1 in group 6
(push 1)
...
; PO 2 in group 6
(push 1)
(assert (not (=> lh_1 (mem g_s107_104 (dom g_s91_92)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s109_106 g_s0_1))
(assert (mem g_s109_106 g_s19_20))
(define-fun lh_1 () Bool (mem g_s95$1_107 g_s11_12))
; PO 1 in group 7
(push 1)
...
; PO 2 in group 7
(push 1)
(assert (not (=> lh_1 (mem g_s109_106 (dom g_s92_93)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
