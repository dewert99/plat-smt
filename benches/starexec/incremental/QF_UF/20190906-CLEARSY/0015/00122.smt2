...
(declare-fun g_s332$1_335 () U)
(declare-fun g_s333_334 () U)
(declare-fun g_s334$1_336 () U)
(declare-fun g_s335$1_337 () U)
(declare-fun g_s337_340 () U)
(declare-fun g_s337_338 () U)
(declare-fun g_s337$1_341 () U)
(declare-fun g_s337$1_339 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s331_332 g_s58_59) (mem g_s332_333 g_s22_23) (mem g_s333_334 BOOL)))
(define-fun |def_inv| () Bool (and (= g_s332_333 g_s332$1_335) (= g_s331_332 g_s334$1_336) (= g_s332$1_335 g_s332$1_335) (= g_s333_334 g_s335$1_337)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s334$1_336 g_s58_59) (mem g_s332$1_335 g_s22_23) (mem g_s335$1_337 BOOL)))
; PO group 0 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s337$1_339 g_s337_338))
; PO 1 in group 0
(assert (not (= g_s334$1_336 g_s331_332)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s337$1_341 g_s337_340))
; PO 1 in group 1
(assert (not (= g_s335$1_337 g_s333_334)))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)