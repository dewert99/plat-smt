...
(declare-fun g_s362$1_363 () U)
(declare-fun g_s363$1_364 () U)
(declare-fun g_s365_365 () U)
(declare-fun g_s365_371 () U)
(declare-fun g_s365_369 () U)
(declare-fun g_s365_367 () U)
(declare-fun g_s365$1_366 () U)
(declare-fun g_s365$1_372 () U)
(declare-fun g_s365$1_370 () U)
(declare-fun g_s365$1_368 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s356_357 g_s111_113) (mem g_s357_358 g_s58_59) (mem g_s358_359 g_s22_23) (mem g_s359_360 BOOL)))
(define-fun |def_inv| () Bool (and (= g_s356_357 g_s360$1_361) (= g_s357_358 g_s361$1_362) (= g_s358_359 g_s362$1_363) (= g_s359_360 g_s363$1_364)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s360$1_361 g_s111_113) (mem g_s361$1_362 g_s58_59) (mem g_s362$1_363 g_s22_23) (mem g_s363$1_364 BOOL)))
; PO group 0 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s365$1_366 g_s365_365))
; PO 1 in group 0
(assert (not (= g_s360$1_361 g_s356_357)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s365$1_368 g_s365_367))
; PO 1 in group 1
(assert (not (= g_s361$1_362 g_s357_358)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s365$1_370 g_s365_369))
; PO 1 in group 2
(assert (not (= g_s362$1_363 g_s358_359)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s365$1_372 g_s365_371))
; PO 1 in group 3
(assert (not (= g_s363$1_364 g_s359_360)))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)