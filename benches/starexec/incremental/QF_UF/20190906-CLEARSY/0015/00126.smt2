...
(declare-fun g_s21$1_22 () U)
(declare-fun g_s22$1_23 () U)
...
(define-fun |def_abs| () Bool  (mem g_s18_19 g_s3_4))
(define-fun |def_inv| () Bool  (= g_s18_19 g_s19$1_20))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s19$1_20 g_s2_3) (mem g_s19$1_20 g_s3_4)))
; PO group 0 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s21$1_22 g_s21_21))
(define-fun lh_1 () Bool (mem g_s22$1_23 g_s2_3))
(define-fun lh_2 () Bool (= g_s22$1_23 g_s19$1_20))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s18_19 g_s2_3))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (= g_s22$1_23 g_s18_19))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)