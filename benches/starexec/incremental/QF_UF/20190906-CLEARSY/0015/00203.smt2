...
(define-fun |def_seext| () Bool (and (mem g_s123_123 (|+->| g_s33_33 g_s56_55)) (mem g_s124_124 (|+->| g_s33_33 g_s56_55)) (mem g_s125_125 (|-->| g_s33_33 NAT)) (mem g_s126_128 (|-->| g_s33_33 (|+->| g_s127_127 g_s128_126))) (mem g_s129_129 (|+->| g_s33_33 g_s9_9)) (mem g_s130_130 (|+->| g_s33_33 g_s9_9)) (subset g_s131_131 g_s33_33) (mem g_s132_132 g_s9_9)))
(define-fun |def_lprp| () Bool true)
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_mchcst| () Bool true)
(define-fun |def_aprp| () Bool true)
(define-fun |def_abs| () Bool  (subset g_s133_133 g_s33_33))
(define-fun |def_inv| () Bool (and (= g_s133_133 g_s133$1_134) (subset g_s133$1_134 g_s33_33)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (subset empty g_s33_33)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s137_135 g_s0_1))
(assert (mem g_s137_135 g_s33_33))
(assert (mem g_s137_135 g_s0_1))
(assert (mem g_s137_135 g_s33_33))
(define-fun lh_1 () Bool (mem g_s137_135 g_s131_131))
(define-fun lh_2 () Bool (mem (mapplet g_s137_135 g_s55_56) g_s124_124))
(define-fun lh_3 () Bool (mem (mapplet g_s137_135 (apply g_s105_105 g_s137_135)) g_s123_123))
(define-fun lh_4 () Bool (not (and (mem g_s137_135 g_s131_131) (mem (mapplet g_s137_135 g_s55_56) g_s124_124) (mem (mapplet g_s137_135 (apply g_s105_105 g_s137_135)) g_s123_123))))
; PO 1 in group 1
(push 1)
(assert (not (=> lh_4 (subset (set_diff g_s133$1_134 (SET g_s137_135)) g_s33_33))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (binary_union g_s133$1_134 (SET g_s137_135)) g_s33_33))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s137_135 g_s0_1))
(assert (mem g_s137_135 g_s33_33))
(define-fun lh_1 () Bool (= (bool (and (mem g_s137_135 g_s131_131) (mem g_s137_135 (dom g_s130_130)) (or (mem (mapplet (mapplet g_s132_132 g_s103_103) (apply g_s130_130 g_s137_135)) g_s27_28) (mem (mapplet (mapplet g_s132_132 g_s103_103) (apply g_s130_130 g_s137_135)) g_s19_20)))) TRUE))
; PO 1 in group 2
(assert (not (=> lh_1 (mem g_s137_135 (dom g_s130_130)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
; PO 1 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s105_105 (|+->| (dom g_s105_105) (ran g_s105_105))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s137_135 (dom g_s105_105)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s137_135 g_s33_33))
(define-fun lh_1 () Bool (mem g_s137_135 g_s131_131))
(define-fun lh_2 () Bool (mem g_s137_135 (dom g_s130_130)))
(define-fun lh_3 () Bool (not (mem (mapplet (mapplet g_s132_132 g_s103_103) (apply g_s130_130 g_s137_135)) g_s27_28)))
; PO 1 in group 5
(push 1)
