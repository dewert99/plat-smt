...
(define-fun |def_abs| () Bool (and (mem g_s74_75 (|>+>| g_s67_68 g_s33_34)) (subset g_s75_76 g_s67_68) (subset g_s76_77 g_s67_68) (subset g_s77_78 g_s67_68) (subset g_s78_79 g_s67_68) (mem g_s74_75 (|>+>| g_s67_68 g_s33_34)) (subset g_s75_76 g_s67_68) (subset g_s76_77 g_s67_68) (subset g_s77_78 g_s67_68) (subset g_s78_79 g_s67_68)))
...
(define-fun lh_2 () Bool (mem g_s82_85 (dom g_s74$1_80)))
(define-fun lh_3 () Bool (mem g_s82_85 (dom g_s72_73)))
(define-fun lh_4 () Bool (not (mem (apply g_s72_73 g_s82_85) (ran g_s74$1_80))))
(define-fun lh_5 () Bool (not (mem g_s82_85 g_s76$1_82)))
(define-fun lh_6 () Bool (not (mem g_s82_85 g_s77$1_83)))
(define-fun lh_7 () Bool (not (mem g_s82_85 g_s78$1_84)))
(define-fun lh_8 () Bool (= g_s84_87 FALSE))
(define-fun lh_9 () Bool (= g_s83_86 g_s18_19))
(define-fun lh_10 () Bool (not (and (mem g_s82_85 (dom g_s72_73)) (not (mem (apply g_s72_73 g_s82_85) (ran g_s74$1_80))) (not (mem g_s82_85 g_s76$1_82)) (not (mem g_s82_85 g_s77$1_83)) (not (mem g_s82_85 g_s78$1_84)) (= g_s84_87 FALSE) (= g_s83_86 g_s18_19))))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (not (mem g_s82_85 g_s77_78)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (not (mem g_s82_85 g_s78_79)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (not (mem g_s82_85 g_s76_77)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (not (mem g_s82_85 (dom g_s74_75))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (not (mem (apply g_s72_73 g_s82_85) (ran g_s74_75))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (mem g_s82_85 (dom g_s74_75)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (subset (set_diff g_s75$1_81 (SET g_s82_85)) g_s67_68))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (= (set_diff g_s75_76 (SET g_s82_85)) (set_diff g_s75$1_81 (SET g_s82_85))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (= (|<+| g_s74_75 (SET (mapplet g_s82_85 (apply g_s72_73 g_s82_85)))) g_s74$1_80))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (= (binary_union g_s75_76 (SET g_s82_85)) (set_diff g_s75$1_81 (SET g_s82_85))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (not (and (mem g_s82_85 g_s73_74) (not (mem g_s82_85 (dom g_s74_75))) (mem g_s82_85 (dom g_s72_73)) (not (mem (apply g_s72_73 g_s82_85) (ran g_s74_75))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_10) (not (and (mem g_s82_85 g_s73_74) (mem g_s82_85 (dom g_s74_75)) (mem g_s82_85 (dom g_s72_73)) (not (mem (apply g_s72_73 g_s82_85) (ran g_s74_75))) (not (mem g_s82_85 g_s76_77)) (not (mem g_s82_85 g_s77_78)) (not (mem g_s82_85 g_s78_79)) (= g_s84_87 FALSE) (= g_s83_86 g_s18_19))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (mem g_s82_85 g_s77_78)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (mem g_s82_85 g_s78_79)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (mem g_s82_85 g_s76_77)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 16 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (mem g_s82_85 (dom g_s74_75))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 17 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (mem (apply g_s72_73 g_s82_85) (ran g_s74_75))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 18 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s82_85 (dom g_s74_75)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 19 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem (|<+| g_s74$1_80 (SET (mapplet g_s82_85 (apply g_s72_73 g_s82_85)))) (|>+>| g_s67_68 g_s33_34)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 20 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (subset (binary_union g_s75$1_81 (SET g_s82_85)) g_s67_68))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 21 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (= g_s74_75 (|<+| g_s74$1_80 (SET (mapplet g_s82_85 (apply g_s72_73 g_s82_85))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 22 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (= (set_diff g_s75_76 (SET g_s82_85)) (binary_union g_s75$1_81 (SET g_s82_85))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 23 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (= (|<+| g_s74_75 (SET (mapplet g_s82_85 (apply g_s72_73 g_s82_85)))) (|<+| g_s74$1_80 (SET (mapplet g_s82_85 (apply g_s72_73 g_s82_85))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 24 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (= (binary_union g_s75_76 (SET g_s82_85)) (binary_union g_s75$1_81 (SET g_s82_85))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 25 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (and (mem g_s82_85 g_s73_74) (not (mem g_s82_85 (dom g_s74_75))) (mem g_s82_85 (dom g_s72_73)) (not (mem (apply g_s72_73 g_s82_85) (ran g_s74_75))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 26 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (and (mem g_s82_85 g_s73_74) (mem g_s82_85 (dom g_s74_75)) (mem g_s82_85 (dom g_s72_73)) (not (mem (apply g_s72_73 g_s82_85) (ran g_s74_75))) (not (mem g_s82_85 g_s76_77)) (not (mem g_s82_85 g_s77_78)) (not (mem g_s82_85 g_s78_79)) (= g_s84_87 FALSE) (= g_s83_86 g_s18_19))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 17
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s72_73 (|+->| (dom g_s72_73) (ran g_s72_73))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
