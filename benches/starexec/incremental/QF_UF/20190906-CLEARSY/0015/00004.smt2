...
(define-fun |def_inv| () Bool (and (= (dom g_s18_20) g_s19_19) (mem g_s18_20 (|+->| g_s8_9 g_s3_4)) (mem g_s20_21 (|+->| g_s8_9 g_s3_4)) (subset g_s21_22 g_s8_9) (subset g_s19_19 g_s8_9)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s23_23 g_s0_1))
(assert (mem g_s23_23 g_s8_9))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s27_25 g_s0_1))
(assert (mem g_s27_25 g_s8_9))
