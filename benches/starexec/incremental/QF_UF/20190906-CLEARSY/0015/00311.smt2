...
(define-fun |def_lprp| () Bool (and (not (= g_s44_46 empty)) (subset g_s45_47 g_s44_46) (mem g_s46_48 g_s44_46) (not (mem g_s46_48 g_s45_47)) (mem g_s47_49 (|+->| NAT g_s44_46)) (mem g_s47_49 (perm g_s45_47))))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s53_50 NATURAL))
(assert (mem g_s53_50 (dom g_s47_49)))
; PO 1 in group 2
