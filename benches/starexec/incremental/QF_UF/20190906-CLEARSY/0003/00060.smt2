...
(declare-fun g_s162_171 () U)
(declare-fun g_s163_172 () U)
(declare-fun g_s164_173 () U)
...
(declare-fun g_s173_182 () U)
(declare-fun g_s173_185 () U)
...
(define-fun |def_lprp| () Bool (and (mem g_s158_166 g_s1_2) (mem g_s159_167 g_s1_2) (mem (mapplet g_s42_46 g_s159_167) g_s35_39) (mem g_s160_168 (seq NAT)) (mem g_s161_169 (seq NAT)) (= (size g_s160_168) e170) (= (size g_s160_168) (size g_s161_169)) (mem g_s162_171 (|-->| g_s17_18 NAT)) (mem g_s163_172 (|-->| g_s17_18 NAT)) (mem g_s164_173 (seq NAT)) (mem g_s165_174 (seq NAT)) (= (size g_s164_173) e175) (= (size g_s164_173) (size g_s165_174)) (mem g_s166_176 (|-->| g_s18_19 NAT)) (mem g_s167_177 (|-->| g_s18_19 NAT)) (mem g_s168_178 g_s29_31) (mem g_s169_179 g_s19_20) (|<=i| e48 g_s169_179)))
...
(assert |def_cst|)
(assert |def_sets|)
(define-fun lh_1 () Bool (mem g_s158_166 g_s1_2))
(define-fun lh_2 () Bool (mem g_s159_167 g_s1_2))
(define-fun lh_3 () Bool (mem (mapplet g_s42_46 g_s159_167) g_s35_39))
(define-fun lh_4 () Bool (mem g_s160_168 (seq NAT)))
(define-fun lh_5 () Bool (mem g_s161_169 (seq NAT)))
(define-fun lh_6 () Bool (= (size g_s160_168) e170))
(define-fun lh_7 () Bool (= (size g_s160_168) (size g_s161_169)))
(define-fun lh_8 () Bool (mem g_s162_171 (|-->| g_s17_18 NAT)))
(define-fun lh_9 () Bool (mem g_s163_172 (|-->| g_s17_18 NAT)))
(define-fun lh_10 () Bool (mem g_s164_173 (seq NAT)))
(define-fun lh_11 () Bool (mem g_s165_174 (seq NAT)))
(define-fun lh_12 () Bool (= (size g_s164_173) e175))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem g_s160_168 (seq (ran g_s160_168))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem g_s160_168 (seq (ran g_s160_168))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem g_s161_169 (seq (ran g_s161_169))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11) (mem g_s164_173 (seq (ran g_s164_173))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (mem g_s164_173 (seq (ran g_s164_173))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (mem g_s165_174 (seq (ran g_s165_174))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s173_180 NAT))
(assert (mem g_s173_180 (dom g_s160_168)))
(assert (mem g_s174_181 NAT))
; PO 1 in group 1
(assert (not (mem g_s160_168 (|+->| (dom g_s160_168) (ran g_s160_168)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_ass|)
(assert (mem g_s173_180 NAT))
(assert (mem g_s173_180 (dom g_s161_169)))
(assert (mem g_s174_181 NAT))
; PO 1 in group 2
(assert (not (mem g_s161_169 (|+->| (dom g_s161_169) (ran g_s161_169)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s173_182 g_s17_18))
(assert (mem g_s178_183 NAT))
(assert (mem g_s179_184 NAT))
; PO 1 in group 3
(push 1)
(assert (not (mem g_s162_171 (|+->| (dom g_s162_171) (ran g_s162_171)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (mem g_s163_172 (|+->| (dom g_s163_172) (ran g_s163_172)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 3
(push 1)
(assert (not (mem g_s173_182 (dom g_s162_171))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 3
(push 1)
(assert (not (mem g_s173_182 (dom g_s163_172))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s173_180 NAT))
(assert (mem g_s173_180 (dom g_s164_173)))
(assert (mem g_s174_181 NAT))
; PO 1 in group 4
(assert (not (mem g_s164_173 (|+->| (dom g_s164_173) (ran g_s164_173)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert |def_ass|)
(assert (mem g_s173_180 NAT))
(assert (mem g_s173_180 (dom g_s165_174)))
(assert (mem g_s174_181 NAT))
; PO 1 in group 5
(assert (not (mem g_s165_174 (|+->| (dom g_s165_174) (ran g_s165_174)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s173_185 g_s18_19))
(assert (mem g_s178_183 NAT))
(assert (mem g_s179_184 NAT))
; PO 1 in group 6
(push 1)
(assert (not (mem g_s166_176 (|+->| (dom g_s166_176) (ran g_s166_176)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 6
(push 1)
(assert (not (mem g_s167_177 (|+->| (dom g_s167_177) (ran g_s167_177)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 6
(push 1)
(assert (not (mem g_s173_185 (dom g_s166_176))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 6
(push 1)
(assert (not (mem g_s173_185 (dom g_s167_177))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
