...
(define-fun |def_inv| () Bool (and (mem g_s202_204 g_s171_172) (mem g_s203_205 g_s197_199) (mem g_s204_206 g_s197_199) (mem g_s205_207 g_s197_199) (mem g_s206_208 (|-->| g_s192_194 g_s198_200)) (mem g_s207_209 g_s35_36) (mem g_s208_210 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s210_211 g_s175_176))
(assert (mem g_s210_211 g_s192_194))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s206_208 (|+->| (dom g_s206_208) (ran g_s206_208)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem g_s210_211 (dom g_s206_208))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)