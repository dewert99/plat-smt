...
(declare-fun g_s104$3_124 () U)
(declare-fun g_s105$1_107 () U)
(declare-fun g_s105$2_125 () U)
(declare-fun g_s106$1_108 () U)
(declare-fun g_s106$2_120 () U)
(declare-fun g_s107$1_109 () U)
(declare-fun g_s108$1_110 () U)
(declare-fun g_s109$1_111 () U)
(declare-fun g_s109$2_117 () U)
(declare-fun g_s109$3_122 () U)
(declare-fun g_s11_12 () U)
(declare-fun g_s110$1_112 () U)
(declare-fun g_s110$2_118 () U)
(declare-fun g_s110$3_123 () U)
(declare-fun g_s111$1_113 () U)
(declare-fun g_s112$1_114 () U)
(declare-fun g_s113$1_115 () U)
(declare-fun g_s114$1_116 () U)
...
(define-fun |def_abs| () Bool  (subset g_s103_104 g_s34_35))
(define-fun |def_inv| () Bool (and (= g_s103_104 g_s103$1_105) (mem g_s104$1_106 BOOL) (mem g_s105$1_107 g_s1_2) (mem g_s106$1_108 g_s20_21)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (subset g_s103$1_105 g_s34_35) (subset g_s107$1_109 g_s34_35) (subset g_s108$1_110 g_s34_35) (subset g_s109$1_111 g_s34_35) (subset g_s110$1_112 g_s34_35) (subset g_s111$1_113 g_s34_35) (subset g_s112$1_114 g_s34_35) (= (binary_inter g_s112$1_114 g_s111$1_113) empty) (subset g_s113$1_115 g_s86_87) (subset g_s114$1_116 g_s86_87) (= (binary_inter g_s114$1_116 g_s113$1_115) empty)))
; PO group 0 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (subset g_s109$2_117 g_s34_35))
(define-fun lh_2 () Bool (subset g_s110$2_118 g_s34_35))
(define-fun lh_3 () Bool (mem g_s104$2_119 BOOL))
(define-fun lh_4 () Bool (mem g_s106$2_120 g_s20_21))
(define-fun lh_5 () Bool (subset g_s86_87 g_s86_87))
(define-fun lh_6 () Bool (subset empty g_s86_87))
(define-fun lh_7 () Bool (= (binary_union empty g_s86_87) g_s86_87))
(define-fun lh_8 () Bool (= (binary_inter empty g_s86_87) empty))
(define-fun lh_9 () Bool (= g_s104$2_119 (bool (not (= g_s86_87 empty)))))
(define-fun lh_10 () Bool (= g_s104$2_119 TRUE))
(define-fun lh_11 () Bool (not (= g_s86_87 empty)))
(define-fun lh_12 () Bool (mem g_s116_121 g_s20_21))
(define-fun lh_13 () Bool (mem g_s116_121 g_s86_87))
(define-fun lh_14 () Bool (subset g_s109$3_122 g_s34_35))
(define-fun lh_15 () Bool (subset g_s110$3_123 g_s34_35))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset empty g_s86_87))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset g_s86_87 g_s86_87))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (binary_inter empty g_s86_87) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (binary_union empty g_s86_87) g_s86_87))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (|<=i| e0 (card g_s86_87)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (not (= g_s86_87 empty)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (subset (set_diff g_s86_87 (SET g_s116_121)) g_s86_87))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (subset (binary_union empty (SET g_s116_121)) g_s86_87))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (= (bool (not (= g_s86_87 (SET g_s116_121)))) (bool (not (= (set_diff g_s86_87 (SET g_s116_121)) empty)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (= (binary_inter (binary_union empty (SET g_s116_121)) (set_diff g_s86_87 (SET g_s116_121))) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (= (binary_union (binary_union empty (SET g_s116_121)) (set_diff g_s86_87 (SET g_s116_121))) g_s86_87))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (|<i| (card (set_diff g_s86_87 (SET g_s116_121))) (card g_s86_87)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_8 () Bool (= (binary_inter empty g_s86_87) empty))
(define-fun lh_9 () Bool (= g_s104$2_119 (bool (not (= g_s86_87 empty)))))
(define-fun lh_10 () Bool (not (= g_s104$2_119 TRUE)))
(define-fun lh_11 () Bool (mem g_s104$3_124 BOOL))
(define-fun lh_12 () Bool (mem g_s105$2_125 g_s1_2))
(define-fun lh_13 () Bool (subset g_s34_35 g_s34_35))
(define-fun lh_14 () Bool (subset empty g_s34_35))
(define-fun lh_15 () Bool (= (binary_union empty g_s34_35) g_s34_35))
(define-fun lh_16 () Bool (= (binary_inter empty g_s34_35) empty))
(define-fun lh_17 () Bool (= g_s104$3_124 (bool (not (= g_s34_35 empty)))))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s86_87 (FIN g_s86_87)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16 lh_17) (mem g_s34_35 (FIN g_s34_35)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
