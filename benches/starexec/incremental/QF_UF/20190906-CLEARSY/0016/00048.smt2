...
(define-fun |def_abs| () Bool (and (mem g_s51_52 g_s2_4) (mem g_s51_52 g_s4_5)))
(define-fun |def_inv| () Bool (and (= g_s51_52 g_s51$1_53) (mem g_s51$1_53 g_s2_4) (mem g_s51$1_53 g_s4_5)))
...
; PO 1 in group 0
(push 1)
(assert (not (mem (apply g_s28_30 (mapplet g_s51$1_53 g_s23_25)) g_s4_5)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (apply g_s28_30 (mapplet g_s51$1_53 g_s23_25)) g_s2_4)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s55_55 g_s55$1_54))
(define-fun lh_1 () Bool (mem g_s55$2_56 g_s2_4))
(define-fun lh_2 () Bool (= g_s55$2_56 g_s51$1_53))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2) (= g_s51_52 g_s55$2_56))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
; PO 2 in group 2
(push 1)
(assert (not (mem (mapplet g_s51$1_53 g_s23_25) (dom g_s28_30))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
