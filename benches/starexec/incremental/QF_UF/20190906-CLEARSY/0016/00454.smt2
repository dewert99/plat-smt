...
(define-fun |def_abs| () Bool  (mem g_s19_21 g_s4_5))
(define-fun |def_inv| () Bool  (= g_s19_21 g_s20$1_22))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s20$1_22 g_s2_4) (mem g_s20$1_22 g_s4_5)))
; PO group 0 
...
(define-fun lh_1 () Bool (mem g_s23$1_25 g_s2_4))
(define-fun lh_2 () Bool (= g_s23$1_25 g_s20$1_22))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s19_21 g_s2_4))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (= g_s23$1_25 g_s19_21))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)