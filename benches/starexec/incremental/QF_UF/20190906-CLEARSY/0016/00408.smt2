...
(define-fun |def_inv| () Bool (and (subset g_s18_17 g_s7_8) (subset g_s19_18 g_s7_8) (= (binary_inter g_s18_17 g_s19_18) empty)))
...
(define-fun lh_1 () Bool (mem g_s24_19 g_s0_1))
(define-fun lh_2 () Bool (mem g_s24_19 g_s7_8))
(define-fun lh_3 () Bool (mem g_s24_19 g_s18_17))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (set_diff g_s18_17 (SET g_s24_19)) g_s7_8))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (binary_union g_s19_18 (SET g_s24_19)) g_s7_8))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
