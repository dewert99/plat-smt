...
(declare-fun g_s610$1_617 () U)
(declare-fun g_s612_620 () U)
(declare-fun g_s612_622 () U)
(declare-fun g_s612_618 () U)
(declare-fun g_s612$1_621 () U)
(declare-fun g_s612$1_623 () U)
(declare-fun g_s612$1_619 () U)
...
(define-fun |def_imext| () Bool (and (mem g_s601$1_612 BOOL) (mem g_s606$1_613 g_s106_107) (mem g_s607$1_614 g_s108_110) (mem g_s610$1_617 g_s108_110) (mem g_s608$1_615 g_s105_106) (mem g_s609$1_616 g_s105_106)))
; PO group 0 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s612$1_619 g_s612_618))
; PO 1 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s612$1_621 g_s612_620))
; PO 1 in group 1
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s612$1_623 g_s612_622))
; PO 1 in group 2
