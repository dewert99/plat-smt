...
(declare-fun g_s39_35 () U)
(declare-fun g_s4_5 () U)
(declare-fun g_s40$1_36 () U)
...
(define-fun |def_lprp| () Bool (and (not (= g_s24_26 empty)) (not (= g_s25_27 empty)) (subset g_s26_28 g_s24_26) (mem g_s27_29 g_s24_26) (not (mem g_s27_29 g_s26_28)) (subset g_s28_30 g_s25_27) (mem g_s29_31 g_s25_27) (not (mem g_s29_31 g_s28_30)) (mem g_s30_32 (|+->| NAT g_s25_27)) (mem g_s30_32 (perm g_s28_30)) (mem g_s31_33 (|>->| g_s28_30 g_s18_20))))
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool true)
(define-fun |def_ass| () Bool true)
(define-fun |def_cst| () Bool true)
(define-fun |def_sets| () Bool (and (not (= g_s24_26 empty)) (not (= g_s25_27 empty))))
; PO group 0 
(push 1)
...
(assert |def_cst|)
(assert |def_sets|)
(define-fun lh_1 () Bool (subset g_s26_28 g_s24_26))
(define-fun lh_2 () Bool (mem g_s27_29 g_s24_26))
(define-fun lh_3 () Bool (not (mem g_s27_29 g_s26_28)))
(define-fun lh_4 () Bool (subset g_s28_30 g_s25_27))
(define-fun lh_5 () Bool (mem g_s29_31 g_s25_27))
(define-fun lh_6 () Bool (not (mem g_s29_31 g_s28_30)))
(define-fun lh_7 () Bool (mem g_s30_32 (|+->| NAT g_s25_27)))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s28_30 (FIN g_s28_30)))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert (mem g_s37_34 (dom g_s30_32)))
; PO 1 in group 2
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s39_35 g_s25_27))
(assert (mem g_s39_35 g_s28_30))
(define-fun lh_1 () Bool (mem g_s40$1_36 g_s10_11))
(define-fun lh_2 () Bool (mem g_s40$1_36 g_s18_20))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s31_33 (|+->| (dom g_s31_33) (ran g_s31_33))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s39_35 (dom g_s31_33)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
