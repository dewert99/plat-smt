...
(declare-fun g_s263$1_260 () U)
(declare-fun g_s265$1_261 () U)
(declare-fun g_s268$1_262 () U)
(declare-fun g_s27_28 () U)
(declare-fun g_s270$1_263 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s250_252 (|-->| g_s237_239 (POW g_s183_185))) (mem g_s251_253 (|+->| g_s237_239 g_s223_225)) (mem g_s252_254 (|+->| g_s237_239 g_s142_144)) (mem g_s253_255 (|+->| g_s237_239 g_s223_225)) (mem g_s254_256 (|+->| g_s237_239 g_s142_144)) (subset g_s255_257 g_s237_239)))
...
; PO 1 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s237_239 g_s142_144))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s237_239 g_s223_225))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s237_239 (SET empty)) (|-->| g_s237_239 (POW g_s183_185)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (subset empty g_s237_239)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s259_258 g_s132_133))
(assert (mem g_s259_258 g_s237_239))
(assert (mem g_s260_259 g_s115_116))
(assert (mem g_s260_259 g_s183_185))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s250_252 (|+->| (dom g_s250_252) (ran g_s250_252)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s259_258 (dom g_s250_252))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s259_258 g_s132_133))
(assert (mem g_s259_258 g_s237_239))
(assert (mem g_s259_258 (dom g_s251_253)))
(define-fun lh_1 () Bool (mem g_s263$1_260 g_s129_130))
; PO 1 in group 2
...
(assert (mem g_s259_258 g_s132_133))
(assert (mem g_s259_258 g_s237_239))
(define-fun lh_1 () Bool (mem g_s259_258 (dom g_s252_254)))
(define-fun lh_2 () Bool (mem g_s265$1_261 g_s140_143))
; PO 1 in group 3
(assert (not (=> (and lh_1 lh_2) (mem g_s252_254 (|+->| (dom g_s252_254) (ran g_s252_254))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (mem g_s259_258 g_s132_133))
(assert (mem g_s259_258 g_s237_239))
(assert (mem g_s259_258 (dom g_s252_254)))
(define-fun lh_1 () Bool (mem g_s265$1_261 g_s140_143))
; PO 1 in group 4
(assert (not (=> lh_1 (mem g_s252_254 (|+->| (dom g_s252_254) (ran g_s252_254))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem g_s259_258 g_s132_133))
(assert (mem g_s259_258 g_s237_239))
(assert (mem g_s259_258 (dom g_s253_255)))
(define-fun lh_1 () Bool (mem g_s268$1_262 g_s129_130))
; PO 1 in group 5
(assert (not (=> lh_1 (mem g_s253_255 (|+->| (dom g_s253_255) (ran g_s253_255))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem g_s259_258 g_s132_133))
(assert (mem g_s259_258 g_s237_239))
(define-fun lh_1 () Bool (mem g_s259_258 (dom g_s254_256)))
(define-fun lh_2 () Bool (mem g_s270$1_263 g_s140_143))
; PO 1 in group 6
...
(assert (mem g_s259_258 g_s132_133))
(assert (mem g_s259_258 g_s237_239))
(assert (mem g_s259_258 (dom g_s254_256)))
(define-fun lh_1 () Bool (mem g_s270$1_263 g_s140_143))
; PO 1 in group 7
