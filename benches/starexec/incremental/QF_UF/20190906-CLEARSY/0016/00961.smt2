...
(define-fun |def_lprp| () Bool (and (not (= g_s15_17 empty)) (not (= g_s16_18 empty)) (subset g_s17_19 g_s15_17) (mem g_s18_20 g_s15_17) (not (mem g_s18_20 g_s17_19)) (mem g_s19_21 (|+->| NAT g_s15_17)) (mem g_s19_21 (perm g_s17_19)) (subset g_s20_22 g_s15_17) (mem g_s21_23 g_s15_17) (not (mem g_s21_23 g_s20_22)) (mem g_s22_24 (|+->| NAT g_s15_17)) (mem g_s22_24 (perm g_s20_22)) (subset g_s23_25 g_s15_17) (mem g_s24_26 g_s15_17) (not (mem g_s24_26 g_s23_25)) (mem g_s25_27 (|+->| NAT g_s15_17)) (mem g_s25_27 (perm g_s23_25)) (subset g_s20_22 g_s23_25) (subset g_s17_19 g_s20_22) (subset g_s26_28 g_s16_18) (mem g_s27_29 g_s16_18) (not (mem g_s27_29 g_s26_28)) (mem g_s28_30 (|+->| NAT g_s16_18)) (mem g_s28_30 (perm g_s26_28)) (subset g_s29_31 g_s16_18) (mem g_s30_32 g_s16_18) (not (mem g_s30_32 g_s29_31)) (mem g_s31_33 (|+->| NAT g_s16_18)) (mem g_s31_33 (perm g_s29_31)) (subset g_s26_28 g_s29_31)))
...
(define-fun lh_6 () Bool (subset g_s20_22 g_s15_17))
(define-fun lh_7 () Bool (mem g_s21_23 g_s15_17))
(define-fun lh_8 () Bool (not (mem g_s21_23 g_s20_22)))
(define-fun lh_9 () Bool (mem g_s22_24 (|+->| NAT g_s15_17)))
(define-fun lh_10 () Bool (mem g_s22_24 (perm g_s20_22)))
(define-fun lh_11 () Bool (subset g_s23_25 g_s15_17))
(define-fun lh_12 () Bool (mem g_s24_26 g_s15_17))
(define-fun lh_13 () Bool (not (mem g_s24_26 g_s23_25)))
(define-fun lh_14 () Bool (mem g_s25_27 (|+->| NAT g_s15_17)))
(define-fun lh_15 () Bool (mem g_s25_27 (perm g_s23_25)))
(define-fun lh_16 () Bool (subset g_s20_22 g_s23_25))
(define-fun lh_17 () Bool (subset g_s17_19 g_s20_22))
(define-fun lh_18 () Bool (subset g_s26_28 g_s16_18))
(define-fun lh_19 () Bool (mem g_s27_29 g_s16_18))
(define-fun lh_20 () Bool (not (mem g_s27_29 g_s26_28)))
(define-fun lh_21 () Bool (mem g_s28_30 (|+->| NAT g_s16_18)))
(define-fun lh_22 () Bool (mem g_s28_30 (perm g_s26_28)))
(define-fun lh_23 () Bool (subset g_s29_31 g_s16_18))
(define-fun lh_24 () Bool (mem g_s30_32 g_s16_18))
(define-fun lh_25 () Bool (not (mem g_s30_32 g_s29_31)))
(define-fun lh_26 () Bool (mem g_s31_33 (|+->| NAT g_s16_18)))
; PO 1 in group 0
(push 1)
...
; PO 3 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14) (mem g_s23_25 (FIN g_s23_25)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16 lh_17 lh_18 lh_19 lh_20 lh_21) (mem g_s26_28 (FIN g_s26_28)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16 lh_17 lh_18 lh_19 lh_20 lh_21 lh_22 lh_23 lh_24 lh_25 lh_26) (mem g_s29_31 (FIN g_s29_31)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s37_34 NATURAL))
(assert (mem g_s37_34 (dom g_s19_21)))
; PO 1 in group 2
...
(assert |def_ass|)
(assert (mem g_s37_34 NATURAL))
(assert (mem g_s37_34 (dom g_s25_27)))
; PO 1 in group 4
...
(assert |def_ass|)
(assert (mem g_s37_34 NATURAL))
(assert (mem g_s37_34 (dom g_s28_30)))
; PO 1 in group 6
...
(assert |def_ass|)
(assert (mem g_s37_34 NATURAL))
(assert (mem g_s37_34 (dom g_s31_33)))
; PO 1 in group 8
