...
(define-fun |def_inv| () Bool (and (mem g_s179_181 (|-->| (set_prod g_s108_109 g_s112_113) BOOL)) (mem g_s180_182 (|-->| g_s108_109 g_s105_106)) (mem g_s181_183 (|-->| g_s108_109 g_s118_121)) (mem g_s182_184 (|-->| g_s108_109 g_s105_106)) (mem g_s183_185 (|-->| g_s108_109 g_s118_121)) (mem g_s184_186 (|-->| g_s108_109 BOOL))))
...
; PO 4 in group 0
(push 1)
(assert (not (mem (set_prod (set_prod g_s108_109 g_s112_113) (SET FALSE)) (|-->| (set_prod g_s108_109 g_s112_113) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)