...
(declare-fun g_s254_311 () U)
(declare-fun g_s257_312 () U)
(declare-fun g_s259_313 () U)
(declare-fun g_s26_27 () U)
(declare-fun g_s262_314 () U)
...
(assert |def_cst|)
(assert |def_sets|)
(define-fun lh_1 () Bool (subset g_s244_304 g_s99_100))
(define-fun lh_2 () Bool (not (mem g_s100_101 g_s244_304)))
(define-fun lh_3 () Bool (= g_s244_304 (SET (mapplet g_s103_104 g_s102_103))))
(define-fun lh_4 () Bool (subset g_s245_305 g_s99_100))
(define-fun lh_5 () Bool (not (mem g_s100_101 g_s245_305)))
(define-fun lh_6 () Bool (= g_s245_305 (SET (mapplet g_s103_104 (mapplet g_s102_103 g_s101_102)))))
(define-fun lh_7 () Bool (mem g_s246_306 (|>->>| g_s244_304 g_s244_304)))
(define-fun lh_8 () Bool (= (binary_inter g_s246_306 (id g_s244_304)) empty))
(define-fun lh_9 () Bool (mem g_s247_307 (|>->| g_s30_31 g_s99_100)))
(define-fun lh_10 () Bool (not (mem (apply g_s247_307 g_s31_32) g_s244_304)))
(define-fun lh_11 () Bool (mem g_s248_308 (|>->>| g_s45_46 (set_diff g_s99_100 (SET g_s101_102)))))
(define-fun lh_12 () Bool (mem g_s249_309 (|>->>| (set_diff g_s99_100 (SET g_s101_102)) g_s45_46)))
(define-fun lh_13 () Bool (= g_s248_308 (inverse g_s249_309)))
(define-fun lh_14 () Bool (not (mem (apply g_s248_308 g_s46_47) g_s244_304)))
(define-fun lh_15 () Bool (mem g_s250_310 (|-->| g_s37_38 g_s30_31)))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s31_32 (dom g_s247_307)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s247_307 (|+->| (dom g_s247_307) (ran g_s247_307))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13) (mem g_s46_47 (dom g_s248_308)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13) (mem g_s248_308 (|+->| (dom g_s248_308) (ran g_s248_308))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (mem g_s41_42 (dom g_s250_310)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (mem g_s250_310 (|+->| (dom g_s250_310) (ran g_s250_310))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s254_311 g_s99_100))
(assert (mem g_s254_311 g_s244_304))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s246_306 (|+->| (dom g_s246_306) (ran g_s246_306)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s254_311 (dom g_s246_306))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s257_312 g_s30_31))
; PO 1 in group 2
(push 1)
(assert (not (mem g_s247_307 (|+->| (dom g_s247_307) (ran g_s247_307)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (mem g_s257_312 (dom g_s247_307))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s259_313 g_s45_46))
; PO 1 in group 3
(push 1)
(assert (not (mem g_s248_308 (|+->| (dom g_s248_308) (ran g_s248_308)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (mem g_s259_313 (dom g_s248_308))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 4
(push 1)
(assert (not (mem g_s249_309 (|+->| (dom g_s249_309) (ran g_s249_309)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (mem g_s254_311 (dom g_s249_309))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s262_314 g_s37_38))
; PO 1 in group 5
(push 1)
(assert (not (mem g_s250_310 (|+->| (dom g_s250_310) (ran g_s250_310)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
(push 1)
(assert (not (mem g_s262_314 (dom g_s250_310))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
