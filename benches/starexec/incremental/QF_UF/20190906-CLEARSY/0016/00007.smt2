...
(declare-fun g_s34$1_39 () U)
(declare-fun g_s35_34 () U)
(declare-fun g_s35$1_38 () U)
(declare-fun g_s36_35 () U)
(declare-fun g_s4_4 () U)
(declare-fun g_s43_36 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s26_28 (|+->| g_s21_23 g_s5_6)) (mem g_s27_29 (|+->| g_s21_23 g_s5_6)) (mem g_s28_30 g_s3_5) (subset g_s29_31 g_s21_23)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s33_32 g_s2_3))
(assert (mem g_s33_32 g_s21_23))
(assert (mem g_s34_33 g_s3_5))
(assert (mem g_s35_34 g_s3_5))
(assert (mem g_s36_35 BOOL))
(assert (mem g_s34_33 g_s20_22))
; PO 1 in group 1
(assert (not (mem (|<+| g_s26_28 (SET (mapplet g_s33_32 g_s34_33))) (|+->| g_s21_23 g_s5_6))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (mem g_s35_34 g_s3_5))
(assert (mem g_s36_35 BOOL))
(assert (not (mem g_s34_33 g_s20_22)))
; PO 1 in group 2
(assert (not (mem (domain_subtraction (SET g_s33_32) g_s26_28) (|+->| g_s21_23 g_s5_6))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (mem g_s35_34 g_s3_5))
(assert (mem g_s36_35 BOOL))
(assert (mem g_s35_34 g_s20_22))
; PO 1 in group 3
(assert (not (mem (|<+| g_s27_29 (SET (mapplet g_s33_32 g_s35_34))) (|+->| g_s21_23 g_s5_6))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (mem g_s35_34 g_s3_5))
(assert (mem g_s36_35 BOOL))
(assert (not (mem g_s35_34 g_s20_22)))
; PO 1 in group 4
(assert (not (mem (domain_subtraction (SET g_s33_32) g_s27_29) (|+->| g_s21_23 g_s5_6))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem g_s35_34 g_s3_5))
(assert (mem g_s36_35 BOOL))
(assert (= g_s36_35 TRUE))
; PO 1 in group 5
(assert (not (subset (binary_union g_s29_31 (SET g_s33_32)) g_s21_23)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem g_s35_34 g_s3_5))
(assert (mem g_s36_35 BOOL))
(assert (not (= g_s36_35 TRUE)))
; PO 1 in group 6
(assert (not (subset (set_diff g_s29_31 (SET g_s33_32)) g_s21_23)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s43_36 g_s2_3))
(assert (mem g_s43_36 g_s21_23))
(assert (mem g_s43_36 (dom g_s27_29)))
(define-fun lh_1 () Bool (mem g_s28$1_37 g_s3_5))
; PO 1 in group 7
(assert (not (=> lh_1 (mem g_s27_29 (|+->| (dom g_s27_29) (ran g_s27_29))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert (mem g_s33_32 g_s2_3))
(assert (mem g_s33_32 g_s21_23))
(assert (mem g_s33_32 (dom g_s27_29)))
(define-fun lh_1 () Bool (mem g_s35$1_38 g_s3_5))
; PO 1 in group 8
(assert (not (=> lh_1 (mem g_s27_29 (|+->| (dom g_s27_29) (ran g_s27_29))))))
(set-info :status unknown)
(check-sat)
...
(assert (mem g_s33_32 g_s2_3))
(assert (mem g_s33_32 g_s21_23))
(assert (mem g_s33_32 (dom g_s26_28)))
(define-fun lh_1 () Bool (mem g_s34$1_39 g_s3_5))
; PO 1 in group 9
(assert (not (=> lh_1 (mem g_s26_28 (|+->| (dom g_s26_28) (ran g_s26_28))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)