...
(declare-fun g_s119$1_179 () U)
(declare-fun g_s12_14 () U)
(declare-fun g_s123_180 () U)
(declare-fun g_s123$1_181 () U)
(declare-fun g_s125_182 () U)
(declare-fun g_s125$1_183 () U)
...
(define-fun |def_abs| () Bool (and (subset g_s117_177 g_s49_51) (subset g_s118_178 g_s49_51) (= (binary_inter g_s117_177 g_s118_178) empty)))
(define-fun |def_inv| () Bool (and (= g_s117_177 (image g_s51_53 (interval e12 g_s119$1_179))) (mem g_s119$1_179 NATURAL) (and (|>=i| g_s119$1_179 e0) (|<=i| g_s119$1_179 (size g_s51_53)))))
...
; PO 2 in group 0
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 (size g_s51_53)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (= empty (image g_s51_53 (interval e12 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s123$1_181 g_s123_180))
(define-fun lh_1 () Bool (mem (card g_s49_51) INT))
; PO 1 in group 1
(push 1)
(assert (not (=> lh_1 (mem (card g_s49_51) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (and (|>=i| (card g_s49_51) e0) (|<=i| (card g_s49_51) (size g_s51_53))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> lh_1 (= g_s49_51 (image g_s51_53 (interval e12 (card g_s49_51)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> lh_1 (= (bool (|<=i| g_s56_58 (card g_s49_51))) (bool (not (= g_s49_51 empty)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (= g_s123$1_181 g_s123_180))
(assert (= g_s125$1_183 g_s125_182))
(define-fun lh_1 () Bool (not (= g_s117_177 empty)))
(define-fun lh_2 () Bool (|<=i| e0 g_s119$1_179))
(define-fun lh_3 () Bool (mem g_s119$1_179 NATURAL))
(define-fun lh_4 () Bool (mem g_s119$1_179 (dom g_s51_53)))
; PO 1 in group 2
(push 1)
(assert (not (=> lh_1 (|<=i| e0 g_s119$1_179))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s119$1_179 (dom g_s51_53)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s51_53 g_s119$1_179) g_s49_51))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s51_53 g_s119$1_179) g_s117_177))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s119$1_179 g_s56_58) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s119$1_179 g_s56_58) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (and (|>=i| (|-i| g_s119$1_179 g_s56_58) e0) (|<=i| (|-i| g_s119$1_179 g_s56_58) (size g_s51_53))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (bool (|<=i| g_s56_58 (|-i| g_s119$1_179 g_s56_58))) (bool (not (= g_s117_177 (SET (apply g_s51_53 g_s119$1_179)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (set_diff g_s117_177 (SET (apply g_s51_53 g_s119$1_179))) (image g_s51_53 (interval e12 (|-i| g_s119$1_179 g_s56_58)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (= g_s117_177 (image g_s51_53 (interval e12 g_s119$1_179))))
(define-fun lh_2 () Bool (mem g_s119$1_179 NATURAL))
; PO 1 in group 3
(assert (not (=> (and lh_1 lh_2) (mem g_s51_53 (seq (ran g_s51_53))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)