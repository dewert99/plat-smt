...
(define-fun |def_abs| () Bool (and (mem g_s81_141 (|+->| g_s9_11 g_s4_5)) (mem g_s82_142 (|+->| g_s9_11 g_s4_5)) (subset g_s83_143 g_s9_11)))
(define-fun |def_inv| () Bool (and (mem g_s84$1_144 (|-->| g_s0_1 g_s2_4)) (= g_s81_141 (range_restriction (domain_restriction g_s9_11 g_s84$1_144) g_s4_5)) (mem g_s85$1_145 (|-->| g_s0_1 g_s2_4)) (= g_s82_142 (range_restriction (domain_restriction g_s9_11 g_s85$1_145) g_s4_5)) (mem g_s86$1_146 (|-->| g_s0_1 BOOL)) (= g_s83_143 (binary_inter g_s9_11 (image (inverse g_s86$1_146) (SET TRUE))))))
...
; PO 3 in group 0
(push 1)
(assert (not (= empty (binary_inter g_s9_11 (image (inverse (set_prod g_s0_1 (SET FALSE))) (SET TRUE))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s90_147 g_s0_1))
(define-fun lh_2 () Bool (mem g_s90_147 g_s9_11))
...
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|<+| g_s84$1_144 (SET (mapplet g_s90_147 g_s91_148))) (|-->| g_s0_1 g_s2_4)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (|<+| g_s81_141 (SET (mapplet g_s90_147 g_s91_148))) (range_restriction (domain_restriction g_s9_11 (|<+| g_s84$1_144 (SET (mapplet g_s90_147 g_s91_148)))) g_s4_5)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|<+| g_s84$1_144 (SET (mapplet g_s90_147 g_s7_9))) (|-->| g_s0_1 g_s2_4)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (domain_subtraction (SET g_s90_147) g_s81_141) (range_restriction (domain_restriction g_s9_11 (|<+| g_s84$1_144 (SET (mapplet g_s90_147 g_s7_9)))) g_s4_5)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|<+| g_s85$1_145 (SET (mapplet g_s90_147 g_s92_149))) (|-->| g_s0_1 g_s2_4)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (|<+| g_s82_142 (SET (mapplet g_s90_147 g_s92_149))) (range_restriction (domain_restriction g_s9_11 (|<+| g_s85$1_145 (SET (mapplet g_s90_147 g_s92_149)))) g_s4_5)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|<+| g_s85$1_145 (SET (mapplet g_s90_147 g_s7_9))) (|-->| g_s0_1 g_s2_4)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (domain_subtraction (SET g_s90_147) g_s82_142) (range_restriction (domain_restriction g_s9_11 (|<+| g_s85$1_145 (SET (mapplet g_s90_147 g_s7_9)))) g_s4_5)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|<+| g_s86$1_146 (SET (mapplet g_s90_147 g_s19_21))) (|-->| g_s0_1 BOOL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (binary_union g_s83_143 (SET g_s90_147)) (binary_inter g_s9_11 (image (inverse (|<+| g_s86$1_146 (SET (mapplet g_s90_147 g_s19_21)))) (SET TRUE)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|<+| g_s86$1_146 (SET (mapplet g_s90_147 g_s20_22))) (|-->| g_s0_1 BOOL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (set_diff g_s83_143 (SET g_s90_147)) (binary_inter g_s9_11 (image (inverse (|<+| g_s86$1_146 (SET (mapplet g_s90_147 g_s20_22)))) (SET TRUE)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s106_158 g_s0_1))
(define-fun lh_2 () Bool (mem g_s106_158 g_s9_11))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s90_147 g_s0_1))
(assert (mem g_s90_147 g_s9_11))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s106_158 g_s0_1))
(assert (mem g_s106_158 g_s9_11))
; PO 1 in group 16
(push 1)
