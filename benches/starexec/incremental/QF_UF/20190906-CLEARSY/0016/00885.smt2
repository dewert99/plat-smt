...
(define-fun |def_lprp| () Bool (and (mem g_s95_96 (|+->| g_s44_45 g_s26_27)) (mem g_s96_97 (|+->| g_s44_45 g_s26_27)) (= (dom g_s95_96) g_s44_45)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s98_98 g_s6_7))
(assert (mem g_s98_98 g_s44_45))
