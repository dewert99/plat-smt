...
(define-fun |def_inv| () Bool (and (mem g_s179_181 (|-->| g_s151_153 (POW g_s167_169))) (mem g_s180_182 (|+->| g_s151_153 g_s137_139)) (mem g_s181_183 (|+->| g_s151_153 g_s120_122)) (mem g_s182_184 (|+->| g_s151_153 g_s137_139)) (mem g_s183_185 (|+->| g_s151_153 g_s120_122)) (subset g_s184_186 g_s151_153)))
...
; PO 1 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s151_153 g_s120_122))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s151_153 g_s137_139))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s151_153 (SET empty)) (|-->| g_s151_153 (POW g_s167_169)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (subset empty g_s151_153)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s188_187 g_s108_109))
(assert (mem g_s188_187 g_s151_153))
(assert (mem g_s189_188 g_s112_113))
(assert (mem g_s189_188 g_s167_169))
; PO 1 in group 1
(push 1)
...
(define-fun lh_1 () Bool (mem g_s192$1_189 g_s105_106))
; PO 1 in group 2
...
(define-fun lh_2 () Bool (mem g_s194$1_190 g_s118_121))
; PO 1 in group 3
...
(define-fun lh_1 () Bool (mem g_s194$1_190 g_s118_121))
; PO 1 in group 4
...
(define-fun lh_1 () Bool (mem g_s197$1_191 g_s105_106))
; PO 1 in group 5
...
(define-fun lh_2 () Bool (mem g_s199$1_192 g_s118_121))
; PO 1 in group 6
...
(define-fun lh_1 () Bool (mem g_s199$1_192 g_s118_121))
; PO 1 in group 7
