...
(define-fun |def_inv| () Bool (and (mem g_s101$1_102 (|+->| g_s62_63 g_s17_18)) (mem g_s102$1_103 g_s15_17) (mem g_s103$1_104 g_s15_17) (mem g_s104$1_105 BOOL)))
...
(assert (mem g_s108_106 g_s4_5))
(assert (mem g_s108_106 g_s62_63))
(assert (= g_s109_108 g_s109$1_107))
(assert (= g_s110_110 g_s110$1_109))
(assert (= g_s111_112 g_s111$1_111))
(assert (mem g_s108_106 g_s4_5))
(assert (mem g_s108_106 g_s62_63))
(define-fun lh_1 () Bool (mem g_s108_106 (binary_inter g_s79_80 (dom g_s81_82))))
(define-fun lh_2 () Bool (mem g_s108_106 (binary_inter g_s77_78 (dom g_s89_90))))
(define-fun lh_3 () Bool (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98))))
(define-fun lh_4 () Bool (mem (apply g_s55_57 (mapplet (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106))) (apply g_s97_98 g_s108_106))) g_s17_18))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|<+| g_s101$1_102 (SET (mapplet g_s108_106 (apply g_s55_57 (mapplet (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106))) (apply g_s97_98 g_s108_106)))))) (|+->| g_s62_63 g_s17_18)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s55_57 (mapplet (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106))) (apply g_s97_98 g_s108_106))) g_s15_17))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= FALSE g_s104$1_105))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= g_s20_22 g_s103$1_104))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s89_90 (|+->| (dom g_s89_90) (ran g_s89_90))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
...
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s108_106 (dom g_s89_90)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s108_106 (dom g_s97_98)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s108_106 (dom g_s81_82)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106)) (dom g_s55_57)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (mapplet (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106))) (apply g_s97_98 g_s108_106)) (dom g_s55_57)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
