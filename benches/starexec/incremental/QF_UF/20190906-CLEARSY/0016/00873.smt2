...
(define-fun |def_lprp| () Bool (and (mem g_s95_96 (|+->| g_s31_32 g_s26_27)) (= (dom g_s95_96) g_s31_32)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s97_97 g_s2_3))
(assert (mem g_s97_97 g_s31_32))
(define-fun lh_1 () Bool (mem g_s97_97 (dom g_s95_96)))
(define-fun lh_2 () Bool (mem g_s98$1_98 g_s0_1))
; PO 1 in group 0
...
(assert (mem g_s97_97 g_s2_3))
(assert (mem g_s97_97 g_s31_32))
(define-fun lh_1 () Bool (mem g_s98$1_98 g_s0_1))
; PO 1 in group 1
(push 1)
...
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (mem g_s97_97 (dom g_s95_96)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
