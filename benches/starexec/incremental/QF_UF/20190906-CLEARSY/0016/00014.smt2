...
(define-fun |def_inv| () Bool (and (= (dom g_s19_22) g_s20_21) (mem g_s19_22 (|+->| g_s9_11 g_s4_5)) (mem g_s21_23 (|+->| g_s9_11 g_s4_5)) (subset g_s22_24 g_s9_11) (subset g_s20_21 g_s9_11)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s24_25 g_s0_1))
(assert (mem g_s24_25 g_s9_11))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s28_27 g_s0_1))
(assert (mem g_s28_27 g_s9_11))
