...
(define-fun |def_abs| () Bool (and (subset g_s80_138 g_s15_14) (subset g_s81_139 g_s15_14) (= (binary_inter g_s80_138 g_s81_139) empty)))
(define-fun |def_inv| () Bool (and (mem g_s82$1_140 NATURAL) (and (|>=i| g_s82$1_140 e0) (|<=i| g_s82$1_140 (size g_s16_15))) (= g_s80_138 (image g_s16_15 (interval e20 g_s82$1_140)))))
...
(define-fun lh_4 () Bool (mem g_s82$1_140 (dom g_s16_15)))
; PO 1 in group 2
(push 1)
...
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s82$1_140 (dom g_s16_15)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s16_15 g_s82$1_140) g_s15_14))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s16_15 g_s82$1_140) g_s80_138))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s82$1_140 e20) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s82$1_140 e20) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (and (|>=i| (|-i| g_s82$1_140 e20) e0) (|<=i| (|-i| g_s82$1_140 e20) (size g_s16_15))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (bool (|<=i| g_s21_21 (|-i| g_s82$1_140 e20))) (bool (not (= g_s80_138 (SET (apply g_s16_15 g_s82$1_140)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (set_diff g_s80_138 (SET (apply g_s16_15 g_s82$1_140))) (image g_s16_15 (interval e20 (|-i| g_s82$1_140 e20)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
