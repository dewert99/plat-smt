...
(define-fun |def_inv| () Bool  (mem g_s55_57 (|+->| g_s7_8 g_s4_5)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (mem empty (|+->| g_s7_8 g_s4_5))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (not (mem (apply g_s54_56 g_s59_58) (ran g_s55_57))))
(assert (mem g_s59_58 (dom g_s54_56)))
(assert (not (mem g_s59_58 (dom g_s55_57))))
(assert (mem g_s59_58 g_s53_55))
(assert (mem g_s60_59 BOOL))
(assert (mem g_s61_60 g_s8_10))
(assert (mem g_s59_58 g_s7_8))
(assert (mem g_s59_58 g_s49_51))
; PO 1 in group 1
(assert (not (mem (|<+| g_s55_57 (SET (mapplet g_s59_58 (apply g_s54_56 g_s59_58)))) (|+->| g_s7_8 g_s4_5))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (not (mem (apply g_s54_56 g_s59_58) (ran g_s55_57))))
(assert (mem g_s59_58 (dom g_s54_56)))
(assert (mem g_s59_58 (dom g_s55_57)))
(assert (mem g_s59_58 g_s53_55))
(assert (mem g_s59_58 (dom g_s55_57)))
(assert (mem g_s59_58 g_s53_55))
(assert (mem g_s60_59 BOOL))
...
(assert (mem g_s59_58 g_s7_8))
(assert (mem g_s59_58 g_s49_51))
(define-fun lh_1 () Bool (mem g_s64$1_61 g_s4_5))
; PO 1 in group 3
...
(assert (mem g_s59_58 g_s7_8))
(assert (mem g_s59_58 g_s49_51))
(define-fun lh_1 () Bool (mem g_s59_58 (dom g_s55_57)))
(define-fun lh_2 () Bool (mem g_s67$1_62 g_s4_5))
; PO 1 in group 4
...
; PO 1 in group 5
(push 1)
(assert (not (mem g_s59_58 (dom g_s54_56))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
