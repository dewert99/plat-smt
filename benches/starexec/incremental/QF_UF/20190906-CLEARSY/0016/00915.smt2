...
; PO 1 in group 0
(push 1)
(assert (not (not (mem g_s148_149 (SET (mapplet g_s147_148 g_s146_147))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (SET (mapplet (mapplet g_s44_45 g_s147_148) (mapplet g_s43_44 g_s146_147))) (|>->>| g_s42_43 (SET (mapplet g_s147_148 g_s146_147))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (subset (SET (mapplet g_s147_148 g_s146_147)) g_s145_146)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s181$1_181 g_s181_180))
(define-fun lh_1 () Bool (mem g_s182_182 g_s42_43))
(define-fun lh_2 () Bool (= g_s182_182 g_s43_44))
(define-fun lh_3 () Bool (= g_s182_182 g_s44_45))
(define-fun lh_4 () Bool (not (= g_s182_182 g_s43_44)))
(define-fun lh_5 () Bool (not (= g_s182_182 g_s44_45)))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= g_s146_147 (apply g_s176_178 g_s182_182)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_3) (= g_s147_148 (apply g_s176_178 g_s182_182)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_4 lh_5) (= g_s177$1_179 (apply g_s176_178 g_s182_182)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s185$1_184 g_s185_183))
(define-fun lh_1 () Bool (mem g_s186_185 g_s145_146))
; PO 1 in group 2
(assert (not (=> lh_1 (= (bool (not (= g_s186_185 g_s148_149))) (bool (mem g_s186_185 g_s175_177))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)