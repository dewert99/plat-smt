...
(define-fun |def_inv| () Bool (and (= (dom g_s26_29) g_s27_28) (mem g_s26_29 (|+->| g_s21_23 g_s5_6)) (mem g_s28_30 (|+->| g_s21_23 g_s5_6)) (subset g_s29_31 g_s21_23) (subset g_s27_28 g_s21_23)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s31_32 g_s2_3))
(assert (mem g_s31_32 g_s21_23))
(assert (mem g_s31_32 (dom g_s28_30)))
(define-fun lh_1 () Bool (mem g_s32$1_33 g_s3_5))
; PO 1 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s35_34 g_s2_3))
(assert (mem g_s35_34 g_s21_23))
(define-fun lh_1 () Bool (mem g_s35_34 (dom g_s28_30)))
(define-fun lh_2 () Bool (mem g_s32$1_33 g_s3_5))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2) (mem g_s28_30 (|+->| (dom g_s28_30) (ran g_s28_30))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (mem g_s31_32 g_s2_3))
(assert (mem g_s31_32 g_s21_23))
(assert (mem g_s31_32 (dom g_s26_29)))
(define-fun lh_1 () Bool (mem g_s37$1_35 g_s3_5))
; PO 1 in group 2
(assert (not (=> lh_1 (mem g_s26_29 (|+->| (dom g_s26_29) (ran g_s26_29))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)