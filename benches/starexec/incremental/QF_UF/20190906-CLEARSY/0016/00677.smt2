...
(define-fun |def_inv| () Bool (and (mem g_s101_102 (|+->| g_s62_63 g_s17_18)) (mem g_s102_103 g_s15_17) (mem g_s103_104 g_s15_17) (mem g_s104_105 BOOL)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (mem empty (|+->| g_s62_63 g_s17_18))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s108_106 g_s4_5))
(assert (mem g_s108_106 g_s62_63))
(assert (mem g_s108_106 (binary_inter g_s79_80 (dom g_s81_82))))
(assert (mem g_s108_106 (binary_inter g_s77_78 (dom g_s89_90))))
(assert (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98))))
; PO 1 in group 1
(assert (not (mem (apply g_s55_57 (mapplet (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106))) (apply g_s97_98 g_s108_106))) g_s15_17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (mem g_s108_106 (binary_inter g_s79_80 (dom g_s81_82))))
(assert (mem g_s108_106 (binary_inter g_s77_78 (dom g_s89_90))))
(assert (not (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98)))))
; PO 1 in group 2
(assert (not (mem (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106))) g_s15_17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (mem g_s108_106 g_s62_63))
(assert (mem g_s108_106 (binary_inter g_s79_80 (dom g_s81_82))))
(assert (not (mem g_s108_106 (binary_inter g_s77_78 (dom g_s89_90)))))
(assert (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98))))
; PO 1 in group 3
(assert (not (mem (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s97_98 g_s108_106))) g_s15_17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (not (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98)))))
; PO 1 in group 4
(assert (not (mem (apply g_s81_82 g_s108_106) g_s15_17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem g_s108_106 g_s4_5))
(assert (mem g_s108_106 g_s62_63))
(assert (not (mem g_s108_106 (binary_inter g_s79_80 (dom g_s81_82)))))
(assert (mem g_s108_106 (binary_inter g_s77_78 (dom g_s89_90))))
(assert (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98))))
; PO 1 in group 5
(assert (not (mem (apply g_s55_57 (mapplet (apply g_s89_90 g_s108_106) (apply g_s97_98 g_s108_106))) g_s15_17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (not (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98)))))
; PO 1 in group 6
(assert (not (mem (apply g_s89_90 g_s108_106) g_s15_17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert (mem g_s108_106 (binary_inter g_s78_79 (dom g_s97_98))))
; PO 1 in group 7
(assert (not (mem (apply g_s97_98 g_s108_106) g_s15_17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert (mem g_s108_106 g_s4_5))
(assert (mem g_s108_106 g_s62_63))
(assert (mem g_s102_103 g_s17_18))
; PO 1 in group 8
(assert (not (mem (|<+| g_s101_102 (SET (mapplet g_s108_106 g_s102_103))) (|+->| g_s62_63 g_s17_18))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
; PO 3 in group 9
(push 1)
(assert (not (mem g_s81_82 (|+->| (dom g_s81_82) (ran g_s81_82)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 9
...
; PO 5 in group 9
(push 1)
(assert (not (mem g_s108_106 (dom g_s89_90))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 9
(push 1)
(assert (not (mem g_s108_106 (dom g_s97_98))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 9
(push 1)
(assert (not (mem g_s108_106 (dom g_s81_82))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 9
(push 1)
(assert (not (mem (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106)) (dom g_s55_57))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 9
(push 1)
(assert (not (mem (mapplet (apply g_s55_57 (mapplet (apply g_s81_82 g_s108_106) (apply g_s89_90 g_s108_106))) (apply g_s97_98 g_s108_106)) (dom g_s55_57))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 6 in group 11
(push 1)
(assert (not (mem (mapplet (apply g_s81_82 g_s108_106) (apply g_s97_98 g_s108_106)) (dom g_s55_57))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 6 in group 13
(push 1)
(assert (not (mem (mapplet (apply g_s89_90 g_s108_106) (apply g_s97_98 g_s108_106)) (dom g_s55_57))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
