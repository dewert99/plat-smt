...
; PO 2 in group 0
(push 1)
(assert (not (mem (set_prod g_s110_111 (SET g_s123_125)) (|-->| g_s110_111 g_s118_121))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s110_111 (SET g_s144_146)) (|-->| g_s110_111 g_s107_108))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (mem (set_prod (set_prod g_s110_111 g_s105_106) (SET g_s54_55)) (|-->| (set_prod g_s110_111 g_s105_106) g_s53_54))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)