...
(define-fun |def_inv| () Bool (and (mem g_s179_181 (|-->| g_s151_153 (POW g_s173_175))) (mem g_s180_182 (|+->| g_s151_153 g_s137_139)) (mem g_s181_183 (|+->| g_s151_153 g_s120_122)) (mem g_s182_184 (|+->| g_s151_153 g_s137_139)) (mem g_s183_185 (|+->| g_s151_153 g_s120_122)) (subset g_s184_186 g_s151_153)))
...
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s151_153 (SET empty)) (|-->| g_s151_153 (POW g_s173_175)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
...
(assert (mem g_s189_188 g_s113_114))
(assert (mem g_s189_188 g_s173_175))
; PO 1 in group 1
(push 1)
