...
(declare-fun g_s252$1_251 () U)
(declare-fun g_s259$1_252 () U)
(declare-fun g_s26_27 () U)
(declare-fun g_s261$1_253 () U)
(declare-fun g_s264$1_254 () U)
(declare-fun g_s266$1_255 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s241_243 (|-->| g_s221_223 (|+->| g_s207_209 g_s234_236))) (mem g_s242_244 (|+->| g_s221_223 g_s212_214)) (mem g_s243_245 (|+->| g_s221_223 g_s189_191)) (mem g_s244_246 (|+->| g_s221_223 g_s212_214)) (mem g_s245_247 (|+->| g_s221_223 g_s189_191)) (subset g_s246_248 g_s221_223)))
...
; PO 1 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s221_223 g_s189_191))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s221_223 g_s212_214))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s221_223 (SET empty)) (|-->| g_s221_223 (|+->| g_s207_209 g_s234_236)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (subset empty g_s221_223)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s250_249 g_s179_180))
(assert (mem g_s250_249 g_s221_223))
(assert (mem g_s251_250 g_s174_175))
(assert (mem g_s251_250 g_s207_209))
(define-fun lh_1 () Bool (mem g_s251_250 (dom (apply g_s241_243 g_s250_249))))
(define-fun lh_2 () Bool (mem g_s252$1_251 g_s107_108))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s241_243 (|+->| (dom g_s241_243) (ran g_s241_243)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s250_249 (dom g_s241_243))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s241_243 (|+->| (dom g_s241_243) (ran g_s241_243))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s250_249 (dom g_s241_243)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (apply g_s241_243 g_s250_249) (|+->| (dom (apply g_s241_243 g_s250_249)) (ran (apply g_s241_243 g_s250_249)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s250_249 g_s179_180))
(define-fun lh_2 () Bool (mem g_s250_249 g_s221_223))
(define-fun lh_3 () Bool (mem g_s251_250 g_s174_175))
(define-fun lh_4 () Bool (mem g_s251_250 g_s207_209))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s241_243 (|+->| (dom g_s241_243) (ran g_s241_243))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s250_249 (dom g_s241_243)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s251_250 g_s174_175))
(assert (mem g_s251_250 g_s207_209))
(assert (mem g_s251_250 (dom (apply g_s241_243 g_s250_249))))
(define-fun lh_1 () Bool (mem g_s252$1_251 g_s107_108))
; PO 1 in group 4
(push 1)
(assert (not (=> lh_1 (mem g_s241_243 (|+->| (dom g_s241_243) (ran g_s241_243))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> lh_1 (mem g_s250_249 (dom g_s241_243)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
(push 1)
(assert (not (=> lh_1 (mem (apply g_s241_243 g_s250_249) (|+->| (dom (apply g_s241_243 g_s250_249)) (ran (apply g_s241_243 g_s250_249)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s250_249 g_s179_180))
(assert (mem g_s250_249 g_s221_223))
(assert (mem g_s250_249 (dom g_s242_244)))
(define-fun lh_1 () Bool (mem g_s259$1_252 g_s176_177))
; PO 1 in group 5
(assert (not (=> lh_1 (mem g_s242_244 (|+->| (dom g_s242_244) (ran g_s242_244))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem g_s250_249 g_s179_180))
(assert (mem g_s250_249 g_s221_223))
(define-fun lh_1 () Bool (mem g_s250_249 (dom g_s243_245)))
(define-fun lh_2 () Bool (mem g_s261$1_253 g_s187_190))
; PO 1 in group 6
(assert (not (=> (and lh_1 lh_2) (mem g_s243_245 (|+->| (dom g_s243_245) (ran g_s243_245))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert (mem g_s250_249 g_s179_180))
(assert (mem g_s250_249 g_s221_223))
(assert (mem g_s250_249 (dom g_s243_245)))
(define-fun lh_1 () Bool (mem g_s261$1_253 g_s187_190))
; PO 1 in group 7
(assert (not (=> lh_1 (mem g_s243_245 (|+->| (dom g_s243_245) (ran g_s243_245))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert (mem g_s250_249 g_s179_180))
(assert (mem g_s250_249 g_s221_223))
(assert (mem g_s250_249 (dom g_s244_246)))
(define-fun lh_1 () Bool (mem g_s264$1_254 g_s176_177))
; PO 1 in group 8
(assert (not (=> lh_1 (mem g_s244_246 (|+->| (dom g_s244_246) (ran g_s244_246))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert (mem g_s250_249 g_s179_180))
(assert (mem g_s250_249 g_s221_223))
(define-fun lh_1 () Bool (mem g_s250_249 (dom g_s245_247)))
(define-fun lh_2 () Bool (mem g_s266$1_255 g_s187_190))
; PO 1 in group 9
(assert (not (=> (and lh_1 lh_2) (mem g_s245_247 (|+->| (dom g_s245_247) (ran g_s245_247))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 10 
...
(assert (mem g_s250_249 g_s179_180))
(assert (mem g_s250_249 g_s221_223))
(assert (mem g_s250_249 (dom g_s245_247)))
(define-fun lh_1 () Bool (mem g_s266$1_255 g_s187_190))
; PO 1 in group 10
(assert (not (=> lh_1 (mem g_s245_247 (|+->| (dom g_s245_247) (ran g_s245_247))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)