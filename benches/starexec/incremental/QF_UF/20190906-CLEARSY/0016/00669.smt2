...
(declare-fun g_s140$1_143 () U)
(declare-fun g_s141_142 () U)
(declare-fun g_s141$1_144 () U)
(declare-fun g_s142$1_145 () U)
(declare-fun g_s143$1_146 () U)
(declare-fun g_s147_147 () U)
(declare-fun g_s149_149 () U)
(declare-fun g_s149$1_148 () U)
...
(define-fun |def_abs| () Bool (and (subset g_s139_140 g_s110_111) (subset g_s140_141 g_s110_111) (subset g_s141_142 g_s110_111)))
(define-fun |def_inv| () Bool (and (= g_s140_141 g_s140$1_143) (= g_s141_142 g_s141$1_144) (mem g_s142$1_145 (|-->| g_s110_111 g_s0_1)) (mem g_s143$1_146 (|-->| g_s110_111 g_s48_48)) (subset g_s140$1_143 g_s110_111) (subset g_s141$1_144 g_s110_111) (= g_s139_140 (image (inverse g_s142$1_145) (SET g_s2_3)))))
...
; PO 4 in group 0
(push 1)
(assert (not (subset (image (inverse (set_prod g_s110_111 (SET g_s1_2))) (SET g_s2_3)) g_s110_111)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s147_147 g_s35_36))
(assert (mem g_s147_147 g_s110_111))
(assert (mem g_s147_147 g_s35_36))
(assert (mem g_s147_147 g_s110_111))
(define-fun lh_1 () Bool (= (apply g_s142$1_145 g_s147_147) g_s1_2))
(define-fun lh_2 () Bool (mem g_s147_147 g_s127_128))
(define-fun lh_3 () Bool (mem g_s147_147 (dom g_s137_138)))
(define-fun lh_4 () Bool (= (apply g_s137_138 g_s147_147) g_s116_117))
(define-fun lh_5 () Bool (not (and (mem g_s147_147 g_s127_128) (mem g_s147_147 (dom g_s137_138)) (= (apply g_s137_138 g_s147_147) g_s116_117))))
(define-fun lh_6 () Bool (= (apply g_s142$1_145 g_s147_147) g_s2_3))
(define-fun lh_7 () Bool (or (not (mem g_s147_147 g_s125_126)) (|<=i| (apply g_s143$1_146 g_s147_147) g_s78_79)))
(define-fun lh_8 () Bool (not (= (apply g_s142$1_145 g_s147_147) g_s1_2)))
(define-fun lh_9 () Bool (not (= (apply g_s142$1_145 g_s147_147) g_s2_3)))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_6 lh_7) (mem (|<+| g_s142$1_145 (SET (mapplet g_s147_147 g_s1_2))) (|-->| g_s110_111 g_s0_1)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_5) (subset (set_diff g_s141$1_144 (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_6 lh_7) (subset (set_diff g_s141$1_144 (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_8 lh_9) (subset (set_diff g_s141$1_144 (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_5) (subset (set_diff g_s140$1_143 (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 1
(push 1)
(assert (not (=> (and lh_8 lh_9) (subset (set_diff g_s140$1_143 (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 1
(push 1)
(assert (not (=> (and lh_6 lh_7) (subset (binary_union (set_diff g_s140$1_143 (SET g_s147_147)) (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_5) (subset (image (inverse g_s142$1_145) (SET g_s2_3)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 1
(push 1)
(assert (not (=> (and lh_8 lh_9) (subset (image (inverse g_s142$1_145) (SET g_s2_3)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 1
(push 1)
(assert (not (=> (and lh_6 lh_7) (subset (image (inverse (|<+| g_s142$1_145 (SET (mapplet g_s147_147 g_s1_2)))) (SET g_s2_3)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|<+| g_s142$1_145 (SET (mapplet g_s147_147 g_s2_3))) (|-->| g_s110_111 g_s0_1)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|<+| g_s143$1_146 (SET (mapplet g_s147_147 g_s81_82))) (|-->| g_s110_111 g_s48_48)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (subset (set_diff g_s140$1_143 (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (subset (binary_union (set_diff g_s141$1_144 (SET g_s147_147)) (SET g_s147_147)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (subset (image (inverse (|<+| g_s142$1_145 (SET (mapplet g_s147_147 g_s2_3)))) (SET g_s2_3)) g_s110_111))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s147_147 g_s35_36))
(assert (mem g_s147_147 g_s110_111))
(assert (= g_s149_149 g_s149$1_148))
(assert (mem g_s147_147 g_s35_36))
(assert (mem g_s147_147 g_s110_111))
; PO 1 in group 2
(assert (not (= (bool (mem g_s147_147 g_s139_140)) (bool (= (apply g_s142$1_145 g_s147_147) g_s2_3)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (mem g_s147_147 g_s110_111))
; PO 1 in group 3
(assert (not (= (bool (mem g_s147_147 g_s141_142)) (bool (mem g_s147_147 g_s141$1_144)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (mem g_s147_147 g_s110_111))
; PO 1 in group 4
(assert (not (= (bool (mem g_s147_147 g_s140_141)) (bool (mem g_s147_147 g_s140$1_143)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(define-fun lh_2 () Bool (mem g_s147_147 g_s127_128))
(define-fun lh_3 () Bool (mem g_s147_147 (dom g_s137_138)))
(define-fun lh_4 () Bool (= (apply g_s142$1_145 g_s147_147) g_s2_3))
(define-fun lh_5 () Bool (not (not (mem g_s147_147 g_s125_126))))
(define-fun lh_6 () Bool (not (or (not (mem g_s147_147 g_s125_126)) (|<=i| (apply g_s143$1_146 g_s147_147) g_s78_79))))
(define-fun lh_7 () Bool (not (or (mem g_s147_147 g_s127_128) (mem g_s147_147 g_s129_130) (mem g_s147_147 g_s128_129))))
; PO 1 in group 5
(push 1)
(assert (not (mem g_s142$1_145 (|+->| (dom g_s142$1_145) (ran g_s142$1_145)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
(push 1)
(assert (not (mem g_s147_147 (dom g_s142$1_145))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 5
(push 1)
(assert (not (=> (and lh_4 lh_5) (mem g_s147_147 (dom g_s143$1_146)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 5
(push 1)
(assert (not (=> (and lh_4 lh_5) (mem g_s143$1_146 (|+->| (dom g_s143$1_146) (ran g_s143$1_146))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s137_138 (|+->| (dom g_s137_138) (ran g_s137_138))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 5
(push 1)
(assert (not (=> (and lh_4 lh_6 lh_7) (mem g_s147_147 (dom g_s143$1_146)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 5
(push 1)
(assert (not (=> (and lh_4 lh_6 lh_7) (mem g_s143$1_146 (|+->| (dom g_s143$1_146) (ran g_s143$1_146))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 5
(push 1)
(assert (not (=> (and lh_2 lh_3 lh_4 lh_6) (mem g_s137_138 (|+->| (dom g_s137_138) (ran g_s137_138))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
