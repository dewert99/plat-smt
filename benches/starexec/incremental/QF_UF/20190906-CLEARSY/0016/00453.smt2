...
(define-fun |def_inv| () Bool (and (mem g_s250_252 (|-->| (set_prod g_s132_133 g_s115_116) BOOL)) (mem g_s251_253 (|-->| g_s132_133 g_s129_130)) (mem g_s252_254 (|-->| g_s132_133 g_s140_143)) (mem g_s253_255 (|-->| g_s132_133 g_s129_130)) (mem g_s254_256 (|-->| g_s132_133 g_s140_143)) (mem g_s255_257 (|-->| g_s132_133 BOOL))))
...
; PO 1 in group 0
(push 1)
(assert (not (mem (set_prod g_s132_133 (SET FALSE)) (|-->| g_s132_133 BOOL))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (set_prod g_s132_133 (SET g_s145_147)) (|-->| g_s132_133 g_s140_143))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s132_133 (SET g_s224_226)) (|-->| g_s132_133 g_s129_130))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (mem (set_prod (set_prod g_s132_133 g_s115_116) (SET FALSE)) (|-->| (set_prod g_s132_133 g_s115_116) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)