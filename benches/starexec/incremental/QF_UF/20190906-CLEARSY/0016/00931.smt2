...
(define-fun |def_lprp| () Bool (and (not (= g_s84_86 empty)) (subset g_s85_87 g_s24_25) (not (mem g_s25_26 g_s85_87)) (= g_s85_87 (SET (mapplet g_s28_29 g_s26_27))) (subset g_s86_88 g_s84_86) (mem g_s87_89 g_s84_86) (not (mem g_s87_89 g_s86_88)) (mem g_s88_90 (|+->| NAT g_s84_86)) (mem g_s88_90 (perm g_s86_88))))
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool true)
(define-fun |def_ass| () Bool true)
(define-fun |def_cst| () Bool true)
(define-fun |def_sets| () Bool  (not (= g_s84_86 empty)))
; PO group 0 
(push 1)
...
(assert |def_cst|)
(assert |def_sets|)
(define-fun lh_1 () Bool (subset g_s85_87 g_s24_25))
(define-fun lh_2 () Bool (not (mem g_s25_26 g_s85_87)))
(define-fun lh_3 () Bool (= g_s85_87 (SET (mapplet g_s28_29 g_s26_27))))
(define-fun lh_4 () Bool (subset g_s86_88 g_s84_86))
(define-fun lh_5 () Bool (mem g_s87_89 g_s84_86))
(define-fun lh_6 () Bool (not (mem g_s87_89 g_s86_88)))
(define-fun lh_7 () Bool (mem g_s88_90 (|+->| NAT g_s84_86)))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s86_88 (FIN g_s86_88)))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem (card g_s86_88) INT))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s86_88 (FIN g_s86_88))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (mem g_s86_88 (FIN g_s86_88)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s94_91 NATURAL))
(assert (mem g_s94_91 (dom g_s88_90)))
; PO 1 in group 2
