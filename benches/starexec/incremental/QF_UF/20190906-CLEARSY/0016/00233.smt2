...
; PO 1 in group 0
(push 1)
(assert (not (mem (set_prod g_s43_44 (SET empty)) (|-->| g_s43_44 (POW g_s83_84)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
; PO 3 in group 0
(push 1)
(assert (not (subset empty g_s80_81)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s121$1_130 (POW g_s38_39)))
(define-fun lh_2 () Bool (mem g_s122$1_131 (POW g_s80_81)))
(define-fun lh_3 () Bool (mem g_s123$1_132 (POW g_s80_81)))
(define-fun lh_4 () Bool (mem g_s128$1_133 (POW g_s86_87)))
(define-fun lh_5 () Bool (mem g_s125$1_134 (POW g_s38_39)))
(define-fun lh_6 () Bool (mem g_s126$1_135 (POW g_s38_39)))
(define-fun lh_7 () Bool (mem g_s127$1_136 (POW g_s38_39)))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (subset g_s125$1_134 g_s38_39))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (subset g_s126$1_135 g_s38_39))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (subset g_s127$1_136 g_s38_39))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (subset g_s121$1_130 g_s38_39))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (subset g_s128$1_133 g_s86_87))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (subset g_s123$1_132 g_s80_81))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (subset g_s122$1_131 g_s80_81))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s133_137 g_s2_3))
(assert (mem g_s133_137 g_s43_44))
(assert (mem g_s134_138 g_s17_18))
(assert (mem g_s134_138 g_s83_84))
; PO 1 in group 2
(push 1)
(assert (not (mem g_s124_125 (|+->| (dom g_s124_125) (ran g_s124_125)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (mem g_s133_137 (dom g_s124_125))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
