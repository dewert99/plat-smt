...
(define-fun |def_lprp| () Bool (and (not (= g_s34_36 empty)) (subset g_s35_37 g_s34_36) (mem g_s36_38 g_s34_36) (not (mem g_s36_38 g_s35_37)) (mem g_s37_39 (|+->| NAT g_s34_36)) (mem g_s37_39 (perm g_s35_37))))
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool true)
(define-fun |def_ass| () Bool true)
(define-fun |def_cst| () Bool true)
(define-fun |def_sets| () Bool  (not (= g_s34_36 empty)))
; PO group 0 
(push 1)
...
(assert |def_cst|)
(assert |def_sets|)
(define-fun lh_1 () Bool (subset g_s35_37 g_s34_36))
(define-fun lh_2 () Bool (mem g_s36_38 g_s34_36))
(define-fun lh_3 () Bool (not (mem g_s36_38 g_s35_37)))
(define-fun lh_4 () Bool (mem g_s37_39 (|+->| NAT g_s34_36)))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s35_37 (FIN g_s35_37)))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem (card g_s35_37) INT))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s35_37 (FIN g_s35_37))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (mem g_s35_37 (FIN g_s35_37)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s43_40 NATURAL))
(assert (mem g_s43_40 (dom g_s37_39)))
; PO 1 in group 2
