...
(declare-fun g_s209$1_211 () U)
(declare-fun g_s209$2_218 () U)
(declare-fun g_s21_22 () U)
(declare-fun g_s210$1_212 () U)
(declare-fun g_s210$2_219 () U)
(declare-fun g_s211$1_213 () U)
(declare-fun g_s211$2_220 () U)
(declare-fun g_s212$1_214 () U)
(declare-fun g_s212$2_221 () U)
(declare-fun g_s213$1_215 () U)
(declare-fun g_s213$2_222 () U)
(declare-fun g_s214$1_216 () U)
(declare-fun g_s214$2_223 () U)
(declare-fun g_s215$1_217 () U)
(declare-fun g_s215$2_224 () U)
(declare-fun g_s219_225 () U)
(declare-fun g_s22_23 () U)
(declare-fun g_s220_226 () U)
(declare-fun g_s221_227 () U)
(declare-fun g_s223_230 () U)
(declare-fun g_s223_235 () U)
(declare-fun g_s223_228 () U)
(declare-fun g_s223_233 () U)
(declare-fun g_s223$1_231 () U)
(declare-fun g_s223$1_236 () U)
(declare-fun g_s223$1_229 () U)
(declare-fun g_s223$1_234 () U)
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s209$2_218 g_s171_172))
(define-fun lh_2 () Bool (mem g_s210$2_219 g_s197_199))
(define-fun lh_3 () Bool (mem g_s211$2_220 g_s197_199))
(define-fun lh_4 () Bool (mem g_s212$2_221 g_s197_199))
(define-fun lh_5 () Bool (mem g_s213$2_222 (|-->| g_s175_176 g_s198_200)))
(define-fun lh_6 () Bool (mem g_s214$2_223 g_s35_36))
(define-fun lh_7 () Bool (mem g_s215$2_224 BOOL))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem (domain_restriction g_s192_194 g_s213$2_222) (|-->| g_s192_194 g_s198_200)))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s219_225 g_s7_8))
(define-fun lh_2 () Bool (mem g_s220_226 g_s0_1))
(define-fun lh_3 () Bool (mem g_s221_227 g_s0_1))
(define-fun lh_4 () Bool (mem g_s209$2_218 g_s171_172))
(define-fun lh_5 () Bool (mem g_s210$2_219 g_s197_199))
(define-fun lh_6 () Bool (mem g_s211$2_220 g_s197_199))
(define-fun lh_7 () Bool (mem g_s212$2_221 g_s197_199))
(define-fun lh_8 () Bool (mem g_s213$2_222 (|-->| g_s175_176 g_s198_200)))
(define-fun lh_9 () Bool (mem g_s214$2_223 g_s35_36))
(define-fun lh_10 () Bool (mem g_s215$2_224 BOOL))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (mem (domain_restriction g_s192_194 g_s213$2_222) (|-->| g_s192_194 g_s198_200)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s223$1_229 g_s223_228))
; PO 1 in group 2
(assert (not (= g_s209$1_211 g_s202_204)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s223$1_231 g_s223_230))
; PO 1 in group 3
(assert (not (= g_s210$1_212 g_s203_205)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (= g_s223$1_231 g_s223_230))
; PO 1 in group 4
(assert (not (= g_s211$1_213 g_s204_206)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (= g_s223$1_231 g_s223_230))
; PO 1 in group 5
(assert (not (= g_s212$1_214 g_s205_207)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert |def_ass|)
(assert (= g_s223$1_231 g_s223_230))
(define-fun lh_1 () Bool (mem g_s228_232 g_s175_176))
(define-fun lh_2 () Bool (mem g_s228_232 g_s192_194))
; PO 1 in group 6
(assert (not (=> (and lh_1 lh_2) (= (apply g_s213$1_215 g_s228_232) (apply g_s206_208 g_s228_232)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s223$1_234 g_s223_233))
; PO 1 in group 7
(assert (not (= g_s214$1_216 g_s207_209)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s223$1_236 g_s223_235))
; PO 1 in group 8
(assert (not (= g_s215$1_217 g_s208_210)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s228_232 g_s175_176))
(assert (mem g_s228_232 g_s192_194))
; PO 1 in group 9
(push 1)
(assert (not (mem g_s213$1_215 (|+->| (dom g_s213$1_215) (ran g_s213$1_215)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 9
(push 1)
(assert (not (mem g_s228_232 (dom g_s213$1_215))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
