...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s166_166 g_s34_35))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s164_165 (|+->| (dom g_s164_165) (ran g_s164_165)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem g_s166_166 (dom g_s164_165))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)