...
(define-fun |def_inv| () Bool (and (subset g_s55_57 g_s49_51) (subset g_s56_58 g_s49_51) (= (binary_inter g_s55_57 g_s56_58) empty)))
...
; PO 3 in group 1
(push 1)
(assert (not (= (binary_inter g_s49_51 empty) empty)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (not (= g_s55_57 empty)))
(define-fun lh_1 () Bool (mem g_s61_59 g_s7_8))
(define-fun lh_2 () Bool (mem g_s61_59 g_s49_51))
(define-fun lh_3 () Bool (mem g_s61_59 g_s55_57))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (set_diff g_s55_57 (SET g_s61_59)) g_s49_51))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (binary_union g_s56_58 (SET g_s61_59)) g_s49_51))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (= (binary_inter (set_diff g_s55_57 (SET g_s61_59)) (binary_union g_s56_58 (SET g_s61_59))) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
