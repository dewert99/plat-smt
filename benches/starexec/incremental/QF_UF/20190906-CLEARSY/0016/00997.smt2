...
(declare-fun g_s83_141 () U)
(declare-fun g_s84$1_142 () U)
(declare-fun g_s85$1_143 () U)
(declare-fun g_s89_144 () U)
(declare-fun g_s89$1_145 () U)
(declare-fun g_s9_10 () U)
(declare-fun g_s92_148 () U)
(declare-fun g_s92_146 () U)
(declare-fun g_s92$1_149 () U)
(declare-fun g_s92$1_147 () U)
(declare-fun e13 () U)
; Defines
...
(define-fun |def_abs| () Bool (and (subset g_s80_138 g_s15_14) (subset g_s81_139 g_s15_14) (= (binary_inter g_s80_138 g_s81_139) empty) (subset g_s82_140 g_s7_8) (subset g_s83_141 g_s7_8) (= (binary_inter g_s82_140 g_s83_141) empty)))
(define-fun |def_inv| () Bool (and (mem g_s84$1_142 NATURAL) (and (|>=i| g_s84$1_142 e0) (|<=i| g_s84$1_142 (size g_s16_15))) (= g_s80_138 (image g_s16_15 (interval e20 g_s84$1_142))) (mem g_s85$1_143 NATURAL) (and (|>=i| g_s85$1_143 e0) (|<=i| g_s85$1_143 (size g_s8_9))) (= g_s82_140 (image g_s8_9 (interval e20 g_s85$1_143)))))
...
; PO 3 in group 0
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 (size g_s16_15)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
...
; PO 5 in group 0
(push 1)
(assert (not (= empty (image g_s16_15 (interval e20 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s89$1_145 g_s89_144))
; PO 1 in group 1
(push 1)
(assert (not (mem (card g_s15_14) NATURAL)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (and (|>=i| (card g_s15_14) e0) (|<=i| (card g_s15_14) (size g_s16_15)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (= g_s15_14 (image g_s16_15 (interval e20 (card g_s15_14))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (= (bool (|<=i| g_s21_21 (card g_s15_14))) (bool (not (= g_s15_14 empty))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (= g_s89$1_145 g_s89_144))
(assert (= g_s92$1_147 g_s92_146))
(define-fun lh_1 () Bool (not (= g_s80_138 empty)))
(define-fun lh_2 () Bool (|<=i| e0 g_s84$1_142))
(define-fun lh_3 () Bool (mem g_s84$1_142 NATURAL))
(define-fun lh_4 () Bool (mem g_s84$1_142 (dom g_s16_15)))
; PO 1 in group 3
(push 1)
(assert (not (=> lh_1 (|<=i| e0 g_s84$1_142))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s84$1_142 (dom g_s16_15)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s16_15 g_s84$1_142) g_s15_14))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s16_15 g_s84$1_142) g_s80_138))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s84$1_142 e20) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s84$1_142 e20) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (and (|>=i| (|-i| g_s84$1_142 e20) e0) (|<=i| (|-i| g_s84$1_142 e20) (size g_s16_15))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (bool (|<=i| g_s21_21 (|-i| g_s84$1_142 e20))) (bool (not (= g_s80_138 (SET (apply g_s16_15 g_s84$1_142)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (set_diff g_s80_138 (SET (apply g_s16_15 g_s84$1_142))) (image g_s16_15 (interval e20 (|-i| g_s84$1_142 e20)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (= g_s89$1_145 g_s89_144))
(assert (= g_s92$1_149 g_s92_148))
(define-fun lh_1 () Bool (not (= g_s82_140 empty)))
(define-fun lh_2 () Bool (|<=i| e0 g_s85$1_143))
(define-fun lh_3 () Bool (mem g_s85$1_143 NATURAL))
(define-fun lh_4 () Bool (mem g_s85$1_143 (dom g_s8_9)))
; PO 1 in group 4
(push 1)
(assert (not (=> lh_1 (|<=i| e0 g_s85$1_143))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s85$1_143 (dom g_s8_9)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s8_9 g_s85$1_143) g_s7_8))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s8_9 g_s85$1_143) g_s82_140))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s85$1_143 g_s21_21) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|-i| g_s85$1_143 g_s21_21) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (and (|>=i| (|-i| g_s85$1_143 g_s21_21) e0) (|<=i| (|-i| g_s85$1_143 g_s21_21) (size g_s8_9))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (bool (|<=i| g_s21_21 (|-i| g_s85$1_143 g_s21_21))) (bool (not (= g_s82_140 (SET (apply g_s8_9 g_s85$1_143)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (set_diff g_s82_140 (SET (apply g_s8_9 g_s85$1_143))) (image g_s8_9 (interval e20 (|-i| g_s85$1_143 g_s21_21)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (mem g_s84$1_142 NATURAL))
(define-fun lh_2 () Bool (and (|>=i| g_s84$1_142 e0) (|<=i| g_s84$1_142 (size g_s16_15))))
(define-fun lh_3 () Bool (= g_s80_138 (image g_s16_15 (interval e20 g_s84$1_142))))
(define-fun lh_4 () Bool (mem g_s85$1_143 NATURAL))
; PO 1 in group 5
(push 1)
(assert (not (=> lh_1 (mem g_s16_15 (seq (ran g_s16_15))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s8_9 (seq (ran g_s8_9))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
