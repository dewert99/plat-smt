...
(declare-fun g_s67$2_70 () U)
(declare-fun g_s7_8 () U)
(declare-fun g_s70$2_71 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s55_57 (|>+>| g_s49_51 g_s29_31)) (subset g_s56_58 g_s49_51) (subset g_s57_59 g_s49_51) (subset g_s58_60 g_s49_51) (subset g_s59_61 g_s49_51) (mem g_s55_57 (|>+>| g_s49_51 g_s29_31)) (subset g_s56_58 g_s49_51) (subset g_s57_59 g_s49_51) (subset g_s58_60 g_s49_51) (subset g_s59_61 g_s49_51) (mem g_s55_57 (|>+>| g_s49_51 g_s29_31)) (subset g_s56_58 g_s49_51) (subset g_s57_59 g_s49_51) (subset g_s58_60 g_s49_51) (subset g_s59_61 g_s49_51)))
(define-fun |def_inv| () Bool (and (= g_s55_57 g_s55$1_62) (= g_s56_58 g_s56$1_63) (= g_s57_59 g_s57$1_64) (= g_s58_60 g_s58$1_65) (= g_s59_61 g_s59$1_66)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s55$1_62 (|>+>| g_s49_51 g_s29_31)) (subset g_s56$1_63 g_s49_51) (subset g_s57$1_64 g_s49_51) (subset g_s58$1_65 g_s49_51) (subset g_s59$1_66 g_s49_51)))
; PO group 0 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s61_67 g_s7_8))
(define-fun lh_2 () Bool (mem g_s61_67 g_s49_51))
(define-fun lh_3 () Bool (mem g_s62_68 g_s8_10))
(define-fun lh_4 () Bool (mem g_s63_69 BOOL))
(define-fun lh_5 () Bool (= (bool (mem g_s61_67 g_s53_55)) TRUE))
(define-fun lh_6 () Bool (mem g_s61_67 g_s53_55))
(define-fun lh_7 () Bool (= (bool (mem g_s61_67 (dom g_s55$1_62))) TRUE))
(define-fun lh_8 () Bool (mem g_s61_67 (dom g_s55$1_62)))
(define-fun lh_9 () Bool (= (bool (and (mem g_s61_67 (dom g_s54_56)) (not (mem (apply g_s54_56 g_s61_67) (ran g_s55$1_62))) (not (mem g_s61_67 g_s57$1_64)) (not (mem g_s61_67 g_s58$1_65)) (not (mem g_s61_67 g_s59$1_66)) (= g_s63_69 FALSE) (= g_s62_68 g_s13_15))) TRUE))
(define-fun lh_10 () Bool (mem g_s61_67 (dom g_s54_56)))
(define-fun lh_11 () Bool (not (mem (apply g_s54_56 g_s61_67) (ran g_s55$1_62))))
(define-fun lh_12 () Bool (not (and (mem g_s61_67 (dom g_s54_56)) (not (mem (apply g_s54_56 g_s61_67) (ran g_s55$1_62))) (not (mem g_s61_67 g_s57$1_64)) (not (mem g_s61_67 g_s58$1_65)) (not (mem g_s61_67 g_s59$1_66)) (= g_s63_69 FALSE) (= g_s62_68 g_s13_15))))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem g_s61_67 g_s53_55))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s61_67 (dom g_s55$1_62)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (mem (apply g_s54_56 g_s61_67) (ran g_s55$1_62))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s61_67 (dom g_s54_56)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (= g_s55$1_62 (|<+| g_s55$1_62 (SET (mapplet g_s61_67 (apply g_s54_56 g_s61_67))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12) (= (set_diff g_s56$1_63 (SET g_s61_67)) (binary_union g_s56$1_63 (SET g_s61_67))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s61_67 g_s7_8))
(assert (mem g_s61_67 g_s49_51))
(assert (mem g_s61_67 (dom g_s55_57)))
(assert (mem g_s61_67 g_s7_8))
(assert (mem g_s61_67 g_s49_51))
(assert (mem g_s61_67 (dom g_s55_57)))
(assert (mem g_s61_67 g_s7_8))
(assert (mem g_s61_67 g_s49_51))
(assert (mem g_s61_67 (dom g_s55$1_62)))
(define-fun lh_1 () Bool (mem g_s67$2_70 g_s4_5))
; PO 1 in group 1
...
(assert (mem g_s61_67 g_s7_8))
(assert (mem g_s61_67 g_s49_51))
(define-fun lh_1 () Bool (mem g_s61_67 (dom g_s55$1_62)))
(define-fun lh_2 () Bool (mem g_s70$2_71 g_s4_5))
; PO 1 in group 2
