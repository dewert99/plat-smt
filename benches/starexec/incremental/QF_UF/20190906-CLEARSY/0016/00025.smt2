...
(define-fun |def_abs| () Bool (and (= (dom g_s19_22) g_s20_21) (mem g_s19_22 (|+->| g_s14_16 g_s4_5)) (mem g_s21_23 (|+->| g_s14_16 g_s4_5)) (subset g_s22_24 g_s14_16) (subset g_s20_21 g_s14_16)))
(define-fun |def_inv| () Bool (and (= g_s19_22 g_s19$1_25) (= g_s21_23 g_s21$1_26) (= g_s22_24 g_s22$1_27) (mem g_s19$1_25 (|+->| g_s14_16 g_s4_5)) (mem g_s21$1_26 (|+->| g_s14_16 g_s4_5)) (subset g_s22$1_27 g_s14_16) (= g_s20_21 (dom g_s19$1_25))))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s26_28 g_s1_2))
(assert (mem g_s26_28 g_s14_16))
...
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (|<+| g_s21$1_26 (SET (mapplet g_s26_28 g_s28_30))) (|+->| g_s14_16 g_s4_5)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (|<+| g_s19$1_25 (SET (mapplet g_s26_28 g_s27_29))) (|+->| g_s14_16 g_s4_5)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (dom (|<+| g_s19$1_25 (SET (mapplet g_s26_28 g_s27_29)))) g_s14_16))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (binary_union g_s22$1_27 (SET g_s26_28)) g_s14_16))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s33_34 g_s1_2))
(assert (mem g_s33_34 g_s14_16))
