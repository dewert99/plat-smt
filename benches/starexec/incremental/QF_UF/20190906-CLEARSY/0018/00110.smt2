...
; PO 3 in group 0
(push 1)
(assert (not (mem g_s31_31 (dom g_s28_29))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (mem (mapplet (apply g_s28_29 g_s31_31) g_s32_32) (dom g_s29_30))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
