...
(declare-fun g_s868_975 () U)
(declare-fun g_s87_88 () U)
(declare-fun g_s876_971 () U)
(declare-fun g_s876$1_972 () U)
(declare-fun g_s88_89 () U)
(declare-fun g_s880_973 () U)
(declare-fun g_s880$1_974 () U)
...
(define-fun |def_abs| () Bool  (mem g_s876_971 g_s741_841))
(define-fun |def_inv| () Bool (and (= g_s876_971 g_s876$1_972) (mem g_s876$1_972 g_s741_841)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s880$1_974 g_s880_973))
(define-fun lh_1 () Bool (mem g_s868_975 g_s305_397))
(define-fun lh_2 () Bool (mem g_s881_976 INTEGER))
(define-fun lh_3 () Bool (mem g_s880_973 g_s336_428))
(define-fun lh_4 () Bool (= (bool (|>=i| g_s876$1_972 e293)) TRUE))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (bool (|>=i| g_s868_975 e368)) (apply g_s865_965 (mapplet g_s876$1_972 g_s868_975))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)