...
(declare-fun g_s776_874 () U)
(declare-fun g_s777_876 () U)
...
(declare-fun g_s783$1_900 () U)
(declare-fun g_s784_884 () U)
(declare-fun g_s785_885 () U)
(declare-fun g_s786_891 () U)
(declare-fun g_s787_892 () U)
(declare-fun g_s788_893 () U)
(declare-fun g_s789_894 () U)
(declare-fun g_s79_80 () U)
(declare-fun g_s790_895 () U)
(declare-fun g_s791_896 () U)
(declare-fun g_s792_897 () U)
(declare-fun g_s793_898 () U)
(declare-fun g_s794_899 () U)
(declare-fun g_s795_890 () U)
(declare-fun g_s799_901 () U)
(declare-fun g_s8_9 () U)
(declare-fun g_s80_81 () U)
(declare-fun g_s800_902 () U)
...
(assert |def_cst|)
(assert |def_sets|)
(define-fun lh_1 () Bool (mem g_s782_882 (|-->| (set_prod (set_prod (set_prod (set_prod (set_prod (set_prod g_s301_393 g_s301_393) g_s332_424) g_s301_393) g_s332_424) g_s301_393) g_s301_393) g_s332_424)))
(define-fun lh_2 () Bool (mem g_s783_883 (|-->| (set_prod (set_prod (set_prod (set_prod (set_prod (set_prod (set_prod g_s301_393 g_s301_393) g_s301_393) g_s332_424) g_s301_393) g_s332_424) g_s301_393) g_s301_393) g_s332_424)))
(define-fun lh_3 () Bool (mem g_s784_884 (|-->| (set_prod g_s661_755 g_s301_393) g_s332_424)))
(define-fun lh_4 () Bool (mem g_s785_885 (|-->| (set_prod (set_prod (set_prod (set_prod (set_prod (set_prod (set_prod (set_prod g_s301_393 g_s301_393) g_s301_393) g_s332_424) g_s301_393) g_s332_424) g_s301_393) g_s301_393) g_s332_424) g_s301_393)))
(define-fun lh_5 () Bool (mem g_s786_891 g_s661_755))
(define-fun lh_6 () Bool (mem g_s787_892 g_s301_393))
(define-fun lh_7 () Bool (= g_s784_884 e886))
(define-fun lh_8 () Bool (mem g_s788_893 g_s301_393))
(define-fun lh_9 () Bool (mem g_s789_894 g_s332_424))
(define-fun lh_10 () Bool (mem g_s790_895 g_s301_393))
(define-fun lh_11 () Bool (mem g_s791_896 g_s332_424))
(define-fun lh_12 () Bool (mem g_s792_897 g_s301_393))
(define-fun lh_13 () Bool (mem g_s793_898 g_s301_393))
(define-fun lh_14 () Bool (= g_s782_882 e887))
(define-fun lh_15 () Bool (mem g_s794_899 g_s301_393))
(define-fun lh_16 () Bool (= g_s783_883 e888))
(define-fun lh_17 () Bool (mem g_s783$1_900 g_s332_424))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem g_s786_891 (dom (SET (mapplet (mapplet e289 (bool (|>=i| g_s787_892 e364))) (mapplet e288 (bool (|<=i| g_s787_892 e367))))))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (SET (mapplet (mapplet e289 (bool (|>=i| g_s787_892 e364))) (mapplet e288 (bool (|<=i| g_s787_892 e367))))) (|+->| (dom (SET (mapplet (mapplet e289 (bool (|>=i| g_s787_892 e364))) (mapplet e288 (bool (|<=i| g_s787_892 e367)))))) (ran (SET (mapplet (mapplet e289 (bool (|>=i| g_s787_892 e364))) (mapplet e288 (bool (|<=i| g_s787_892 e367)))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13) (mem g_s789_894 (dom (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892)))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13) (mem (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892)))))) (|+->| (dom (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892))))))) (ran (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892))))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (mem g_s789_894 (dom (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893) (|>=i| (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892)) g_s794_899)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892) (|>=i| g_s787_892 g_s794_899)))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15) (mem (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893) (|>=i| (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892)) g_s794_899)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892) (|>=i| g_s787_892 g_s794_899)))))) (|+->| (dom (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893) (|>=i| (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892)) g_s794_899)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892) (|>=i| g_s787_892 g_s794_899))))))) (ran (SET (mapplet (mapplet FALSE (bool (and (= g_s791_896 TRUE) (|<i| g_s787_892 g_s792_897) (|<i| (|-i| g_s793_898 g_s787_892) g_s788_893) (|>=i| (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892)) g_s794_899)))) (mapplet TRUE (bool (and (|<i| (|-i| g_s790_895 g_s787_892) g_s788_893) (|>i| g_s790_895 g_s787_892) (|>=i| g_s787_892 g_s794_899))))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16 lh_17) (mem g_s783$1_900 (dom (SET (mapplet (mapplet FALSE g_s794_899) (mapplet TRUE (apply (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892))) g_s789_894)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16 lh_17) (mem g_s789_894 (dom (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16 lh_17) (mem (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892))) (|+->| (dom (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892)))) (ran (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16 lh_17) (mem (SET (mapplet (mapplet FALSE g_s794_899) (mapplet TRUE (apply (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892))) g_s789_894)))) (|+->| (dom (SET (mapplet (mapplet FALSE g_s794_899) (mapplet TRUE (apply (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892))) g_s789_894))))) (ran (SET (mapplet (mapplet FALSE g_s794_899) (mapplet TRUE (apply (SET (mapplet (mapplet FALSE (|-i| g_s790_895 (|-i| g_s793_898 g_s787_892))) (mapplet TRUE g_s787_892))) g_s789_894))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s787_892 g_s301_393))
(assert (mem g_s799_901 INTEGER))
(assert (mem g_s800_902 g_s332_424))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s784_884 (|+->| (dom g_s784_884) (ran g_s784_884)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem (mapplet g_s795_890 g_s787_892) (dom g_s784_884))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
