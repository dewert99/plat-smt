...
(define-fun |def_inv| () Bool (and (mem g_s802$1_899 g_s653_675) (mem g_s803$1_900 g_s653_675) (mem g_s804$1_901 g_s653_675) (mem g_s805$1_902 g_s653_675) (= g_s801_898 (binary_union (binary_union (binary_union (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s110_111)))) g_s802$1_899) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s111_112)))) g_s803$1_900)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s112_113)))) g_s804$1_901)) (apply (SET (mapplet (mapplet FALSE empty) (mapplet TRUE (SET g_s113_114)))) g_s805$1_902)))))
...
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem (bool (and (= g_s802$1_899 TRUE) (= g_s811_904 TRUE))) g_s653_675))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_6) (mem (bool (and (= g_s803$1_900 TRUE) (= g_s811_904 TRUE))) g_s653_675))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_7) (mem (bool (and (= g_s804$1_901 TRUE) (= g_s811_904 TRUE))) g_s653_675))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5 lh_8) (mem (bool (and (= g_s805$1_902 TRUE) (= g_s811_904 TRUE))) g_s653_675))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
...
(define-fun lh_3 () Bool (mem g_s804$1_901 g_s653_675))
(define-fun lh_4 () Bool (mem g_s805$1_902 g_s653_675))
; PO 1 in group 9
(push 1)
