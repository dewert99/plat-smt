...
(declare-fun g_s1463$1_1506 () U)
(declare-fun g_s1464_1500 () U)
(declare-fun g_s1464$1_1507 () U)
(declare-fun g_s1465_1501 () U)
(declare-fun g_s1465$1_1508 () U)
(declare-fun g_s1466_1502 () U)
(declare-fun g_s1466$1_1509 () U)
(declare-fun g_s1467_1503 () U)
(declare-fun g_s1467$1_1510 () U)
(declare-fun g_s1468_1504 () U)
(declare-fun g_s1468$1_1511 () U)
(declare-fun g_s1469_1505 () U)
(declare-fun g_s1469$1_1512 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s1463_1499 g_s0_1) (mem g_s1464_1500 g_s0_1) (and (|>=i| g_s1465_1501 e0) (|<=i| g_s1465_1501 e419)) (mem g_s1466_1502 (|-->| g_s680_707 BOOL)) (and (|>=i| g_s1467_1503 e0) (|<=i| g_s1467_1503 e419)) (mem g_s1468_1504 g_s943_971) (mem g_s1469_1505 (|-->| g_s680_707 BOOL))))
(define-fun |def_inv| () Bool (and (= g_s1463_1499 g_s1463$1_1506) (= g_s1464_1500 g_s1464$1_1507) (= g_s1465_1501 g_s1465$1_1508) (= g_s1466_1502 g_s1466$1_1509) (= g_s1467_1503 g_s1467$1_1510) (= g_s1468_1504 g_s1468$1_1511) (= g_s1469_1505 g_s1469$1_1512)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (mem (iuminus g_s546_554) INT)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
