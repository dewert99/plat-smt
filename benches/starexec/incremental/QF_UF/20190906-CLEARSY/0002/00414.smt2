...
(declare-fun g_s1425$1_1468 () U)
(declare-fun g_s1426_1463 () U)
(declare-fun g_s1426$1_1469 () U)
(declare-fun g_s1427_1464 () U)
(declare-fun g_s1427$1_1470 () U)
(declare-fun g_s1428_1465 () U)
(declare-fun g_s1428$1_1471 () U)
(declare-fun g_s1429_1466 () U)
(declare-fun g_s1429$1_1472 () U)
(declare-fun g_s143_144 () U)
(declare-fun g_s1430_1467 () U)
(declare-fun g_s1430$1_1473 () U)
(declare-fun g_s1436_1474 () U)
(declare-fun g_s1437_1475 () U)
(declare-fun g_s1438_1476 () U)
(declare-fun g_s1439_1477 () U)
(declare-fun g_s144_145 () U)
(declare-fun g_s1440$1_1478 () U)
(declare-fun g_s1441$1_1479 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s1425_1462 g_s0_1) (mem g_s1426_1463 g_s0_1) (mem g_s1427_1464 g_s17_18) (mem g_s1428_1465 g_s731_759) (mem g_s1429_1466 g_s425_432) (mem g_s1430_1467 g_s425_432)))
(define-fun |def_inv| () Bool (and (= g_s1425_1462 g_s1425$1_1468) (= g_s1426_1463 g_s1426$1_1469) (= g_s1427_1464 g_s1427$1_1470) (= g_s1428_1465 g_s1428$1_1471) (= g_s1429_1466 g_s1429$1_1472) (= g_s1430_1467 g_s1430$1_1473) (mem g_s1425$1_1468 g_s0_1) (mem g_s1426$1_1469 g_s0_1) (mem g_s1427$1_1470 g_s17_18) (mem g_s1428$1_1471 g_s731_759) (mem g_s1429$1_1472 g_s425_432) (mem g_s1430$1_1473 g_s425_432)))
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s1436_1474 g_s0_1))
(define-fun lh_2 () Bool (mem g_s1437_1475 g_s0_1))
(define-fun lh_3 () Bool (mem g_s1438_1476 g_s17_18))
(define-fun lh_4 () Bool (mem g_s1439_1477 g_s731_759))
(define-fun lh_5 () Bool (and (|>=i| g_s1429$1_1472 e0) (|<=i| g_s1429$1_1472 e421)))
(define-fun lh_6 () Bool (and (|>=i| g_s1430$1_1473 e0) (|<=i| g_s1430$1_1473 e421)))
(define-fun lh_7 () Bool (and (|>=i| g_s1440$1_1478 e0) (|<=i| g_s1440$1_1478 e421)))
(define-fun lh_8 () Bool (and (|>=i| g_s1441$1_1479 e0) (|<=i| g_s1441$1_1479 e421)))
(define-fun lh_9 () Bool (mem g_s666_693 g_s41_42))
(define-fun lh_10 () Bool (mem g_s308_309 g_s281_282))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (and (|>=i| g_s1429$1_1472 e0) (|<=i| g_s1429$1_1472 e421)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (and (|>=i| g_s1430$1_1473 e0) (|<=i| g_s1430$1_1473 e421)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (mem g_s1440$1_1478 g_s425_432))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (mem g_s1441$1_1479 g_s425_432))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
