...
(declare-fun g_s1212_1243 () U)
(declare-fun g_s1213_1244 () U)
(declare-fun g_s1215_1245 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1182_1218 BOOL) (mem g_s1183_1219 (|-->| (set_diff g_s23_24 (SET g_s629_656)) BOOL)) (mem g_s1184_1220 g_s174_175) (mem g_s1185_1221 g_s24_25) (mem g_s1186_1222 BOOL) (and (|>=i| g_s1187_1223 e430) (|<=i| g_s1187_1223 e423)) (mem g_s1188_1224 g_s1_2) (mem g_s1189_1225 (|-->| (set_diff g_s23_24 (SET g_s629_656)) BOOL)) (mem g_s1190_1226 g_s0_1) (mem g_s1191_1227 g_s0_1) (and (|>=i| g_s1192_1228 e430) (|<=i| g_s1192_1228 e423)) (mem g_s1193_1229 g_s0_1) (mem g_s1194_1230 g_s0_1) (mem g_s1195_1231 g_s24_25) (mem g_s1196_1232 BOOL) (mem g_s1197_1233 BOOL) (and (|>=i| g_s1198_1234 e430) (|<=i| g_s1198_1234 e423)) (and (|>=i| g_s1199_1235 e0) (|<=i| g_s1199_1235 e421)) (and (|>=i| g_s1200_1236 e0) (|<=i| g_s1200_1236 e421)) (mem g_s1201_1237 g_s0_1) (mem g_s1202_1238 g_s0_1) (mem g_s1203_1239 BOOL) (and (|>=i| g_s1204_1240 e0) (|<=i| g_s1204_1240 e419)) (mem g_s1205_1241 (|-->| (set_diff g_s23_24 (SET g_s629_656)) g_s24_25)) (mem g_s1206_1242 (|-->| (set_diff g_s23_24 (SET g_s629_656)) BOOL))))
...
; PO 4 in group 0
(push 1)
(assert (not (mem (set_prod (set_diff g_s23_24 (SET g_s629_656)) (SET TRUE)) (|-->| (set_diff g_s23_24 (SET g_s629_656)) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (mem (set_prod (set_diff g_s23_24 (SET g_s629_656)) (SET FALSE)) (|-->| (set_diff g_s23_24 (SET g_s629_656)) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (mem (set_prod (set_diff g_s23_24 (SET g_s629_656)) (SET g_s631_658)) (|-->| (set_diff g_s23_24 (SET g_s629_656)) g_s24_25))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1212_1243 (set_diff g_s23_24 (SET g_s629_656))))
(assert (mem g_s1213_1244 BOOL))
; PO 1 in group 3
(assert (not (mem (|<+| g_s1183_1219 (SET (mapplet g_s1212_1243 g_s1213_1244))) (|-->| (set_diff g_s23_24 (SET g_s629_656)) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_ass|)
(assert (mem g_s1212_1243 (set_diff g_s23_24 (SET g_s629_656))))
(assert (mem g_s1215_1245 BOOL))
; PO 1 in group 4
(assert (not (mem (|<+| g_s1189_1225 (SET (mapplet g_s1212_1243 g_s1215_1245))) (|-->| (set_diff g_s23_24 (SET g_s629_656)) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)