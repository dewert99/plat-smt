...
(declare-fun g_s1505_1534 () U)
(declare-fun g_s1507_1535 () U)
(declare-fun g_s1509_1543 () U)
(declare-fun g_s1509_1536 () U)
(declare-fun g_s151_152 () U)
(declare-fun g_s1511_1537 () U)
(declare-fun g_s1513_1538 () U)
(declare-fun g_s1514_1539 () U)
(declare-fun g_s1517_1540 () U)
(declare-fun g_s152_153 () U)
(declare-fun g_s1520_1541 () U)
(declare-fun g_s1521_1542 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1463_1499 (|-->| (interval e425 g_s446_454) g_s7_8)) (mem g_s1464_1500 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 g_s446_454))) (and (|>=i| g_s1465_1501 e0) (|<=i| g_s1465_1501 g_s446_454)) (mem g_s1466_1502 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e598))) (mem g_s1467_1503 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (|-->| (interval e0 e598) BOOL))) (mem g_s1468_1504 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423))) (mem g_s1469_1505 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e421))) (mem g_s1470_1506 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e421))) (mem g_s1471_1507 (|-->| (interval e425 g_s446_454) g_s7_8)) (mem g_s1472_1508 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 g_s446_454))) (and (|>=i| g_s1473_1509 e0) (|<=i| g_s1473_1509 g_s446_454)) (mem g_s1474_1510 (|-->| (set_diff g_s7_8 (SET g_s625_652)) g_s26_27)) (mem g_s1475_1511 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423))) (mem g_s1476_1512 (|-->| (set_diff g_s46_47 (SET g_s677_704)) (|-->| (interval e0 e598) BOOL))) (mem g_s1477_1513 g_s26_27) (and (|>=i| g_s1478_1514 e0) (|<=i| g_s1478_1514 e598)) (mem g_s1479_1515 (|-->| (interval e0 e598) BOOL)) (and (|>=i| g_s1480_1516 e430) (|<=i| g_s1480_1516 e423)) (and (|>=i| g_s1481_1517 e0) (|<=i| g_s1481_1517 e421)) (and (|>=i| g_s1482_1518 e0) (|<=i| g_s1482_1518 e421)) (mem g_s1483_1519 g_s0_1) (mem g_s1484_1520 g_s0_1) (mem g_s1485_1521 g_s17_18) (mem g_s1486_1522 g_s26_27) (and (|>=i| g_s1487_1523 e430) (|<=i| g_s1487_1523 e423)) (and (|>=i| g_s1488_1524 e0) (|<=i| g_s1488_1524 e421)) (and (|>=i| g_s1489_1525 e0) (|<=i| g_s1489_1525 e421)) (mem g_s1490_1526 g_s0_1) (mem g_s1491_1527 g_s0_1) (mem g_s1492_1528 g_s26_27) (and (|>=i| g_s1493_1529 e0) (|<=i| g_s1493_1529 e598)) (mem g_s1494_1530 (|-->| (interval e0 e598) BOOL)) (and (|>=i| g_s1495_1531 e430) (|<=i| g_s1495_1531 e423)) (and (|>=i| g_s1496_1532 e0) (|<=i| g_s1496_1532 e421)) (and (|>=i| g_s1497_1533 e0) (|<=i| g_s1497_1533 e421)) (= (range_subtraction g_s1464_1500 (SET e0)) (inverse (domain_restriction (interval e425 g_s1465_1501) g_s1463_1499))) (= (range_subtraction g_s1472_1508 (SET e0)) (inverse (domain_restriction (interval e425 g_s1473_1509) g_s1471_1507)))))
(define-fun |def_ass| () Bool (and (= (interval e425 g_s1465_1501) (ran (range_subtraction g_s1464_1500 (SET e0)))) (= g_s1465_1501 (card (range_subtraction g_s1464_1500 (SET e0)))) (= (interval e425 g_s1473_1509) (ran (range_subtraction g_s1472_1508 (SET e0)))) (= g_s1473_1509 (card (range_subtraction g_s1472_1508 (SET e0))))))
...
; PO 1 in group 2
(assert (not (= (interval e425 g_s1473_1509) (ran (range_subtraction g_s1472_1508 (SET e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (= (interval e425 g_s1465_1501) (ran (range_subtraction g_s1464_1500 (SET e0)))))
(assert (= g_s1465_1501 (card (range_subtraction g_s1464_1500 (SET e0)))))
(assert (= (interval e425 g_s1473_1509) (ran (range_subtraction g_s1472_1508 (SET e0)))))
; PO 1 in group 3
(assert (not (= g_s1473_1509 (card (range_subtraction g_s1472_1508 (SET e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
; PO 2 in group 4
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 e598))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
...
; PO 6 in group 4
(push 1)
(assert (not (mem (set_prod (set_diff g_s7_8 (SET g_s625_652)) (SET e0)) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e598)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 4
(push 1)
(assert (not (mem (set_prod (set_diff g_s7_8 (SET g_s625_652)) (SET e0)) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e421)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 4
...
; PO 9 in group 4
(push 1)
(assert (not (mem (set_prod (set_diff g_s7_8 (SET g_s625_652)) (SET g_s635_662)) (|-->| (set_diff g_s7_8 (SET g_s625_652)) g_s26_27))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 4
(push 1)
(assert (not (mem (set_prod (set_diff g_s7_8 (SET g_s625_652)) (SET (set_prod (interval e0 e598) (SET FALSE)))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (|-->| (interval e0 e598) BOOL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 4
(push 1)
(assert (not (mem (set_prod (set_diff g_s46_47 (SET g_s677_704)) (SET (set_prod (interval e0 e598) (SET FALSE)))) (|-->| (set_diff g_s46_47 (SET g_s677_704)) (|-->| (interval e0 e598) BOOL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 4
(push 1)
(assert (not (mem (set_prod (interval e0 e598) (SET FALSE)) (|-->| (interval e0 e598) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 4
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_1 () Bool (= (apply g_s1464_1500 g_s1505_1534) e0))
; PO 1 in group 7
(push 1)
(assert (not (=> lh_1 (mem (|<+| g_s1463_1499 (SET (mapplet (|+i| g_s1465_1501 e425) g_s1505_1534))) (|-->| (interval e425 g_s446_454) g_s7_8)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 7
(push 1)
(assert (not (=> lh_1 (mem (|<+| g_s1464_1500 (SET (mapplet g_s1505_1534 (|+i| g_s1465_1501 e425)))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 g_s446_454))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 7
(push 1)
(assert (not (=> lh_1 (and (|>=i| (|+i| g_s1465_1501 e425) e0) (|<=i| (|+i| g_s1465_1501 e425) g_s446_454)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 7
(push 1)
(assert (not (=> lh_1 (= (range_subtraction (|<+| g_s1464_1500 (SET (mapplet g_s1505_1534 (|+i| g_s1465_1501 e425)))) (SET e0)) (inverse (domain_restriction (interval e425 (|+i| g_s1465_1501 e425)) (|<+| g_s1463_1499 (SET (mapplet (|+i| g_s1465_1501 e425) g_s1505_1534)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(assert (and (|>=i| g_s1507_1535 e0) (|<=i| g_s1507_1535 e598)))
(assert (|>i| (apply g_s1464_1500 g_s1505_1534) e0))
; PO 1 in group 8
(assert (not (mem (|<+| g_s1466_1502 (SET (mapplet g_s1505_1534 g_s1507_1535))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e598)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert |def_ass|)
(assert (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(assert (mem g_s1509_1536 (|-->| (interval e0 e598) BOOL)))
(assert (|>i| (apply g_s1464_1500 g_s1505_1534) e0))
; PO 1 in group 9
(assert (not (mem (|<+| g_s1467_1503 (SET (mapplet g_s1505_1534 g_s1509_1536))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (|-->| (interval e0 e598) BOOL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 10 
...
(assert |def_ass|)
(assert (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(assert (and (|>=i| g_s1511_1537 e430) (|<=i| g_s1511_1537 e423)))
(assert (|>i| (apply g_s1464_1500 g_s1505_1534) e0))
; PO 1 in group 10
(assert (not (mem (|<+| g_s1468_1504 (SET (mapplet g_s1505_1534 g_s1511_1537))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 11 
...
(assert |def_ass|)
(assert (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(assert (and (|>=i| g_s1513_1538 e0) (|<=i| g_s1513_1538 e421)))
(assert (and (|>=i| g_s1514_1539 e0) (|<=i| g_s1514_1539 e421)))
(assert (|>i| (apply g_s1464_1500 g_s1505_1534) e0))
; PO 1 in group 11
(push 1)
(assert (not (mem (|<+| g_s1469_1505 (SET (mapplet g_s1505_1534 g_s1513_1538))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e421)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 11
(push 1)
(assert (not (mem (|<+| g_s1470_1506 (SET (mapplet g_s1505_1534 g_s1514_1539))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 e421)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_1 () Bool (= (apply g_s1472_1508 g_s1505_1534) e0))
; PO 1 in group 12
(push 1)
(assert (not (=> lh_1 (mem (|<+| g_s1471_1507 (SET (mapplet (|+i| g_s1473_1509 e425) g_s1505_1534))) (|-->| (interval e425 g_s446_454) g_s7_8)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 12
(push 1)
(assert (not (=> lh_1 (mem (|<+| g_s1472_1508 (SET (mapplet g_s1505_1534 (|+i| g_s1473_1509 e425)))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 g_s446_454))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 12
(push 1)
(assert (not (=> lh_1 (and (|>=i| (|+i| g_s1473_1509 e425) e0) (|<=i| (|+i| g_s1473_1509 e425) g_s446_454)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 12
(push 1)
(assert (not (=> lh_1 (= (range_subtraction (|<+| g_s1472_1508 (SET (mapplet g_s1505_1534 (|+i| g_s1473_1509 e425)))) (SET e0)) (inverse (domain_restriction (interval e425 (|+i| g_s1473_1509 e425)) (|<+| g_s1471_1507 (SET (mapplet (|+i| g_s1473_1509 e425) g_s1505_1534)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(assert (mem g_s1517_1540 (set_diff g_s26_27 (SET g_s635_662))))
(assert (|>i| (apply g_s1472_1508 g_s1505_1534) e0))
; PO 1 in group 13
(assert (not (mem (|<+| g_s1474_1510 (SET (mapplet g_s1505_1534 g_s1517_1540))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) g_s26_27))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 14 
...
(assert (|>i| (apply g_s1472_1508 g_s1505_1534) e0))
; PO 1 in group 14
(assert (not (mem (|<+| g_s1475_1511 (SET (mapplet g_s1505_1534 g_s1511_1537))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 15 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1520_1541 (set_diff g_s46_47 (SET g_s677_704))))
(assert (and (|>=i| g_s1521_1542 e0) (|<=i| g_s1521_1542 e598)))
(assert (mem g_s1509_1543 BOOL))
; PO 1 in group 15
(assert (not (mem (|<+| g_s1476_1512 (SET (mapplet g_s1520_1541 (|<+| (apply g_s1476_1512 g_s1520_1541) (SET (mapplet g_s1521_1542 g_s1509_1543)))))) (|-->| (set_diff g_s46_47 (SET g_s677_704)) (|-->| (interval e0 e598) BOOL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 16 
...
(assert (= (interval e425 g_s1473_1509) (ran (range_subtraction g_s1472_1508 (SET e0)))))
; PO 1 in group 17
(assert (not (mem (range_subtraction g_s1472_1508 (SET e0)) (FIN (range_subtraction g_s1472_1508 (SET e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 18 
...
; PO 1 in group 18
(push 1)
(assert (not (mem g_s1505_1534 (dom g_s1464_1500))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 18
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_2 () Bool (and (|>=i| g_s1507_1535 e0) (|<=i| g_s1507_1535 e598)))
; PO 1 in group 19
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1505_1534 (dom g_s1464_1500)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 19
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1464_1500 (|+->| (dom g_s1464_1500) (ran g_s1464_1500))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_2 () Bool (mem g_s1509_1536 (|-->| (interval e0 e598) BOOL)))
; PO 1 in group 20
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1505_1534 (dom g_s1464_1500)))))
(set-info :status unknown)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_2 () Bool (and (|>=i| g_s1511_1537 e430) (|<=i| g_s1511_1537 e423)))
; PO 1 in group 21
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1505_1534 (dom g_s1464_1500)))))
(set-info :status unknown)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_2 () Bool (and (|>=i| g_s1513_1538 e0) (|<=i| g_s1513_1538 e421)))
(define-fun lh_3 () Bool (and (|>=i| g_s1514_1539 e0) (|<=i| g_s1514_1539 e421)))
; PO 1 in group 22
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1505_1534 (dom g_s1464_1500)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 22
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1464_1500 (|+->| (dom g_s1464_1500) (ran g_s1464_1500))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 23
(push 1)
(assert (not (mem g_s1505_1534 (dom g_s1472_1508))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 23
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s1505_1534 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_2 () Bool (mem g_s1517_1540 (set_diff g_s26_27 (SET g_s635_662))))
; PO 1 in group 24
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1505_1534 (dom g_s1472_1508)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 24
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1472_1508 (|+->| (dom g_s1472_1508) (ran g_s1472_1508))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 26
(push 1)
(assert (not (mem g_s1520_1541 (dom g_s1476_1512))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 26
