...
(declare-fun g_s1544_1573 () U)
(declare-fun g_s1546_1574 () U)
(declare-fun g_s1549_1575 () U)
(declare-fun g_s155_156 () U)
(declare-fun g_s1550_1576 () U)
(declare-fun g_s1552_1577 () U)
(declare-fun g_s1554_1578 () U)
(declare-fun g_s1556_1579 () U)
(declare-fun g_s1558_1580 () U)
(declare-fun g_s156_157 () U)
(declare-fun g_s1560_1581 () U)
(declare-fun g_s1562_1582 () U)
(declare-fun g_s1564_1583 () U)
(declare-fun g_s1566_1584 () U)
(declare-fun g_s1568_1585 () U)
(declare-fun g_s157_158 () U)
(declare-fun g_s1570_1586 () U)
(declare-fun g_s1572_1587 () U)
(declare-fun g_s1574_1588 () U)
(declare-fun g_s1576_1589 () U)
(declare-fun g_s1578_1590 () U)
(declare-fun g_s158_159 () U)
(declare-fun g_s1580_1591 () U)
(declare-fun g_s1582_1592 () U)
(declare-fun g_s1584_1593 () U)
(declare-fun g_s1585_1594 () U)
(declare-fun g_s1587_1595 () U)
(declare-fun g_s1589_1596 () U)
(declare-fun g_s159_160 () U)
(declare-fun g_s1591_1597 () U)
(declare-fun g_s1593_1598 () U)
(declare-fun g_s1595_1599 () U)
(declare-fun g_s1597_1600 () U)
(declare-fun g_s1599_1601 () U)
(declare-fun g_s16_17 () U)
(declare-fun g_s160_161 () U)
(declare-fun g_s1601_1602 () U)
(declare-fun g_s1603_1603 () U)
(declare-fun g_s1605_1604 () U)
(declare-fun g_s1608_1605 () U)
(declare-fun g_s161_162 () U)
(declare-fun g_s1610_1606 () U)
(declare-fun g_s1612_1607 () U)
(declare-fun g_s1614_1608 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1463_1499 g_s1_2) (mem g_s1464_1500 (|-->| (interval e425 g_s446_454) g_s7_8)) (mem g_s1465_1501 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 g_s446_454))) (and (|>=i| g_s1466_1502 e0) (|<=i| g_s1466_1502 g_s446_454)) (mem g_s1467_1503 (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423))) (mem g_s1468_1504 g_s0_1) (mem g_s1469_1505 g_s0_1) (mem g_s1470_1506 g_s17_18) (and (|>=i| g_s1471_1507 e430) (|<=i| g_s1471_1507 e423)) (and (|>=i| g_s1472_1508 e0) (|<=i| g_s1472_1508 e421)) (and (|>=i| g_s1473_1509 e0) (|<=i| g_s1473_1509 e421)) (mem g_s1474_1510 g_s0_1) (mem g_s1475_1511 g_s0_1) (mem g_s1476_1512 g_s17_18) (mem g_s1477_1513 BOOL) (mem g_s1478_1514 BOOL) (mem g_s1479_1515 BOOL) (and (|>=i| g_s1480_1516 e0) (|<=i| g_s1480_1516 e559)) (mem g_s1481_1517 BOOL) (mem g_s1482_1518 BOOL) (and (|>=i| g_s1483_1519 e0) (|<=i| g_s1483_1519 g_s566_580)) (mem g_s1484_1520 g_s862_890) (mem g_s1485_1521 g_s863_891) (mem g_s1486_1522 g_s858_886) (mem g_s1487_1523 g_s858_886) (mem g_s1488_1524 g_s858_886) (mem g_s1489_1525 g_s864_892) (mem g_s1490_1526 g_s858_886) (mem g_s1491_1527 g_s858_886) (mem g_s1492_1528 g_s858_886) (mem g_s1493_1529 g_s858_886) (mem g_s1494_1530 g_s858_886) (mem g_s1495_1531 g_s858_886) (mem g_s1496_1532 (|-->| g_s857_885 (interval e430 e423))) (mem g_s1497_1533 g_s858_886) (mem g_s1498_1534 (|-->| g_s857_885 (interval e430 e423))) (mem g_s1499_1535 g_s858_886) (mem g_s1500_1536 g_s858_886) (mem g_s1501_1537 g_s861_889) (mem g_s1502_1538 (|-->| (interval e425 g_s567_581) g_s315_316)) (mem g_s1503_1539 (|-->| (interval e425 g_s567_581) (interval e0 e559))) (mem g_s1504_1540 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1505_1541 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1506_1542 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1507_1543 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1508_1544 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1509_1545 (|-->| (interval e425 g_s567_581) (interval e0 e559))) (and (|>=i| g_s1510_1546 e430) (|<=i| g_s1510_1546 e423)) (and (|>=i| g_s1511_1547 e0) (|<=i| g_s1511_1547 e421)) (and (|>=i| g_s1512_1548 e0) (|<=i| g_s1512_1548 e421)) (mem g_s1513_1549 g_s860_888) (mem g_s1514_1550 g_s0_1) (mem g_s1515_1551 g_s0_1) (and (|>=i| g_s1516_1552 e0) (|<=i| g_s1516_1552 e417)) (and (|>=i| g_s1517_1553 e0) (|<=i| g_s1517_1553 e423)) (mem g_s1518_1554 BOOL) (mem g_s1519_1555 g_s1063_1091) (mem g_s1520_1556 (|-->| (interval e425 e600) g_s39_40)) (mem g_s1521_1557 (|-->| (interval e425 e600) g_s260_261)) (mem g_s1522_1558 (|-->| (interval e425 e600) BOOL)) (mem g_s1523_1559 (|-->| (interval e425 e600) g_s17_18)) (mem g_s1524_1560 (|-->| (interval e425 e600) g_s725_753)) (mem g_s1525_1561 (|-->| (interval e425 e600) BOOL)) (mem g_s1526_1562 (|-->| (interval e425 e600) g_s17_18)) (mem g_s1527_1563 (|-->| (interval e425 e600) g_s725_753)) (= (range_subtraction g_s1465_1501 (SET e0)) (inverse (domain_restriction (interval e425 g_s1466_1502) g_s1464_1500))) (mem g_s1528_1564 g_s0_1) (mem g_s1529_1565 g_s0_1) (mem g_s1530_1566 g_s17_18) (and (|>=i| g_s1531_1567 e430) (|<=i| g_s1531_1567 e423)) (and (|>=i| g_s1532_1568 e0) (|<=i| g_s1532_1568 e559)) (and (|>=i| g_s1533_1569 e0) (|<=i| g_s1533_1569 e559)) (and (|>=i| g_s1534_1570 e430) (|<=i| g_s1534_1570 e423)) (and (|>=i| g_s1535_1571 e0) (|<=i| g_s1535_1571 e421)) (and (|>=i| g_s1536_1572 e0) (|<=i| g_s1536_1572 e421))))
(define-fun |def_ass| () Bool (and (= (interval e425 g_s1466_1502) (ran (range_subtraction g_s1465_1501 (SET e0)))) (= g_s1466_1502 (card (range_subtraction g_s1465_1501 (SET e0))))))
...
; PO 1 in group 0
(push 1)
(assert (not (= g_s1466_1502 (card (range_subtraction g_s1465_1501 (SET e0))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (= (interval e425 g_s1466_1502) (ran (range_subtraction g_s1465_1501 (SET e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 1
(push 1)
(assert (not (and (|>=i| e0 e430) (|<=i| e0 e423))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 e417))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 e421))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 e559))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 e423))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 1
...
; PO 7 in group 1
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 g_s566_580))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 1
(push 1)
(assert (not (mem (set_prod g_s857_885 (SET FALSE)) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 1
(push 1)
(assert (not (mem (set_prod g_s857_885 (SET e0)) g_s860_888)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 1
(push 1)
(assert (not (mem (set_prod g_s857_885 (SET e0)) (|-->| g_s857_885 (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 1
(push 1)
(assert (not (mem (set_prod g_s857_885 (SET g_s1306_1342)) g_s864_892)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 1
(push 1)
(assert (not (mem (set_prod g_s857_885 (SET g_s664_691)) g_s862_890)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 1
(push 1)
(assert (not (mem (set_prod g_s857_885 (SET g_s699_726)) g_s863_891)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 1
(push 1)
(assert (not (mem (set_prod g_s857_885 (SET g_s254_255)) g_s861_889)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 1
...
; PO 17 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 e600) (SET FALSE)) (|-->| (interval e425 e600) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 18 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 e600) (SET e0)) (|-->| (interval e425 e600) g_s725_753))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 19 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 e600) (SET g_s610_637)) (|-->| (interval e425 e600) g_s17_18))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 20 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 e600) (SET g_s664_691)) (|-->| (interval e425 e600) g_s39_40))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 21 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 e600) (SET g_s263_264)) (|-->| (interval e425 e600) g_s260_261))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 22 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 e600) (SET g_s268_269)) g_s1063_1091)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 23 in group 1
...
; PO 24 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 g_s567_581) (SET FALSE)) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 25 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 g_s567_581) (SET e0)) (|-->| (interval e425 g_s567_581) (interval e0 e559)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 26 in group 1
(push 1)
(assert (not (mem (set_prod (interval e425 g_s567_581) (SET g_s316_317)) (|-->| (interval e425 g_s567_581) g_s315_316))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 27 in group 1
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1544_1573 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_1 () Bool (= (apply g_s1465_1501 g_s1544_1573) e0))
; PO 1 in group 4
(push 1)
(assert (not (=> lh_1 (mem (|<+| g_s1464_1500 (SET (mapplet (|+i| g_s1466_1502 e425) g_s1544_1573))) (|-->| (interval e425 g_s446_454) g_s7_8)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> lh_1 (mem (|<+| g_s1465_1501 (SET (mapplet g_s1544_1573 (|+i| g_s1466_1502 e425)))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e0 g_s446_454))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
(push 1)
(assert (not (=> lh_1 (and (|>=i| (|+i| g_s1466_1502 e425) e0) (|<=i| (|+i| g_s1466_1502 e425) g_s446_454)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 4
(push 1)
(assert (not (=> lh_1 (= (range_subtraction (|<+| g_s1465_1501 (SET (mapplet g_s1544_1573 (|+i| g_s1466_1502 e425)))) (SET e0)) (inverse (domain_restriction (interval e425 (|+i| g_s1466_1502 e425)) (|<+| g_s1464_1500 (SET (mapplet (|+i| g_s1466_1502 e425) g_s1544_1573)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1544_1573 (set_diff g_s7_8 (SET g_s625_652))))
(assert (and (|>=i| g_s1546_1574 e430) (|<=i| g_s1546_1574 e423)))
(assert (|>i| (apply g_s1465_1501 g_s1544_1573) e0))
; PO 1 in group 5
(assert (not (mem (|<+| g_s1467_1503 (SET (mapplet g_s1544_1573 g_s1546_1574))) (|-->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1550_1576 g_s39_40))
; PO 1 in group 7
(assert (not (mem (|<+| g_s1484_1520 (SET (mapplet g_s1549_1575 g_s1550_1576))) g_s862_890)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1552_1577 g_s40_41))
; PO 1 in group 8
(assert (not (mem (|<+| g_s1485_1521 (SET (mapplet g_s1549_1575 g_s1552_1577))) g_s863_891)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1554_1578 BOOL))
; PO 1 in group 9
(assert (not (mem (|<+| g_s1486_1522 (SET (mapplet g_s1549_1575 g_s1554_1578))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 10 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1556_1579 BOOL))
; PO 1 in group 10
(assert (not (mem (|<+| g_s1487_1523 (SET (mapplet g_s1549_1575 g_s1556_1579))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 11 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1558_1580 BOOL))
; PO 1 in group 11
(assert (not (mem (|<+| g_s1488_1524 (SET (mapplet g_s1549_1575 g_s1558_1580))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 12 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1560_1581 g_s747_775))
; PO 1 in group 12
(assert (not (mem (|<+| g_s1489_1525 (SET (mapplet g_s1549_1575 g_s1560_1581))) g_s864_892)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 13 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1562_1582 BOOL))
; PO 1 in group 13
(assert (not (mem (|<+| g_s1490_1526 (SET (mapplet g_s1549_1575 g_s1562_1582))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 14 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1564_1583 BOOL))
; PO 1 in group 14
(assert (not (mem (|<+| g_s1491_1527 (SET (mapplet g_s1549_1575 g_s1564_1583))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 15 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1566_1584 BOOL))
; PO 1 in group 15
(assert (not (mem (|<+| g_s1492_1528 (SET (mapplet g_s1549_1575 g_s1566_1584))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 16 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1568_1585 BOOL))
; PO 1 in group 16
(assert (not (mem (|<+| g_s1497_1533 (SET (mapplet g_s1549_1575 g_s1568_1585))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 17 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1570_1586 BOOL))
; PO 1 in group 17
(assert (not (mem (|<+| g_s1493_1529 (SET (mapplet g_s1549_1575 g_s1570_1586))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 18 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1572_1587 BOOL))
; PO 1 in group 18
(assert (not (mem (|<+| g_s1494_1530 (SET (mapplet g_s1549_1575 g_s1572_1587))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 19 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1574_1588 BOOL))
; PO 1 in group 19
(assert (not (mem (|<+| g_s1495_1531 (SET (mapplet g_s1549_1575 g_s1574_1588))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 20 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (and (|>=i| g_s1576_1589 e430) (|<=i| g_s1576_1589 e423)))
; PO 1 in group 20
(assert (not (mem (|<+| g_s1496_1532 (SET (mapplet g_s1549_1575 g_s1576_1589))) (|-->| g_s857_885 (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 21 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1578_1590 BOOL))
; PO 1 in group 21
(assert (not (mem (|<+| g_s1499_1535 (SET (mapplet g_s1549_1575 g_s1578_1590))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 22 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (mem g_s1580_1591 g_s253_254))
; PO 1 in group 22
(assert (not (mem (|<+| g_s1501_1537 (SET (mapplet g_s1549_1575 g_s1580_1591))) g_s861_889)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 23 
...
(assert |def_ass|)
(assert (mem g_s1549_1575 g_s857_885))
(assert (and (|>=i| g_s1582_1592 e430) (|<=i| g_s1582_1592 e423)))
; PO 1 in group 23
(assert (not (mem (|<+| g_s1498_1534 (SET (mapplet g_s1549_1575 g_s1582_1592))) (|-->| g_s857_885 (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 24 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (mem g_s1585_1594 g_s315_316))
; PO 1 in group 24
(assert (not (mem (|<+| g_s1502_1538 (SET (mapplet g_s1584_1593 g_s1585_1594))) (|-->| (interval e425 g_s567_581) g_s315_316))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 25 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (and (|>=i| g_s1587_1595 e0) (|<=i| g_s1587_1595 e559)))
; PO 1 in group 25
(assert (not (mem (|<+| g_s1503_1539 (SET (mapplet g_s1584_1593 g_s1587_1595))) (|-->| (interval e425 g_s567_581) (interval e0 e559)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 26 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (and (|>=i| g_s1589_1596 e0) (|<=i| g_s1589_1596 e559)))
; PO 1 in group 26
(assert (not (mem (|<+| g_s1509_1545 (SET (mapplet g_s1584_1593 g_s1589_1596))) (|-->| (interval e425 g_s567_581) (interval e0 e559)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 27 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (mem g_s1591_1597 BOOL))
; PO 1 in group 27
(assert (not (mem (|<+| g_s1508_1544 (SET (mapplet g_s1584_1593 g_s1591_1597))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 28 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (mem g_s1593_1598 BOOL))
; PO 1 in group 28
(assert (not (mem (|<+| g_s1504_1540 (SET (mapplet g_s1584_1593 g_s1593_1598))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 29 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (mem g_s1595_1599 BOOL))
; PO 1 in group 29
(assert (not (mem (|<+| g_s1505_1541 (SET (mapplet g_s1584_1593 g_s1595_1599))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 30 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (mem g_s1597_1600 BOOL))
; PO 1 in group 30
(assert (not (mem (|<+| g_s1506_1542 (SET (mapplet g_s1584_1593 g_s1597_1600))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 31 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1584_1593 e425) (|<=i| g_s1584_1593 g_s567_581)))
(assert (mem g_s1599_1601 BOOL))
; PO 1 in group 31
(assert (not (mem (|<+| g_s1507_1543 (SET (mapplet g_s1584_1593 g_s1599_1601))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 32 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1584_1593 g_s857_885))
(assert (mem g_s1601_1602 BOOL))
; PO 1 in group 32
(assert (not (mem (|<+| g_s1500_1536 (SET (mapplet g_s1584_1593 g_s1601_1602))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 33 
...
(assert |def_ass|)
(assert (mem g_s1584_1593 g_s857_885))
(assert (and (|>=i| g_s1603_1603 e0) (|<=i| g_s1603_1603 e559)))
; PO 1 in group 33
(assert (not (mem (|<+| g_s1513_1549 (SET (mapplet g_s1584_1593 g_s1603_1603))) g_s860_888)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 34 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s1549_1575 e425) (|<=i| g_s1549_1575 e600)))
(assert (mem g_s1605_1604 g_s264_265))
; PO 1 in group 34
(assert (not (mem (|<+| g_s1519_1555 (SET (mapplet g_s1549_1575 g_s1605_1604))) g_s1063_1091)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 35 
...
(assert (mem g_s1550_1576 g_s39_40))
; PO 1 in group 35
(assert (not (mem (|<+| g_s1520_1556 (SET (mapplet g_s1549_1575 g_s1550_1576))) (|-->| (interval e425 e600) g_s39_40))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 36 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1549_1575 e425) (|<=i| g_s1549_1575 e600)))
(assert (mem g_s1608_1605 g_s260_261))
; PO 1 in group 36
(assert (not (mem (|<+| g_s1521_1557 (SET (mapplet g_s1549_1575 g_s1608_1605))) (|-->| (interval e425 e600) g_s260_261))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 37 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1549_1575 e425) (|<=i| g_s1549_1575 e600)))
(assert (mem g_s1610_1606 BOOL))
; PO 1 in group 37
(assert (not (mem (|<+| g_s1522_1558 (SET (mapplet g_s1549_1575 g_s1610_1606))) (|-->| (interval e425 e600) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 38 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1549_1575 e425) (|<=i| g_s1549_1575 e600)))
(assert (mem g_s1612_1607 (set_diff g_s17_18 (SET g_s610_637))))
; PO 1 in group 38
(assert (not (mem (|<+| g_s1523_1559 (SET (mapplet g_s1549_1575 g_s1612_1607))) (|-->| (interval e425 e600) g_s17_18))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 39 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1549_1575 e425) (|<=i| g_s1549_1575 e600)))
(assert (mem g_s1614_1608 g_s725_753))
; PO 1 in group 39
(assert (not (mem (|<+| g_s1524_1560 (SET (mapplet g_s1549_1575 g_s1614_1608))) (|-->| (interval e425 e600) g_s725_753))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 40 
...
(assert (mem g_s1595_1599 BOOL))
; PO 1 in group 40
(assert (not (mem (|<+| g_s1525_1561 (SET (mapplet g_s1549_1575 g_s1595_1599))) (|-->| (interval e425 e600) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 41 
...
(assert (mem g_s1612_1607 (set_diff g_s17_18 (SET g_s610_637))))
; PO 1 in group 41
(assert (not (mem (|<+| g_s1526_1562 (SET (mapplet g_s1549_1575 g_s1612_1607))) (|-->| (interval e425 e600) g_s17_18))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 42 
...
(assert (mem g_s1614_1608 g_s725_753))
; PO 1 in group 42
(assert (not (mem (|<+| g_s1527_1563 (SET (mapplet g_s1549_1575 g_s1614_1608))) (|-->| (interval e425 e600) g_s725_753))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 43 
...
(assert |def_seext|)
(assert |def_inv|)
(define-fun lh_1 () Bool (= (interval e425 g_s1466_1502) (ran (range_subtraction g_s1465_1501 (SET e0)))))
; PO 1 in group 43
(assert (not (=> lh_1 (mem (range_subtraction g_s1465_1501 (SET e0)) (FIN (range_subtraction g_s1465_1501 (SET e0)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 44 
...
; PO 1 in group 44
(push 1)
(assert (not (mem g_s1544_1573 (dom g_s1465_1501))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 44
(push 1)
(assert (not (mem g_s1465_1501 (|+->| (dom g_s1465_1501) (ran g_s1465_1501)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s1544_1573 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_2 () Bool (and (|>=i| g_s1546_1574 e430) (|<=i| g_s1546_1574 e423)))
; PO 1 in group 45
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1544_1573 (dom g_s1465_1501)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 45
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1465_1501 (|+->| (dom g_s1465_1501) (ran g_s1465_1501))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
