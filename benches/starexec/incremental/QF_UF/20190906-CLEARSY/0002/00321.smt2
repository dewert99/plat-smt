...
(declare-fun g_s1538_1569 () U)
(declare-fun g_s154_155 () U)
(declare-fun g_s1540_1571 () U)
(declare-fun g_s1543_1572 () U)
(declare-fun g_s1544_1573 () U)
(declare-fun g_s1546_1574 () U)
(declare-fun g_s1548_1575 () U)
...
(declare-fun g_s1577_1590 () U)
(declare-fun g_s1579_1591 () U)
(declare-fun g_s158_159 () U)
(declare-fun g_s1581_1592 () U)
(declare-fun g_s1583_1593 () U)
...
(declare-fun g_s1602_1602 () U)
(declare-fun g_s1604_1603 () U)
(declare-fun g_s1606_1604 () U)
(declare-fun g_s1608_1605 () U)
(declare-fun g_s161_162 () U)
(declare-fun g_s1615_1606 () U)
(declare-fun g_s1617_1607 () U)
(declare-fun g_s1618_1608 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1463_1499 g_s1_2) (mem g_s1464_1500 (iseq (set_diff g_s7_8 (SET g_s625_652)))) (mem g_s1465_1501 (|+->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423))) (mem g_s1466_1502 g_s0_1) (mem g_s1467_1503 g_s0_1) (mem g_s1468_1504 g_s17_18) (and (|>=i| g_s1469_1505 e430) (|<=i| g_s1469_1505 e423)) (and (|>=i| g_s1470_1506 e0) (|<=i| g_s1470_1506 e421)) (and (|>=i| g_s1471_1507 e0) (|<=i| g_s1471_1507 e421)) (mem g_s1472_1508 g_s0_1) (mem g_s1473_1509 g_s0_1) (mem g_s1474_1510 g_s17_18) (mem g_s1475_1511 BOOL) (mem g_s1476_1512 BOOL) (mem g_s1477_1513 BOOL) (and (|>=i| g_s1478_1514 e0) (|<=i| g_s1478_1514 g_s566_580)) (mem g_s1479_1515 BOOL) (mem g_s1480_1516 g_s862_890) (mem g_s1481_1517 g_s863_891) (mem g_s1482_1518 g_s858_886) (mem g_s1483_1519 g_s858_886) (mem g_s1484_1520 g_s858_886) (mem g_s1485_1521 g_s864_892) (mem g_s1486_1522 g_s858_886) (mem g_s1487_1523 g_s858_886) (mem g_s1488_1524 g_s858_886) (mem g_s1489_1525 g_s858_886) (mem g_s1490_1526 g_s858_886) (mem g_s1491_1527 g_s858_886) (mem g_s1492_1528 (|-->| g_s857_885 (interval e430 e423))) (mem g_s1493_1529 g_s858_886) (mem g_s1494_1530 g_s861_889) (mem g_s1495_1531 (|-->| g_s857_885 (interval e430 e423))) (mem g_s1496_1532 (|-->| (interval e425 g_s567_581) g_s315_316)) (mem g_s1497_1533 (|-->| (interval e425 g_s567_581) (interval e0 e559))) (mem g_s1498_1534 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1499_1535 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1500_1536 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1501_1537 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1502_1538 (|-->| (interval e425 g_s567_581) BOOL)) (mem g_s1503_1539 (|-->| (interval e425 g_s567_581) (interval e0 e559))) (mem g_s1504_1540 g_s858_886) (and (|>=i| g_s1505_1541 e430) (|<=i| g_s1505_1541 e423)) (and (|>=i| g_s1506_1542 e0) (|<=i| g_s1506_1542 e421)) (and (|>=i| g_s1507_1543 e0) (|<=i| g_s1507_1543 e421)) (mem g_s1508_1544 g_s860_888) (mem g_s1509_1545 g_s858_886) (mem g_s1510_1546 (|-->| (interval e425 e600) BOOL)) (mem g_s1511_1547 g_s0_1) (mem g_s1512_1548 g_s0_1) (and (|>=i| g_s1513_1549 e0) (|<=i| g_s1513_1549 e417)) (and (|>=i| g_s1514_1550 e0) (|<=i| g_s1514_1550 e423)) (mem g_s1515_1551 BOOL) (mem g_s1516_1552 g_s1063_1091) (mem g_s1517_1553 (|-->| (interval e425 e600) g_s39_40)) (mem g_s1518_1554 (|-->| (interval e425 e600) g_s260_261)) (mem g_s1519_1555 (|-->| (interval e425 e600) BOOL)) (mem g_s1520_1556 (|-->| (interval e425 e600) g_s17_18)) (mem g_s1521_1557 (|-->| (interval e425 e600) g_s725_753)) (mem g_s1522_1558 (|-->| (interval e425 e600) g_s17_18)) (mem g_s1523_1559 (|-->| (interval e425 e600) g_s725_753)) (mem g_s1524_1560 g_s0_1) (mem g_s1525_1561 g_s0_1) (mem g_s1526_1562 g_s17_18) (and (|>=i| g_s1527_1563 e430) (|<=i| g_s1527_1563 e423)) (and (|>=i| g_s1528_1564 e0) (|<=i| g_s1528_1564 e559)) (and (|>=i| g_s1529_1565 e0) (|<=i| g_s1529_1565 e559)) (and (|>=i| g_s1530_1566 e430) (|<=i| g_s1530_1566 e423)) (and (|>=i| g_s1531_1567 e0) (|<=i| g_s1531_1567 e421)) (and (|>=i| g_s1532_1568 e0) (|<=i| g_s1532_1568 e421))))
...
; PO 1 in group 0
(push 1)
(assert (not (mem empty (iseq (set_diff g_s7_8 (SET g_s625_652))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem empty (|+->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1538_1569 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_1 () Bool (mem g_s1464$1_1570 (perm (binary_union (ran g_s1464_1500) (SET g_s1538_1569)))))
; PO 1 in group 3
(assert (not (=> lh_1 (mem g_s1464$1_1570 (iseq (set_diff g_s7_8 (SET g_s625_652)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_ass|)
(assert (mem g_s1538_1569 (set_diff g_s7_8 (SET g_s625_652))))
(assert (and (|>=i| g_s1540_1571 e430) (|<=i| g_s1540_1571 e423)))
(assert (mem g_s1538_1569 (ran g_s1464_1500)))
; PO 1 in group 4
(assert (not (mem (|<+| g_s1465_1501 (SET (mapplet g_s1538_1569 g_s1540_1571))) (|+->| (set_diff g_s7_8 (SET g_s625_652)) (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1544_1573 g_s39_40))
; PO 1 in group 6
(assert (not (mem (|<+| g_s1480_1516 (SET (mapplet g_s1543_1572 g_s1544_1573))) g_s862_890)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1546_1574 g_s40_41))
; PO 1 in group 7
(assert (not (mem (|<+| g_s1481_1517 (SET (mapplet g_s1543_1572 g_s1546_1574))) g_s863_891)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1548_1575 BOOL))
; PO 1 in group 8
(assert (not (mem (|<+| g_s1482_1518 (SET (mapplet g_s1543_1572 g_s1548_1575))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1550_1576 BOOL))
; PO 1 in group 9
(assert (not (mem (|<+| g_s1483_1519 (SET (mapplet g_s1543_1572 g_s1550_1576))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 10 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1552_1577 BOOL))
; PO 1 in group 10
(assert (not (mem (|<+| g_s1484_1520 (SET (mapplet g_s1543_1572 g_s1552_1577))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 11 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1554_1578 g_s747_775))
; PO 1 in group 11
(assert (not (mem (|<+| g_s1485_1521 (SET (mapplet g_s1543_1572 g_s1554_1578))) g_s864_892)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 12 
...
; PO 1 in group 12
(assert (not (mem (|<+| g_s1486_1522 (SET (mapplet g_s1543_1572 g_s1556_1579))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 13 
...
; PO 1 in group 13
(assert (not (mem (|<+| g_s1487_1523 (SET (mapplet g_s1543_1572 g_s1558_1580))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 14 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1560_1581 BOOL))
; PO 1 in group 14
(assert (not (mem (|<+| g_s1488_1524 (SET (mapplet g_s1543_1572 g_s1560_1581))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 15 
...
; PO 1 in group 15
(assert (not (mem (|<+| g_s1489_1525 (SET (mapplet g_s1543_1572 g_s1562_1582))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 16 
...
; PO 1 in group 16
(assert (not (mem (|<+| g_s1490_1526 (SET (mapplet g_s1543_1572 g_s1564_1583))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 17 
...
; PO 1 in group 17
(assert (not (mem (|<+| g_s1491_1527 (SET (mapplet g_s1543_1572 g_s1566_1584))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 18 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (and (|>=i| g_s1568_1585 e430) (|<=i| g_s1568_1585 e423)))
; PO 1 in group 18
(assert (not (mem (|<+| g_s1492_1528 (SET (mapplet g_s1543_1572 g_s1568_1585))) (|-->| g_s857_885 (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 19 
...
; PO 1 in group 19
(assert (not (mem (|<+| g_s1493_1529 (SET (mapplet g_s1543_1572 g_s1570_1586))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 20 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (mem g_s1572_1587 g_s253_254))
; PO 1 in group 20
(assert (not (mem (|<+| g_s1494_1530 (SET (mapplet g_s1543_1572 g_s1572_1587))) g_s861_889)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 21 
...
(assert |def_ass|)
(assert (mem g_s1543_1572 g_s857_885))
(assert (and (|>=i| g_s1574_1588 e430) (|<=i| g_s1574_1588 e423)))
; PO 1 in group 21
(assert (not (mem (|<+| g_s1495_1531 (SET (mapplet g_s1543_1572 g_s1574_1588))) (|-->| g_s857_885 (interval e430 e423)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 22 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s1576_1589 e425) (|<=i| g_s1576_1589 g_s567_581)))
(assert (mem g_s1577_1590 g_s315_316))
; PO 1 in group 22
(assert (not (mem (|<+| g_s1496_1532 (SET (mapplet g_s1576_1589 g_s1577_1590))) (|-->| (interval e425 g_s567_581) g_s315_316))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 23 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1576_1589 e425) (|<=i| g_s1576_1589 g_s567_581)))
(assert (and (|>=i| g_s1579_1591 e0) (|<=i| g_s1579_1591 e559)))
; PO 1 in group 23
(assert (not (mem (|<+| g_s1497_1533 (SET (mapplet g_s1576_1589 g_s1579_1591))) (|-->| (interval e425 g_s567_581) (interval e0 e559)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 24 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1576_1589 e425) (|<=i| g_s1576_1589 g_s567_581)))
(assert (mem g_s1581_1592 BOOL))
; PO 1 in group 24
(assert (not (mem (|<+| g_s1498_1534 (SET (mapplet g_s1576_1589 g_s1581_1592))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 25 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1576_1589 e425) (|<=i| g_s1576_1589 g_s567_581)))
(assert (and (|>=i| g_s1583_1593 e0) (|<=i| g_s1583_1593 e559)))
; PO 1 in group 25
(assert (not (mem (|<+| g_s1503_1539 (SET (mapplet g_s1576_1589 g_s1583_1593))) (|-->| (interval e425 g_s567_581) (interval e0 e559)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 26 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1576_1589 e425) (|<=i| g_s1576_1589 g_s567_581)))
(assert (mem g_s1585_1594 BOOL))
; PO 1 in group 26
(assert (not (mem (|<+| g_s1502_1538 (SET (mapplet g_s1576_1589 g_s1585_1594))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 27 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1576_1589 e425) (|<=i| g_s1576_1589 g_s567_581)))
(assert (mem g_s1587_1595 BOOL))
; PO 1 in group 27
(assert (not (mem (|<+| g_s1499_1535 (SET (mapplet g_s1576_1589 g_s1587_1595))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 28 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1576_1589 e425) (|<=i| g_s1576_1589 g_s567_581)))
(assert (mem g_s1589_1596 BOOL))
; PO 1 in group 28
(assert (not (mem (|<+| g_s1500_1536 (SET (mapplet g_s1576_1589 g_s1589_1596))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 29 
...
; PO 1 in group 29
(assert (not (mem (|<+| g_s1501_1537 (SET (mapplet g_s1576_1589 g_s1591_1597))) (|-->| (interval e425 g_s567_581) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 30 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1576_1589 g_s857_885))
(assert (mem g_s1593_1598 BOOL))
; PO 1 in group 30
(assert (not (mem (|<+| g_s1504_1540 (SET (mapplet g_s1576_1589 g_s1593_1598))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 31 
...
(assert |def_ass|)
(assert (mem g_s1576_1589 g_s857_885))
(assert (and (|>=i| g_s1595_1599 e0) (|<=i| g_s1595_1599 e559)))
; PO 1 in group 31
(assert (not (mem (|<+| g_s1508_1544 (SET (mapplet g_s1576_1589 g_s1595_1599))) g_s860_888)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 32 
...
; PO 1 in group 32
(assert (not (mem (|<+| g_s1509_1545 (SET (mapplet g_s1543_1572 g_s1597_1600))) g_s858_886)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 33 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s1543_1572 e425) (|<=i| g_s1543_1572 e600)))
(assert (mem g_s1599_1601 g_s264_265))
; PO 1 in group 33
(assert (not (mem (|<+| g_s1516_1552 (SET (mapplet g_s1543_1572 g_s1599_1601))) g_s1063_1091)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 34 
...
(assert (mem g_s1544_1573 g_s39_40))
; PO 1 in group 34
(assert (not (mem (|<+| g_s1517_1553 (SET (mapplet g_s1543_1572 g_s1544_1573))) (|-->| (interval e425 e600) g_s39_40))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 35 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1543_1572 e425) (|<=i| g_s1543_1572 e600)))
(assert (mem g_s1602_1602 g_s260_261))
; PO 1 in group 35
(assert (not (mem (|<+| g_s1518_1554 (SET (mapplet g_s1543_1572 g_s1602_1602))) (|-->| (interval e425 e600) g_s260_261))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 36 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1543_1572 e425) (|<=i| g_s1543_1572 e600)))
(assert (mem g_s1604_1603 BOOL))
; PO 1 in group 36
(assert (not (mem (|<+| g_s1519_1555 (SET (mapplet g_s1543_1572 g_s1604_1603))) (|-->| (interval e425 e600) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 37 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1543_1572 e425) (|<=i| g_s1543_1572 e600)))
(assert (mem g_s1606_1604 (set_diff g_s17_18 (SET g_s610_637))))
; PO 1 in group 37
(assert (not (mem (|<+| g_s1520_1556 (SET (mapplet g_s1543_1572 g_s1606_1604))) (|-->| (interval e425 e600) g_s17_18))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 38 
...
(assert |def_ass|)
(assert (and (|>=i| g_s1543_1572 e425) (|<=i| g_s1543_1572 e600)))
(assert (mem g_s1608_1605 g_s725_753))
; PO 1 in group 38
(assert (not (mem (|<+| g_s1521_1557 (SET (mapplet g_s1543_1572 g_s1608_1605))) (|-->| (interval e425 e600) g_s725_753))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 39 
...
(assert (mem g_s1587_1595 BOOL))
; PO 1 in group 39
(assert (not (mem (|<+| g_s1510_1546 (SET (mapplet g_s1543_1572 g_s1587_1595))) (|-->| (interval e425 e600) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 40 
...
(assert (mem g_s1606_1604 (set_diff g_s17_18 (SET g_s610_637))))
; PO 1 in group 40
(assert (not (mem (|<+| g_s1522_1558 (SET (mapplet g_s1543_1572 g_s1606_1604))) (|-->| (interval e425 e600) g_s17_18))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 41 
...
(assert (mem g_s1608_1605 g_s725_753))
; PO 1 in group 41
(assert (not (mem (|<+| g_s1523_1559 (SET (mapplet g_s1543_1572 g_s1608_1605))) (|-->| (interval e425 e600) g_s725_753))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 42 
...
(assert (mem g_s1538_1569 (set_diff g_s7_8 (SET g_s625_652))))
; PO 1 in group 42
(assert (not (mem (binary_union (ran g_s1464_1500) (SET g_s1538_1569)) (FIN (binary_union (ran g_s1464_1500) (SET g_s1538_1569))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 43 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s1615_1606 e0) (|<=i| g_s1615_1606 e419)))
; PO 1 in group 43
(assert (not (mem g_s1464_1500 (seq (ran g_s1464_1500)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 44 
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (and (|>=i| g_s1617_1607 e0) (|<=i| g_s1617_1607 e419)))
(define-fun lh_2 () Bool (mem g_s1618_1608 (set_diff g_s7_8 (SET g_s625_652))))
; PO 1 in group 44
(assert (not (=> (and lh_1 lh_2) (mem g_s1464_1500 (seq (ran g_s1464_1500))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 45 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s1617_1607 e0) (|<=i| g_s1617_1607 e419)))
(assert (mem g_s1618_1608 (set_diff g_s7_8 (SET g_s625_652))))
(assert (and (|>=i| g_s1617_1607 e425) (|<=i| g_s1617_1607 (size g_s1464_1500))))
; PO 1 in group 45
(push 1)
...
; PO 2 in group 45
(push 1)
(assert (not (mem g_s1617_1607 (dom g_s1464_1500))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 46
(push 1)
(assert (not (mem g_s1538_1569 (dom g_s1465_1501))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 46
