...
(declare-fun g_s1466_1501 () U)
(declare-fun g_s1467_1502 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1463_1499 g_s733_761) (mem g_s1464_1500 g_s733_761)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1466_1501 g_s593_620))
(assert (mem g_s1466_1501 (dom g_s1463_1499)))
(assert (mem g_s1467_1502 BOOL))
; PO 1 in group 0
(assert (not (mem (|<+| g_s1463_1499 (SET (mapplet g_s1466_1501 g_s1467_1502))) g_s733_761)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_ass|)
(assert (mem g_s1466_1501 g_s593_620))
(assert (mem g_s1466_1501 (dom g_s1464_1500)))
(assert (mem g_s1467_1502 BOOL))
; PO 1 in group 2
