...
(define-fun |def_inv| () Bool (and (subset g_s1182_1218 (set_diff g_s23_24 (SET g_s629_656))) (subset g_s1183_1219 (set_diff g_s23_24 (SET g_s629_656))) (= (binary_inter g_s1182_1218 g_s1183_1219) empty)))
...
(assert |def_ass|)
(assert (mem g_s1187_1220 BOOL))
(assert (mem g_s1189_1221 (set_diff g_s23_24 (SET g_s629_656))))
(assert (not (= g_s1182_1218 empty)))
(define-fun lh_1 () Bool (mem g_s1190_1222 (set_diff g_s23_24 (SET g_s629_656))))
(define-fun lh_2 () Bool (mem g_s1190_1222 g_s1182_1218))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (set_diff g_s1182_1218 (SET g_s1190_1222)) (set_diff g_s23_24 (SET g_s629_656))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (binary_union g_s1183_1219 (SET g_s1190_1222)) (set_diff g_s23_24 (SET g_s629_656))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
