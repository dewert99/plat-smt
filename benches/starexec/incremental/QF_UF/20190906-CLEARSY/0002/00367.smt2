...
(define-fun |def_inv| () Bool (and (subset g_s1093_1121 g_s503_521) (subset g_s1094_1122 g_s503_521) (= (binary_inter g_s1093_1121 g_s1094_1122) empty)))
...
; PO 1 in group 0
(push 1)
(assert (not (subset empty g_s503_521)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
; PO 2 in group 1
(push 1)
(assert (not (subset g_s503_521 g_s503_521)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (= (binary_inter g_s503_521 empty) empty)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1098_1123 BOOL))
(assert (mem g_s1100_1124 g_s503_521))
(assert (not (= g_s1093_1121 empty)))
(define-fun lh_1 () Bool (mem g_s1101_1125 g_s503_521))
(define-fun lh_2 () Bool (mem g_s1101_1125 g_s1093_1121))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (set_diff g_s1093_1121 (SET g_s1101_1125)) g_s503_521))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (binary_union g_s1094_1122 (SET g_s1101_1125)) g_s503_521))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
