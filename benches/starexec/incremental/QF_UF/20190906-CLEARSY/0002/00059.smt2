...
(declare-fun g_s1383_1410 () U)
(declare-fun g_s1384_1411 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1380_1408 g_s639_659) (mem g_s1381_1409 g_s639_659)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1383_1410 g_s445_463))
(assert (mem g_s1383_1410 (dom g_s1380_1408)))
(assert (mem g_s1384_1411 BOOL))
; PO 1 in group 0
(assert (not (mem (|<+| g_s1380_1408 (SET (mapplet g_s1383_1410 g_s1384_1411))) g_s639_659)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert (mem g_s1384_1411 BOOL))
; PO 1 in group 1
(assert (not (mem g_s1380_1408 (|+->| (dom g_s1380_1408) (ran g_s1380_1408)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_ass|)
(assert (mem g_s1383_1410 g_s445_463))
(assert (mem g_s1383_1410 (dom g_s1381_1409)))
(assert (mem g_s1384_1411 BOOL))
; PO 1 in group 2
(assert (not (mem g_s1381_1409 (|+->| (dom g_s1381_1409) (ran g_s1381_1409)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)