...
(define-fun |def_abs| () Bool (and (subset g_s1182_1218 (set_diff g_s7_8 (SET g_s625_652))) (subset g_s1183_1219 (set_diff g_s7_8 (SET g_s625_652)))))
(define-fun |def_inv| () Bool (and (and (|>=i| g_s1184$1_1220 e0) (|<=i| g_s1184$1_1220 e419)) (and (|>=i| g_s1184$1_1220 e0) (|<=i| g_s1184$1_1220 (card (set_diff g_s7_8 (SET g_s625_652))))) (= g_s1182_1218 (image g_s1141_1177 (interval e425 g_s1184$1_1220)))))
...
(define-fun lh_1 () Bool (mem g_s1188_1221 BOOL))
(define-fun lh_2 () Bool (mem g_s1191_1223 (set_diff g_s7_8 (SET g_s625_652))))
(define-fun lh_3 () Bool (not (= g_s1182_1218 empty)))
(define-fun lh_4 () Bool (mem g_s1184$1_1220 (dom g_s1141_1177)))
(define-fun lh_5 () Bool (mem g_s1184$1_1220 g_s419_424))
(define-fun lh_6 () Bool (mem g_s1191$1_1224 g_s624_651))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1184$1_1220 (dom g_s1141_1177)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s1191$1_1224 g_s624_651))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s1184$1_1220 g_s419_424))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1141_1177 g_s1184$1_1220) g_s1182_1218))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1141_1177 g_s1184$1_1220) (set_diff g_s7_8 (SET g_s625_652))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
...
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (and (|>=i| (|-i| g_s1184$1_1220 e425) e0) (|<=i| (|-i| g_s1184$1_1220 e425) (card (set_diff g_s7_8 (SET g_s625_652))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (bool (|<=i| e425 (|-i| g_s1184$1_1220 e425))) (bool (not (= g_s1182_1218 (SET (apply g_s1141_1177 g_s1184$1_1220)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (set_diff g_s1182_1218 (SET (apply g_s1141_1177 g_s1184$1_1220))) (image g_s1141_1177 (interval e425 (|-i| g_s1184$1_1220 e425)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 3
(assert (not (=> lh_1 (mem (set_diff g_s7_8 (SET g_s625_652)) (FIN (set_diff g_s7_8 (SET g_s625_652)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)