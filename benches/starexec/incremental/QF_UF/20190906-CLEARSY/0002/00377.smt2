...
(define-fun |def_abs| () Bool (and (subset g_s1182_1218 g_s680_707) (subset g_s1183_1219 g_s680_707) (= (binary_inter g_s1182_1218 g_s1183_1219) empty)))
(define-fun |def_inv| () Bool (and (and (|>=i| g_s1184$1_1220 e0) (|<=i| g_s1184$1_1220 e419)) (and (|>=i| g_s1184$1_1220 e0) (|<=i| g_s1184$1_1220 (card g_s680_707))) (= g_s1182_1218 (image g_s1153_1189 (interval e425 g_s1184$1_1220)))))
...
; PO 2 in group 0
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 (card g_s680_707)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (= empty (image g_s1153_1189 (interval e425 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (and (|>=i| (card (set_diff g_s48_49 (SET g_s681_708))) e0) (|<=i| (card (set_diff g_s48_49 (SET g_s681_708))) (card g_s680_707))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= g_s680_707 (image g_s1153_1189 (interval e425 (card (set_diff g_s48_49 (SET g_s681_708)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (bool (|<=i| e425 (card (set_diff g_s48_49 (SET g_s681_708))))) (bool (not (= g_s680_707 empty)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s1188_1221 BOOL))
(define-fun lh_2 () Bool (mem g_s1191_1223 g_s680_707))
(define-fun lh_3 () Bool (not (= g_s1182_1218 empty)))
(define-fun lh_4 () Bool (mem g_s1191$1_1224 g_s680_707))
(define-fun lh_5 () Bool (mem g_s1184$1_1220 g_s419_424))
(define-fun lh_6 () Bool (mem g_s1184$1_1220 (dom g_s1153_1189)))
; PO 1 in group 2
(push 1)
...
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1184$1_1220 (dom g_s1153_1189)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1191$1_1224 g_s680_707))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1153_1189 g_s1184$1_1220) g_s680_707))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1153_1189 g_s1184$1_1220) g_s1182_1218))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
...
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (and (|>=i| (|-i| g_s1184$1_1220 e425) e0) (|<=i| (|-i| g_s1184$1_1220 e425) (card g_s680_707))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (bool (|<=i| e425 (|-i| g_s1184$1_1220 e425))) (bool (not (= g_s1182_1218 (SET (apply g_s1153_1189 g_s1184$1_1220)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (set_diff g_s1182_1218 (SET (apply g_s1153_1189 g_s1184$1_1220))) (image g_s1153_1189 (interval e425 (|-i| g_s1184$1_1220 e425)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 3
(assert (not (=> lh_1 (mem g_s680_707 (FIN g_s680_707)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)