...
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod (interval e425 e582) (SET g_s666_693)) (|-->| (interval e425 e582) g_s41_42))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
