...
(declare-fun g_s1475_1506 () U)
(declare-fun g_s1476_1507 () U)
(declare-fun g_s1478_1508 () U)
(declare-fun g_s148_149 () U)
(declare-fun g_s1480_1509 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1463_1499 g_s0_1) (mem g_s1464_1500 g_s0_1) (and (|>=i| g_s1465_1501 e0) (|<=i| g_s1465_1501 e419)) (mem g_s1466_1502 (|-->| g_s680_707 BOOL)) (and (|>=i| g_s1467_1503 e0) (|<=i| g_s1467_1503 e419)) (mem g_s1468_1504 g_s943_971) (mem g_s1469_1505 (|-->| g_s680_707 BOOL))))
...
; PO 2 in group 0
(push 1)
(assert (not (mem (set_prod g_s680_707 (SET FALSE)) (|-->| g_s680_707 BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s680_707 (SET (iuminus g_s546_554))) g_s943_971)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1475_1506 g_s680_707))
(assert (mem g_s1476_1507 BOOL))
; PO 1 in group 3
(assert (not (mem (|<+| g_s1466_1502 (SET (mapplet g_s1475_1506 g_s1476_1507))) (|-->| g_s680_707 BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1478_1508 (set_diff (interval e0 e419) (SET e0))))
; PO 1 in group 4
(assert (not (and (|>=i| g_s1478_1508 e0) (|<=i| g_s1478_1508 e419))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert |def_ass|)
(assert (mem g_s1475_1506 g_s680_707))
(assert (and (|>=i| g_s1480_1509 e430) (|<=i| g_s1480_1509 e423)))
; PO 1 in group 5
(assert (not (mem (|<+| g_s1468_1504 (SET (mapplet g_s1475_1506 g_s1480_1509))) g_s943_971)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem g_s1476_1507 BOOL))
; PO 1 in group 6
(assert (not (mem (|<+| g_s1469_1505 (SET (mapplet g_s1475_1506 g_s1476_1507))) (|-->| g_s680_707 BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)