...
(declare-fun g_s1468_1501 () U)
(declare-fun g_s1468$1_1502 () U)
(declare-fun g_s147_148 () U)
(declare-fun g_s1470_1503 () U)
...
(define-fun |def_inv| () Bool (and (subset g_s1463_1499 g_s650_677) (subset g_s1464_1500 g_s650_677) (= (binary_inter g_s1463_1499 g_s1464_1500) empty)))
...
; PO 1 in group 0
(push 1)
(assert (not (subset empty g_s650_677)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1468_1501 BOOL))
(define-fun lh_1 () Bool (= g_s1468$1_1502 (bool (not (= g_s650_677 empty)))))
; PO 1 in group 1
(push 1)
(assert (not (=> lh_1 (subset empty g_s650_677))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (subset g_s650_677 g_s650_677))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> lh_1 (= (binary_inter g_s650_677 empty) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1468_1501 BOOL))
(assert (mem g_s1470_1503 g_s650_677))
(assert (not (= g_s1463_1499 empty)))
(define-fun lh_1 () Bool (mem g_s1471_1504 g_s650_677))
(define-fun lh_2 () Bool (mem g_s1471_1504 g_s1463_1499))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (set_diff g_s1463_1499 (SET g_s1471_1504)) g_s650_677))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (binary_union g_s1464_1500 (SET g_s1471_1504)) g_s650_677))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (binary_inter (set_diff g_s1463_1499 (SET g_s1471_1504)) (binary_union g_s1464_1500 (SET g_s1471_1504))) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
