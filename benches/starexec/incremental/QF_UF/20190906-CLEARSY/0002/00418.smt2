...
(define-fun |def_inv| () Bool (and (subset g_s1093_1121 g_s535_553) (subset g_s1094_1122 g_s535_553) (= (binary_inter g_s1093_1121 g_s1094_1122) empty) (= (binary_union g_s1093_1121 g_s1094_1122) g_s535_553)))
...
; PO 1 in group 0
(push 1)
(assert (not (subset empty g_s535_553)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (subset g_s535_553 g_s535_553)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (= (binary_inter g_s535_553 empty) empty)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (= (binary_union g_s535_553 empty) g_s535_553)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1098_1123 BOOL))
(assert (mem g_s1100_1124 g_s42_43))
(assert (not (= g_s1093_1121 empty)))
(define-fun lh_1 () Bool (mem g_s1101_1125 g_s535_553))
(define-fun lh_2 () Bool (mem g_s1101_1125 g_s1093_1121))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (set_diff g_s1093_1121 (SET g_s1101_1125)) g_s535_553))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (binary_union g_s1094_1122 (SET g_s1101_1125)) g_s535_553))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
...
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (binary_union (set_diff g_s1093_1121 (SET g_s1101_1125)) (binary_union g_s1094_1122 (SET g_s1101_1125))) g_s535_553))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
