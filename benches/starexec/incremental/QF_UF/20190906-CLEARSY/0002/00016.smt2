...
(declare-fun g_s1463$1_1502 () U)
(declare-fun g_s1464_1500 () U)
(declare-fun g_s1464$1_1503 () U)
(declare-fun g_s1465_1501 () U)
(declare-fun g_s1465$1_1504 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s1463_1499 (|-->| (set_diff g_s14_15 (SET g_s604_631)) (interval e430 e423))) (mem g_s1464_1500 (|-->| (set_diff g_s14_15 (SET g_s604_631)) BOOL)) (mem g_s1465_1501 (|-->| (set_diff g_s45_46 (SET g_s674_701)) (interval e430 e423)))))
(define-fun |def_inv| () Bool (and (= g_s1463_1499 g_s1463$1_1502) (= g_s1464_1500 g_s1464$1_1503) (= g_s1465_1501 g_s1465$1_1504)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (= (set_prod (set_diff g_s14_15 (SET g_s604_631)) (SET e0)) g_s1215_1251)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
