...
(declare-fun g_s1465$1_1501 () U)
(declare-fun g_s1469_1502 () U)
(declare-fun g_s1469$1_1503 () U)
(declare-fun g_s147_148 () U)
(declare-fun g_s1471_1504 () U)
(declare-fun g_s1471$1_1505 () U)
...
(define-fun |def_abs| () Bool (and (subset g_s1463_1499 g_s617_644) (subset g_s1464_1500 g_s617_644) (= (binary_inter g_s1463_1499 g_s1464_1500) empty)))
(define-fun |def_inv| () Bool (and (mem g_s1465$1_1501 g_s417_420) (and (|>=i| g_s1465$1_1501 e0) (|<=i| g_s1465$1_1501 (card g_s617_644))) (= g_s1463_1499 (image g_s1140_1176 (interval e425 g_s1465$1_1501))) (= g_s1465$1_1501 (card g_s1463_1499))))
...
; PO 2 in group 0
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 (card g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (= empty (image g_s1140_1176 (interval e425 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s1469$1_1503 g_s1469_1502))
(define-fun lh_1 () Bool (mem g_s1469_1502 BOOL))
(define-fun lh_2 () Bool (mem g_s1465$1_1501 g_s417_420))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (card g_s617_644) g_s417_420))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (and (|>=i| (card g_s617_644) e0) (|<=i| (card g_s617_644) (card g_s617_644))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= g_s617_644 (image g_s1140_1176 (interval e425 (card g_s617_644)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (bool (|<=i| e425 (card g_s617_644))) (bool (not (= g_s617_644 empty)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (= g_s1469$1_1503 g_s1469_1502))
(assert (= g_s1471$1_1505 g_s1471_1504))
(define-fun lh_1 () Bool (mem g_s1469_1502 BOOL))
(define-fun lh_2 () Bool (mem g_s1471_1504 g_s617_644))
(define-fun lh_3 () Bool (not (= g_s1463_1499 empty)))
(define-fun lh_4 () Bool (mem g_s1465$1_1501 (dom g_s1140_1176)))
(define-fun lh_5 () Bool (mem g_s1465$1_1501 g_s419_424))
(define-fun lh_6 () Bool (mem g_s1471$1_1505 g_s617_644))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1465$1_1501 (dom g_s1140_1176)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s1471$1_1505 g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s1465$1_1501 g_s419_424))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1140_1176 g_s1465$1_1501) g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1140_1176 g_s1465$1_1501) g_s1463_1499))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|-i| g_s1465$1_1501 e425) INT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (|-i| g_s1465$1_1501 e425) g_s417_420))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (and (|>=i| (|-i| g_s1465$1_1501 e425) e0) (|<=i| (|-i| g_s1465$1_1501 e425) (card g_s617_644))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (bool (|<=i| e425 (|-i| g_s1465$1_1501 e425))) (bool (not (= g_s1463_1499 (SET (apply g_s1140_1176 g_s1465$1_1501)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (set_diff g_s1463_1499 (SET (apply g_s1140_1176 g_s1465$1_1501))) (image g_s1140_1176 (interval e425 (|-i| g_s1465$1_1501 e425)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (|-i| g_s1465$1_1501 e425) (card (set_diff g_s1463_1499 (SET (apply g_s1140_1176 g_s1465$1_1501))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (mem g_s1465$1_1501 g_s417_420))
(define-fun lh_2 () Bool (and (|>=i| g_s1465$1_1501 e0) (|<=i| g_s1465$1_1501 (card g_s617_644))))
(define-fun lh_3 () Bool (= g_s1463_1499 (image g_s1140_1176 (interval e425 g_s1465$1_1501))))
; PO 1 in group 3
(push 1)
(assert (not (=> lh_1 (mem g_s617_644 (FIN g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1463_1499 (FIN g_s1463_1499)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
