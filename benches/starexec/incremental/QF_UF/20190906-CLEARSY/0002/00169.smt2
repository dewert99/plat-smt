...
(define-fun |def_inv| () Bool (and (subset g_s1463_1499 g_s617_644) (subset g_s1464_1500 g_s617_644) (= (binary_inter g_s1463_1499 g_s1464_1500) empty)))
...
; PO 1 in group 0
(push 1)
(assert (not (subset empty g_s617_644)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
(define-fun lh_1 () Bool (= g_s1468$1_1502 (bool (not (= g_s617_644 empty)))))
; PO 1 in group 1
(push 1)
(assert (not (=> lh_1 (subset empty g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (subset g_s617_644 g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> lh_1 (= (binary_inter g_s617_644 empty) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1468_1501 BOOL))
(assert (mem g_s1470_1503 g_s617_644))
(assert (not (= g_s1463_1499 empty)))
(define-fun lh_1 () Bool (mem g_s1471_1504 g_s617_644))
(define-fun lh_2 () Bool (mem g_s1471_1504 g_s1463_1499))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (set_diff g_s1463_1499 (SET g_s1471_1504)) g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (binary_union g_s1464_1500 (SET g_s1471_1504)) g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
