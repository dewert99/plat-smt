...
(declare-fun g_s1101_1124 () U)
(declare-fun g_s1102_1125 () U)
(declare-fun g_s1103_1126 () U)
(declare-fun g_s1104_1127 () U)
(declare-fun g_s1108_1128 () U)
(declare-fun g_s1109_1129 () U)
(declare-fun g_s111_112 () U)
(declare-fun g_s1110_1130 () U)
(declare-fun g_s1111_1131 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s1093_1121 (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL)) (mem g_s1094_1122 (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL)) (mem g_s1095_1123 (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL))))
...
; PO 1 in group 0
(push 1)
(assert (not (mem (set_prod (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) (SET TRUE)) (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (set_prod (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) (SET FALSE)) (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1101_1124 g_s459_477))
(assert (mem g_s1102_1125 g_s324_325))
(assert (mem g_s1103_1126 g_s643_662))
(assert (mem g_s1104_1127 BOOL))
; PO 1 in group 3
(assert (not (mem (|<+| g_s1095_1123 (SET (mapplet (mapplet (mapplet g_s1101_1124 g_s1102_1125) g_s1103_1126) g_s1104_1127))) (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (mem g_s1104_1127 BOOL))
; PO 1 in group 4
(assert (not (mem (|<+| g_s1094_1122 (SET (mapplet (mapplet (mapplet g_s1101_1124 g_s1102_1125) g_s1103_1126) g_s1104_1127))) (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem g_s1104_1127 BOOL))
; PO 1 in group 5
(assert (not (mem (|<+| g_s1093_1121 (SET (mapplet (mapplet (mapplet g_s1101_1124 g_s1102_1125) g_s1103_1126) g_s1104_1127))) (|-->| (set_prod (set_prod g_s459_477 g_s324_325) g_s643_662) BOOL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1108_1128 g_s459_477))
(assert (mem g_s1109_1129 g_s643_662))
(assert (mem g_s1110_1130 g_s324_325))
(assert (mem g_s1111_1131 BOOL))
; PO 1 in group 6
(push 1)
(assert (not (mem g_s1093_1121 (|+->| (dom g_s1093_1121) (ran g_s1093_1121)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 6
(push 1)
(assert (not (mem (mapplet (mapplet g_s1108_1128 g_s1110_1130) g_s1109_1129) (dom g_s1093_1121))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 7
(push 1)
(assert (not (mem g_s1095_1123 (|+->| (dom g_s1095_1123) (ran g_s1095_1123)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 7
(push 1)
(assert (not (mem (mapplet (mapplet g_s1101_1124 g_s1102_1125) g_s1103_1126) (dom g_s1095_1123))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 8
(push 1)
(assert (not (mem g_s1094_1122 (|+->| (dom g_s1094_1122) (ran g_s1094_1122)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 8
(push 1)
(assert (not (mem (mapplet (mapplet g_s1101_1124 g_s1102_1125) g_s1103_1126) (dom g_s1094_1122))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
