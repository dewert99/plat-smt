...
(declare-fun g_s1463$1_1501 () U)
(declare-fun g_s1464_1500 () U)
(declare-fun g_s1464$1_1502 () U)
(declare-fun g_s1468_1503 () U)
(declare-fun g_s1469_1504 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s1463_1499 g_s733_761) (mem g_s1464_1500 g_s733_761)))
(define-fun |def_inv| () Bool (and (= g_s1463_1499 g_s1463$1_1501) (= g_s1464_1500 g_s1464$1_1502)))
...
(assert |def_ass|)
; PO 1 in group 0
(assert (not (mem g_s1463$1_1501 g_s733_761)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1468_1503 g_s593_620))
(assert (mem g_s1468_1503 (dom g_s1463_1499)))
(assert (mem g_s1469_1504 BOOL))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s1463$1_1501 (|+->| (dom g_s1463$1_1501) (ran g_s1463$1_1501)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s1468_1503 (dom g_s1463$1_1501))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1468_1503 g_s593_620))
(assert (mem g_s1468_1503 (dom g_s1464_1500)))
(assert (mem g_s1469_1504 BOOL))
; PO 1 in group 2
(push 1)
(assert (not (mem g_s1464$1_1502 (|+->| (dom g_s1464$1_1502) (ran g_s1464$1_1502)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (mem g_s1468_1503 (dom g_s1464$1_1502))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
