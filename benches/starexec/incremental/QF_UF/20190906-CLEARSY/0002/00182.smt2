...
(define-fun |def_abs| () Bool (and (subset g_s1463_1499 g_s650_677) (subset g_s1464_1500 g_s650_677) (= (binary_inter g_s1463_1499 g_s1464_1500) empty)))
(define-fun |def_inv| () Bool (and (mem g_s1465$1_1501 g_s417_420) (and (|>=i| g_s1465$1_1501 e0) (|<=i| g_s1465$1_1501 (card g_s650_677))) (= g_s1463_1499 (image g_s1146_1182 (interval e425 g_s1465$1_1501))) (= g_s1465$1_1501 (card g_s1463_1499))))
...
; PO 2 in group 0
(push 1)
(assert (not (and (|>=i| e0 e0) (|<=i| e0 (card g_s650_677)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (= empty (image g_s1146_1182 (interval e425 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
...
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (card g_s650_677) g_s417_420))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (and (|>=i| (card g_s650_677) e0) (|<=i| (card g_s650_677) (card g_s650_677))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= g_s650_677 (image g_s1146_1182 (interval e425 (card g_s650_677)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (bool (|<=i| e425 (card g_s650_677))) (bool (not (= g_s650_677 empty)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s1469_1502 BOOL))
(define-fun lh_2 () Bool (mem g_s1471_1504 g_s650_677))
(define-fun lh_3 () Bool (not (= g_s1463_1499 empty)))
(define-fun lh_4 () Bool (mem g_s1465$1_1501 (dom g_s1146_1182)))
(define-fun lh_5 () Bool (mem g_s1465$1_1501 g_s419_424))
(define-fun lh_6 () Bool (mem g_s1471$1_1505 g_s650_677))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s1465$1_1501 (dom g_s1146_1182)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s1471$1_1505 g_s650_677))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
...
; PO 4 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1146_1182 g_s1465$1_1501) g_s650_677))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s1146_1182 g_s1465$1_1501) g_s1463_1499))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
...
; PO 8 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (and (|>=i| (|-i| g_s1465$1_1501 e425) e0) (|<=i| (|-i| g_s1465$1_1501 e425) (card g_s650_677))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (bool (|<=i| e425 (|-i| g_s1465$1_1501 e425))) (bool (not (= g_s1463_1499 (SET (apply g_s1146_1182 g_s1465$1_1501)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (set_diff g_s1463_1499 (SET (apply g_s1146_1182 g_s1465$1_1501))) (image g_s1146_1182 (interval e425 (|-i| g_s1465$1_1501 e425)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= (|-i| g_s1465$1_1501 e425) (card (set_diff g_s1463_1499 (SET (apply g_s1146_1182 g_s1465$1_1501))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_2 () Bool (and (|>=i| g_s1465$1_1501 e0) (|<=i| g_s1465$1_1501 (card g_s650_677))))
(define-fun lh_3 () Bool (= g_s1463_1499 (image g_s1146_1182 (interval e425 g_s1465$1_1501))))
; PO 1 in group 3
(push 1)
(assert (not (=> lh_1 (mem g_s650_677 (FIN g_s650_677)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
