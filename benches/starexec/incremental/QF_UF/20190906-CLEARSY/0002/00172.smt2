...
(declare-fun g_s1482$1_1554 () U)
(declare-fun g_s1483_1519 () U)
(declare-fun g_s1483$1_1556 () U)
(declare-fun g_s1484_1520 () U)
(declare-fun g_s1484$1_1558 () U)
(declare-fun g_s1485_1521 () U)
(declare-fun g_s1485$1_1560 () U)
(declare-fun g_s1486_1522 () U)
(declare-fun g_s1486$1_1544 () U)
(declare-fun g_s1487_1523 () U)
(declare-fun g_s1487$1_1562 () U)
(declare-fun g_s149_150 () U)
(declare-fun g_s1492_1524 () U)
(declare-fun g_s1494_1525 () U)
(declare-fun g_s1496_1527 () U)
(declare-fun g_s1498_1529 () U)
(declare-fun g_s15_16 () U)
(declare-fun g_s150_151 () U)
(declare-fun g_s1500_1531 () U)
(declare-fun g_s1502_1533 () U)
(declare-fun g_s1504_1535 () U)
(declare-fun g_s1506_1537 () U)
(declare-fun g_s1508_1539 () U)
(declare-fun g_s151_152 () U)
(declare-fun g_s1510_1540 () U)
(declare-fun g_s1512_1541 () U)
(declare-fun g_s1514_1543 () U)
(declare-fun g_s1516_1545 () U)
(declare-fun g_s1517_1546 () U)
(declare-fun g_s1518_1547 () U)
(declare-fun g_s1519_1548 () U)
(declare-fun g_s152_153 () U)
(declare-fun g_s1521_1549 () U)
(declare-fun g_s1523_1550 () U)
(declare-fun g_s1525_1552 () U)
(declare-fun g_s1527_1553 () U)
(declare-fun g_s1529_1555 () U)
(declare-fun g_s153_154 () U)
(declare-fun g_s1531_1557 () U)
(declare-fun g_s1533_1559 () U)
(declare-fun g_s1535_1561 () U)
(declare-fun g_s1537_1563 () U)
(declare-fun g_s1538_1564 () U)
(declare-fun g_s1539_1565 () U)
(declare-fun g_s154_155 () U)
(declare-fun g_s1540_1566 () U)
(declare-fun g_s1541_1567 () U)
(declare-fun g_s1542_1568 () U)
(declare-fun g_s1543_1569 () U)
(declare-fun g_s1544_1570 () U)
(declare-fun g_s1546_1572 () U)
(declare-fun g_s1549_1573 () U)
(declare-fun g_s155_156 () U)
(declare-fun g_s1554_1574 () U)
(declare-fun g_s1556_1575 () U)
(declare-fun g_s156_157 () U)
(declare-fun g_s1560_1576 () U)
(declare-fun g_s1562_1577 () U)
...
; PO 1 in group 0
(push 1)
(assert (not (mem empty (POW (ran empty)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem empty (iseq g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem empty (|-->| (ran empty) g_s723_751))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (mem empty (|-->| (ran empty) g_s731_759))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (mem empty (|>+>| (ran empty) g_s663_690))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (mem empty (|+->| (ran empty) g_s40_41))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 0
(push 1)
(assert (not (mem empty (|-->| (ran empty) g_s185_186))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 0
(push 1)
(assert (not (mem (set_prod g_s617_644 (SET e0)) (|-->| g_s617_644 g_s731_759))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 0
(push 1)
(assert (not (mem (set_prod g_s617_644 (SET g_s1306_1342)) (|-->| g_s617_644 g_s747_775))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 0
(push 1)
(assert (not (mem (set_prod g_s617_644 (SET g_s254_255)) (|-->| g_s617_644 g_s253_254))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 0
...
; PO 12 in group 0
(push 1)
(assert (not (= (binary_inter (dom empty) (dom empty)) empty)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 0
(push 1)
(assert (not (= (binary_union (dom empty) (dom empty)) (ran empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
; PO 1 in group 2
(push 1)
(assert (not (mem (binary_union g_s1464_1500 (SET g_s1492_1524)) (POW (ran g_s1463_1499)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (subset g_s1466_1502 (binary_union g_s1464_1500 (SET g_s1492_1524)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (subset g_s1465_1501 (binary_union g_s1464_1500 (SET g_s1492_1524)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1492_1524 g_s1464_1500))
(assert (mem g_s1494_1525 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1494_1525 TRUE) (= g_s1466$1_1526 (binary_union g_s1466_1502 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1494_1525 FALSE) (= g_s1466$1_1526 (set_diff g_s1466_1502 (SET g_s1492_1524)))))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1466$1_1526 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset g_s1466$1_1526 g_s1464_1500))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1496_1527 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1496_1527 TRUE) (= g_s1467$1_1528 (binary_union g_s1467_1503 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1496_1527 FALSE) (= g_s1467$1_1528 (set_diff g_s1467_1503 (SET g_s1492_1524)))))
; PO 1 in group 4
(assert (not (=> (and lh_1 lh_2) (mem g_s1467$1_1528 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1498_1529 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1498_1529 TRUE) (= g_s1468$1_1530 (binary_union g_s1468_1504 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1498_1529 FALSE) (= g_s1468$1_1530 (set_diff g_s1468_1504 (SET g_s1492_1524)))))
; PO 1 in group 5
(assert (not (=> (and lh_1 lh_2) (mem g_s1468$1_1530 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1500_1531 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1500_1531 TRUE) (= g_s1469$1_1532 (binary_union g_s1469_1505 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1500_1531 FALSE) (= g_s1469$1_1532 (set_diff g_s1469_1505 (SET g_s1492_1524)))))
; PO 1 in group 6
(assert (not (=> (and lh_1 lh_2) (mem g_s1469$1_1532 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1502_1533 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1502_1533 TRUE) (= g_s1470$1_1534 (binary_union g_s1470_1506 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1502_1533 FALSE) (= g_s1470$1_1534 (set_diff g_s1470_1506 (SET g_s1492_1524)))))
; PO 1 in group 7
(assert (not (=> (and lh_1 lh_2) (mem g_s1470$1_1534 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1504_1535 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1504_1535 TRUE) (= g_s1471$1_1536 (binary_union g_s1471_1507 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1504_1535 FALSE) (= g_s1471$1_1536 (set_diff g_s1471_1507 (SET g_s1492_1524)))))
; PO 1 in group 8
(assert (not (=> (and lh_1 lh_2) (mem g_s1471$1_1536 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1506_1537 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1506_1537 TRUE) (= g_s1472$1_1538 (binary_union g_s1472_1508 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1506_1537 FALSE) (= g_s1472$1_1538 (set_diff g_s1472_1508 (SET g_s1492_1524)))))
; PO 1 in group 9
(assert (not (=> (and lh_1 lh_2) (mem g_s1472$1_1538 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 10 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1508_1539 g_s747_775))
; PO 1 in group 10
(assert (not (mem (|<+| g_s1473_1509 (SET (mapplet g_s1492_1524 g_s1508_1539))) (|-->| g_s617_644 g_s747_775))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 11 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1510_1540 g_s253_254))
; PO 1 in group 11
(assert (not (mem (|<+| g_s1474_1510 (SET (mapplet g_s1492_1524 g_s1510_1540))) (|-->| g_s617_644 g_s253_254))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 12 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1512_1541 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1512_1541 TRUE) (= g_s1475$1_1542 (binary_union g_s1475_1511 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1512_1541 FALSE) (= g_s1475$1_1542 (set_diff g_s1475_1511 (SET g_s1492_1524)))))
; PO 1 in group 12
(assert (not (=> (and lh_1 lh_2) (mem g_s1475$1_1542 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 13 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1514_1543 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1514_1543 TRUE) (= g_s1486$1_1544 (binary_union g_s1486_1522 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1514_1543 FALSE) (= g_s1486$1_1544 (set_diff g_s1486_1522 (SET g_s1492_1524)))))
; PO 1 in group 13
(assert (not (=> (and lh_1 lh_2) (mem g_s1486$1_1544 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 14 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1516_1545 g_s616_643))
(assert (mem g_s1517_1546 g_s616_643))
(assert (mem g_s1518_1547 g_s663_690))
(assert (mem g_s1519_1548 g_s698_725))
(assert (mem g_s1516_1545 (ran g_s1463_1499)))
(assert (mem g_s1517_1546 (ran g_s1463_1499)))
(assert (not (= g_s1516_1545 g_s1517_1546)))
(assert (not (mem g_s1516_1545 (dom (binary_union g_s1476_1512 g_s1477_1513)))))
(assert (not (mem g_s1517_1546 (dom (binary_union g_s1476_1512 g_s1477_1513)))))
(assert (not (mem g_s1518_1547 (ran (binary_union g_s1476_1512 g_s1477_1513)))))
; PO 1 in group 14
(push 1)
(assert (not (mem (|<+| g_s1476_1512 (SET (mapplet g_s1516_1545 g_s1518_1547))) (|>+>| (ran g_s1463_1499) g_s663_690))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 14
(push 1)
(assert (not (mem (|<+| g_s1477_1513 (SET (mapplet g_s1517_1546 g_s1518_1547))) (|>+>| (ran g_s1463_1499) g_s663_690))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 14
(push 1)
(assert (not (mem (|<+| g_s1479_1515 (SET (mapplet g_s1516_1545 g_s1519_1548))) (|+->| (ran g_s1463_1499) g_s40_41))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 14
(push 1)
(assert (not (mem (|<+| g_s1480_1516 (SET (mapplet g_s1517_1546 g_s1519_1548))) (|+->| (ran g_s1463_1499) g_s40_41))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 14
(push 1)
(assert (not (= (ran (|<+| g_s1476_1512 (SET (mapplet g_s1516_1545 g_s1518_1547)))) (ran (|<+| g_s1477_1513 (SET (mapplet g_s1517_1546 g_s1518_1547)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 14
(push 1)
(assert (not (= (binary_inter (dom (|<+| g_s1476_1512 (SET (mapplet g_s1516_1545 g_s1518_1547)))) (dom (|<+| g_s1477_1513 (SET (mapplet g_s1517_1546 g_s1518_1547))))) empty)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 14
(push 1)
(assert (not (= (binary_union (dom (|<+| g_s1476_1512 (SET (mapplet g_s1516_1545 g_s1518_1547)))) (dom (|<+| g_s1477_1513 (SET (mapplet g_s1517_1546 g_s1518_1547))))) (ran g_s1463_1499))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s1516_1545 g_s616_643))
(assert (mem g_s1517_1546 g_s616_643))
(assert (mem g_s1521_1549 g_s185_186))
(assert (mem g_s1516_1545 (ran g_s1463_1499)))
(assert (mem g_s1517_1546 (ran g_s1463_1499)))
(assert (not (= g_s1516_1545 g_s1517_1546)))
; PO 1 in group 15
(assert (not (mem (|<+| g_s1478_1514 (SET (mapplet (mapplet g_s1517_1546 g_s1521_1549) (mapplet g_s1516_1545 (apply g_s1114_1150 g_s1521_1549))))) (|-->| (ran g_s1463_1499) g_s185_186))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 16 
...
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1492_1524 g_s1464_1500))
(assert (mem g_s1523_1550 BOOL))
(define-fun lh_1 () Bool (=> (= g_s1523_1550 TRUE) (= g_s1465$1_1551 (binary_union g_s1465_1501 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1523_1550 FALSE) (= g_s1465$1_1551 (set_diff g_s1465_1501 (SET g_s1492_1524)))))
; PO 1 in group 16
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1465$1_1551 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 16
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset g_s1465$1_1551 g_s1464_1500))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1525_1552 g_s731_759))
; PO 1 in group 17
(assert (not (mem (|<+| g_s1481_1517 (SET (mapplet g_s1492_1524 g_s1525_1552))) (|-->| (ran g_s1463_1499) g_s731_759))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 18 
...
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1527_1553 BOOL))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(define-fun lh_1 () Bool (=> (= g_s1527_1553 TRUE) (= g_s1482$1_1554 (binary_union g_s1482_1518 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1527_1553 FALSE) (= g_s1482$1_1554 (set_diff g_s1482_1518 (SET g_s1492_1524)))))
; PO 1 in group 18
(assert (not (=> (and lh_1 lh_2) (mem g_s1482$1_1554 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 19 
...
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1529_1555 BOOL))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(define-fun lh_1 () Bool (=> (= g_s1529_1555 TRUE) (= g_s1483$1_1556 (binary_union g_s1483_1519 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1529_1555 FALSE) (= g_s1483$1_1556 (set_diff g_s1483_1519 (SET g_s1492_1524)))))
; PO 1 in group 19
(assert (not (=> (and lh_1 lh_2) (mem g_s1483$1_1556 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 20 
...
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1531_1557 BOOL))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(define-fun lh_1 () Bool (=> (= g_s1531_1557 TRUE) (= g_s1484$1_1558 (binary_union g_s1484_1520 (SET g_s1492_1524)))))
(define-fun lh_2 () Bool (=> (= g_s1531_1557 FALSE) (= g_s1484$1_1558 (set_diff g_s1484_1520 (SET g_s1492_1524)))))
; PO 1 in group 20
(assert (not (=> (and lh_1 lh_2) (mem g_s1484$1_1558 (POW (ran g_s1463_1499))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 21 
...
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1533_1559 g_s731_759))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(define-fun lh_1 () Bool (= g_s1485$1_1560 (|<+| g_s1485_1521 (SET (mapplet g_s1492_1524 g_s1533_1559)))))
; PO 1 in group 21
(assert (not (=> lh_1 (mem g_s1485$1_1560 (|-->| g_s617_644 g_s731_759)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 22 
...
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1535_1561 g_s723_751))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(define-fun lh_1 () Bool (= g_s1487$1_1562 (|<+| g_s1487_1523 (SET (mapplet g_s1492_1524 g_s1535_1561)))))
; PO 1 in group 22
(assert (not (=> lh_1 (mem g_s1487$1_1562 (|-->| (ran g_s1463_1499) g_s723_751)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 23 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1537_1563 g_s617_644))
(assert (mem g_s1538_1564 g_s617_644))
(assert (not (mem g_s1537_1563 (ran g_s1463_1499))))
(assert (not (mem g_s1538_1564 (ran g_s1463_1499))))
(assert (not (= g_s1537_1563 g_s1538_1564)))
(assert (mem g_s1539_1565 g_s315_316))
(assert (mem g_s1540_1566 g_s663_690))
(assert (not (mem g_s1540_1566 (ran g_s1476_1512))))
(assert (not (mem g_s1540_1566 (ran g_s1477_1513))))
(assert (mem g_s1541_1567 g_s40_41))
(assert (mem g_s1542_1568 g_s185_186))
(assert (mem g_s1543_1569 g_s731_759))
(assert (mem g_s1544_1570 g_s723_751))
(define-fun lh_1 () Bool (mem g_s1463$1_1571 (iseq g_s617_644)))
(define-fun lh_2 () Bool (mem g_s1463$1_1571 (perm (binary_union (ran g_s1463_1499) (SET (mapplet g_s1538_1564 g_s1537_1563))))))
; PO 1 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1469_1505 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1466_1502 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1486_1522 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1475_1511 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1472_1508 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1484_1520 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1470_1506 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1465_1501 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1471_1507 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1464_1500 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1483_1519 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1482_1518 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1467_1503 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s1468_1504 (POW (ran g_s1463$1_1571))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s1481_1517 (set_prod (SET (mapplet g_s1538_1564 g_s1537_1563)) (SET g_s1543_1569))) (|-->| (ran g_s1463$1_1571) g_s731_759)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 16 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s1487_1523 (set_prod (SET (mapplet g_s1538_1564 g_s1537_1563)) (SET g_s1544_1570))) (|-->| (ran g_s1463$1_1571) g_s723_751)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 17 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s1476_1512 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (= g_s1539_1565 g_s316_317))) g_s1540_1566))) (|>+>| (ran g_s1463$1_1571) g_s663_690)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 18 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s1477_1513 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (not (= g_s1539_1565 g_s316_317)))) g_s1540_1566))) (|>+>| (ran g_s1463$1_1571) g_s663_690)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 19 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s1479_1515 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (= g_s1539_1565 g_s316_317))) g_s1541_1567))) (|+->| (ran g_s1463$1_1571) g_s40_41)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 20 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s1480_1516 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (not (= g_s1539_1565 g_s316_317)))) g_s1541_1567))) (|+->| (ran g_s1463$1_1571) g_s40_41)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 21 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s1478_1514 (SET (mapplet (mapplet g_s1538_1564 g_s1542_1568) (mapplet g_s1537_1563 (apply g_s1114_1150 g_s1542_1568))))) (|-->| (ran g_s1463$1_1571) g_s185_186)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 22 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (ran (|<+| g_s1476_1512 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (= g_s1539_1565 g_s316_317))) g_s1540_1566)))) (ran (|<+| g_s1477_1513 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (not (= g_s1539_1565 g_s316_317)))) g_s1540_1566))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 23 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (binary_inter (dom (|<+| g_s1476_1512 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (= g_s1539_1565 g_s316_317))) g_s1540_1566)))) (dom (|<+| g_s1477_1513 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (not (= g_s1539_1565 g_s316_317)))) g_s1540_1566))))) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 24 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (binary_union (dom (|<+| g_s1476_1512 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (= g_s1539_1565 g_s316_317))) g_s1540_1566)))) (dom (|<+| g_s1477_1513 (SET (mapplet (apply (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (bool (not (= g_s1539_1565 g_s316_317)))) g_s1540_1566))))) (ran g_s1463$1_1571)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1546_1572 g_s417_420))
; PO 1 in group 24
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1549_1573 g_s1188_1224))
(assert (mem g_s1492_1524 g_s616_643))
; PO 1 in group 25
(push 1)
...
; PO 2 in group 25
(push 1)
(assert (not (mem g_s1549_1573 (dom g_s1463_1499))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 g_s617_644))
(assert (mem g_s1508_1539 g_s747_775))
; PO 1 in group 26
(push 1)
(assert (not (mem g_s1473_1509 (|+->| (dom g_s1473_1509) (ran g_s1473_1509)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 26
(push 1)
(assert (not (mem g_s1492_1524 (dom g_s1473_1509))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 27
(push 1)
(assert (not (mem g_s1474_1510 (|+->| (dom g_s1474_1510) (ran g_s1474_1510)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 27
(push 1)
(assert (not (mem g_s1492_1524 (dom g_s1474_1510))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 28
(push 1)
(assert (not (mem g_s1492_1524 (dom (binary_union g_s1476_1512 g_s1477_1513)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 28
(push 1)
(assert (not (mem (binary_union g_s1476_1512 g_s1477_1513) (|+->| (dom (binary_union g_s1476_1512 g_s1477_1513)) (ran (binary_union g_s1476_1512 g_s1477_1513))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (ran g_s1463_1499)))
(assert (mem g_s1554_1574 g_s40_41))
; PO 1 in group 29
(push 1)
(assert (not (mem g_s1492_1524 (dom (binary_union g_s1479_1515 g_s1480_1516)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 29
(push 1)
(assert (not (mem (binary_union g_s1479_1515 g_s1480_1516) (|+->| (dom (binary_union g_s1479_1515 g_s1480_1516)) (ran (binary_union g_s1479_1515 g_s1480_1516))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1492_1524 (dom g_s1478_1514)))
(assert (mem g_s1556_1575 g_s185_186))
; PO 1 in group 30
(assert (not (mem g_s1478_1514 (|+->| (dom g_s1478_1514) (ran g_s1478_1514)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 31 
...
(assert (mem g_s1492_1524 g_s616_643))
(assert (mem g_s1525_1552 g_s731_759))
(assert (mem g_s1492_1524 (dom g_s1481_1517)))
; PO 1 in group 31
(assert (not (mem g_s1481_1517 (|+->| (dom g_s1481_1517) (ran g_s1481_1517)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 32 
...
; PO 2 in group 32
(push 1)
(assert (not (mem g_s1492_1524 (dom g_s1485_1521))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1560_1576 g_s616_643))
(assert (mem g_s1560_1576 g_s617_644))
(assert (mem g_s1560_1576 (ran g_s1463_1499)))
(assert (mem g_s1544_1570 g_s723_751))
; PO 1 in group 33
(push 1)
(assert (not (mem g_s1560_1576 (dom g_s1487_1523))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 33
(push 1)
(assert (not (mem g_s1487_1523 (|+->| (dom g_s1487_1523) (ran g_s1487_1523)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1562_1577 g_s577_603))
; PO 1 in group 34
(assert (not (mem g_s1463_1499 (seq (ran g_s1463_1499)))))
(set-info :status unknown)
(check-sat)
...
; PO 2 in group 35
(push 1)
(assert (not (mem g_s1521_1549 (dom g_s1114_1150))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 36
(push 1)
(assert (not (mem g_s1542_1568 (dom g_s1114_1150))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 36
(push 1)
(assert (not (mem (bool (not (= g_s1539_1565 g_s316_317))) (dom (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 36
(push 1)
(assert (not (mem (bool (= g_s1539_1565 g_s316_317)) (dom (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 36
(push 1)
(assert (not (mem (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))) (|+->| (dom (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563)))) (ran (SET (mapplet (mapplet FALSE g_s1538_1564) (mapplet TRUE g_s1537_1563))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 36
(push 1)
(assert (not (=> lh_1 (mem (binary_union (ran g_s1463_1499) (SET (mapplet g_s1538_1564 g_s1537_1563))) (FIN (binary_union (ran g_s1463_1499) (SET (mapplet g_s1538_1564 g_s1537_1563))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
