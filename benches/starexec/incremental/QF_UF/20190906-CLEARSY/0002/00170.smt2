...
(declare-fun g_s1479$1_1550 () U)
(declare-fun g_s148_149 () U)
(declare-fun g_s1480_1516 () U)
(declare-fun g_s1481_1517 () U)
(declare-fun g_s1481$1_1553 () U)
(declare-fun g_s1482_1518 () U)
(declare-fun g_s1482$1_1555 () U)
(declare-fun g_s1483_1519 () U)
(declare-fun g_s1483$1_1557 () U)
(declare-fun g_s1484_1520 () U)
(declare-fun g_s1484$1_1559 () U)
(declare-fun g_s1485_1521 () U)
(declare-fun g_s1485$1_1543 () U)
(declare-fun g_s1486_1522 () U)
(declare-fun g_s1486$1_1561 () U)
(declare-fun g_s149_150 () U)
(declare-fun g_s1491_1523 () U)
(declare-fun g_s1493_1524 () U)
(declare-fun g_s1495_1526 () U)
(declare-fun g_s1497_1528 () U)
(declare-fun g_s1499_1530 () U)
(declare-fun g_s15_16 () U)
(declare-fun g_s150_151 () U)
(declare-fun g_s1501_1532 () U)
(declare-fun g_s1503_1534 () U)
(declare-fun g_s1505_1536 () U)
(declare-fun g_s1507_1538 () U)
(declare-fun g_s1509_1539 () U)
(declare-fun g_s151_152 () U)
(declare-fun g_s1511_1540 () U)
(declare-fun g_s1513_1542 () U)
(declare-fun g_s1515_1544 () U)
(declare-fun g_s1516_1545 () U)
(declare-fun g_s1517_1546 () U)
(declare-fun g_s1518_1547 () U)
(declare-fun g_s152_153 () U)
(declare-fun g_s1520_1548 () U)
(declare-fun g_s1522_1549 () U)
(declare-fun g_s1524_1551 () U)
(declare-fun g_s1526_1552 () U)
(declare-fun g_s1528_1554 () U)
(declare-fun g_s153_154 () U)
(declare-fun g_s1530_1556 () U)
(declare-fun g_s1532_1558 () U)
(declare-fun g_s1534_1560 () U)
(declare-fun g_s1536_1562 () U)
(declare-fun g_s154_155 () U)
(declare-fun g_s1540_1564 () U)
(declare-fun g_s1542_1565 () U)
(declare-fun g_s1544_1566 () U)
(declare-fun g_s1549_1567 () U)
(declare-fun g_s155_156 () U)
(declare-fun g_s1551_1568 () U)
(declare-fun g_s1551$1_1569 () U)
(declare-fun g_s1553_1570 () U)
(declare-fun g_s1557_1571 () U)
...
; PO 1 in group 0
(push 1)
(assert (not (mem empty (POW g_s617_644))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
; PO 3 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s617_644 g_s723_751))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s617_644 g_s731_759))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s617_644 g_s663_690))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s617_644 g_s40_41))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s617_644 g_s315_316))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 0
(push 1)
(assert (not (mem empty (|+->| g_s617_644 g_s185_186))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1491_1523 g_s617_644))
; PO 1 in group 2
(assert (not (mem (binary_union g_s1464_1500 (SET g_s1491_1523)) (POW g_s617_644))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1493_1524 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1493_1524 TRUE) (= g_s1465$1_1525 (binary_union g_s1465_1501 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1493_1524 FALSE) (= g_s1465$1_1525 (set_diff g_s1465_1501 (SET g_s1491_1523)))))
; PO 1 in group 3
(assert (not (=> (and lh_1 lh_2) (mem g_s1465$1_1525 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1495_1526 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1495_1526 TRUE) (= g_s1466$1_1527 (binary_union g_s1466_1502 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1495_1526 FALSE) (= g_s1466$1_1527 (set_diff g_s1466_1502 (SET g_s1491_1523)))))
; PO 1 in group 4
(assert (not (=> (and lh_1 lh_2) (mem g_s1466$1_1527 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1497_1528 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1497_1528 TRUE) (= g_s1467$1_1529 (binary_union g_s1467_1503 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1497_1528 FALSE) (= g_s1467$1_1529 (set_diff g_s1467_1503 (SET g_s1491_1523)))))
; PO 1 in group 5
(assert (not (=> (and lh_1 lh_2) (mem g_s1467$1_1529 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1499_1530 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1499_1530 TRUE) (= g_s1468$1_1531 (binary_union g_s1468_1504 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1499_1530 FALSE) (= g_s1468$1_1531 (set_diff g_s1468_1504 (SET g_s1491_1523)))))
; PO 1 in group 6
(assert (not (=> (and lh_1 lh_2) (mem g_s1468$1_1531 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1501_1532 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1501_1532 TRUE) (= g_s1469$1_1533 (binary_union g_s1469_1505 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1501_1532 FALSE) (= g_s1469$1_1533 (set_diff g_s1469_1505 (SET g_s1491_1523)))))
; PO 1 in group 7
(assert (not (=> (and lh_1 lh_2) (mem g_s1469$1_1533 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1503_1534 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1503_1534 TRUE) (= g_s1470$1_1535 (binary_union g_s1470_1506 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1503_1534 FALSE) (= g_s1470$1_1535 (set_diff g_s1470_1506 (SET g_s1491_1523)))))
; PO 1 in group 8
(assert (not (=> (and lh_1 lh_2) (mem g_s1470$1_1535 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1505_1536 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1505_1536 TRUE) (= g_s1471$1_1537 (binary_union g_s1471_1507 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1505_1536 FALSE) (= g_s1471$1_1537 (set_diff g_s1471_1507 (SET g_s1491_1523)))))
; PO 1 in group 9
(assert (not (=> (and lh_1 lh_2) (mem g_s1471$1_1537 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 10 
...
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1491_1523 g_s617_644))
(assert (mem g_s1507_1538 g_s747_775))
; PO 1 in group 10
(assert (not (mem (|<+| g_s1472_1508 (SET (mapplet g_s1491_1523 g_s1507_1538))) (|-->| g_s617_644 g_s747_775))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 11 
...
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1491_1523 g_s617_644))
(assert (mem g_s1509_1539 g_s253_254))
; PO 1 in group 11
(assert (not (mem (|<+| g_s1473_1509 (SET (mapplet g_s1491_1523 g_s1509_1539))) (|-->| g_s617_644 g_s253_254))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 12 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1511_1540 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1511_1540 TRUE) (= g_s1474$1_1541 (binary_union g_s1474_1510 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1511_1540 FALSE) (= g_s1474$1_1541 (set_diff g_s1474_1510 (SET g_s1491_1523)))))
; PO 1 in group 12
(assert (not (=> (and lh_1 lh_2) (mem g_s1474$1_1541 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 13 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1513_1542 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1513_1542 TRUE) (= g_s1485$1_1543 (binary_union g_s1485_1521 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1513_1542 FALSE) (= g_s1485$1_1543 (set_diff g_s1485_1521 (SET g_s1491_1523)))))
; PO 1 in group 13
(assert (not (=> (and lh_1 lh_2) (mem g_s1485$1_1543 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 14 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1515_1544 g_s616_643))
(assert (mem g_s1516_1545 g_s616_643))
(assert (mem g_s1517_1546 g_s663_690))
(assert (mem g_s1518_1547 g_s40_41))
(assert (mem g_s1515_1544 g_s617_644))
(assert (mem g_s1516_1545 g_s617_644))
(assert (not (= g_s1515_1544 g_s1516_1545)))
(assert (not (mem g_s1515_1544 (dom g_s1476_1512))))
(assert (not (mem g_s1516_1545 (dom g_s1476_1512))))
(assert (not (mem g_s1517_1546 (ran g_s1476_1512))))
; PO 1 in group 14
(push 1)
(assert (not (mem (|<+| g_s1475_1511 (SET (mapplet (mapplet g_s1516_1545 g_s317_318) (mapplet g_s1515_1544 g_s316_317)))) (|+->| g_s617_644 g_s315_316))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 14
(push 1)
(assert (not (mem (|<+| g_s1476_1512 (SET (mapplet (mapplet g_s1516_1545 g_s1517_1546) (mapplet g_s1515_1544 g_s1517_1546)))) (|+->| g_s617_644 g_s663_690))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 14
(push 1)
(assert (not (mem (|<+| g_s1477_1513 (SET (mapplet (mapplet g_s1516_1545 g_s1518_1547) (mapplet g_s1515_1544 g_s1518_1547)))) (|+->| g_s617_644 g_s40_41))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s1515_1544 g_s616_643))
(assert (mem g_s1516_1545 g_s616_643))
(assert (mem g_s1520_1548 g_s185_186))
(assert (mem g_s1515_1544 g_s617_644))
(assert (mem g_s1516_1545 g_s617_644))
(assert (not (= g_s1515_1544 g_s1516_1545)))
; PO 1 in group 15
(assert (not (mem (|<+| g_s1478_1514 (SET (mapplet (mapplet g_s1516_1545 g_s1520_1548) (mapplet g_s1515_1544 (apply g_s1114_1150 g_s1520_1548))))) (|+->| g_s617_644 g_s185_186))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 16 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1522_1549 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1522_1549 TRUE) (= g_s1479$1_1550 (binary_union g_s1479_1515 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1522_1549 FALSE) (= g_s1479$1_1550 (set_diff g_s1479_1515 (SET g_s1491_1523)))))
; PO 1 in group 16
(assert (not (=> (and lh_1 lh_2) (mem g_s1479$1_1550 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 17 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1524_1551 g_s731_759))
(assert (mem g_s1491_1523 g_s617_644))
; PO 1 in group 17
(assert (not (mem (|<+| g_s1480_1516 (SET (mapplet g_s1491_1523 g_s1524_1551))) (|+->| g_s617_644 g_s731_759))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 18 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1526_1552 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1526_1552 TRUE) (= g_s1481$1_1553 (binary_union g_s1481_1517 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1526_1552 FALSE) (= g_s1481$1_1553 (set_diff g_s1481_1517 (SET g_s1491_1523)))))
; PO 1 in group 18
(assert (not (=> (and lh_1 lh_2) (mem g_s1481$1_1553 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 19 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1528_1554 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1528_1554 TRUE) (= g_s1482$1_1555 (binary_union g_s1482_1518 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1528_1554 FALSE) (= g_s1482$1_1555 (set_diff g_s1482_1518 (SET g_s1491_1523)))))
; PO 1 in group 19
(assert (not (=> (and lh_1 lh_2) (mem g_s1482$1_1555 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 20 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1530_1556 BOOL))
(assert (mem g_s1491_1523 g_s617_644))
(define-fun lh_1 () Bool (=> (= g_s1530_1556 TRUE) (= g_s1483$1_1557 (binary_union g_s1483_1519 (SET g_s1491_1523)))))
(define-fun lh_2 () Bool (=> (= g_s1530_1556 FALSE) (= g_s1483$1_1557 (set_diff g_s1483_1519 (SET g_s1491_1523)))))
; PO 1 in group 20
(assert (not (=> (and lh_1 lh_2) (mem g_s1483$1_1557 (POW g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 21 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1532_1558 g_s731_759))
(assert (mem g_s1491_1523 (ran g_s1463_1499)))
(define-fun lh_1 () Bool (= g_s1484$1_1559 (|<+| g_s1484_1520 (SET (mapplet g_s1491_1523 g_s1532_1558)))))
; PO 1 in group 21
(assert (not (=> lh_1 (mem g_s1484$1_1559 (|+->| g_s617_644 g_s731_759)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 22 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1534_1560 g_s723_751))
(assert (mem g_s1491_1523 (ran g_s1463_1499)))
(define-fun lh_1 () Bool (= g_s1486$1_1561 (|<+| g_s1486_1522 (SET (mapplet g_s1491_1523 g_s1534_1560)))))
; PO 1 in group 22
(assert (not (=> lh_1 (mem g_s1486$1_1561 (|+->| g_s617_644 g_s723_751)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 23 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1536_1562 g_s617_644))
(define-fun lh_1 () Bool (mem g_s1463$1_1563 (perm (binary_union (ran g_s1463_1499) (SET g_s1536_1562)))))
; PO 1 in group 23
(assert (not (=> lh_1 (mem g_s1463$1_1563 (iseq g_s617_644)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 24 
...
; PO 2 in group 24
(push 1)
(assert (not (mem g_s1520_1548 (dom g_s1114_1150))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1540_1564 g_s417_420))
; PO 1 in group 25
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1542_1565 g_s1188_1224))
(assert (mem g_s1491_1523 g_s616_643))
; PO 1 in group 26
(push 1)
...
; PO 2 in group 26
(push 1)
(assert (not (mem g_s1542_1565 (dom g_s1463_1499))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1544_1566 g_s577_603))
; PO 1 in group 27
(assert (not (mem g_s1463_1499 (seq (ran g_s1463_1499)))))
(set-info :status unknown)
(check-sat)
...
; PO 1 in group 28
(push 1)
(assert (not (mem g_s1472_1508 (|+->| (dom g_s1472_1508) (ran g_s1472_1508)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 28
(push 1)
(assert (not (mem g_s1491_1523 (dom g_s1472_1508))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 29
(push 1)
(assert (not (mem g_s1491_1523 (dom g_s1473_1509))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1491_1523 (dom g_s1476_1512)))
(assert (mem g_s1517_1546 g_s663_690))
; PO 1 in group 30
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1549_1567 g_s40_41))
(assert (mem g_s1491_1523 (dom g_s1477_1513)))
; PO 1 in group 31
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1491_1523 (dom g_s1475_1511)))
(assert (mem g_s1551_1568 g_s315_316))
(define-fun lh_1 () Bool (mem g_s1551$1_1569 g_s315_316))
; PO 1 in group 32
(assert (not (=> lh_1 (mem g_s1475_1511 (|+->| (dom g_s1475_1511) (ran g_s1475_1511))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 33 
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1491_1523 (dom g_s1478_1514)))
(assert (mem g_s1553_1570 g_s185_186))
; PO 1 in group 33
...
(assert (mem g_s1491_1523 g_s616_643))
(assert (mem g_s1524_1551 g_s731_759))
(assert (mem g_s1491_1523 (dom g_s1480_1516)))
; PO 1 in group 34
...
(assert |def_ass|)
(assert (mem g_s1491_1523 g_s617_644))
(assert (mem g_s1491_1523 (dom g_s1484_1520)))
(assert (mem g_s1532_1558 g_s731_759))
; PO 1 in group 35
(assert (not (mem g_s1484_1520 (|+->| (dom g_s1484_1520) (ran g_s1484_1520)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 36 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s1536_1562 g_s616_643))
(assert (mem g_s1536_1562 g_s617_644))
(assert (mem g_s1536_1562 (dom g_s1486_1522)))
(assert (mem g_s1557_1571 g_s723_751))
; PO 1 in group 36
...
(assert (mem g_s1536_1562 g_s617_644))
; PO 1 in group 37
(assert (not (mem (binary_union (ran g_s1463_1499) (SET g_s1536_1562)) (FIN (binary_union (ran g_s1463_1499) (SET g_s1536_1562))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)