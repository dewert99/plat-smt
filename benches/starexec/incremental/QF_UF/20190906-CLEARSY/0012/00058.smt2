...
(define-fun |def_inv| () Bool (and (mem g_s282_289 (|-->| g_s161_167 INTEGER)) (mem g_s283_290 (|-->| g_s161_167 INTEGER)) (mem g_s284_291 (|-->| g_s161_167 INTEGER)) (mem g_s285_292 INTEGER)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s289_293 g_s37_37))
(assert (and (|>=i| g_s289_293 e0) (|<=i| g_s289_293 g_s103_109)))
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
; PO 1 in group 1
(assert (not (mem (|<+| g_s282_289 (SET (mapplet (|+i| g_s289_293 e70) g_s232_239))) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
; PO 1 in group 2
(assert (not (mem (|<+| g_s282_289 (SET (mapplet (|+i| g_s289_293 e70) (|-i| (apply g_s282_289 (|+i| g_s289_293 e70)) e70)))) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
; PO 1 in group 3
(assert (not (mem (|<+| g_s283_290 (SET (mapplet (|+i| g_s289_293 e70) g_s233_240))) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
; PO 1 in group 4
(assert (not (mem (|<+| g_s283_290 (SET (mapplet (|+i| g_s289_293 e70) (|-i| (apply g_s283_290 (|+i| g_s289_293 e70)) e70)))) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
; PO 1 in group 5
(assert (not (mem (|<+| g_s284_291 (SET (mapplet (|+i| g_s289_293 e70) g_s234_241))) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
; PO 1 in group 6
(assert (not (mem (|<+| g_s284_291 (SET (mapplet (|+i| g_s289_293 e70) (|-i| (apply g_s284_291 (|+i| g_s289_293 e70)) e70)))) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
; PO 2 in group 7
(push 1)
(assert (not (mem (|+i| g_s289_293 e70) (dom g_s282_289))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (and (|>=i| g_s289_293 e0) (|<=i| g_s289_293 g_s103_109)))
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
(assert (mem g_s298_294 g_s37_37))
; PO 1 in group 8
(push 1)
...
; PO 3 in group 8
(push 1)
(assert (not (mem (bool (|<=i| (apply g_s282_289 (|+i| g_s289_293 e70)) e0)) (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 8
...
; PO 2 in group 9
(push 1)
(assert (not (mem (|+i| g_s289_293 e70) (dom g_s283_290))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem (|+i| g_s289_293 e70) g_s161_167))
(assert (mem g_s298_294 g_s37_37))
(define-fun lh_1 () Bool (not (|<=i| (apply g_s283_290 (|+i| g_s289_293 e70)) e0)))
; PO 1 in group 10
(push 1)
(assert (not (mem g_s41_45 (|+->| (dom g_s41_45) (ran g_s41_45)))))
(set-info :status unknown)
...
; PO 3 in group 10
(push 1)
(assert (not (mem (bool (or (|<=i| (apply g_s283_290 (|+i| g_s289_293 e70)) e0) (|>=i| (apply g_s283_290 (|+i| g_s289_293 e70)) g_s233_240))) (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 10
...
; PO 5 in group 10
(push 1)
(assert (not (=> lh_1 (mem g_s283_290 (|+->| (dom g_s283_290) (ran g_s283_290))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 10
(push 1)
(assert (not (=> lh_1 (mem (|+i| g_s289_293 e70) (dom g_s283_290)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 11
(push 1)
(assert (not (mem (|+i| g_s289_293 e70) (dom g_s284_291))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 3 in group 12
(push 1)
(assert (not (mem (bool (|<=i| (apply g_s284_291 (|+i| g_s289_293 e70)) e0)) (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 12
...
; PO 2 in group 13
(push 1)
(assert (not (mem (bool (|<=i| g_s285_292 e0)) (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
