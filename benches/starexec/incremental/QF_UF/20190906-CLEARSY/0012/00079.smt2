...
(declare-fun g_s283$1_299 () U)
(declare-fun g_s284_291 () U)
(declare-fun g_s284$1_305 () U)
...
(declare-fun g_s323_306 () U)
(declare-fun g_s324_308 () U)
(declare-fun g_s324_307 () U)
...
(define-fun |def_seext| () Bool (and (subset g_s282_289 (interval e70 g_s102_108)) (mem g_s41_45 (|+->| BOOL g_s37_37)) (mem g_s41_45 (|+->| BOOL g_s35_35)) (mem g_s41_45 (|+->| BOOL g_s33_33))))
(define-fun |def_lprp| () Bool true)
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool (and (mem g_s283_290 BOOL) (subset g_s284_291 (interval e70 g_s102_108)) (mem g_s285_292 (|-->| g_s19_20 INTEGER)) (mem g_s286_293 (|-->| g_s19_20 INTEGER)) (mem g_s287_294 (|-->| g_s19_20 INTEGER)) (mem g_s288_295 (|-->| g_s19_20 INTEGER)) (mem g_s289_296 (|-->| (interval e0 g_s103_109) INTEGER)) (mem g_s290_297 (|-->| g_s19_20 INTEGER)) (mem g_s291_298 BOOL)))
...
(assert |def_inext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s283$1_299 BOOL))
(define-fun lh_2 () Bool (mem g_s291$1_300 BOOL))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (set_prod g_s19_20 (SET e0)) (|-->| g_s19_20 INTEGER)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (set_prod (interval e0 g_s103_109) (SET e0)) (|-->| (interval e0 g_s103_109) INTEGER)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s295_301 g_s19_20))
; PO 1 in group 1
(assert (not (mem (|<+| g_s285_292 (SET (mapplet g_s295_301 (|+i| (apply g_s285_292 g_s295_301) e70)))) (|-->| g_s19_20 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s297_302 g_s37_37))
(assert (and (|>=i| g_s297_302 e0) (|<=i| g_s297_302 g_s103_109)))
; PO 1 in group 2
(assert (not (mem (|<+| g_s289_296 (SET (mapplet g_s297_302 (|+i| (apply g_s289_296 g_s297_302) e70)))) (|-->| (interval e0 g_s103_109) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_ass|)
(assert (mem g_s295_301 g_s19_20))
(assert (mem g_s300_303 g_s37_37))
(assert (and (|>=i| g_s300_303 e0) (|<=i| g_s300_303 g_s103_109)))
(assert (mem g_s301_304 g_s37_37))
(assert (and (|>=i| g_s301_304 e0) (|<=i| g_s301_304 g_s103_109)))
(assert (mem (|+i| g_s300_303 e70) g_s282_289))
(assert (mem (|+i| g_s301_304 e70) g_s282_289))
; PO 1 in group 4
(assert (not (mem (|<+| g_s286_293 (SET (mapplet g_s295_301 (|+i| (apply g_s286_293 g_s295_301) e70)))) (|-->| g_s19_20 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem (|+i| g_s300_303 e70) g_s282_289))
(assert (mem (|+i| g_s301_304 e70) g_s282_289))
(assert (= (apply g_s287_294 g_s295_301) (|-i| (apply g_s286_293 g_s295_301) e70)))
; PO 1 in group 5
(assert (not (mem (|<+| g_s287_294 (SET (mapplet g_s295_301 (|+i| (apply g_s287_294 g_s295_301) e70)))) (|-->| g_s19_20 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem (|+i| g_s300_303 e70) g_s282_289))
(assert (mem (|+i| g_s301_304 e70) g_s282_289))
(assert (= (apply g_s288_295 g_s295_301) (|-i| (apply g_s286_293 g_s295_301) e70)))
; PO 1 in group 7
(assert (not (mem (|<+| g_s288_295 (SET (mapplet g_s295_301 (|+i| (apply g_s288_295 g_s295_301) e70)))) (|-->| g_s19_20 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 8 
...
(assert |def_ass|)
(assert (mem g_s295_301 g_s19_20))
(assert (= (apply g_s290_297 g_s295_301) (|-i| (apply g_s285_292 g_s295_301) e70)))
; PO 1 in group 8
(assert (not (mem (|<+| g_s290_297 (SET (mapplet g_s295_301 (|+i| (apply g_s290_297 g_s295_301) e70)))) (|-->| g_s19_20 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 9 
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s283$1_299 BOOL))
(define-fun lh_2 () Bool (mem g_s284$1_305 (POW (interval e70 g_s102_108))))
; PO 1 in group 10
(assert (not (=> (and lh_1 lh_2) (subset g_s284$1_305 (interval e70 g_s102_108)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 11 
...
; PO 2 in group 11
(push 1)
(assert (not (mem g_s295_301 (dom g_s285_292))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 12
(push 1)
(assert (not (mem g_s297_302 (dom g_s289_296))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 14
(push 1)
(assert (not (mem g_s295_301 (dom g_s286_293))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s295_301 g_s19_20))
(define-fun lh_2 () Bool (mem g_s300_303 g_s37_37))
(define-fun lh_3 () Bool (and (|>=i| g_s300_303 e0) (|<=i| g_s300_303 g_s103_109)))
(define-fun lh_4 () Bool (mem g_s301_304 g_s37_37))
(define-fun lh_5 () Bool (and (|>=i| g_s301_304 e0) (|<=i| g_s301_304 g_s103_109)))
(define-fun lh_6 () Bool (mem (|+i| g_s300_303 e70) g_s282_289))
(define-fun lh_7 () Bool (mem (|+i| g_s301_304 e70) g_s282_289))
; PO 1 in group 15
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s286_293 (|+->| (dom g_s286_293) (ran g_s286_293))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 15
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s287_294 (|+->| (dom g_s287_294) (ran g_s287_294))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 15
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s295_301 (dom g_s286_293)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 15
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s295_301 (dom g_s287_294)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 16
(push 1)
(assert (not (mem g_s295_301 (dom g_s287_294))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 19
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s288_295 (|+->| (dom g_s288_295) (ran g_s288_295))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 19
...
; PO 4 in group 19
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s295_301 (dom g_s288_295)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 20
(push 1)
(assert (not (mem g_s295_301 (dom g_s288_295))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 21
(push 1)
(assert (not (=> lh_1 (mem g_s285_292 (|+->| (dom g_s285_292) (ran g_s285_292))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 21
(push 1)
(assert (not (=> lh_1 (mem g_s290_297 (|+->| (dom g_s290_297) (ran g_s290_297))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 21
(push 1)
(assert (not (=> lh_1 (mem g_s295_301 (dom g_s285_292)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 21
(push 1)
(assert (not (=> lh_1 (mem g_s295_301 (dom g_s290_297)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 22
(push 1)
(assert (not (mem g_s295_301 (dom g_s290_297))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s295_301 g_s19_20))
(define-fun lh_2 () Bool (mem g_s323_306 g_s22_23))
(define-fun lh_3 () Bool (mem g_s324_307 g_s22_23))
(define-fun lh_4 () Bool (= (apply g_s287_294 g_s295_301) (apply g_s286_293 g_s295_301)))
(define-fun lh_5 () Bool (= (apply g_s288_295 g_s295_301) (apply g_s286_293 g_s295_301)))
; PO 1 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s286_293 (|+->| (dom g_s286_293) (ran g_s286_293))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s287_294 (|+->| (dom g_s287_294) (ran g_s287_294))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s295_301 (dom g_s286_293)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s295_301 (dom g_s287_294)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s286_293 (|+->| (dom g_s286_293) (ran g_s286_293))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s288_295 (|+->| (dom g_s288_295) (ran g_s288_295))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s295_301 (dom g_s286_293)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s295_301 (dom g_s288_295)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem g_s285_292 (|+->| (dom g_s285_292) (ran g_s285_292))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem g_s290_297 (|+->| (dom g_s290_297) (ran g_s290_297))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem g_s295_301 (dom g_s285_292)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 23
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem g_s295_301 (dom g_s290_297)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s324_308 g_s37_37))
; PO 1 in group 24
(push 1)
...
; PO 2 in group 24
(push 1)
(assert (not (mem g_s283_290 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 25
(push 1)
(assert (not (mem g_s291_298 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
