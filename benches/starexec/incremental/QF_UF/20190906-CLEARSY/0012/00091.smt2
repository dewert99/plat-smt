...
(declare-fun g_s15$1_21 () U)
(declare-fun g_s16_20 () U)
(declare-fun g_s16$1_22 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s13_17 BOOL) (mem g_s14_18 BOOL) (mem g_s15_19 BOOL) (mem g_s16_20 g_s4_4) (=> (= g_s15_19 TRUE) (not (mem g_s16_20 (SET (mapplet e12 e0)))))))
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s15$1_21 BOOL))
(define-fun lh_2 () Bool (mem g_s16$1_22 g_s4_4))
(define-fun lh_3 () Bool (=> (= g_s15$1_21 TRUE) (not (mem g_s16$1_22 (SET (mapplet e12 e0))))))
(define-fun lh_4 () Bool (= g_s15$1_21 TRUE))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (not (mem g_s16$1_22 (SET (mapplet e12 e0)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
