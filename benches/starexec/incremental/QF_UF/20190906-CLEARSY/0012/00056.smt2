...
(declare-fun g_s301$1_309 () U)
(declare-fun g_s302$1_310 () U)
(declare-fun g_s303$1_311 () U)
(declare-fun g_s304$1_312 () U)
(declare-fun g_s308_313 () U)
(declare-fun g_s31_32 () U)
(declare-fun g_s312_314 () U)
(declare-fun g_s312$1_315 () U)
...
(define-fun |def_abs| () Bool  (mem g_s298_305 BOOL))
(define-fun |def_inv| () Bool (and (= g_s298_305 g_s298$1_306) (mem g_s299$1_307 BOOL) (mem g_s300$1_308 BOOL) (mem g_s298$1_306 BOOL) (mem g_s301$1_309 (|-->| g_s161_167 INTEGER)) (mem g_s302$1_310 (|-->| g_s161_167 INTEGER)) (mem g_s303$1_311 (|-->| g_s161_167 INTEGER)) (mem g_s304$1_312 INTEGER)))
...
; PO 1 in group 0
(push 1)
(assert (not (mem (set_prod g_s161_167 (SET e0)) (|-->| g_s161_167 INTEGER))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (set_prod g_s161_167 (SET g_s234_241)) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s161_167 (SET g_s233_240)) (|-->| g_s161_167 INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s308_313 g_s37_37))
(assert (and (|>=i| g_s308_313 e0) (|<=i| g_s308_313 g_s103_109)))
(assert (mem (|+i| g_s308_313 e70) g_s161_167))
(define-fun lh_1 () Bool (= g_s300$1_308 TRUE))
; PO 1 in group 1
(assert (not (=> lh_1 (mem (|<+| g_s301$1_309 (SET (mapplet (|+i| g_s308_313 e70) g_s232_239))) (|-->| g_s161_167 INTEGER)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (and (|>=i| g_s308_313 e0) (|<=i| g_s308_313 g_s103_109)))
(assert (mem (|+i| g_s308_313 e70) g_s161_167))
(define-fun lh_1 () Bool (= g_s300$1_308 FALSE))
(define-fun lh_2 () Bool (|<=i| (apply g_s301$1_309 (|+i| g_s308_313 e70)) e0))
(define-fun lh_3 () Bool (not (and (= g_s300$1_308 FALSE) (|<=i| (apply g_s301$1_309 (|+i| g_s308_313 e70)) e0))))
; PO 1 in group 2
(push 1)
(assert (not (=> lh_3 (mem (|<+| g_s302$1_310 (SET (mapplet (|+i| g_s308_313 e70) (|-i| (apply g_s302$1_310 (|+i| g_s308_313 e70)) e70)))) (|-->| g_s161_167 INTEGER)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|<+| g_s302$1_310 (SET (mapplet (|+i| g_s308_313 e70) g_s233_240))) (|-->| g_s161_167 INTEGER)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (and (|>=i| g_s308_313 e0) (|<=i| g_s308_313 g_s103_109)))
(assert (mem (|+i| g_s308_313 e70) g_s161_167))
(define-fun lh_1 () Bool (|>i| (apply g_s302$1_310 (|+i| g_s308_313 e70)) e0))
(define-fun lh_2 () Bool (|<i| (apply g_s302$1_310 (|+i| g_s308_313 e70)) g_s233_240))
(define-fun lh_3 () Bool (= g_s300$1_308 TRUE))
(define-fun lh_4 () Bool (not (and (|>i| (apply g_s302$1_310 (|+i| g_s308_313 e70)) e0) (|<i| (apply g_s302$1_310 (|+i| g_s308_313 e70)) g_s233_240) (= g_s300$1_308 TRUE))))
; PO 1 in group 3
(push 1)
(assert (not (=> lh_4 (mem (|<+| g_s303$1_311 (SET (mapplet (|+i| g_s308_313 e70) g_s234_241))) (|-->| g_s161_167 INTEGER)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (|<+| g_s303$1_311 (SET (mapplet (|+i| g_s308_313 e70) (|-i| (apply g_s303$1_311 (|+i| g_s308_313 e70)) e70)))) (|-->| g_s161_167 INTEGER)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s312_314 g_s37_37))
(assert (= g_s312_314 g_s312$1_315))
; PO 1 in group 4
(assert (not (mem g_s312$1_315 g_s37_37)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem g_s312_314 g_s37_37))
(assert (= g_s312_314 g_s312$1_315))
(assert (mem g_s312$1_315 g_s37_37))
; PO 1 in group 5
(assert (not (= (apply g_s41_45 g_s298_305) (apply g_s41_45 g_s298$1_306))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (and (|>=i| g_s308_313 e0) (|<=i| g_s308_313 g_s103_109)))
(assert (mem (|+i| g_s308_313 e70) g_s161_167))
(define-fun lh_1 () Bool (not (= g_s300$1_308 TRUE)))
; PO 1 in group 6
(push 1)
(assert (not (=> lh_1 (mem g_s301$1_309 (|+->| (dom g_s301$1_309) (ran g_s301$1_309))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 6
(push 1)
(assert (not (=> lh_1 (mem (|+i| g_s308_313 e70) (dom g_s301$1_309)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem (|+i| g_s308_313 e70) g_s161_167))
(define-fun lh_1 () Bool (= g_s300$1_308 FALSE))
(define-fun lh_2 () Bool (not (and (= g_s300$1_308 FALSE) (|<=i| (apply g_s301$1_309 (|+i| g_s308_313 e70)) e0))))
; PO 1 in group 7
(push 1)
(assert (not (=> lh_1 (mem g_s301$1_309 (|+->| (dom g_s301$1_309) (ran g_s301$1_309))))))
(set-info :status unknown)
...
; PO 2 in group 7
(push 1)
(assert (not (=> lh_2 (mem g_s302$1_310 (|+->| (dom g_s302$1_310) (ran g_s302$1_310))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 7
...
; PO 4 in group 7
(push 1)
(assert (not (=> lh_2 (mem (|+i| g_s308_313 e70) (dom g_s302$1_310)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_2 () Bool (|<i| (apply g_s302$1_310 (|+i| g_s308_313 e70)) g_s233_240))
(define-fun lh_3 () Bool (= g_s300$1_308 TRUE))
(define-fun lh_4 () Bool (= g_s299$1_307 TRUE))
; PO 1 in group 8
(push 1)
(assert (not (mem g_s302$1_310 (|+->| (dom g_s302$1_310) (ran g_s302$1_310)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 8
(push 1)
(assert (not (mem (|+i| g_s308_313 e70) (dom g_s302$1_310))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 8
(push 1)
(assert (not (=> lh_1 (mem g_s302$1_310 (|+->| (dom g_s302$1_310) (ran g_s302$1_310))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 8
(push 1)
(assert (not (=> lh_1 (mem (|+i| g_s308_313 e70) (dom g_s302$1_310)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s303$1_311 (|+->| (dom g_s303$1_311) (ran g_s303$1_311))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (|+i| g_s308_313 e70) (dom g_s303$1_311)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|<+| g_s303$1_311 (SET (mapplet (|+i| g_s308_313 e70) (|-i| (apply g_s303$1_311 (|+i| g_s308_313 e70)) e70)))) (|+->| (dom (|<+| g_s303$1_311 (SET (mapplet (|+i| g_s308_313 e70) (|-i| (apply g_s303$1_311 (|+i| g_s308_313 e70)) e70))))) (ran (|<+| g_s303$1_311 (SET (mapplet (|+i| g_s308_313 e70) (|-i| (apply g_s303$1_311 (|+i| g_s308_313 e70)) e70))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (|+i| g_s308_313 e70) (dom (|<+| g_s303$1_311 (SET (mapplet (|+i| g_s308_313 e70) (|-i| (apply g_s303$1_311 (|+i| g_s308_313 e70)) e70)))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 9
(push 1)
(assert (not (mem g_s298$1_306 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
