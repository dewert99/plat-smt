...
(declare-fun g_s18$1_25 () U)
(declare-fun g_s19_23 () U)
(declare-fun g_s19$1_26 () U)
...
(define-fun |def_seext| () Bool (and (mem g_s13_17 NATURAL) (subset g_s14_18 (interval e0 g_s13_17)) (mem g_s15_19 BOOL) (mem g_s16_20 BOOL) (mem g_s17_21 BOOL) (mem g_s12_16 (|+->| BOOL g_s8_8)) (mem g_s12_16 (|+->| BOOL g_s6_6)) (mem g_s12_16 (|+->| BOOL g_s4_4))))
(define-fun |def_lprp| () Bool true)
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool (and (mem g_s18_22 NATURAL) (mem g_s19_23 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s13_17 (|+i| g_s18_22 e24)))
(define-fun lh_1 () Bool (= g_s18$1_25 (|+i| g_s18_22 e24)))
(define-fun lh_2 () Bool (or (= g_s19$1_26 g_s19_23) (= g_s19$1_26 TRUE)))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2) (mem g_s18$1_25 NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s24_27 g_s8_8))
; PO 1 in group 2
(push 1)
(assert (not (mem g_s19_23 (dom g_s12_16))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
