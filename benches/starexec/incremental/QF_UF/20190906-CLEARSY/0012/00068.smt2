...
; PO 3 in group 0
(push 1)
(assert (not (= (dom empty) (interval e70 e0))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 1
(push 1)
(assert (not (mem (card g_s282_289) NATURAL)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem (card (binary_inter g_s282_289 g_s284_291)) NATURAL)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (mem (card (binary_inter g_s282_289 g_s283_290)) NATURAL)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (|<=i| (card g_s282_289) g_s102_108)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (|<=i| (card (binary_inter g_s282_289 g_s284_291)) g_s102_108)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 1
(push 1)
(assert (not (|<=i| (card (binary_inter g_s282_289 g_s283_290)) g_s102_108)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 2
(push 1)
(assert (not (mem (|<+| g_s306_313 (SET (mapplet (|+i| g_s298_305 e70) g_s299_306))) (|+->| NATURAL NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (mem (|<+| g_s307_314 (SET (mapplet (|+i| g_s298_305 e70) g_s302_309))) (|+->| NATURAL NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (mem (|<+| g_s308_315 (SET (mapplet (|+i| g_s298_305 e70) g_s305_312))) (|+->| NATURAL NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 2
(push 1)
(assert (not (mem (|+i| g_s298_305 e70) NATURAL)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 2
(push 1)
(assert (not (= (dom (|<+| g_s306_313 (SET (mapplet (|+i| g_s298_305 e70) g_s299_306)))) (interval e70 (|+i| g_s298_305 e70)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 2
(push 1)
(assert (not (= (dom (|<+| g_s307_314 (SET (mapplet (|+i| g_s298_305 e70) g_s302_309)))) (interval e70 (|+i| g_s298_305 e70)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 2
(push 1)
(assert (not (= (dom (|<+| g_s308_315 (SET (mapplet (|+i| g_s298_305 e70) g_s305_312)))) (interval e70 (|+i| g_s298_305 e70)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (|>i| g_s298_305 e0))
(define-fun lh_2 () Bool (|<=i| g_s302_309 g_s299_306))
(define-fun lh_3 () Bool (= g_s302_309 (apply g_s307_314 g_s298_305)))
; PO 1 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s307_314 (|+->| (dom g_s307_314) (ran g_s307_314))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s298_305 (dom g_s307_314)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s306_313 (|+->| (dom g_s306_313) (ran g_s306_313))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s298_305 (dom g_s306_313)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (|>i| g_s298_305 e0))
(define-fun lh_2 () Bool (|<=i| g_s305_312 g_s299_306))
(define-fun lh_3 () Bool (= g_s305_312 (apply g_s308_315 g_s298_305)))
; PO 1 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s308_315 (|+->| (dom g_s308_315) (ran g_s308_315))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s298_305 (dom g_s308_315)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 5
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s319_316 g_s37_37))
; PO 1 in group 6
(push 1)
...
; PO 2 in group 6
(push 1)
(assert (not (mem g_s300_307 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 7
(push 1)
(assert (not (mem g_s301_308 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 8
(push 1)
(assert (not (mem g_s303_310 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 9
(push 1)
(assert (not (mem g_s304_311 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
