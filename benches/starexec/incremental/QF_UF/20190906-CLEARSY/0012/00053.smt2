...
(define-fun |def_seext| () Bool (and (subset g_s177_184 (interval e46 g_s40_44)) (mem g_s25_29 (|+->| BOOL g_s21_21)) (mem g_s25_29 (|+->| BOOL g_s19_19)) (mem g_s25_29 (|+->| BOOL g_s17_17))))
(define-fun |def_lprp| () Bool true)
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool  (mem g_s178_185 BOOL))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s180_186 g_s21_21))
; PO 1 in group 0
(push 1)
...
; PO 2 in group 0
(push 1)
(assert (not (mem g_s178_185 (dom g_s25_29))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)