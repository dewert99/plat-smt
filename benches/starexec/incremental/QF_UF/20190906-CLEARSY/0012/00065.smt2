...
(declare-fun g_s138$1_149 () U)
(declare-fun g_s139_145 () U)
(declare-fun g_s139$1_150 () U)
(declare-fun g_s14_15 () U)
(declare-fun g_s140_146 () U)
(declare-fun g_s140$1_151 () U)
(declare-fun g_s141_147 () U)
(declare-fun g_s141$1_152 () U)
...
(define-fun |def_seext| () Bool (and (subset g_s122_128 (interval e57 g_s89_95)) (subset g_s123_129 (interval e57 g_s89_95)) (subset g_s124_130 (interval e57 g_s89_95)) (subset g_s125_131 (interval e57 g_s89_95)) (mem g_s126_132 (|-->| (interval e57 g_s89_95) g_s24_24)) (mem g_s127_133 (|-->| (interval e57 g_s89_95) g_s24_24)) (mem g_s128_134 (|-->| (interval e57 g_s89_95) g_s24_24)) (mem g_s129_135 (|-->| (interval e57 g_s89_95) g_s24_24)) (subset g_s130_136 (interval e57 g_s89_95)) (subset g_s131_137 (interval e57 g_s89_95)) (subset g_s132_138 (interval e57 g_s89_95)) (subset g_s133_139 (interval e57 g_s89_95)) (mem g_s134_140 (|+->| (interval e57 g_s89_95) g_s22_22)) (mem g_s135_141 (|+->| (interval e57 g_s89_95) g_s22_22)) (subset g_s136_142 (interval e57 g_s89_95)) (mem g_s137_143 (|-->| (interval e0 g_s90_96) g_s22_22)) (mem g_s28_32 (|+->| BOOL g_s24_24)) (mem g_s28_32 (|+->| BOOL g_s22_22)) (mem g_s28_32 (|+->| BOOL g_s20_20))))
(define-fun |def_lprp| () Bool true)
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool (and (mem g_s138_144 BOOL) (mem g_s139_145 BOOL) (mem g_s140_146 BOOL) (subset g_s141_147 (interval e57 g_s89_95)) (subset g_s142_148 (interval e57 g_s89_95))))
...
(assert |def_inext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s138$1_149 BOOL))
(define-fun lh_2 () Bool (mem g_s139$1_150 BOOL))
(define-fun lh_3 () Bool (mem g_s140$1_151 BOOL))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3) (subset empty (interval e57 g_s89_95)))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(define-fun lh_2 () Bool (mem g_s139$1_150 BOOL))
(define-fun lh_3 () Bool (mem g_s140$1_151 BOOL))
(define-fun lh_4 () Bool (mem g_s141$1_152 (POW (interval e57 g_s89_95))))
(define-fun lh_5 () Bool (mem g_s142$1_153 (POW (interval e57 g_s89_95))))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (subset g_s141$1_152 (interval e57 g_s89_95)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (subset g_s142$1_153 (interval e57 g_s89_95)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s147_154 g_s24_24))
; PO 1 in group 2
(push 1)
...
; PO 2 in group 2
(push 1)
(assert (not (mem g_s140_146 (dom g_s28_32))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 3
(push 1)
(assert (not (mem g_s138_144 (dom g_s28_32))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
...
; PO 1 in group 4
(push 1)
(assert (not (mem g_s139_145 (dom g_s28_32))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
