...
(define-fun |def_inv| () Bool (and (subset g_s13_17 g_s0_1) (subset g_s14_18 g_s0_1)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (subset empty g_s0_1)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s18_19 g_s0_1))
(assert (mem g_s19_20 g_s4_4))
(assert (mem g_s20_21 g_s4_4))
(assert (mem g_s21_22 g_s4_4))
(assert (mem g_s22_23 g_s8_8))
(define-fun lh_1 () Bool (subset g_s13$1_24 (binary_union g_s13_17 (SET g_s18_19))))
(define-fun lh_2 () Bool (subset g_s13_17 g_s13$1_24))
(define-fun lh_3 () Bool (subset g_s14$1_25 (binary_union g_s14_18 (SET g_s18_19))))
(define-fun lh_4 () Bool (subset g_s14_18 g_s14$1_25))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (subset g_s13$1_24 g_s0_1))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (subset g_s14$1_25 g_s0_1))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 2
(push 1)
(assert (not (mem (bool (mem g_s18_19 g_s13_17)) (dom g_s12_16))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 3
(push 1)
(assert (not (mem (bool (mem g_s18_19 g_s14_18)) (dom g_s12_16))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
