...
(define-fun |def_inv| () Bool (and (mem g_s298_305 BOOL) (mem g_s299_306 NATURAL) (subset g_s300_307 (interval e0 g_s299_306)) (mem g_s301_308 (|<->| g_s161_167 (interval e0 g_s299_306))) (mem g_s302_309 BOOL)))
...
(assert |def_inext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s302$1_310 BOOL))
; PO 1 in group 0
(push 1)
(assert (not (=> lh_1 (mem empty (|<->| g_s161_167 (interval e0 e0))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> lh_1 (mem e0 NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> lh_1 (subset empty (interval e0 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (= g_s298_305 TRUE))
; PO 1 in group 1
(push 1)
(assert (not (=> lh_1 (mem (binary_union g_s301_308 (set_prod (binary_inter g_s161_167 g_s290_297) (SET (|+i| g_s299_306 e70)))) (|<->| g_s161_167 (interval e0 (|+i| g_s299_306 e70)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (mem (|+i| g_s299_306 e70) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> lh_1 (subset (binary_union g_s300_307 (SET (|+i| g_s299_306 e70))) (interval e0 (|+i| g_s299_306 e70))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s307_311 g_s37_37))
; PO 1 in group 2
(push 1)
...
; PO 2 in group 2
(push 1)
(assert (not (mem g_s302_309 (dom g_s41_45))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
