...
(declare-fun g_s123$1_133 () U)
(declare-fun g_s124_130 () U)
(declare-fun g_s124$1_132 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s122_128 BOOL) (subset g_s123_129 (interval e57 g_s89_95)) (mem g_s124_130 BOOL)))
...
(assert |def_inext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s122$1_131 BOOL))
(define-fun lh_2 () Bool (mem g_s124$1_132 BOOL))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2) (subset empty (interval e57 g_s89_95)))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(define-fun lh_1 () Bool (mem g_s122$1_131 BOOL))
(define-fun lh_2 () Bool (mem g_s124$1_132 BOOL))
(define-fun lh_3 () Bool (mem g_s123$1_133 (POW (interval e57 g_s89_95))))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3) (subset g_s123$1_133 (interval e57 g_s89_95)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s129_134 g_s24_24))
; PO 1 in group 2
(push 1)
...
; PO 2 in group 3
(push 1)
(assert (not (mem g_s124_130 (dom g_s28_32))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
