...
(define-fun |def_inv| () Bool (and (= g_s298_305 g_s298$1_306) (subset g_s299$1_307 INTEGER) (mem g_s300$1_308 (|<->| g_s161_167 INTEGER)) (mem g_s301$1_309 INTEGER)))
...
(assert |def_inext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s298$2_310 BOOL))
; PO 1 in group 0
(push 1)
(assert (not (=> lh_1 (mem empty (|<->| g_s161_167 INTEGER)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> lh_1 (subset empty INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (subset g_s161_167 (binary_inter g_s282_289 (binary_union (binary_union g_s292_299 g_s293_300) (set_diff g_s161_167 g_s290_297)))))
; PO 1 in group 1
(push 1)
(assert (not (=> lh_1 (mem (binary_union g_s300$1_308 (set_prod (binary_inter g_s161_167 g_s290_297) (SET (|+i| g_s301$1_309 e70)))) (|<->| g_s161_167 INTEGER)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> lh_1 (subset (binary_union g_s299$1_307 (SET (|+i| g_s301$1_309 e70))) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s306_311 g_s37_37))
(assert (= g_s306_311 g_s306$1_312))
; PO 1 in group 2
(assert (not (mem g_s306$1_312 g_s37_37)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (mem g_s306_311 g_s37_37))
(assert (= g_s306_311 g_s306$1_312))
(assert (mem g_s306$1_312 g_s37_37))
; PO 1 in group 3
