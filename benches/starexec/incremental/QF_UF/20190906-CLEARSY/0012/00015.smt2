...
(declare-fun g_s15$1_25 () U)
(declare-fun g_s16_21 () U)
(declare-fun g_s16$1_26 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s13_17 NATURAL) (subset g_s14_19 (interval e18 g_s13_17)) (= g_s14_19 empty) (subset g_s15_20 (interval e18 g_s13_17)) (mem g_s16_21 BOOL) (= g_s16_21 (bool (mem g_s13_17 g_s15_20)))))
...
; PO 2 in group 0
(push 1)
(assert (not (subset empty (interval e18 e0))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s20_22 g_s8_8))
(assert (mem g_s21_23 g_s8_8))
(assert (mem g_s22_24 g_s8_8))
(assert (mem g_s22_24 g_s11_15))
(define-fun lh_1 () Bool (subset g_s15$1_25 (interval e18 (|+i| g_s13_17 e18))))
(define-fun lh_2 () Bool (= g_s16$1_26 (bool (mem (|+i| g_s13_17 e18) g_s15$1_25))))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|+i| g_s13_17 e18) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset empty (interval e18 (|+i| g_s13_17 e18))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
