...
(define-fun |def_inv| () Bool (and (mem g_s13_17 NATURAL) (mem g_s14_18 BOOL) (mem g_s15_19 BOOL) (mem g_s16_20 BOOL)))
...
(assert (mem g_s20_22 g_s11_15))
(define-fun lh_1 () Bool (= g_s13$1_24 (|+i| g_s13_17 e23)))
(define-fun lh_2 () Bool (mem g_s14$1_25 BOOL))
(define-fun lh_3 () Bool (mem g_s15$1_21 BOOL))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s13$1_24 NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
