...
(declare-fun g_s298$1_317 () U)
(declare-fun g_s299_306 () U)
(declare-fun g_s299$1_316 () U)
...
(declare-fun g_s305$1_318 () U)
(declare-fun g_s309_319 () U)
(declare-fun g_s31_32 () U)
(declare-fun g_s310$1_320 () U)
(declare-fun g_s314$1_321 () U)
(declare-fun g_s315$1_322 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s298_305 BOOL) (mem g_s299_306 BOOL) (mem g_s300_307 BOOL) (mem g_s301_308 (|-->| g_s161_167 INTEGER)) (mem g_s302_309 (|-->| g_s161_167 INTEGER)) (mem g_s303_310 (|-->| g_s161_167 INTEGER)) (mem g_s304_311 INTEGER) (mem g_s300_307 BOOL)))
(define-fun |def_inv| () Bool (and (= g_s301_308 g_s301$1_312) (= g_s302_309 g_s302$1_313) (= g_s303_310 g_s303$1_314) (= g_s304_311 g_s304$1_315) (= g_s299_306 g_s299$1_316) (= g_s298_305 g_s298$1_317) (mem g_s299$1_316 BOOL) (mem g_s298$1_317 BOOL) (mem g_s305$1_318 g_s37_37) (= g_s305$1_318 (apply g_s41_45 g_s300_307))))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s301$1_312 (|-->| g_s161_167 INTEGER)) (mem g_s302$1_313 (|-->| g_s161_167 INTEGER)) (mem g_s303$1_314 (|-->| g_s161_167 INTEGER)) (mem g_s304$1_315 INTEGER)))
; PO group 0 
(push 1)
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem (set_prod g_s161_167 (SET e0)) (|-->| g_s161_167 INTEGER)))
(define-fun lh_2 () Bool (mem (set_prod g_s161_167 (SET g_s233_240)) (|-->| g_s161_167 INTEGER)))
(define-fun lh_3 () Bool (mem (set_prod g_s161_167 (SET g_s234_241)) (|-->| g_s161_167 INTEGER)))
(define-fun lh_4 () Bool (mem g_s235_242 INTEGER))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= g_s39_40 (apply g_s41_45 FALSE)))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s309_319 g_s37_37))
(define-fun lh_2 () Bool (and (|>=i| g_s309_319 e0) (|<=i| g_s309_319 g_s103_109)))
(define-fun lh_3 () Bool (mem (|+i| g_s309_319 e70) g_s161_167))
(define-fun lh_4 () Bool (mem g_s310$1_320 g_s37_37))
(define-fun lh_5 () Bool (= (apply g_s41_45 (bool (mem (|+i| g_s309_319 e70) g_s282_289))) g_s38_39))
(define-fun lh_6 () Bool (mem (|+i| g_s309_319 e70) g_s282_289))
(define-fun lh_7 () Bool (or (= g_s309_319 g_s142_148) (= g_s309_319 g_s143_149)))
(define-fun lh_8 () Bool (mem (apply g_s41_45 (bool (mem (|+i| g_s309_319 e70) g_s282_289))) g_s37_37))
(define-fun lh_9 () Bool (= (apply g_s41_45 (bool (mem (|+i| g_s309_319 e70) g_s291_298))) g_s39_40))
(define-fun lh_10 () Bool (not (mem (|+i| g_s309_319 e70) g_s291_298)))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem (|+i| g_s309_319 e70) g_s282_289))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (or (= g_s309_319 g_s142_148) (= g_s309_319 g_s143_149)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (apply g_s41_45 (bool (mem (|+i| g_s309_319 e70) g_s282_289))) g_s37_37))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (not (mem (|+i| g_s309_319 e70) g_s291_298)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= (bool (mem (|+i| g_s309_319 e70) (binary_inter g_s282_289 g_s291_298))) FALSE))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_3 () Bool (mem (|+i| g_s309_319 e70) g_s161_167))
(define-fun lh_4 () Bool (mem g_s310$1_320 g_s37_37))
(define-fun lh_5 () Bool (mem g_s314$1_321 BOOL))
(define-fun lh_6 () Bool (mem g_s315$1_322 BOOL))
(define-fun lh_7 () Bool (= (bool (and (= (bool (= g_s299$1_316 FALSE)) TRUE) (= (bool (= (apply g_s41_45 (bool (|<=i| (apply g_s301$1_312 (|+i| g_s309_319 e70)) e0))) g_s38_39)) TRUE))) TRUE))
(define-fun lh_8 () Bool (not (and (= g_s299$1_316 FALSE) (|<=i| (apply g_s301$1_312 (|+i| g_s309_319 e70)) e0))))
; PO 1 in group 2
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8) (= (|<+| g_s302$1_313 (SET (mapplet (|+i| g_s309_319 e70) (|-i| (apply g_s302$1_313 (|+i| g_s309_319 e70)) e70)))) (|<+| g_s302$1_313 (SET (mapplet (|+i| g_s309_319 e70) g_s233_240)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(define-fun lh_5 () Bool (mem g_s314$1_321 BOOL))
(define-fun lh_6 () Bool (mem g_s315$1_322 BOOL))
(define-fun lh_7 () Bool (= (bool (or (= (bool (= g_s299$1_316 FALSE)) TRUE) (= (bool (= (apply g_s41_45 (bool (or (|<=i| (apply g_s302$1_313 (|+i| g_s309_319 e70)) e0) (|>=i| (apply g_s302$1_313 (|+i| g_s309_319 e70)) g_s233_240)))) g_s38_39)) TRUE))) TRUE))
(define-fun lh_8 () Bool (|>i| (apply g_s302$1_313 (|+i| g_s309_319 e70)) e0))
(define-fun lh_9 () Bool (|<i| (apply g_s302$1_313 (|+i| g_s309_319 e70)) g_s233_240))
(define-fun lh_10 () Bool (= g_s299$1_316 TRUE))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= (bool (and (= g_s298$1_317 TRUE) (|>i| (apply (|<+| g_s303$1_314 (SET (mapplet (|+i| g_s309_319 e70) (|-i| (apply g_s303$1_314 (|+i| g_s309_319 e70)) e70)))) (|+i| g_s309_319 e70)) e0))) FALSE))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10) (= (|<+| g_s303$1_314 (SET (mapplet (|+i| g_s309_319 e70) (|-i| (apply g_s303$1_314 (|+i| g_s309_319 e70)) e70)))) (|<+| g_s303$1_314 (SET (mapplet (|+i| g_s309_319 e70) g_s234_241)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s310$1_320 g_s37_37))
(define-fun lh_2 () Bool (mem g_s314$1_321 BOOL))
(define-fun lh_3 () Bool (= g_s298$1_317 FALSE))
(define-fun lh_4 () Bool (= (bool (= (apply g_s41_45 (bool (|<=i| g_s235_242 e0))) g_s38_39)) TRUE))
; PO 1 in group 4
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= g_s38_39 (apply g_s41_45 (bool (|<=i| g_s235_242 e0)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (= g_s301_308 g_s301$1_312))
(define-fun lh_2 () Bool (= g_s302_309 g_s302$1_313))
(define-fun lh_3 () Bool (= g_s303_310 g_s303$1_314))
(define-fun lh_4 () Bool (= g_s304_311 g_s304$1_315))
(define-fun lh_5 () Bool (= g_s299_306 g_s299$1_316))
(define-fun lh_6 () Bool (= g_s298_305 g_s298$1_317))
(define-fun lh_7 () Bool (mem g_s299$1_316 BOOL))
(define-fun lh_8 () Bool (mem g_s298$1_317 BOOL))
(define-fun lh_9 () Bool (mem g_s305$1_318 g_s37_37))
; PO 1 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s41_45 (|+->| (dom g_s41_45) (ran g_s41_45))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s300_307 (dom g_s41_45)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
