...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s139_142 g_s60_65))
(define-fun lh_1 () Bool (= (apply g_s118_122 g_s139_142) FALSE))
(define-fun lh_2 () Bool (= (apply g_s137$1_143 g_s139_142) g_s9_10))
(define-fun lh_3 () Bool (not (mem g_s139_142 g_s136$1_144)))
(define-fun lh_4 () Bool (not (mem g_s139_142 g_s133$1_145)))
(define-fun lh_5 () Bool (=> (= (apply g_s118_122 g_s139_142) FALSE) (and (= (apply g_s137$1_143 g_s139_142) g_s9_10) (not (mem g_s139_142 g_s136$1_144)) (not (mem g_s139_142 g_s133$1_145)) (= (apply g_s129$1_146 g_s139_142) g_s15_16))))
(define-fun lh_6 () Bool (= (apply g_s118_122 g_s139_142) TRUE))
(define-fun lh_7 () Bool (= (apply g_s125_129 g_s139_142) TRUE))
(define-fun lh_8 () Bool (= (apply g_s124_128 g_s139_142) TRUE))
(define-fun lh_9 () Bool (not (|<i| (apply g_s122_126 g_s139_142) g_s73_77)))
(define-fun lh_10 () Bool (or (|<i| (apply g_s122_126 g_s139_142) g_s73_77) (|>i| (apply g_s122_126 g_s139_142) g_s74_78)))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s139_142 (dom g_s118_122))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
; PO 3 in group 0
(push 1)
(assert (not (=> lh_1 (mem g_s137$1_143 (|+->| (dom g_s137$1_143) (ran g_s137$1_143))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (=> lh_1 (mem g_s139_142 (dom g_s137$1_143)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> lh_5 (mem g_s139_142 (dom g_s118_122)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (=> lh_5 (mem g_s118_122 (|+->| (dom g_s118_122) (ran g_s118_122))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6) (mem g_s139_142 (dom g_s125_129)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6) (mem g_s125_129 (|+->| (dom g_s125_129) (ran g_s125_129))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6 lh_7) (mem g_s124_128 (|+->| (dom g_s124_128) (ran g_s124_128))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6 lh_7) (mem g_s139_142 (dom g_s124_128)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6 lh_7 lh_8) (mem g_s122_126 (|+->| (dom g_s122_126) (ran g_s122_126))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s129$1_146 (|+->| (dom g_s129$1_146) (ran g_s129$1_146))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6 lh_7 lh_8) (mem g_s139_142 (dom g_s122_126)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s139_142 (dom g_s129$1_146)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s122_126 (|+->| (dom g_s122_126) (ran g_s122_126))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 16 in group 0
(push 1)
(assert (not (=> (and lh_5 lh_6 lh_7 lh_8 lh_9) (mem g_s139_142 (dom g_s122_126)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 17 in group 0
(push 1)
(assert (not (=> (and lh_4 lh_5 lh_6 lh_7 lh_8 lh_10) (mem g_s129$1_146 (|+->| (dom g_s129$1_146) (ran g_s129$1_146))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 18 in group 0
(push 1)
(assert (not (=> (and lh_4 lh_5 lh_6 lh_7 lh_8 lh_10) (mem g_s139_142 (dom g_s129$1_146)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
