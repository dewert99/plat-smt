...
(declare-fun g_s65$1_64 () U)
(declare-fun g_s68$1_65 () U)
(declare-fun g_s7_8 () U)
(declare-fun g_s70$1_66 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s57_57 (|+->| g_s2_3 g_s13_14)) (mem g_s58_58 (|+->| g_s2_3 g_s13_14)) (mem g_s59_59 (|+->| g_s2_3 g_s21_22)) (mem g_s60_60 (|+->| g_s2_3 g_s13_14)) (= (dom g_s57_57) (dom g_s58_58)) (= (dom g_s60_60) (dom g_s59_59))))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s62_61 g_s0_1))
(assert (mem g_s62_61 g_s2_3))
(assert (mem g_s63_62 g_s12_13))
(assert (mem g_s63_62 g_s13_14))
(assert (mem g_s64_63 g_s21_22))
(assert (|>=i| g_s64_63 e0))
(define-fun lh_1 () Bool (mem g_s62_61 (dom g_s59_59)))
(define-fun lh_2 () Bool (mem (apply g_s29_30 (mapplet g_s63_62 (apply g_s59_59 g_s62_61))) (apply g_s30_31 (mapplet g_s53_53 g_s64_63))))
(define-fun lh_3 () Bool (mem g_s65$1_64 g_s12_13))
; PO 1 in group 0
(push 1)
...
; PO 4 in group 0
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s53_53 g_s64_63) (dom g_s30_31)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s63_62 (apply g_s59_59 g_s62_61)) (dom g_s29_30)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
...
; PO 8 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (mapplet g_s63_62 (apply g_s59_59 g_s62_61)) (dom g_s29_30)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert (mem g_s62_61 g_s0_1))
(assert (mem g_s62_61 g_s2_3))
(define-fun lh_1 () Bool (mem g_s62_61 (dom g_s57_57)))
(define-fun lh_2 () Bool (mem g_s68$1_65 g_s12_13))
; PO 1 in group 1
...
(assert (mem g_s62_61 g_s0_1))
(assert (mem g_s62_61 g_s2_3))
(define-fun lh_1 () Bool (mem g_s62_61 (dom g_s58_58)))
(define-fun lh_2 () Bool (mem g_s70$1_66 g_s12_13))
; PO 1 in group 2
...
(assert (mem g_s63_62 g_s12_13))
(assert (mem g_s63_62 g_s13_14))
(assert (mem g_s62_61 (dom g_s59_59)))
(define-fun lh_1 () Bool (mem g_s65$1_64 g_s12_13))
; PO 1 in group 3
(push 1)
(assert (not (=> lh_1 (mem g_s59_59 (|+->| (dom g_s59_59) (ran g_s59_59))))))
(set-info :status unknown)
