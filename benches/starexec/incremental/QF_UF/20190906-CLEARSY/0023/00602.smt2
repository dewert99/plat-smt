...
; PO 2 in group 0
(push 1)
(assert (not (mem g_s158_161 (dom g_s155_157))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 1
(push 1)
(assert (not (mem g_s156_160 (|+->| (dom g_s156_160) (ran g_s156_160)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s158_161 (dom g_s156_160))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
