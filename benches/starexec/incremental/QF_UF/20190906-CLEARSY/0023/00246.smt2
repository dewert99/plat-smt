...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s141_144 g_s60_65))
; PO 1 in group 0
(push 1)
...
; PO 2 in group 0
(push 1)
(assert (not (mem g_s141_144 (dom g_s136_140))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)