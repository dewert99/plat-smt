...
(define-fun |def_inv| () Bool (and (mem g_s36_39 BOOL) (mem g_s37_40 (|-->| g_s27_30 g_s14_16)) (subset g_s38_41 g_s27_30) (subset g_s39_42 g_s27_30) (mem g_s40_43 (|-->| g_s27_30 g_s0_1)) (mem g_s41_44 (|-->| g_s27_30 g_s8_10)) (subset g_s42_45 g_s27_30)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s44_46 g_s27_30))
(assert (mem g_s45_47 g_s14_16))
(assert (mem g_s46_48 BOOL))
(assert (mem g_s47_49 BOOL))
(assert (mem g_s48_50 g_s0_1))
(assert (mem g_s49_51 g_s8_10))
(assert (mem g_s50_52 BOOL))
; PO 1 in group 0
(push 1)
(assert (not (mem (|<+| g_s37_40 (SET (mapplet g_s44_46 g_s45_47))) (|-->| g_s27_30 g_s14_16))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (|<+| g_s40_43 (SET (mapplet g_s44_46 g_s48_50))) (|-->| g_s27_30 g_s0_1))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (|<+| g_s41_44 (SET (mapplet g_s44_46 g_s49_51))) (|-->| g_s27_30 g_s8_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (subset (binary_union (set_diff g_s38_41 (SET g_s44_46)) (image (SET (mapplet g_s46_48 g_s44_46)) (SET TRUE))) g_s27_30)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (subset (binary_union (set_diff g_s39_42 (SET g_s44_46)) (image (SET (mapplet g_s47_49 g_s44_46)) (SET TRUE))) g_s27_30)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (subset (binary_union (set_diff g_s42_45 (SET g_s44_46)) (image (SET (mapplet g_s50_52 g_s44_46)) (SET TRUE))) g_s27_30)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 1
(push 1)
(assert (not (mem g_s37_40 (|+->| (dom g_s37_40) (ran g_s37_40)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s44_46 (dom g_s37_40))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 2
(push 1)
(assert (not (mem g_s44_46 (dom g_s40_43))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (mem g_s40_43 (|+->| (dom g_s40_43) (ran g_s40_43)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 3
(push 1)
(assert (not (mem g_s44_46 (dom g_s41_44))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (mem g_s41_44 (|+->| (dom g_s41_44) (ran g_s41_44)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
