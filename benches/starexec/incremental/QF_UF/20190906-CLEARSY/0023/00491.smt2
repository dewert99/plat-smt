...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s131_131 g_s40_41))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s131_131 (dom (SET (mapplet (mapplet g_s42_43 e132) (mapplet g_s41_42 e0)))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (SET (mapplet (mapplet g_s42_43 e132) (mapplet g_s41_42 e0))) (|+->| (dom (SET (mapplet (mapplet g_s42_43 e132) (mapplet g_s41_42 e0)))) (ran (SET (mapplet (mapplet g_s42_43 e132) (mapplet g_s41_42 e0))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s131_133 e0) (|<=i| g_s131_133 e132)))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s131_133 (dom (SET (mapplet (mapplet e132 g_s42_43) (mapplet e0 g_s41_42)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem (SET (mapplet (mapplet e132 g_s42_43) (mapplet e0 g_s41_42))) (|+->| (dom (SET (mapplet (mapplet e132 g_s42_43) (mapplet e0 g_s41_42)))) (ran (SET (mapplet (mapplet e132 g_s42_43) (mapplet e0 g_s41_42))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
