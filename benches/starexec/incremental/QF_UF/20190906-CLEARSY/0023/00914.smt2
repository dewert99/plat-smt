...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s50_50 g_s10_11))
(define-fun lh_2 () Bool (mem g_s50_50 g_s25_26))
(define-fun lh_3 () Bool (mem g_s51_51 g_s6_7))
(define-fun lh_4 () Bool (mem g_s51_51 g_s35_36))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s44_45 (|+->| (dom g_s44_45) (ran g_s44_45))))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem g_s50_50 (dom g_s44_45)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)