...
(declare-fun g_s35$1_35 () U)
(declare-fun g_s39$1_36 () U)
(declare-fun g_s4_5 () U)
(declare-fun g_s42$1_37 () U)
(declare-fun g_s45$1_38 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s25_26 g_s12_13) (mem g_s26_27 g_s15_16) (mem g_s27_28 (|+->| g_s7_8 g_s13_14)) (mem g_s28_29 (|+->| g_s7_8 g_s16_17)) (mem g_s29_30 (|+->| g_s7_8 g_s13_14)) (mem g_s30_31 (|+->| g_s7_8 g_s16_17)) (subset g_s31_32 g_s7_8) (subset g_s32_33 g_s7_8) (= (dom g_s27_28) (dom g_s28_29)) (= (dom g_s29_30) (dom g_s30_31)) (= (dom g_s27_28) g_s32_33) (= (dom g_s28_29) g_s32_33)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(define-fun lh_1 () Bool (mem g_s34_34 (dom g_s27_28)))
(define-fun lh_2 () Bool (mem g_s35$1_35 g_s12_13))
; PO 1 in group 0
...
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(assert (mem g_s34_34 (dom g_s27_28)))
(define-fun lh_1 () Bool (mem g_s35$1_35 g_s12_13))
; PO 1 in group 1
...
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(define-fun lh_1 () Bool (mem g_s34_34 (dom g_s28_29)))
(define-fun lh_2 () Bool (mem g_s39$1_36 g_s15_16))
; PO 1 in group 2
...
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(assert (mem g_s34_34 (dom g_s28_29)))
(define-fun lh_1 () Bool (mem g_s39$1_36 g_s15_16))
; PO 1 in group 3
...
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(define-fun lh_1 () Bool (mem g_s34_34 (dom g_s29_30)))
(define-fun lh_2 () Bool (mem g_s42$1_37 g_s12_13))
; PO 1 in group 4
...
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(assert (mem g_s34_34 (dom g_s29_30)))
(define-fun lh_1 () Bool (mem g_s42$1_37 g_s12_13))
; PO 1 in group 5
...
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(define-fun lh_1 () Bool (mem g_s34_34 (dom g_s30_31)))
(define-fun lh_2 () Bool (mem g_s45$1_38 g_s15_16))
; PO 1 in group 6
...
(assert (mem g_s34_34 g_s1_2))
(assert (mem g_s34_34 g_s7_8))
(assert (mem g_s34_34 (dom g_s30_31)))
(define-fun lh_1 () Bool (mem g_s45$1_38 g_s15_16))
; PO 1 in group 7
