...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s92_101 g_s14_14))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s85_97 (dom g_s18_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
