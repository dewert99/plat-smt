...
(declare-fun g_s82$1_93 () U)
(declare-fun g_s83_91 () U)
(declare-fun g_s83$1_94 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s80_88 NATURAL) (subset g_s81_89 (interval e0 g_s80_88)) (mem g_s82_90 BOOL) (mem g_s83_91 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s87_92 g_s10_10))
(define-fun lh_1 () Bool (mem g_s82$1_93 BOOL))
(define-fun lh_2 () Bool (or (= g_s83$1_94 g_s83_91) (= g_s83$1_94 TRUE)))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|+i| g_s80_88 e43) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset g_s81_89 (interval e0 (|+i| g_s80_88 e43))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (subset (binary_union g_s81_89 (SET (|+i| g_s80_88 e43))) (interval e0 (|+i| g_s80_88 e43))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 2
(push 1)
(assert (not (mem (bool (mem g_s80_88 g_s81_89)) (dom g_s18_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 3
(push 1)
(assert (not (mem g_s83_91 (dom g_s18_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
...
; PO 2 in group 4
(push 1)
(assert (not (mem g_s82_90 (dom g_s18_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
