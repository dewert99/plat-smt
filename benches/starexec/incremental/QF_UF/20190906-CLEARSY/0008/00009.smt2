...
(define-fun |def_lprp| () Bool (and (mem g_s62_73 (|-->| (set_prod (set_prod (set_prod g_s6_8 (|-->| (interval e0 g_s58_65) g_s6_8)) g_s8_12) g_s6_8) g_s7_10)) (mem g_s63_74 (|-->| (set_prod (set_prod (set_prod g_s6_8 (|-->| (interval e0 g_s56_63) g_s6_8)) g_s8_12) g_s6_8) g_s7_10))))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s65_75 g_s6_8))
(assert (mem g_s66_76 (|-->| (interval e0 g_s58_65) g_s8_12)))
(assert (mem g_s67_77 g_s8_12))
(assert (mem g_s68_78 g_s6_8))
(assert (mem g_s69_79 g_s7_10))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s62_73 (|+->| (dom g_s62_73) (ran g_s62_73)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (mapplet (mapplet (mapplet g_s65_75 g_s66_76) g_s67_77) g_s68_78) (dom g_s62_73))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (mem g_s65_75 g_s6_8))
(assert (mem g_s66_76 (|-->| (interval e0 g_s56_63) g_s8_12)))
(assert (mem g_s67_77 g_s8_12))
(assert (mem g_s68_78 g_s6_8))
(assert (mem g_s69_79 g_s7_10))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s63_74 (|+->| (dom g_s63_74) (ran g_s63_74)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem (mapplet (mapplet (mapplet g_s65_75 g_s66_76) g_s67_77) g_s68_78) (dom g_s63_74))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
