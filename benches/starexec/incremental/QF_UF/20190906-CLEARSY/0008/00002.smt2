...
; PO 1 in group 0
(push 1)
(assert (not (mem e24 g_s6_6)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem e22 g_s6_6)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
...
; PO 7 in group 0
(push 1)
(assert (not (= e31 (|-i| e18 e27))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 0
(push 1)
(assert (not (= e32 (|-i| e20 e27))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 0
...
; PO 11 in group 0
(push 1)
(assert (not (|<=i| e22 e29)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 0
(push 1)
(assert (not (|<=i| e31 e31)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 0
