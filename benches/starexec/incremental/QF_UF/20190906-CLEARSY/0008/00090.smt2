...
(declare-fun g_s13$1_23 () U)
(declare-fun g_s14_20 () U)
(declare-fun g_s14$1_24 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s13_18 g_s5_9) (mem g_s14_20 (|-->| (interval e0 e19) g_s5_9)) (mem g_s15_21 g_s4_7)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s17_22 g_s3_5))
(define-fun lh_1 () Bool (or (= g_s13$1_23 g_s13_18) (= g_s13$1_23 g_s9_13)))
(define-fun lh_2 () Bool (mem g_s14$1_24 (|-->| (interval e0 e19) g_s5_9)))
(define-fun lh_3 () Bool (mem g_s15$1_25 g_s4_7))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3) (mem g_s13$1_23 g_s5_9))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s20_26 g_s5_9))
(assert (mem g_s21_27 g_s5_9))
(assert (and (|>=i| g_s21_27 e0) (|<=i| g_s21_27 e19)))
(assert (= g_s13_18 g_s9_13))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s14_20 (|+->| (dom g_s14_20) (ran g_s14_20)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s21_27 (dom g_s14_20))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
