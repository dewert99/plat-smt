...
(declare-fun g_s226$1_266 () U)
(declare-fun g_s227_249 () U)
(declare-fun g_s227$1_267 () U)
(declare-fun g_s228_250 () U)
(declare-fun g_s228$1_268 () U)
(declare-fun g_s229_251 () U)
(declare-fun g_s229$1_269 () U)
(declare-fun g_s23_24 () U)
(declare-fun g_s230_252 () U)
(declare-fun g_s230$1_270 () U)
(declare-fun g_s231_253 () U)
(declare-fun g_s231$1_271 () U)
(declare-fun g_s232_254 () U)
(declare-fun g_s232$1_272 () U)
(declare-fun g_s233_255 () U)
(declare-fun g_s233$1_273 () U)
(declare-fun g_s234_256 () U)
(declare-fun g_s234$1_274 () U)
(declare-fun g_s235_257 () U)
(declare-fun g_s235$1_275 () U)
(declare-fun g_s236_258 () U)
(declare-fun g_s236$1_276 () U)
(declare-fun g_s237_259 () U)
(declare-fun g_s237$1_277 () U)
(declare-fun g_s238_260 () U)
(declare-fun g_s238$1_278 () U)
(declare-fun g_s239_261 () U)
(declare-fun g_s239$1_279 () U)
(declare-fun g_s24_25 () U)
(declare-fun g_s240_262 () U)
(declare-fun g_s240$1_280 () U)
(declare-fun g_s241_263 () U)
(declare-fun g_s242_265 () U)
(declare-fun g_s242$1_281 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s225_247 (|-->| (interval e0 g_s62_68) g_s41_45)) (mem g_s226_248 g_s41_45) (mem g_s227_249 g_s41_45) (mem g_s228_250 g_s41_45) (mem g_s229_251 g_s41_45) (mem g_s230_252 g_s41_45) (mem g_s231_253 g_s40_43) (mem g_s232_254 (|-->| (interval e0 e76) g_s41_45)) (mem g_s233_255 g_s41_45) (mem g_s234_256 g_s39_41) (mem g_s235_257 g_s41_45) (mem g_s236_258 (|-->| (interval e0 e76) g_s41_45)) (mem g_s237_259 g_s40_43) (mem g_s238_260 g_s40_43) (mem g_s239_261 g_s41_45) (mem g_s240_262 (|-->| (interval e0 g_s62_68) g_s41_45)) (mem g_s241_263 g_s40_43) (mem g_s242_265 (|-->| (interval e0 e264) g_s41_45))))
...
(assert |def_inext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s226$1_266 g_s41_45))
(define-fun lh_2 () Bool (mem g_s227$1_267 g_s41_45))
(define-fun lh_3 () Bool (mem g_s228$1_268 g_s41_45))
(define-fun lh_4 () Bool (mem g_s229$1_269 g_s41_45))
(define-fun lh_5 () Bool (mem g_s230$1_270 g_s41_45))
(define-fun lh_6 () Bool (mem g_s231$1_271 g_s40_43))
(define-fun lh_7 () Bool (mem g_s232$1_272 (|-->| (interval e0 e76) g_s41_45)))
(define-fun lh_8 () Bool (mem g_s233$1_273 g_s41_45))
(define-fun lh_9 () Bool (mem g_s234$1_274 g_s39_41))
(define-fun lh_10 () Bool (mem g_s235$1_275 g_s41_45))
(define-fun lh_11 () Bool (mem g_s236$1_276 (|-->| (interval e0 e76) g_s41_45)))
(define-fun lh_12 () Bool (mem g_s237$1_277 g_s40_43))
(define-fun lh_13 () Bool (mem g_s238$1_278 g_s40_43))
(define-fun lh_14 () Bool (mem g_s239$1_279 g_s41_45))
(define-fun lh_15 () Bool (mem g_s240$1_280 (|-->| (interval e0 g_s62_68) g_s41_45)))
(define-fun lh_16 () Bool (mem g_s242$1_281 (|-->| (interval e0 e264) g_s41_45)))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16) (mem e0 g_s40_43))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7 lh_8 lh_9 lh_10 lh_11 lh_12 lh_13 lh_14 lh_15 lh_16) (mem (set_prod (interval e0 g_s62_68) (SET e0)) (|-->| (interval e0 g_s62_68) g_s41_45)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
