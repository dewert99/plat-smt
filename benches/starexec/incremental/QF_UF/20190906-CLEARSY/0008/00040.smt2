...
(declare-fun g_s88$1_98 () U)
(declare-fun g_s89_97 () U)
(declare-fun g_s89$1_99 () U)
(declare-fun g_s9_11 () U)
(declare-fun g_s90$1_100 () U)
(declare-fun g_s91$1_101 () U)
(declare-fun g_s92$1_102 () U)
(declare-fun g_s93$1_103 () U)
(declare-fun g_s94$1_104 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s88_96 NATURAL) (mem g_s89_97 BOOL)))
(define-fun |def_inv| () Bool (and (= g_s88_96 g_s88$1_98) (= g_s89_97 g_s89$1_99) (mem g_s90$1_100 g_s14_14) (mem g_s91$1_101 INTEGER) (mem g_s88$1_98 NATURAL) (mem g_s92$1_102 g_s10_10) (mem g_s93$1_103 g_s10_10) (mem g_s94$1_104 g_s10_10) (mem g_s89$1_99 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s98_105 g_s10_10))
(assert (mem g_s99_106 g_s12_12))
(assert (= g_s84_92 (|+i| g_s88_96 e43)))
(define-fun lh_1 () Bool (mem (|+i| g_s88$1_98 e43) g_s85_93))
(define-fun lh_2 () Bool (or (|<=i| (|-i| g_s91$1_101 g_s99_106) e0) (and (|>i| g_s94$1_104 g_s67_74) (|>i| (|+i| g_s88$1_98 e43) g_s42_49) (= (binary_inter (interval (|-i| (|+i| g_s88$1_98 e43) g_s42_49) (|-i| (|+i| g_s88$1_98 e43) e43)) g_s85_93) empty))))
(define-fun lh_3 () Bool (|<=i| (|-i| g_s91$1_101 g_s99_106) e0))
(define-fun lh_4 () Bool (not (= g_s93$1_103 e0)))
(define-fun lh_5 () Bool (not (mem (|-i| (apply g_s62_69 (mapplet g_s67_74 g_s67_74)) (apply g_s62_69 (mapplet g_s98_105 g_s98_105))) (interval (iuminus g_s44_51) g_s44_51))))
(define-fun lh_6 () Bool (not (and (|<=i| (|-i| g_s91$1_101 g_s99_106) e0) (not (= g_s93$1_103 e0)))))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_5 lh_6) (or (= TRUE g_s89_97) (= TRUE TRUE)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_5 lh_6) (mem (|+i| g_s88$1_98 e43) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_5 lh_6) (= (|+i| g_s88_96 e43) (|+i| g_s88$1_98 e43)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (or (= TRUE g_s89_97) (= TRUE TRUE)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem (|+i| g_s88$1_98 e43) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= (|+i| g_s88_96 e43) (|+i| g_s88$1_98 e43)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s101_107 g_s14_14))
(assert (= g_s101_107 g_s101$1_108))
; PO 1 in group 2
(assert (not (mem g_s101$1_108 g_s14_14)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (mem g_s101_107 g_s14_14))
(assert (= g_s101_107 g_s101$1_108))
(assert (mem g_s101$1_108 g_s14_14))
; PO 1 in group 4
(assert (not (= (apply g_s18_23 g_s89_97) (apply g_s18_23 g_s89$1_99))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(define-fun lh_3 () Bool (|<=i| (|-i| g_s91$1_101 g_s99_106) e0))
(define-fun lh_4 () Bool (not (= g_s93$1_103 e0)))
(define-fun lh_5 () Bool (not (and (|<=i| (|-i| g_s91$1_101 g_s99_106) e0) (not (= g_s93$1_103 e0)))))
; PO 1 in group 5
(push 1)
...
; PO 3 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_5) (mem (mapplet g_s98_105 g_s98_105) (dom g_s62_69)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 5
...
; PO 6 in group 5
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (mapplet g_s98_105 g_s98_105) (dom g_s62_69)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 6
(push 1)
(assert (not (mem g_s89$1_99 (dom g_s18_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 6
