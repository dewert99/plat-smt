...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s80_91 g_s8_12))
(assert (and (|>=i| g_s80_91 e0) (|<=i| g_s80_91 e88)))
(assert (mem g_s81_92 g_s8_12))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s77_89 (|+->| (dom g_s77_89) (ran g_s77_89)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem g_s80_91 (dom g_s77_89))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)