...
(define-fun |def_abs| () Bool  (mem g_s33_48 BOOL))
(define-fun |def_inv| () Bool (and (= g_s34$1_49 g_s33_48) (= g_s35$1_50 g_s33_48) (= g_s36$1_51 g_s33_48) (= g_s37$1_52 g_s33_48)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s34$1_49 BOOL) (mem g_s35$1_50 BOOL) (mem g_s36$1_51 BOOL) (mem g_s37$1_52 BOOL)))
; PO group 0 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s4_5 g_s3_4))
(define-fun lh_2 () Bool (mem TRUE BOOL))
(define-fun lh_3 () Bool (mem g_s5_6 g_s3_4))
(define-fun lh_4 () Bool (= g_s5_6 g_s4_5))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= g_s35$1_50 TRUE))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= g_s37$1_52 TRUE))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s4_5 g_s3_4))
(define-fun lh_2 () Bool (mem FALSE BOOL))
(define-fun lh_3 () Bool (mem g_s5_6 g_s3_4))
(define-fun lh_4 () Bool (= g_s5_6 g_s4_5))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= g_s35$1_50 FALSE))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= g_s37$1_52 FALSE))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
