...
(define-fun |def_abs| () Bool (and (mem g_s33_48 BOOL) (mem g_s34_49 BOOL)))
(define-fun |def_inv| () Bool (and (= g_s33_48 g_s35$1_50) (= g_s33_48 g_s36$1_51) (= g_s34_49 g_s37$1_52) (= g_s34_49 g_s38$1_53)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s35$1_50 BOOL) (mem g_s36$1_51 BOOL) (mem g_s37$1_52 BOOL) (mem g_s38$1_53 BOOL)))
; PO group 0 
(push 1)
...
(define-fun lh_1 () Bool (mem g_s40_54 g_s0_1))
(define-fun lh_2 () Bool (mem g_s4_5 g_s3_4))
(define-fun lh_3 () Bool (mem FALSE BOOL))
(define-fun lh_4 () Bool (= g_s40_54 g_s1_2))
(define-fun lh_5 () Bool (mem g_s5_6 g_s3_4))
(define-fun lh_6 () Bool (= g_s5_6 g_s4_5))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= FALSE g_s36$1_51))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)