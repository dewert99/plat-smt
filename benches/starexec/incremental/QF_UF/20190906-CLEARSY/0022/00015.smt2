...
(define-fun |def_inv| () Bool (and (mem g_s46_61 BOOL) (mem g_s47_62 g_s0_1) (mem g_s48_63 g_s6_7) (mem g_s49_64 BOOL) (mem g_s50_65 BOOL) (mem g_s51_66 BOOL) (mem g_s52_67 BOOL)))
(define-fun |def_ass| () Bool (and (|<i| e20 g_s25_38) (|>i| (idiv (|*i| (|*i| e27 g_s17_18) e24) g_s25_38) e68)))
...
; PO 1 in group 0
(push 1)
(assert (not (|>i| (idiv (|*i| (|*i| e27 g_s17_18) e24) g_s25_38) e68)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (|<i| e20 g_s25_38)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_seext|)
(assert |def_inv|)
(define-fun lh_1 () Bool (|<i| e20 g_s25_38))
; PO 1 in group 1
(assert (not (=> lh_1 (not (= g_s25_38 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)