...
(define-fun |def_inv| () Bool (and (mem g_s33_48 BOOL) (mem g_s34_49 g_s0_1) (mem g_s35_50 BOOL) (mem g_s36_51 BOOL) (subset g_s37_52 g_s15_16) (mem g_s38_53 BOOL)))
(define-fun |def_ass| () Bool  (|>=i| (|-i| g_s21_29 g_s22_30) g_s16_17))
...
(assert |def_inv|)
; PO 1 in group 0
(assert (not (|>=i| (|-i| g_s21_29 g_s22_30) g_s16_17)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
