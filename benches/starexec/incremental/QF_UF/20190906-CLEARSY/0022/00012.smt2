...
(define-fun |def_mchcst| () Bool  (mem g_s33_48 NAT1))
(define-fun |def_aprp| () Bool true)
(define-fun |def_abs| () Bool (and (mem g_s34_49 BOOL) (mem g_s35_50 NAT) (=> (= g_s34_49 FALSE) (= g_s35_50 e0)) (=> (= g_s34_49 TRUE) (|<=i| g_s35_50 g_s33_48))))
(define-fun |def_inv| () Bool (and (= g_s34_49 g_s34$1_51) (= g_s35_50 g_s35$1_52)))
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (= g_s34$1_51 TRUE))
(define-fun lh_2 () Bool (|>=i| g_s35$1_52 g_s25_38))
(define-fun lh_3 () Bool (|<i| g_s35$1_52 g_s25_38))
; PO 1 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|-i| g_s35$1_52 g_s25_38) INT))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (|-i| g_s35$1_52 g_s25_38) NAT))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (= (|-i| g_s35$1_52 g_s25_38) e0))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)