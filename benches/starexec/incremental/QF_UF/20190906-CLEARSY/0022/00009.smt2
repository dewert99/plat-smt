...
(define-fun |def_abs| () Bool (and (mem g_s33_48 BOOL) (mem g_s34_49 g_s9_10) (mem g_s35_50 g_s9_10) (mem g_s36_51 g_s9_10) (mem g_s37_52 g_s9_10) (mem g_s38_53 BOOL) (mem g_s39_54 BOOL) (mem g_s40_55 BOOL) (mem g_s41_56 BOOL) (mem g_s42_57 BOOL) (mem g_s43_58 BOOL) (mem g_s44_59 BOOL) (mem g_s45_60 BOOL)))
(define-fun |def_inv| () Bool (and (= g_s38_53 TRUE) (= g_s39_54 TRUE) (= g_s40_55 TRUE) (= g_s41_56 TRUE) (= g_s42_57 FALSE) (= g_s43_58 FALSE) (= g_s44_59 FALSE) (= g_s45_60 FALSE)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s47$1_62 g_s47_61))
(define-fun lh_1 () Bool (mem g_s48_63 g_s3_4))
(define-fun lh_2 () Bool (mem g_s49_64 g_s12_13))
(define-fun lh_3 () Bool (=> (= g_s49_64 g_s14_15) (= g_s19_26 e27)))
(define-fun lh_4 () Bool (= g_s48_63 g_s4_5))
(define-fun lh_5 () Bool (= g_s49_64 g_s13_14))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= TRUE g_s38_53))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(define-fun lh_5 () Bool (= g_s49_64 g_s13_14))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= FALSE g_s42_57))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)