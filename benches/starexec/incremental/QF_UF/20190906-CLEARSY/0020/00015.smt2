...
; PO 1 in group 0
(push 1)
(assert (not (mem e25 NAT)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem e26 NAT)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem e27 NAT)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (|<i| e25 e17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (|<i| e27 MaxInt)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (|<=i| e11 e25)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 0
(push 1)
(assert (not (|<=i| e11 e26)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 0
(push 1)
(assert (not (|<=i| e11 e27)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 9 in group 0
(push 1)
(assert (not (|<=i| e21 e25)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 0
(push 1)
(assert (not (|<=i| e26 e17)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 0
(push 1)
(assert (not (|<=i| (|+i| e25 e26) e22)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 0
(push 1)
(assert (not (|<=i| (|+i| (|+i| e25 e26) e26) e23)))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)