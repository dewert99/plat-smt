...
(declare-fun g_s139_149 () U)
(declare-fun g_s139$1_148 () U)
(declare-fun g_s14_15 () U)
(declare-fun g_s140_151 () U)
(declare-fun g_s140$1_150 () U)
(declare-fun g_s140$2_152 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s124_126 g_s59_60) (mem g_s125_127 g_s62_63) (mem g_s126_128 g_s59_60) (mem g_s127_129 g_s59_60) (mem g_s128_130 (|+->| g_s53_54 g_s63_64)) (mem g_s129_131 g_s3_4) (mem g_s130_132 g_s6_7) (mem g_s131_133 BOOL) (mem g_s132_134 BOOL)))
(define-fun |def_inv| () Bool (and (= g_s124_126 g_s124$1_135) (= g_s125_127 g_s125$1_136) (= g_s126_128 g_s126$1_137) (= g_s127_129 g_s127$1_138) (= g_s128_130 g_s128$1_139) (= g_s129_131 g_s129$1_140) (= g_s130_132 g_s130$1_141) (= g_s131_133 g_s131$1_142) (= g_s132_134 g_s132$1_143) (mem g_s124$1_135 g_s59_60) (mem g_s125$1_136 g_s62_63) (mem g_s126$1_137 g_s59_60) (mem g_s127$1_138 g_s59_60) (mem g_s128$1_139 (|+->| g_s53_54 g_s63_64)) (mem g_s129$1_140 g_s3_4) (mem g_s130$1_141 g_s6_7) (mem g_s131$1_142 BOOL) (mem g_s132$1_143 BOOL)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (mem empty (|+->| g_s53_54 g_s63_64))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s136_144 g_s0_1))
(assert (mem g_s136_144 g_s41_42))
(assert (= g_s136_144 g_s67_68))
(assert (mem g_s136_144 g_s0_1))
(assert (mem g_s136_144 g_s41_42))
(assert (= g_s136_144 g_s67_68))
(define-fun lh_1 () Bool (= g_s131$1_142 TRUE))
(define-fun lh_2 () Bool (= g_s132$1_143 TRUE))
(define-fun lh_3 () Bool (mem g_s129$1_140 g_s4_5))
(define-fun lh_4 () Bool (mem g_s130$1_141 g_s7_8))
(define-fun lh_5 () Bool (mem g_s129$2_145 g_s4_5))
(define-fun lh_6 () Bool (mem g_s130$2_146 g_s7_8))
(define-fun lh_7 () Bool (= (mapplet g_s129$2_145 g_s130$2_146) (apply g_s17_18 (mapplet (mapplet (mapplet g_s129$1_140 g_s130$1_141) g_s93_95) g_s94_96))))
(define-fun lh_8 () Bool (not (and (= g_s131$1_142 TRUE) (= g_s132$1_143 TRUE))))
(define-fun lh_9 () Bool (= g_s123_125 TRUE))
(define-fun lh_10 () Bool (not (and (mem g_s120_122 g_s4_5) (mem g_s121_123 g_s7_8))))
(define-fun lh_11 () Bool (not (mem (mapplet g_s129$1_140 g_s130$1_141) (apply g_s20_21 (mapplet (mapplet g_s91_93 g_s92_94) g_s84_85)))))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_3 lh_4 lh_8 lh_9 lh_10 lh_11) (mem empty (|+->| g_s53_54 g_s63_64)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s130$2_146 g_s6_7))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s129$2_145 g_s3_4))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s138_147 g_s2_3))
(assert (mem g_s138_147 g_s53_54))
(assert (= g_s139_149 g_s139$1_148))
(assert (= g_s140_151 g_s140$1_150))
(assert (mem g_s138_147 g_s2_3))
(assert (mem g_s138_147 g_s53_54))
(define-fun lh_1 () Bool (mem g_s138_147 (dom g_s128$1_139)))
(define-fun lh_2 () Bool (mem g_s140$2_152 g_s62_63))
(define-fun lh_3 () Bool (= g_s140$2_152 (apply g_s128$1_139 g_s138_147)))
(define-fun lh_4 () Bool (mem g_s138_147 (dom g_s128_130)))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s128_130 g_s138_147) g_s62_63))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (bool (mem g_s138_147 (dom g_s128_130))) (bool (mem g_s138_147 (dom g_s128$1_139)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (apply g_s128_130 g_s138_147) g_s140$2_152))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_5 () Bool (mem g_s129$2_145 g_s4_5))
(define-fun lh_6 () Bool (mem g_s130$2_146 g_s7_8))
(define-fun lh_7 () Bool (not (and (= g_s131$1_142 TRUE) (= g_s132$1_143 TRUE))))
(define-fun lh_8 () Bool (= g_s123_125 TRUE))
(define-fun lh_9 () Bool (mem g_s120_122 g_s4_5))
(define-fun lh_10 () Bool (mem g_s121_123 g_s7_8))
(define-fun lh_11 () Bool (not (mem (mapplet g_s120_122 g_s121_123) (apply g_s20_21 (mapplet (mapplet g_s91_93 g_s92_94) g_s84_85)))))
(define-fun lh_12 () Bool (not (and (mem g_s120_122 g_s4_5) (mem g_s121_123 g_s7_8))))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_7 lh_8 lh_9 lh_10) (mem g_s20_21 (|+->| (dom g_s20_21) (ran g_s20_21))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_7 lh_8 lh_9 lh_10) (mem (mapplet (mapplet g_s91_93 g_s92_94) g_s84_85) (dom g_s20_21)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 3
(push 1)
(assert (not (=> (and lh_3 lh_4 lh_7 lh_8 lh_12) (mem g_s20_21 (|+->| (dom g_s20_21) (ran g_s20_21))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 3
(push 1)
(assert (not (=> (and lh_3 lh_4 lh_7 lh_8 lh_12) (mem (mapplet (mapplet g_s91_93 g_s92_94) g_s84_85) (dom g_s20_21)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem g_s17_18 (|+->| (dom g_s17_18) (ran g_s17_18))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (mapplet (mapplet (mapplet g_s129$1_140 g_s130$1_141) g_s93_95) g_s94_96) (dom g_s17_18)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 3
(push 1)
(assert (not (=> (and lh_3 lh_4 lh_7 lh_8 lh_9 lh_10 lh_11) (mem g_s20_21 (|+->| (dom g_s20_21) (ran g_s20_21))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 3
(push 1)
(assert (not (=> (and lh_3 lh_4 lh_7 lh_8 lh_9 lh_10 lh_11) (mem (mapplet (mapplet g_s91_93 g_s92_94) g_s84_85) (dom g_s20_21)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
