...
(define-fun |def_inv| () Bool (and (mem g_s51_53 BOOL) (subset g_s52_54 g_s15_17) (mem g_s53_55 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s57_56 g_s7_8))
(define-fun lh_1 () Bool (mem g_s58$1_57 NAT))
(define-fun lh_2 () Bool (mem g_s52$1_58 (POW g_s15_17)))
(define-fun lh_3 () Bool (mem g_s53$1_59 BOOL))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3) (subset g_s52$1_58 g_s15_17))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)