...
(declare-fun g_s87_85 () U)
(declare-fun g_s89_86 () U)
(declare-fun g_s9_10 () U)
(declare-fun g_s92_87 () U)
(declare-fun g_s99$1_88 () U)
; Defines
...
(define-fun |def_inv| () Bool (and (mem g_s80_81 (|-->| g_s71_72 NATURAL)) (mem g_s81_82 (|-->| g_s71_72 NATURAL)) (mem g_s82_83 (|+->| (interval e0 g_s26_27) g_s71_72)) (mem g_s83_84 (|+->| (interval e0 g_s26_27) NATURAL))))
...
; PO 1 in group 0
(push 1)
(assert (not (mem empty (|+->| (interval e0 g_s26_27) NATURAL))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem empty (|+->| (interval e0 g_s26_27) g_s71_72))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s71_72 (SET e0)) (|-->| g_s71_72 NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s87_85 e0) (|<=i| g_s87_85 g_s26_27)))
; PO 1 in group 1
(assert (not (mem (domain_subtraction (SET g_s87_85) g_s82_83) (|+->| (interval e0 g_s26_27) g_s71_72))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_ass|)
(assert (and (|>=i| g_s87_85 e0) (|<=i| g_s87_85 g_s26_27)))
(assert (mem g_s89_86 g_s0_1))
(assert (mem g_s89_86 g_s71_72))
; PO 1 in group 2
(assert (not (mem (|<+| g_s82_83 (SET (mapplet g_s87_85 g_s89_86))) (|+->| (interval e0 g_s26_27) g_s71_72))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (and (|>=i| g_s87_85 e0) (|<=i| g_s87_85 g_s26_27)))
; PO 1 in group 3
(assert (not (mem (domain_subtraction (SET g_s87_85) g_s83_84) (|+->| (interval e0 g_s26_27) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_ass|)
(assert (and (|>=i| g_s87_85 e0) (|<=i| g_s87_85 g_s26_27)))
(assert (mem g_s92_87 NATURAL))
; PO 1 in group 4
(assert (not (mem (|<+| g_s83_84 (SET (mapplet g_s87_85 g_s92_87))) (|+->| (interval e0 g_s26_27) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (mem g_s89_86 g_s0_1))
(assert (mem g_s89_86 g_s71_72))
(assert (mem g_s87_85 NATURAL))
; PO 1 in group 5
(assert (not (mem (|<+| g_s80_81 (SET (mapplet g_s89_86 g_s87_85))) (|-->| g_s71_72 NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (mem g_s92_87 NATURAL))
; PO 1 in group 6
(assert (not (mem (|<+| g_s81_82 (SET (mapplet g_s89_86 g_s92_87))) (|-->| g_s71_72 NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
; PO 1 in group 7
(push 1)
(assert (not (mem g_s80_81 (|+->| (dom g_s80_81) (ran g_s80_81)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 7
(push 1)
(assert (not (mem g_s89_86 (dom g_s80_81))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 8
(push 1)
(assert (not (mem g_s89_86 (dom g_s81_82))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
(assert (and (|>=i| g_s87_85 e0) (|<=i| g_s87_85 g_s26_27)))
(define-fun lh_1 () Bool (mem g_s87_85 (dom g_s82_83)))
(define-fun lh_2 () Bool (mem g_s99$1_88 g_s0_1))
; PO 1 in group 9
...
(assert |def_ass|)
(assert (and (|>=i| g_s87_85 e0) (|<=i| g_s87_85 g_s26_27)))
(define-fun lh_1 () Bool (mem g_s87_85 (dom g_s83_84)))
; PO 1 in group 10
