...
(define-fun |def_inv| () Bool (and (subset g_s45_46 g_s15_16) (subset g_s46_47 g_s15_16) (= (binary_inter g_s45_46 g_s46_47) empty)))
...
; PO 3 in group 1
(push 1)
(assert (not (= (binary_inter g_s15_16 empty) empty)))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s51_48 g_s2_3))
(define-fun lh_2 () Bool (mem g_s51_48 g_s15_16))
(define-fun lh_3 () Bool (mem g_s51_48 g_s45_46))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (set_diff g_s45_46 (SET g_s51_48)) g_s15_16))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (subset (binary_union g_s46_47 (SET g_s51_48)) g_s15_16))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (= (binary_inter (set_diff g_s45_46 (SET g_s51_48)) (binary_union g_s46_47 (SET g_s51_48))) empty))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
