...
(declare-fun g_s101$1_105 () U)
(declare-fun g_s102_106 () U)
(declare-fun g_s108_107 () U)
(declare-fun g_s109$2_108 () U)
...
(declare-fun g_s92$1_98 () U)
(declare-fun g_s93_95 () U)
(declare-fun g_s93$1_99 () U)
(declare-fun g_s94_96 () U)
(declare-fun g_s94$1_100 () U)
(declare-fun g_s95_97 () U)
(declare-fun g_s95$1_101 () U)
(declare-fun g_s96$1_102 () U)
(declare-fun g_s97$1_103 () U)
(declare-fun e12 () U)
(declare-fun e11 () U)
; Defines
...
(define-fun |def_abs| () Bool (and (mem g_s92_94 (|-->| g_s83_85 NATURAL)) (mem g_s93_95 (|-->| g_s83_85 NATURAL)) (mem g_s94_96 (|+->| (interval e0 g_s38_40) g_s83_85)) (mem g_s95_97 (|+->| (interval e0 g_s38_40) NATURAL))))
(define-fun |def_inv| () Bool (and (= g_s92_94 g_s92$1_98) (= g_s93_95 g_s93$1_99) (= g_s94_96 g_s94$1_100) (= g_s95_97 g_s95$1_101) (mem g_s96$1_102 BOOL) (mem g_s97$1_103 NATURAL)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s92$1_98 (|-->| g_s83_85 NATURAL)) (mem g_s93$1_99 (|-->| g_s83_85 NATURAL)) (mem g_s94$1_100 (|+->| (interval e0 g_s38_40) g_s83_85)) (mem g_s95$1_101 (|+->| (interval e0 g_s38_40) NATURAL))))
; PO group 0 
(push 1)
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem (set_prod g_s83_85 (SET e0)) (|-->| g_s83_85 NATURAL)))
(define-fun lh_2 () Bool (mem empty (|+->| (interval e0 g_s38_40) g_s83_85)))
(define-fun lh_3 () Bool (mem empty (|+->| (interval e0 g_s38_40) NATURAL)))
; PO 1 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s101$1_105 g_s101_104))
(define-fun lh_1 () Bool (mem g_s102_106 g_s8_9))
(define-fun lh_2 () Bool (mem g_s102_106 g_s83_85))
; PO 1 in group 1
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s102_106 g_s8_9))
(assert (mem g_s102_106 g_s83_85))
(assert (mem g_s102_106 g_s8_9))
(assert (mem g_s102_106 g_s83_85))
; PO 1 in group 2
(push 1)
(assert (not (mem g_s93$1_99 (|+->| (dom g_s93$1_99) (ran g_s93$1_99)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (mem g_s102_106 (dom g_s93$1_99))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 3
(push 1)
(assert (not (mem g_s92$1_98 (|+->| (dom g_s92$1_98) (ran g_s92$1_98)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (mem g_s102_106 (dom g_s92$1_98))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (and (|>=i| g_s108_107 e0) (|<=i| g_s108_107 g_s38_40)))
(assert (and (|>=i| g_s108_107 e0) (|<=i| g_s108_107 g_s38_40)))
(define-fun lh_1 () Bool (mem g_s108_107 (dom g_s94$1_100)))
(define-fun lh_2 () Bool (mem g_s109$2_108 g_s8_9))
; PO 1 in group 4
(assert (not (=> (and lh_1 lh_2) (mem g_s94$1_100 (|+->| (dom g_s94$1_100) (ran g_s94$1_100))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (and (|>=i| g_s108_107 e0) (|<=i| g_s108_107 g_s38_40)))
(assert (and (|>=i| g_s108_107 e0) (|<=i| g_s108_107 g_s38_40)))
(define-fun lh_1 () Bool (mem g_s108_107 (dom g_s95$1_101)))
; PO 1 in group 5
(assert (not (=> lh_1 (mem g_s95$1_101 (|+->| (dom g_s95$1_101) (ran g_s95$1_101))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)