...
(define-fun |def_inv| () Bool (and (mem g_s45_46 g_s21_22) (mem g_s46_47 g_s24_25) (mem g_s47_48 g_s21_22) (mem g_s48_49 g_s21_22) (mem g_s49_50 (|+->| g_s15_16 g_s25_26))))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (mem empty (|+->| g_s15_16 g_s25_26))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s53_51 g_s0_1))
(assert (mem g_s53_51 g_s3_4))
(assert (= g_s53_51 g_s29_30))
; PO 1 in group 1
(assert (not (mem empty (|+->| g_s15_16 g_s25_26))))
(set-info :status unknown)
(check-sat)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s55_52 g_s2_3))
(assert (mem g_s55_52 g_s15_16))
(define-fun lh_1 () Bool (mem g_s55_52 (dom g_s49_50)))
(define-fun lh_2 () Bool (mem g_s56$1_53 g_s24_25))
; PO 1 in group 2
(assert (not (=> (and lh_1 lh_2) (mem g_s49_50 (|+->| (dom g_s49_50) (ran g_s49_50))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)