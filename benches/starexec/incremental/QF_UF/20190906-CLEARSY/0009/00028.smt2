...
; PO 1 in group 0
(push 1)
(assert (not (mem (set_prod g_s8_9 (SET g_s24_26)) (|-->| g_s8_9 g_s18_20))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (set_prod g_s8_9 (SET g_s41_43)) (|-->| g_s8_9 g_s11_12))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem (set_prod g_s8_9 (SET g_s26_28)) (|-->| g_s8_9 g_s21_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s55_54 g_s8_9))
(assert (mem g_s55_54 g_s31_33))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s55_54 (dom g_s46_48))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
...
; PO 2 in group 2
(push 1)
(assert (not (mem g_s55_54 (dom g_s47_49))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 3
(push 1)
(assert (not (mem g_s55_54 (dom g_s48_50))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 4
(push 1)
(assert (not (mem g_s55_54 (dom g_s49_51))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 5
(push 1)
(assert (not (mem g_s55_54 (dom g_s50_52))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 6
(push 1)
(assert (not (mem g_s55_54 (dom g_s51_53))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
