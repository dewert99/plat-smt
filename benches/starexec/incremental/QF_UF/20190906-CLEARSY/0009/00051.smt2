...
(declare-fun g_s50_48 () U)
(declare-fun g_s53_49 () U)
(declare-fun g_s54$1_50 () U)
...
(define-fun |def_seext| () Bool (and (mem g_s30_31 g_s21_22) (mem g_s31_32 g_s24_25) (mem g_s32_33 g_s21_22) (mem g_s33_34 g_s21_22) (mem g_s34_35 (|+->| g_s15_16 g_s25_26)) (mem g_s35_37 g_s36_36) (mem g_s37_38 g_s36_36) (mem g_s38_40 g_s39_39) (mem g_s40_42 g_s41_41) (mem g_s42_43 g_s39_39) (mem g_s43_44 g_s41_41) (mem g_s44_45 BOOL)))
(define-fun |def_lprp| () Bool true)
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool  (mem g_s45_46 (|+->| g_s2_3 g_s24_25)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (mem empty (|+->| g_s2_3 g_s24_25))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s49_47 g_s29_30))
(assert (mem g_s49_47 g_s0_1))
(assert (mem g_s49_47 g_s3_4))
(assert (mem g_s50_48 g_s2_3))
(assert (mem g_s50_48 g_s15_16))
; PO 1 in group 1
(assert (not (mem (domain_subtraction (SET g_s50_48) g_s45_46) (|+->| g_s2_3 g_s24_25))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (mem g_s50_48 g_s15_16))
; PO 1 in group 2
(assert (not (mem (|<+| (domain_subtraction (SET g_s50_48) g_s45_46) (domain_restriction (SET g_s50_48) g_s34_35)) (|+->| g_s2_3 g_s24_25))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s53_49 g_s2_3))
(assert (mem g_s53_49 g_s15_16))
(define-fun lh_1 () Bool (mem g_s53_49 (dom g_s45_46)))
(define-fun lh_2 () Bool (mem g_s54$1_50 g_s24_25))
; PO 1 in group 3
(assert (not (=> (and lh_1 lh_2) (mem g_s45_46 (|+->| (dom g_s45_46) (ran g_s45_46))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)