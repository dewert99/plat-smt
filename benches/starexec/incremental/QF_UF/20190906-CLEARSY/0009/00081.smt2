...
(declare-fun g_s52$1_60 () U)
(declare-fun g_s53_55 () U)
(declare-fun g_s53$1_61 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s51_53 BOOL) (subset g_s52_54 g_s15_17) (mem g_s53_55 BOOL) (subset g_s54_56 g_s15_17) (subset g_s55_57 g_s21_23)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s59_58 g_s7_8))
(define-fun lh_1 () Bool (mem g_s60$1_59 NAT))
(define-fun lh_2 () Bool (mem g_s52$1_60 (POW g_s15_17)))
(define-fun lh_3 () Bool (mem g_s53$1_61 BOOL))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3) (subset g_s52$1_60 g_s15_17))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s62_62 g_s8_9))
(assert (mem g_s62_62 g_s15_17))
(assert (mem g_s63_63 BOOL))
(define-fun lh_1 () Bool (= g_s63_63 TRUE))
; PO 1 in group 2
(assert (not (=> lh_1 (subset (binary_union g_s54_56 (SET g_s62_62)) g_s15_17))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s65_64 g_s9_10))
(assert (mem g_s65_64 g_s21_23))
(assert (mem g_s66_65 BOOL))
(define-fun lh_1 () Bool (= g_s66_65 TRUE))
; PO 1 in group 3
(assert (not (=> lh_1 (subset (binary_union g_s55_57 (SET g_s65_64)) g_s21_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)