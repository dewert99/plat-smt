...
(assert (mem g_s22_22 g_s9_10))
(define-fun lh_1 () Bool (mem g_s23$1_23 g_s0_1))
; PO 1 in group 0
(push 1)
...
; PO 2 in group 0
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s21_21 g_s22_22) (dom g_s13_14)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)