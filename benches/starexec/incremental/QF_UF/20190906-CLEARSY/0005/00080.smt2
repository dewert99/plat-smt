...
(define-fun |def_aprp| () Bool (and (= g_s13_19 e18) (= g_s14_21 e20) (= g_s15_23 e22) (= g_s16_25 e24) (mem g_s14_21 g_s4_4) (|<i| g_s14_21 g_s3_5) (mem g_s17_26 g_s4_4) (= g_s17_26 (|-i| g_s14_21 e27)) (mem g_s13_19 g_s4_4) (mem g_s18_28 g_s4_4) (|<i| g_s13_19 g_s3_5) (= g_s18_28 (|-i| g_s13_19 e27)) (mem g_s15_23 g_s6_6) (|<=i| g_s15_23 e29) (mem g_s16_25 g_s6_6) (|<=i| (|+i| g_s15_23 g_s16_25) e20) (|<=i| e30 g_s18_28) (|<=i| e20 g_s14_21)))
(define-fun |def_abs| () Bool true)
(define-fun |def_inv| () Bool true)
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool (and (= g_s18_28 e30) (= g_s13_19 e18) (= g_s17_26 e31) (= g_s14_21 e20) (= g_s15_23 e32) (= g_s16_25 e33)))
...
; PO 1 in group 0
(push 1)
(assert (not (mem e33 g_s6_6)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem e32 g_s6_6)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem e30 g_s4_4)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (mem e18 g_s4_4)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 0
(push 1)
(assert (not (mem e31 g_s4_4)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 0
(push 1)
(assert (not (mem e20 g_s4_4)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 0
...
; PO 9 in group 0
(push 1)
(assert (not (= e30 (|-i| e18 e27))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 10 in group 0
(push 1)
(assert (not (= e31 (|-i| e20 e27))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 11 in group 0
(push 1)
(assert (not (|<i| e18 g_s3_5)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 12 in group 0
(push 1)
(assert (not (|<i| e20 g_s3_5)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 13 in group 0
(push 1)
(assert (not (|<=i| e32 e29)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 14 in group 0
(push 1)
(assert (not (|<=i| e30 e30)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 15 in group 0
(push 1)
(assert (not (|<=i| e20 e20)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 16 in group 0
(push 1)
(assert (not (|<=i| (|+i| e32 e33) e20)))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)