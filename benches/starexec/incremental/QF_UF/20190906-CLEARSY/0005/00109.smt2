...
(define-fun |def_abs| () Bool (and (mem g_s93_111 INTEGER) (mem g_s94_112 INTEGER)))
(define-fun |def_inv| () Bool (and (mem g_s95$1_113 g_s10_10) (mem g_s96$1_114 g_s10_10) (=> (|<=i| g_s93_111 e0) (= g_s95$1_113 g_s28_33)) (=> (|>i| g_s93_111 e0) (= g_s95$1_113 (|+i| g_s28_33 g_s93_111))) (=> (|<=i| g_s94_112 e0) (= g_s96$1_114 g_s28_33)) (=> (|>i| g_s94_112 e0) (= g_s96$1_114 (|+i| g_s28_33 g_s94_112)))))
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (|<=i| g_s26_31 e0))
(define-fun lh_2 () Bool (|<=i| g_s27_32 e0))
; PO 1 in group 0
(push 1)
(assert (not (=> lh_1 (= g_s29_34 g_s28_33))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> lh_2 (= g_s30_35 g_s28_33))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (|<i| g_s28_33 g_s95$1_113))
(define-fun lh_2 () Bool (|<=i| (|-i| g_s93_111 e43) e0))
(define-fun lh_3 () Bool (|>i| (|-i| g_s93_111 e43) e0))
; PO 1 in group 1
(push 1)
(assert (not (=> lh_1 (mem (apply g_s81_88 (mapplet g_s95$1_113 e43)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (apply g_s81_88 (mapplet g_s95$1_113 e43)) g_s28_33))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_3) (= (apply g_s81_88 (mapplet g_s95$1_113 e43)) (|+i| g_s28_33 (|-i| g_s93_111 e43))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s102$2_117 BOOL))
; PO 1 in group 3
(assert (not (=> lh_1 (= (bool (|<=i| g_s95$1_113 g_s28_33)) (bool (|<=i| g_s93_111 e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (|<i| g_s28_33 g_s96$1_114))
(define-fun lh_2 () Bool (|<=i| (|-i| g_s94_112 e43) e0))
(define-fun lh_3 () Bool (|>i| (|-i| g_s94_112 e43) e0))
; PO 1 in group 4
(push 1)
(assert (not (=> lh_1 (mem (apply g_s81_88 (mapplet g_s96$1_114 e43)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (apply g_s81_88 (mapplet g_s96$1_114 e43)) g_s28_33))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_3) (= (apply g_s81_88 (mapplet g_s96$1_114 e43)) (|+i| g_s28_33 (|-i| g_s94_112 e43))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (|<=i| g_s27_32 e0))
; PO 1 in group 5
(assert (not (=> lh_1 (= g_s30_35 g_s28_33))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(define-fun lh_1 () Bool (mem g_s102$2_117 BOOL))
; PO 1 in group 6
(assert (not (=> lh_1 (= (bool (|<=i| g_s96$1_114 g_s28_33)) (bool (|<=i| g_s94_112 e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
; PO 1 in group 7
(push 1)
(assert (not (=> lh_1 (mem g_s81_88 (|+->| (dom g_s81_88) (ran g_s81_88))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 7
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s95$1_113 e43) (dom g_s81_88)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 8
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s96$1_114 e43) (dom g_s81_88)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
