...
(declare-fun g_s113$1_131 () U)
(declare-fun g_s117_132 () U)
(declare-fun g_s118$1_133 () U)
(declare-fun g_s12_12 () U)
(declare-fun g_s121_134 () U)
(declare-fun g_s121$1_135 () U)
(declare-fun g_s121$2_136 () U)
...
(define-fun |def_seext| () Bool (and (mem g_s93_111 g_s10_10) (mem g_s94_112 g_s10_10) (mem g_s95_113 g_s14_14) (or (= g_s95_113 e43) (= g_s95_113 e22)) (mem g_s96_114 g_s10_10) (mem g_s97_115 g_s10_10) (mem g_s98_116 g_s10_10) (mem g_s99_117 g_s10_10) (mem g_s100_118 g_s10_10) (mem g_s101_119 g_s10_10) (mem g_s102_121 (|-->| (interval e0 g_s103_120) g_s14_14)) (mem g_s104_122 g_s10_10) (mem g_s105_123 g_s10_10) (mem g_s106_124 g_s10_10) (mem g_s107_125 g_s10_10) (mem g_s108_126 g_s10_10) (mem g_s109_127 (|-->| (interval e0 e22) g_s14_14)) (mem g_s110_128 (|-->| (interval e0 e22) g_s14_14)) (mem g_s111_129 g_s12_12) (mem g_s18_23 (|+->| BOOL g_s14_14)) (mem g_s18_23 (|+->| BOOL g_s12_12)) (mem g_s18_23 (|+->| BOOL g_s10_10))))
(define-fun |def_mchcst| () Bool true)
(define-fun |def_aprp| () Bool true)
(define-fun |def_abs| () Bool (and (mem g_s112_130 INTEGER) (|<=i| g_s112_130 g_s21_26)))
(define-fun |def_inv| () Bool (and (mem g_s113$1_131 g_s10_10) (=> (|<=i| g_s112_130 e0) (= g_s113$1_131 g_s22_27)) (=> (|>i| g_s112_130 e0) (= g_s113$1_131 (|+i| g_s22_27 g_s112_130)))))
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (|<=i| g_s21_26 e0))
; PO 1 in group 0
(assert (not (=> lh_1 (= g_s23_28 g_s22_27))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s117_132 g_s12_12))
(define-fun lh_2 () Bool (mem g_s118$1_133 g_s10_10))
(define-fun lh_3 () Bool (|<i| (apply g_s80_87 (mapplet g_s22_27 g_s117_132)) g_s113$1_131))
(define-fun lh_4 () Bool (|<=i| (|-i| g_s112_130 g_s117_132) e0))
(define-fun lh_5 () Bool (|>i| (|-i| g_s112_130 g_s117_132) e0))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (apply g_s81_88 (mapplet g_s113$1_131 g_s117_132)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (apply g_s81_88 (mapplet g_s113$1_131 g_s117_132)) g_s22_27))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5) (= (apply g_s81_88 (mapplet g_s113$1_131 g_s117_132)) (|+i| g_s22_27 (|-i| g_s112_130 g_s117_132))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s121$1_135 g_s121_134))
(define-fun lh_1 () Bool (mem g_s121$2_136 BOOL))
; PO 1 in group 3
(assert (not (=> lh_1 (= (bool (|<=i| g_s113$1_131 g_s22_27)) (bool (|<=i| g_s112_130 e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s117_132 g_s12_12))
(define-fun lh_1 () Bool (mem g_s118$1_133 g_s10_10))
(define-fun lh_2 () Bool (|<i| (apply g_s80_87 (mapplet g_s22_27 g_s117_132)) g_s113$1_131))
; PO 1 in group 4
(push 1)
...
; PO 2 in group 4
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s22_27 g_s117_132) (dom g_s80_87)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
...
; PO 4 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (mapplet g_s113$1_131 g_s117_132) (dom g_s81_88)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
