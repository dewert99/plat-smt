...
(define-fun |def_inv| () Bool (and (mem g_s13_18 g_s5_9) (mem g_s13_18 g_s11_15) (mem g_s14_19 g_s5_9) (mem g_s14_19 g_s11_15) (mem g_s15_20 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s15_20 TRUE))
(define-fun lh_1 () Bool (mem g_s13$1_21 g_s11_15))
(define-fun lh_2 () Bool (mem g_s14$1_22 g_s11_15))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s14$1_22 g_s5_9))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s13$1_21 g_s5_9))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
