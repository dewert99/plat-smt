...
(declare-fun g_s104$1_118 () U)
(declare-fun g_s104$2_119 () U)
...
(declare-fun g_s95$1_113 () U)
(declare-fun g_s96$1_114 () U)
(declare-fun e102 () U)
(declare-fun e103 () U)
(declare-fun e104 () U)
(declare-fun e96 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s93_111 INTEGER) (|<=i| g_s93_111 g_s41_48) (mem g_s94_112 NATURAL)))
(define-fun |def_inv| () Bool (and (mem g_s95$1_113 g_s10_10) (mem g_s96$1_114 g_s10_10) (=> (|<=i| g_s94_112 g_s42_49) (= g_s94_112 (|-i| g_s96$1_114 g_s39_46))) (=> (|>=i| g_s94_112 g_s42_49) (= g_s96$1_114 g_s43_50)) (=> (|<=i| g_s93_111 e0) (= g_s95$1_113 g_s39_46)) (=> (|>i| g_s93_111 e0) (= g_s95$1_113 (|+i| g_s39_46 g_s93_111)))))
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (|<=i| e0 g_s42_49))
(define-fun lh_2 () Bool (|>=i| e0 g_s42_49))
(define-fun lh_3 () Bool (|>i| e0 e0))
; PO 1 in group 0
(push 1)
(assert (not (=> lh_1 (= e0 (|-i| g_s39_46 g_s39_46)))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (=> lh_2 (= g_s39_46 g_s43_50))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (=> lh_3 (= g_s39_46 (|+i| g_s39_46 e0)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s100_115 g_s12_12))
(define-fun lh_2 () Bool (mem g_s101$1_116 g_s10_10))
(define-fun lh_3 () Bool (|<i| (apply g_s80_87 (mapplet g_s39_46 g_s100_115)) g_s95$1_113))
(define-fun lh_4 () Bool (|<=i| (|-i| g_s93_111 g_s100_115) e0))
(define-fun lh_5 () Bool (|>i| (|-i| g_s93_111 g_s100_115) e0))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (apply g_s81_88 (mapplet g_s95$1_113 g_s100_115)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (apply g_s81_88 (mapplet g_s95$1_113 g_s100_115)) g_s39_46))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_5) (= (apply g_s81_88 (mapplet g_s95$1_113 g_s100_115)) (|+i| g_s39_46 (|-i| g_s93_111 g_s100_115))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (|<=i| g_s41_48 e0))
; PO 1 in group 2
(assert (not (=> lh_1 (= g_s40_47 g_s39_46))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s104$1_118 g_s104_117))
(define-fun lh_1 () Bool (mem g_s104$2_119 BOOL))
; PO 1 in group 3
(assert (not (=> lh_1 (= (bool (|<=i| g_s95$1_113 g_s39_46)) (bool (|<=i| g_s93_111 e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (|<i| g_s96$1_114 g_s43_50))
(define-fun lh_2 () Bool (|<=i| (|+i| g_s94_112 e43) g_s42_49))
(define-fun lh_3 () Bool (|>=i| (|+i| g_s94_112 e43) g_s42_49))
; PO 1 in group 4
(push 1)
(assert (not (=> lh_1 (mem (apply g_s80_87 (mapplet g_s96$1_114 e43)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_3) (= (apply g_s80_87 (mapplet g_s96$1_114 e43)) g_s43_50))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (= (|+i| g_s94_112 e43) (|-i| (apply g_s80_87 (mapplet g_s96$1_114 e43)) g_s39_46)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s104$2_119 BOOL))
; PO 1 in group 5
(assert (not (=> lh_1 (= (bool (|<=i| g_s43_50 g_s96$1_114)) (bool (|>=i| g_s94_112 g_s42_49))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s100_115 g_s12_12))
(define-fun lh_1 () Bool (mem g_s101$1_116 g_s10_10))
(define-fun lh_2 () Bool (|<i| (apply g_s80_87 (mapplet g_s39_46 g_s100_115)) g_s95$1_113))
; PO 1 in group 7
(push 1)
(assert (not (=> lh_1 (mem g_s80_87 (|+->| (dom g_s80_87) (ran g_s80_87))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 7
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s39_46 g_s100_115) (dom g_s80_87)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 7
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s81_88 (|+->| (dom g_s81_88) (ran g_s81_88))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 7
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (mapplet g_s95$1_113 g_s100_115) (dom g_s81_88)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 2 in group 8
(push 1)
(assert (not (=> lh_1 (mem (mapplet g_s96$1_114 e43) (dom g_s80_87)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
