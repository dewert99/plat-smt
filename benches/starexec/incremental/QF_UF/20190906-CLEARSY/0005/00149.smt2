...
(declare-fun g_s176$1_199 () U)
(declare-fun g_s177$1_200 () U)
(declare-fun g_s18_19 () U)
(declare-fun g_s182_201 () U)
(declare-fun g_s182$1_202 () U)
(declare-fun g_s183$1_203 () U)
(declare-fun g_s185_204 () U)
(declare-fun g_s186$1_205 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s170_193 INTEGER) (mem g_s171_194 INTEGER) (mem g_s172_195 INTEGER) (mem g_s173_196 INTEGER)))
(define-fun |def_inv| () Bool (and (mem g_s174$1_197 g_s10_10) (mem g_s175$1_198 g_s10_10) (mem g_s176$1_199 g_s10_10) (mem g_s177$1_200 g_s10_10) (= g_s174$1_197 (|+i| (imax (SET (mapplet g_s171_194 e0))) g_s126_148)) (= g_s175$1_198 (|+i| (imax (SET (mapplet g_s170_193 e0))) g_s126_148)) (= g_s176$1_199 (|+i| (imax (SET (mapplet g_s172_195 e0))) g_s126_148)) (= g_s177$1_200 (|+i| (imax (SET (mapplet g_s173_196 e0))) g_s126_148))))
...
; PO 1 in group 0
(push 1)
(assert (not (mem g_s126_148 g_s10_10)))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (= g_s130_152 (|+i| (imax (SET (mapplet g_s121_143 e0))) g_s126_148))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (= g_s133_155 (|+i| (imax (SET (mapplet g_s125_147 e0))) g_s126_148))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (= g_s126_148 (|+i| (imax (SET (mapplet e0 e0))) g_s126_148))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s182$1_202 g_s182_201))
(define-fun lh_1 () Bool (mem g_s182_201 BOOL))
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
; PO 1 in group 2
(assert (not (=> (and lh_1 lh_2) (= (bool (|<=i| g_s177$1_200 g_s134_156)) (bool (|<=i| g_s173_196 (|-i| g_s125_147 g_s124_146)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s185_204 g_s25_25))
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_3 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_4 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s177$1_200))
; PO 1 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s85_92 (mapplet g_s177$1_200 g_s185_204)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (apply g_s85_92 (mapplet g_s177$1_200 g_s185_204)) (|+i| (imax (SET (mapplet (|-i| g_s173_196 g_s185_204) e0))) g_s126_148)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_ass|)
; PO 1 in group 4
(assert (not (= g_s131_153 (|+i| (imax (SET (mapplet g_s122_144 e0))) g_s126_148))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
; PO 1 in group 5
(assert (not (=> (and lh_1 lh_2) (= (bool (|<=i| g_s174$1_197 g_s126_148)) (bool (|<=i| g_s171_194 e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_3 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_4 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s174$1_197))
; PO 1 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s85_92 (mapplet g_s174$1_197 g_s185_204)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 6
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (apply g_s85_92 (mapplet g_s174$1_197 g_s185_204)) (|+i| (imax (SET (mapplet (|-i| g_s171_194 g_s185_204) e0))) g_s126_148)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_3 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_4 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s175$1_198))
; PO 1 in group 7
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s85_92 (mapplet g_s175$1_198 g_s185_204)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 7
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (apply g_s85_92 (mapplet g_s175$1_198 g_s185_204)) (|+i| (imax (SET (mapplet (|-i| g_s170_193 g_s185_204) e0))) g_s126_148)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_3 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_4 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s176$1_199))
; PO 1 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (apply g_s85_92 (mapplet g_s176$1_199 g_s185_204)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 8
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (= (apply g_s85_92 (mapplet g_s176$1_199 g_s185_204)) (|+i| (imax (SET (mapplet (|-i| g_s172_195 g_s185_204) e0))) g_s126_148)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
; PO 1 in group 10
(assert (not (=> (and lh_1 lh_2) (= (bool (|<=i| g_s176$1_199 g_s126_148)) (bool (|<=i| g_s172_195 e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 11 
...
(define-fun lh_2 () Bool (mem g_s183$1_203 g_s10_10))
; PO 1 in group 11
(assert (not (=> (and lh_1 lh_2) (= (bool (|<=i| g_s175$1_198 g_s126_148)) (bool (|<=i| g_s170_193 e0))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 12 
...
(assert |def_ass|)
; PO 1 in group 12
(assert (not (= g_s132_154 (|+i| (imax (SET (mapplet g_s123_145 e0))) g_s126_148))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 13 
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (mem g_s174$1_197 g_s10_10))
(define-fun lh_2 () Bool (mem g_s175$1_198 g_s10_10))
(define-fun lh_3 () Bool (mem g_s176$1_199 g_s10_10))
(define-fun lh_4 () Bool (mem g_s177$1_200 g_s10_10))
(define-fun lh_5 () Bool (= g_s174$1_197 (|+i| (imax (SET (mapplet g_s171_194 e0))) g_s126_148)))
(define-fun lh_6 () Bool (= g_s175$1_198 (|+i| (imax (SET (mapplet g_s170_193 e0))) g_s126_148)))
(define-fun lh_7 () Bool (= g_s176$1_199 (|+i| (imax (SET (mapplet g_s172_195 e0))) g_s126_148)))
; PO 1 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (not (= (SET (mapplet g_s171_194 e0)) empty)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4) (mem (binary_inter (SET (mapplet g_s171_194 e0)) NATURAL) (FIN NATURAL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (not (= (SET (mapplet g_s170_193 e0)) empty)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (mem (binary_inter (SET (mapplet g_s170_193 e0)) NATURAL) (FIN NATURAL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 5 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (not (= (SET (mapplet g_s172_195 e0)) empty)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 6 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem (binary_inter (SET (mapplet g_s172_195 e0)) NATURAL) (FIN NATURAL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 7 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (not (= (SET (mapplet g_s173_196 e0)) empty)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 8 in group 13
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem (binary_inter (SET (mapplet g_s173_196 e0)) NATURAL) (FIN NATURAL)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s185_204 g_s25_25))
(define-fun lh_1 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_2 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_3 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s177$1_200))
; PO 1 in group 14
(push 1)
...
; PO 2 in group 14
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (mapplet g_s126_148 g_s185_204) (dom g_s84_91)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 14
...
; PO 4 in group 14
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (mapplet g_s177$1_200 g_s185_204) (dom g_s85_92)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_2 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_3 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s174$1_197))
; PO 1 in group 15
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s84_91 (|+->| (dom g_s84_91) (ran g_s84_91))))))
(set-info :status unknown)
...
; PO 4 in group 15
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (mapplet g_s174$1_197 g_s185_204) (dom g_s85_92)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_2 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_3 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s175$1_198))
; PO 1 in group 16
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s84_91 (|+->| (dom g_s84_91) (ran g_s84_91))))))
(set-info :status unknown)
...
; PO 4 in group 16
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (mapplet g_s175$1_198 g_s185_204) (dom g_s85_92)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_1 () Bool (mem g_s183$1_203 g_s10_10))
(define-fun lh_2 () Bool (mem g_s186$1_205 g_s10_10))
(define-fun lh_3 () Bool (|<i| (apply g_s84_91 (mapplet g_s126_148 g_s185_204)) g_s176$1_199))
; PO 1 in group 17
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s84_91 (|+->| (dom g_s84_91) (ran g_s84_91))))))
(set-info :status unknown)
...
; PO 4 in group 17
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (mem (mapplet g_s176$1_199 g_s185_204) (dom g_s85_92)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
