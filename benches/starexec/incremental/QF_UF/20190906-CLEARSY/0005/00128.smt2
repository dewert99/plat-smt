...
(define-fun |def_inv| () Bool (and (mem g_s13_18 BOOL) (mem g_s14_19 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s16_20 g_s8_8))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s13_18 (dom g_s12_17))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
; PO 1 in group 1
(push 1)
(assert (not (mem g_s14_19 (dom g_s12_17))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
