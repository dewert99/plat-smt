...
(declare-fun g_s115$1_135 () U)
(declare-fun g_s116_134 () U)
(declare-fun g_s117$1_136 () U)
(declare-fun g_s12_12 () U)
(declare-fun g_s121_137 () U)
(declare-fun g_s122$1_138 () U)
(declare-fun g_s123$1_139 () U)
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s21_26 INTEGER))
(define-fun lh_2 () Bool (|<=i| g_s21_26 g_s21_26))
; PO 1 in group 0
...
(assert |def_inv|)
(assert |def_ass|)
(define-fun lh_1 () Bool (mem g_s121_137 g_s12_12))
(define-fun lh_2 () Bool (mem g_s122$1_138 g_s10_10))
(define-fun lh_3 () Bool (mem g_s123$1_139 BOOL))
(define-fun lh_4 () Bool (|<=i| g_s97_115 g_s31_36))
(define-fun lh_5 () Bool (= (bool (|<=i| (|-i| g_s115$1_135 g_s121_137) e0)) TRUE))
(define-fun lh_6 () Bool (|<=i| (|-i| g_s115$1_135 g_s121_137) e0))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (= g_s15_16 (apply g_s18_23 TRUE)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (= g_s115_133 g_s115$1_135))
(define-fun lh_2 () Bool (mem g_s117$1_136 g_s14_14))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem g_s116_134 (dom g_s18_23)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
