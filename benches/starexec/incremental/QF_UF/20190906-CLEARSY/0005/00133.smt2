...
(declare-fun g_s112$1_131 () U)
(declare-fun g_s113$1_132 () U)
(declare-fun g_s117_133 () U)
(declare-fun g_s119_134 () U)
(declare-fun g_s119$1_135 () U)
...
(define-fun |def_abs| () Bool  (mem g_s112_130 BOOL))
(define-fun |def_inv| () Bool (and (= g_s112_130 g_s112$1_131) (mem g_s113$1_132 INTEGER) (|<=i| g_s113$1_132 g_s21_26) (mem g_s112$1_131 BOOL)))
...
(assert |def_seext|)
; PO 1 in group 0
(assert (not (|<=i| g_s21_26 g_s21_26)))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s117_133 g_s12_12))
(define-fun lh_1 () Bool (|<=i| g_s93_111 g_s31_36))
(define-fun lh_2 () Bool (|<=i| (|-i| g_s113$1_132 g_s117_133) e0))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (or (= TRUE TRUE) (= TRUE TRUE)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (|<=i| (|-i| g_s113$1_132 g_s117_133) g_s21_26))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s119_134 g_s14_14))
(assert (= g_s119_134 g_s119$1_135))
; PO 1 in group 2
(assert (not (mem g_s119$1_135 g_s14_14)))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (mem g_s119_134 g_s14_14))
(assert (= g_s119_134 g_s119$1_135))
(assert (mem g_s119$1_135 g_s14_14))
; PO 1 in group 3
(assert (not (= (apply g_s18_23 g_s112_130) (apply g_s18_23 g_s112$1_131))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
; PO 1 in group 4
(push 1)
(assert (not (mem g_s112$1_131 (dom g_s18_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 4
