...
(define-fun |def_inv| () Bool (and (mem g_s98_116 BOOL) (mem g_s99_117 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s101_118 g_s14_14))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s98_116 (dom g_s18_23))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
...
; PO 1 in group 1
(push 1)
(assert (not (mem g_s99_117 (dom g_s18_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
