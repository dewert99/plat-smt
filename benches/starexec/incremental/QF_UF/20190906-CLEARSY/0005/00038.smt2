...
(declare-fun g_s276_304 () U)
(declare-fun g_s277_305 () U)
(declare-fun g_s278_306 () U)
(declare-fun g_s279_307 () U)
(declare-fun g_s28_29 () U)
(declare-fun g_s280_308 () U)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s291_318 g_s138_142))
(assert (and (|>=i| g_s291_318 e152) (|<=i| g_s291_318 g_s252_279)))
(assert (mem g_s292_319 g_s137_140))
; PO 1 in group 0
(push 1)
(assert (not (mem g_s291_318 (dom g_s286_314))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem g_s286_314 (|+->| (dom g_s286_314) (ran g_s286_314)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s295_320 g_s138_142))
(assert (and (|>=i| g_s295_320 e152) (|<=i| g_s295_320 g_s252_279)))
(assert (mem g_s292_319 g_s137_140))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s287_315 (|+->| (dom g_s287_315) (ran g_s287_315)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s295_320 (dom g_s287_315))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 2
(push 1)
(assert (not (mem g_s288_316 (|+->| (dom g_s288_316) (ran g_s288_316)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (mem g_s295_320 (dom g_s288_316))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
