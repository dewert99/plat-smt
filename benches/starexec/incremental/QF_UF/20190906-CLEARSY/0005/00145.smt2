...
(declare-fun g_s58$1_74 () U)
(declare-fun g_s58$2_81 () U)
(declare-fun g_s59_69 () U)
(declare-fun g_s59$1_75 () U)
(declare-fun g_s59$2_82 () U)
(declare-fun g_s6_12 () U)
(declare-fun g_s60_70 () U)
(declare-fun g_s60$1_76 () U)
(declare-fun g_s60$2_83 () U)
(declare-fun g_s61_71 () U)
(declare-fun g_s61$1_77 () U)
(declare-fun g_s61$2_84 () U)
(declare-fun g_s62_72 () U)
(declare-fun g_s62$1_78 () U)
(declare-fun g_s62$2_85 () U)
(declare-fun g_s63_73 () U)
(declare-fun g_s64_92 () U)
(declare-fun g_s65_93 () U)
(declare-fun g_s66$1_80 () U)
(declare-fun g_s66$2_86 () U)
(declare-fun g_s7_13 () U)
(declare-fun g_s70_88 () U)
(declare-fun g_s70$1_89 () U)
(declare-fun g_s71_90 () U)
...
(define-fun |def_abs| () Bool (and (mem g_s58_68 g_s1_4) (mem g_s59_69 g_s2_6) (mem g_s60_70 g_s0_2) (mem g_s61_71 g_s0_2) (mem g_s62_72 g_s2_6) (mem g_s63_73 (|-->| (interval e0 g_s4_9) (|-->| (interval e0 e67) g_s2_6)))))
(define-fun |def_inv| () Bool (and (= g_s58_68 g_s58$1_74) (= g_s59_69 g_s59$1_75) (= g_s60_70 g_s60$1_76) (= g_s61_71 g_s61$1_77) (= g_s62_72 g_s62$1_78) (= g_s63_73 e79)))
(define-fun |def_ass| () Bool true)
(define-fun |def_sets| () Bool true)
(define-fun |def_imlprp| () Bool true)
(define-fun |def_imprp| () Bool true)
(define-fun |def_imext| () Bool (and (mem g_s58$1_74 g_s1_4) (mem g_s59$1_75 g_s2_6) (mem g_s60$1_76 g_s0_2) (mem g_s61$1_77 g_s0_2) (mem g_s62$1_78 g_s2_6) (mem g_s66$1_80 (|-->| (set_prod (interval e0 g_s4_9) (interval e0 e67)) g_s2_6))))
; PO group 0 
(push 1)
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (mem g_s58$2_81 g_s1_4))
(define-fun lh_2 () Bool (mem g_s59$2_82 g_s2_6))
(define-fun lh_3 () Bool (mem g_s60$2_83 g_s0_2))
(define-fun lh_4 () Bool (mem g_s61$2_84 g_s0_2))
(define-fun lh_5 () Bool (mem g_s62$2_85 g_s2_6))
(define-fun lh_6 () Bool (mem g_s66$2_86 (|-->| (set_prod (interval e0 g_s4_9) (interval e0 e67)) g_s2_6)))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem e87 (|-->| (interval e0 g_s4_9) (|-->| (interval e0 e67) g_s2_6))))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (= g_s70$1_89 g_s70_88))
(define-fun lh_1 () Bool (mem g_s71_90 g_s2_6))
(define-fun lh_2 () Bool (and (|>=i| g_s71_90 e0) (|<=i| g_s71_90 g_s4_9)))
(define-fun lh_3 () Bool (mem g_s72_91 g_s2_6))
(define-fun lh_4 () Bool (and (|>=i| g_s72_91 e0) (|<=i| g_s72_91 e67)))
(define-fun lh_5 () Bool (mem g_s70_88 g_s2_6))
; PO 1 in group 1
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5) (= (apply g_s66$1_80 (mapplet g_s71_90 g_s72_91)) (apply (apply g_s63_73 g_s71_90) g_s72_91)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_seext|)
(assert |def_abs|)
(define-fun lh_1 () Bool (= g_s58_68 g_s58$1_74))
(define-fun lh_2 () Bool (= g_s59_69 g_s59$1_75))
(define-fun lh_3 () Bool (= g_s60_70 g_s60$1_76))
(define-fun lh_4 () Bool (= g_s61_71 g_s61$1_77))
(define-fun lh_5 () Bool (= g_s62_72 g_s62$1_78))
(define-fun lh_6 () Bool (and (|>=i| g_s64_92 e0) (|<=i| g_s64_92 g_s4_9)))
(define-fun lh_7 () Bool (and (|>=i| g_s65_93 e0) (|<=i| g_s65_93 e67)))
; PO 1 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem g_s66$1_80 (|+->| (dom g_s66$1_80) (ran g_s66$1_80))))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6 lh_7) (mem (mapplet g_s64_92 g_s65_93) (dom g_s66$1_80)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s71_90 g_s2_6))
(assert (and (|>=i| g_s71_90 e0) (|<=i| g_s71_90 g_s4_9)))
(assert (mem g_s72_91 g_s2_6))
(assert (and (|>=i| g_s72_91 e0) (|<=i| g_s72_91 e67)))
(assert (mem g_s70_88 g_s2_6))
(assert (mem g_s71_90 g_s2_6))
(assert (and (|>=i| g_s71_90 e0) (|<=i| g_s71_90 g_s4_9)))
(assert (mem g_s72_91 g_s2_6))
(assert (and (|>=i| g_s72_91 e0) (|<=i| g_s72_91 e67)))
; PO 1 in group 3
(push 1)
(assert (not (mem g_s66$1_80 (|+->| (dom g_s66$1_80) (ran g_s66$1_80)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 3
(push 1)
(assert (not (mem (mapplet g_s71_90 g_s72_91) (dom g_s66$1_80))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
