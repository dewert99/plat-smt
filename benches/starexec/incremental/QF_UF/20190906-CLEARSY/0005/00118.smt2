...
(define-fun |def_seext| () Bool (and (mem g_s13_18 NATURAL) (subset g_s14_19 (interval e0 g_s13_18)) (mem g_s15_20 BOOL) (mem g_s16_21 BOOL) (mem g_s12_17 (|+->| BOOL g_s8_8)) (mem g_s12_17 (|+->| BOOL g_s6_6)) (mem g_s12_17 (|+->| BOOL g_s4_4))))
(define-fun |def_lprp| () Bool true)
(define-fun |def_inprp| () Bool true)
(define-fun |def_inext| () Bool true)
(define-fun |def_inv| () Bool (and (mem g_s17_22 NATURAL) (mem g_s18_23 BOOL)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s22_24 g_s6_6))
(assert (mem g_s23_25 g_s4_4))
(assert (= g_s13_18 (|+i| g_s17_22 e26)))
(define-fun lh_1 () Bool (or (= g_s18$1_27 g_s18_23) (= g_s18$1_27 TRUE)))
; PO 1 in group 1
(assert (not (=> lh_1 (mem (|+i| g_s17_22 e26) NATURAL))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s25_28 g_s8_8))
; PO 1 in group 2
(push 1)
(assert (not (mem g_s18_23 (dom g_s12_17))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 2
