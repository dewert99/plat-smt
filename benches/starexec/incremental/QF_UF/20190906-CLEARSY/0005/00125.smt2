...
(define-fun |def_inv| () Bool (and (mem g_s94$1_112 g_s10_10) (=> (|<=i| g_s93_111 e0) (= g_s94$1_112 g_s34_40)) (=> (|>i| g_s93_111 e0) (= g_s94$1_112 (|+i| g_s34_40 g_s93_111)))))
...
(assert |def_imext|)
(assert |def_seext|)
(define-fun lh_1 () Bool (|<=i| g_s33_39 e0))
; PO 1 in group 0
(assert (not (=> lh_1 (= g_s35_41 g_s34_40))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(define-fun lh_2 () Bool (|<i| g_s34_40 g_s94$1_112))
(define-fun lh_3 () Bool (|<=i| (|-i| g_s93_111 e43) e0))
(define-fun lh_4 () Bool (|>i| (|-i| g_s93_111 e43) e0))
; PO 1 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (apply g_s81_88 (mapplet g_s94$1_112 e43)) g_s10_10))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_3) (= (apply g_s81_88 (mapplet g_s94$1_112 e43)) g_s34_40))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 1
(push 1)
(assert (not (=> (and lh_1 lh_2 lh_4) (= (apply g_s81_88 (mapplet g_s94$1_112 e43)) (|+i| g_s34_40 (|-i| g_s93_111 e43))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(define-fun lh_4 () Bool (|<=i| g_s94$1_112 g_s34_40))
; PO 1 in group 3
...
; PO 2 in group 4
(push 1)
(assert (not (=> (and lh_1 lh_2) (mem (mapplet g_s94$1_112 e43) (dom g_s81_88)))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
