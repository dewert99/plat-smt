...
(define-fun |def_inv| () Bool (and (mem g_s58_68 g_s1_4) (mem g_s59_69 g_s2_6) (mem g_s60_70 g_s0_2) (mem g_s61_71 g_s0_2) (mem g_s62_72 g_s2_6) (mem g_s63_73 (|-->| (interval e0 g_s4_9) (|-->| (interval e0 e67) g_s2_6)))))
...
; PO 2 in group 0
(push 1)
(assert (not (mem g_s65_74 (dom g_s63_73))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 3 in group 0
(push 1)
(assert (not (mem g_s66_75 (dom (apply g_s63_73 g_s65_74)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 4 in group 0
(push 1)
(assert (not (mem (apply g_s63_73 g_s65_74) (|+->| (dom (apply g_s63_73 g_s65_74)) (ran (apply g_s63_73 g_s65_74))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(exit)