...
(define-fun |def_inv| () Bool (and (mem g_s58_68 (|-->| (interval e0 g_s5_11) INTEGER)) (mem g_s59_69 (|-->| (interval e0 g_s5_11) INTEGER)) (mem g_s60_70 (|-->| (interval e0 g_s5_11) INTEGER))))
...
; PO 1 in group 0
(push 1)
(assert (not (mem (set_prod (interval e0 g_s5_11) (SET e0)) (|-->| (interval e0 g_s5_11) INTEGER))))
(check-sat)
(pop 1)
; PO 2 in group 0
(push 1)
(assert (not (mem (set_prod (interval e0 g_s5_11) (SET g_s24_33)) (|-->| (interval e0 g_s5_11) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s64_71 g_s2_6))
(assert (and (|>=i| g_s64_71 e0) (|<=i| g_s64_71 g_s5_11)))
; PO 1 in group 1
(assert (not (mem (|<+| g_s59_69 (SET (mapplet g_s64_71 g_s25_34))) (|-->| (interval e0 g_s5_11) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 2 
...
(assert (and (|>=i| g_s64_71 e0) (|<=i| g_s64_71 g_s5_11)))
; PO 1 in group 2
(assert (not (mem (|<+| g_s59_69 (SET (mapplet g_s64_71 (|-i| (apply g_s59_69 g_s64_71) e10)))) (|-->| (interval e0 g_s5_11) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 3 
...
(assert (and (|>=i| g_s64_71 e0) (|<=i| g_s64_71 g_s5_11)))
; PO 1 in group 3
(assert (not (mem (|<+| g_s58_68 (SET (mapplet g_s64_71 (|-i| (apply g_s58_68 g_s64_71) e10)))) (|-->| (interval e0 g_s5_11) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 4 
...
(assert (and (|>=i| g_s64_71 e0) (|<=i| g_s64_71 g_s5_11)))
; PO 1 in group 4
(assert (not (mem (|<+| g_s60_70 (SET (mapplet g_s64_71 (|-i| (apply g_s60_70 g_s64_71) e10)))) (|-->| (interval e0 g_s5_11) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 5 
...
(assert (and (|>=i| g_s64_71 e0) (|<=i| g_s64_71 g_s5_11)))
; PO 1 in group 5
(assert (not (mem (|<+| g_s58_68 (SET (mapplet g_s64_71 g_s24_33))) (|-->| (interval e0 g_s5_11) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 6 
...
(assert (and (|>=i| g_s64_71 e0) (|<=i| g_s64_71 g_s5_11)))
; PO 1 in group 6
(assert (not (mem (|<+| g_s60_70 (SET (mapplet g_s64_71 g_s26_35))) (|-->| (interval e0 g_s5_11) INTEGER))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO group 7 
...
(assert (mem g_s64_71 g_s2_6))
(assert (and (|>=i| g_s64_71 e0) (|<=i| g_s64_71 g_s5_11)))
(assert (mem g_s71_72 BOOL))
; PO 1 in group 7
(push 1)
(assert (not (mem g_s59_69 (|+->| (dom g_s59_69) (ran g_s59_69)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 7
(push 1)
(assert (not (mem g_s64_71 (dom g_s59_69))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 9
(push 1)
(assert (not (mem g_s58_68 (|+->| (dom g_s58_68) (ran g_s58_68)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 9
(push 1)
(assert (not (mem g_s64_71 (dom g_s58_68))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
...
; PO 1 in group 10
(push 1)
(assert (not (mem g_s60_70 (|+->| (dom g_s60_70) (ran g_s60_70)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 10
(push 1)
(assert (not (mem g_s64_71 (dom g_s60_70))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
