...
(declare-fun g_s15$1_29 () U)
(declare-fun g_s16_23 () U)
(declare-fun g_s16$1_30 () U)
(declare-fun g_s17_24 () U)
(declare-fun g_s17$1_31 () U)
(declare-fun g_s18_25 () U)
(declare-fun g_s18$1_32 () U)
(declare-fun g_s19_26 () U)
(declare-fun g_s19$1_33 () U)
...
(define-fun |def_inv| () Bool (and (mem g_s13_18 g_s5_9) (mem g_s14_20 (|-->| (interval e0 e19) g_s5_9)) (mem g_s15_21 g_s4_7) (mem g_s16_23 (|-->| (interval e0 e22) g_s5_9)) (mem g_s17_24 g_s4_7) (mem g_s18_25 g_s4_7) (mem g_s19_26 g_s5_9)))
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s21_27 g_s3_5))
(define-fun lh_1 () Bool (or (= g_s13$1_28 g_s13_18) (= g_s13$1_28 g_s9_13)))
(define-fun lh_2 () Bool (mem g_s15$1_29 g_s4_7))
(define-fun lh_3 () Bool (mem g_s16$1_30 (|-->| (interval e0 e22) g_s5_9)))
(define-fun lh_4 () Bool (mem g_s17$1_31 g_s4_7))
(define-fun lh_5 () Bool (mem g_s18$1_32 g_s4_7))
(define-fun lh_6 () Bool (mem g_s19$1_33 g_s5_9))
; PO 1 in group 0
(assert (not (=> (and lh_1 lh_2 lh_3 lh_4 lh_5 lh_6) (mem g_s13$1_28 g_s5_9))))
(check-sat)
(pop 1)
; PO group 1 
(push 1)
...
(assert |def_inv|)
(assert |def_ass|)
(assert (mem g_s24_34 g_s5_9))
(assert (mem g_s25_35 g_s5_9))
(assert (and (|>=i| g_s25_35 e0) (|<=i| g_s25_35 e22)))
(assert (= g_s13_18 g_s9_13))
; PO 1 in group 1
(push 1)
(assert (not (mem g_s16_23 (|+->| (dom g_s16_23) (ran g_s16_23)))))
(set-info :status unknown)
(check-sat)
(pop 1)
; PO 2 in group 1
(push 1)
(assert (not (mem g_s25_35 (dom g_s16_23))))
(set-info :status unknown)
(check-sat)
(pop 1)
(pop 1)
