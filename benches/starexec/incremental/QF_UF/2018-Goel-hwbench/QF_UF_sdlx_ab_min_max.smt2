...
(assert
 (let ((?x693 (Concat_32_1_31 RegRW z$n0s31)))
 (= z$1026 ?x693)))
(assert
...
(assert
 (let ((?x4507 (Concat_32_1_31 ALUoutRW z$n0s31)))
 (= z$1051 ?x4507)))
(assert
...
(assert
 (let ((?x2958 (Concat_32_1_31 MDRW z$n0s31)))
 (= z$1056 ?x2958)))
(assert
...
(assert
 (let ((?x3374 (Concat_32_1_31 BCRW z$n0s31)))
 (= z$1061 ?x3374)))
(assert
...
(assert
 ...
 (= z$981 $x3450)))
(assert
 (let (($x1043 (and z$1379 z$1068 prop z$1152 z$1184 z$1183 z$1276 z$1275 z$1359 z$1364 z$243 z$981)))
 (= z$1387 $x1043)))
(assert
 z$1387)
(assert
 (=> p$0 (= z$1224 (not ARW$next))))
(assert
 (=> p$0 z$1224))
(assert
 (=> p$1 (= z$1311 (and (distinct NextState$next z$n1s6) true))))
(assert
 (=> p$1 z$1311))
(assert
 (=> p$2 (= z$1312 (and (distinct NextState$next z$n2s6) true))))
(assert
 (=> p$2 z$1312))
(assert
 (=> p$3 (= z$1313 (and (distinct NextState$next z$n0s6) true))))
(assert
 (=> p$3 z$1313))
(check-sat)
(assert p$1)
