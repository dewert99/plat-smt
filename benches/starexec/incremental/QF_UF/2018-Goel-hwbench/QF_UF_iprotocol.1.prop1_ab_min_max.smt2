...
(declare-fun v_nakd_2$next () utt8)
...
(assert
 (let (($x149 (not a_wait_Consumer)))
 (= z$39 $x149)))
(assert
 (= z$2328 (and a_put_data z$39)))
(assert
 (= z$2330 (not z$2328)))
(assert
 (let (($x93 (not a_dataOk)))
 (= z$11 $x93)))
(assert
 (= z$2349 (and z$11 a_data_Receiver)))
(assert
 (= z$2351 (not z$2349)))
(assert
 (= z$49 (not dve_invalid)))
(assert
 (= z$2358 (and a_dataOk z$49)))
(assert
 (= z$2359 (not z$2358)))
(assert
 (= z$2367 (and a_put_data z$49)))
(assert
 (= z$2369 (not z$2367)))
(assert
 (= z$2376 (and z$11 a_data_Receiver z$49)))
(assert
 (= z$2377 (not z$2376)))
(assert
 (= z$2416 (and a_wait_Medium z$49)))
(assert
 (= z$2417 (not z$2416)))
(assert
 (= z$2471 (and a_data_Sender z$49)))
(assert
 (= z$2473 (not z$2471)))
(assert
 (= z$2481 (and (distinct v_recseq v_rack) true)))
(assert
 (= z$2544 (and z$39 z$2481)))
(assert
 (= z$2546 (not z$2544)))
(assert
 (= z$2630 (and (distinct v_rack v_sendseq) true)))
(assert
...
(assert
 (= z$2887 (and z$39 z$2184)))
(assert
 (= z$2888 (not z$2887)))
(assert
 (= z$2895 (and z$49 z$2184)))
(assert
 (= z$2896 (not z$2895)))
(assert
 (let (($x89 (not a_corr_data)))
 (= z$9 $x89)))
(assert
 (let (($x97 (not a_data_Medium)))
 (= z$13 $x97)))
(assert
 (= z$2980 (and z$9 z$11 z$13 z$2444)))
(assert
 (= z$2981 (not z$2980)))
(assert
 (let (($x109 (not a_nakOk)))
 (= z$19 $x109)))
(assert
 (= z$3136 (and z$19 a_nak_Sender)))
(assert
 (= z$3137 (not z$3136)))
(assert
 (let (($x78 (not a_ack_Medium)))
 (= z$3 $x78)))
(assert
 (let (($x113 (not a_nak_Medium)))
 (= z$21 $x113)))
(assert
 (= z$3144 (and z$3 z$9 z$21 a_wait_Medium z$49)))
(assert
 (= z$3145 (not z$3144)))
(assert
...
(assert
 ...
 (= z$931 ?x1644)))
(assert
 (let ((?x1648 (ite z$52 v_nakd_0 z$931)))
 (= z$933 ?x1648)))
(assert
...
(assert
 ...
 (= z$972 ?x1743)))
(assert
 (let ((?x1747 (ite z$80 v_nakd_0 z$972)))
 (= z$974 ?x1747)))
(assert
...
(assert
 (= z$1650 (not z$1649)))
(assert
 (let (($x82 (not a_ack_Sender)))
 (= z$5 $x82)))
(assert
 (let (($x3357 (not z$1643)))
 (= z$1651 $x3357)))
(assert
...
(assert
 (= z$1661 (not z$1660)))
(assert
 (let (($x117 (not a_nak_Sender)))
 (= z$23 $x117)))
(assert
 (let (($x3384 (not z$1654)))
 (= z$1662 $x3384)))
(assert
...
(assert
 (let (($x141 (not a_timeout)))
 (= z$35 $x141)))
(assert
 (let (($x3415 (not z$1665)))
 (= z$1675 $x3415)))
(assert
...
(assert
 (= z$1693 (not z$1692)))
(assert
 (let (($x129 (not a_put_data)))
 (= z$29 $x129)))
(assert
 (let (($x3460 (not z$1686)))
 (= z$1694 $x3460)))
(assert
...
(assert
 (= z$1726 (not z$1725)))
(assert
 (let (($x121 (not a_on_timeout)))
 (= z$25 $x121)))
(assert
 (let (($x3541 (not z$1719)))
 (= z$1727 $x3541)))
(assert
...
(assert
 (let (($x145 (not a_timeout_ack)))
 (= z$37 $x145)))
(assert
 (let (($x3572 (not z$1730)))
 (= z$1740 $x3572)))
(assert
...
(assert
 ...
 (= z$226 $x4710)))
(assert
 (= z$2441 (and (distinct v_recseq v_sendseq) true)))
(assert
 (= z$3179 (and z$49 z$2441 z$2736)))
(assert
 (= z$3180 (not z$3179)))
(assert
 (= z$3191 (and a_timeout z$49 z$2630 z$2641)))
(assert
 (= z$3192 (not z$3191)))
(assert
 (let (($x112785 (= z$n2s32 z$137)))
 (= z$406 $x112785)))
(assert
 (= z$407 (and z$406 f30)))
(assert
 (let (($x27207 (= z$n2s8 v_i)))
 (= z$409 $x27207)))
(assert
 (= z$410 (and z$409 f28)))
(assert
 (= z$412 (and z$409 f17)))
(assert
 (let ((?x58741 (ite z$412 z$n0s8 v_nakd_2)))
 (= z$414 ?x58741)))
(assert
 (let ((?x5542 (ite z$410 z$n1s8 z$414)))
 (= z$416 ?x5542)))
(assert
 (let ((?x68959 (ite z$407 z$n1s8 z$416)))
 (= z$418 ?x68959)))
(assert
 (let (($x59835 (= v_nakd_2$next z$418)))
 (= z$420 $x59835)))
(assert
 (= z$3310 (and a_corr_data z$49)))
(assert
 (= z$3312 (not z$3310)))
(assert
...
(assert
 ...
 (= z$241 $x12663)))
(assert
 (let (($x109120 (and z$2330 z$2351 z$2359 z$2369 z$2377 z$2417 z$2473 z$2546 z$2813 z$2880 z$2888 z$2896 z$2981 z$3137 z$3145 z$1970 prop z$195 z$292 z$324 z$331 z$371 z$422 z$434 z$441 z$455 z$467 z$534 z$555 z$570 z$589 z$597 z$605 z$613 z$660 z$667 z$677 z$687 z$697 z$732 z$743 z$751 z$758 z$768 z$776 z$784 z$1964 z$2018 z$898 z$2617 z$2731 z$2741 z$2762 z$2767 z$2794 z$2831 z$2830 z$2860 z$2865 z$2925 z$2928 z$2949 z$2948 z$2997 z$2996 z$226 z$231 z$3180 z$3192 z$420 z$3312 z$241)))
 (= z$3341 $x109120)))
(assert
 z$3341)
(assert
