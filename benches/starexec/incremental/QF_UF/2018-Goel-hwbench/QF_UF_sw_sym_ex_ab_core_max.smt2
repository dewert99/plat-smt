...
(assert
 (and (distinct z$n0s8 z$n2s8 z$n3s8 z$n5s8 z$n4s8 z$n255s8 z$n1s8) true))
(assert
 (= z$282 (and (distinct X z$n0s8) true)))
(assert
 (= z$355 (and (distinct X z$n3s8) true)))
(assert
 (= z$397 (and z$282 z$355)))
(assert
 (= z$398 (not z$397)))
(assert
 z$398)
(assert
 (= z$238 (and (distinct Y z$n4s8) true)))
(assert
 z$238)
(assert
...
(assert
 (= z$407 (and L5 LoneHot z$96 z$237)))
(assert
 (= z$408 (not z$407)))
(assert
 z$408)
...
(assert
 ...
 (= z$8 $x67)))
(assert
 (= z$607 (and z$2 z$4 z$6 z$8 z$96)))
(assert
 (= z$608 (not z$607)))
(assert
 z$608)
(assert
 ...
 (= z$10 $x71)))
(assert
 (= z$281 (and (distinct Y z$n0s8) true)))
(assert
 (= z$616 (and z$10 z$96 z$281)))
(assert
 (= z$617 (not z$616)))
(assert
 z$617)
(assert
 (= z$638 (and z$4 z$10 z$96 z$281)))
(assert
 (= z$639 (not z$638)))
(assert
 z$639)
(assert
 (= z$652 (and z$8 z$10 z$281)))
(assert
 (= z$653 (not z$652)))
(assert
 z$653)
(assert
 (= z$660 (and LoneHot z$96 z$281)))
(assert
 (= z$661 (not z$660)))
(assert
 z$661)
...
(assert
 ...
 (= z$243 $x367)))
(assert
 (= z$352 (and z$344 z$20 z$6 z$2 z$243 z$36 z$46)))
(assert
 (= z$353 (not z$352)))
(assert
 z$353)
(assert
 (let (($x2369 (= X$next Y$next)))
 (= z$412 $x2369)))
(assert
 (let (($x1435 (= Y$next z$n0s8)))
 (= z$308 $x1435)))
(assert
 (= z$428 (and z$412 z$308 z$243)))
(assert
 (= z$430 (not z$428)))
(assert
 z$430)
(assert
 ...
 (= z$296 $x510)))
(assert
 (= z$427 (and z$296 z$20 z$96)))
(assert
 (= z$429 (not z$427)))
(assert
 z$429)
(assert
 (let (($x2152 (= X$next z$n0s8)))
 (= z$337 $x2152)))
(assert
 (= z$245 (and (distinct Y$next z$n4s8) true)))
(assert
 (= z$506 (and z$337 z$243 z$245)))
(assert
 (= z$508 (not z$506)))
(assert
 z$508)
(assert
 ...
 (= z$18 $x80)))
(assert
 (= z$505 (and z$18 z$96 z$238)))
(assert
 (= z$507 (not z$505)))
(assert
 z$507)
(assert
 (let (($x2478 (= X$next z$n3s8)))
 (= z$343 $x2478)))
(assert
 (= z$561 (and L3 LoneHot z$24 z$26 z$36 z$343 z$243)))
(assert
 (= z$562 (not z$561)))
(assert
 z$562)
...
(assert
 (=> p$1 z$217))
(assert
 (=> p$2 (= z$227 (not L0$next))))
(assert
 (=> p$2 z$227))
(assert
 (=> p$3 (= z$228 (not L1$next))))
(assert
 (=> p$3 z$228))
(assert
 (=> p$4 (= z$230 (not L3$next))))
(assert
 (=> p$4 z$230))
(assert
 (=> p$5 (= z$232 (not L4$next))))
(assert
 (=> p$5 z$232))
(assert
 (=> p$6 (= z$233 (not L5$next))))
(assert
 (=> p$6 z$233))
(assert
 (=> p$7 (= z$234 (not L6$next))))
(assert
 (=> p$7 z$234))
(assert
 (let ((?x364 (Add_8_8_8 X$next Y$next)))
...
(assert
 (=> p$8 z$243))
(assert
 (let (($x388 (= z$245 (and (distinct Y$next z$n4s8) true))))
 (=> p$9 $x388)))
(assert
 (=> p$9 z$245))
(assert
 (=> p$10 (= z$271 (and (distinct Y$next z$n5s8) true))))
(assert
 (=> p$10 z$271))
(assert
 (=> p$11 (= z$284 (and (distinct Y$next z$n0s8) true))))
(assert
 (=> p$11 z$284))
(assert
 (=> p$12 (= z$472 (not LoneHot$next))))
(assert
 (=> p$12 z$472))
(assert
 (let (($x2478 (= X$next z$n3s8)))
 (let (($x2100 (= z$343 $x2478)))
 (=> p$13 $x2100))))
(assert
 (=> p$13 z$343))
(assert
 (=> p$14 (= z$300 (and (distinct Y$next z$n3s8) true))))
(assert
 (=> p$14 z$300))
(check-sat)
(assert p$0)
