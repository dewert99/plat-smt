...
(assert
 ...
 (= z$165 $x394)))
(assert
 (= z$4862 (and a_finished_customer_0 z$131 z$165)))
(assert
 (= z$4864 (not z$4862)))
(assert
 z$4864)
...
(assert
 (= z$4951 (and a_wait_scheduler_0 z$183)))
(assert
 (= z$4953 (not z$4951)))
(assert
 z$4953)
(assert
 (= z$27 (not a_init_state_scheduler_0)))
(assert
...
(assert
 ...
 (= z$105 $x274)))
(assert
 (= z$4959 (and a_finished_customer_0 z$27 z$29 z$105 z$183)))
(assert
 (= z$4960 (not z$4959)))
(assert
 z$4960)
(assert
 ...
 (= z$157 $x378)))
(assert
 (= z$4970 (and a_finished_customer_0 z$27 z$105 z$157 z$183)))
(assert
 (= z$4971 (not z$4970)))
(assert
 z$4971)
...
(assert
 z$4578)
(assert
 (= z$4983 (and a_finished_customer_0 z$27 z$29 z$105 z$165 z$183)))
(assert
 (= z$4984 (not z$4983)))
(assert
 z$4984)
(assert
 (= z$4998 (and z$9 a_init_state_scheduler_12 z$139 z$183)))
(assert
 (= z$4999 (not z$4998)))
(assert
 z$4999)
(assert
 (= z$5006 (and a_finished_customer_0 z$9 z$27 z$29 z$105 z$183)))
(assert
 (= z$5007 (not z$5006)))
(assert
 z$5007)
(assert
 z$27)
(assert
 (= z$5032 (and a_finished_customer_0 z$29 z$105 z$183)))
(assert
 (= z$5033 (not z$5032)))
(assert
 z$5033)
(assert
 (let ((?x12060 (ite f15 z$n1s8 v_done_scheduler_0)))
 (= z$243 ?x12060)))
(assert
 (let ((?x11147 (ite f21 z$n0s8 z$243)))
 (= z$245 ?x11147)))
(assert
 (let ((?x16239 (ite f22 z$n0s8 z$245)))
 (= z$247 ?x16239)))
(assert
 (let (($x14119 (= v_done_scheduler_0$next z$247)))
 (= z$249 $x14119)))
(assert
 z$249)
(assert
 (let ((?x16003 (ite f17 z$n1s8 v_ready_scheduler_0)))
 (= z$252 ?x16003)))
(assert
 (let ((?x10370 (ite f21 z$n0s8 z$252)))
 (= z$254 ?x10370)))
(assert
 (let ((?x15968 (ite f22 z$n0s8 z$254)))
 (= z$256 ?x15968)))
(assert
 (let (($x16740 (= v_ready_scheduler_0$next z$256)))
 (= z$258 $x16740)))
(assert
 z$258)
(assert
 (= z$5049 (and a_init_state_scheduler_12 z$113 z$139)))
(assert
 (= z$5050 (not z$5049)))
(assert
 z$5050)
(assert
 (= z$5057 (and a_init_state_scheduler_12 z$113 z$139 z$157 z$183)))
(assert
 (= z$5058 (not z$5057)))
(assert
 z$5058)
(assert
 (= z$5072 (and a_init_state_scheduler_12 z$139 a_wait_scheduler_0 z$183)))
(assert
 (= z$5073 (not z$5072)))
(assert
 z$5073)
(assert
 (let (($x10865 (and a_finished_customer_0 a_init_state_scheduler_12 z$105 z$139 z$157 z$183)))
 (= z$5080 $x10865)))
(assert
 (= z$5081 (not z$5080)))
(assert
...
(assert
 (=> p$6 a_finished_customer_12$next))
(assert
 (=> p$7 a_q_error_customer_12$next))
(assert
 (=> p$8 a_init_state_scheduler_12$next))
(assert
 (=> p$9 a_to_start_scheduler_12$next))
(assert
 (=> p$10 f00$next))
(assert
 (let (($x51 (= z$4574 (not dve_invalid$next))))
 (=> p$11 $x51)))
(assert
 (=> p$11 z$4574))
(assert
 (=> p$12 (= z$4595 (not a_running_customer_2$next))))
(assert
 (=> p$12 z$4595))
(assert
 (=> p$13 (= z$4594 (not a_finished_customer_2$next))))
(assert
 (=> p$13 z$4594))
(assert
 (=> p$14 (= z$4589 (not a_q_error_customer_1$next))))
(assert
 (=> p$14 z$4589))
(assert
 (=> p$15 (= z$4587 (not a_finished_customer_1$next))))
(assert
 (=> p$15 z$4587))
(assert
 (=> p$16 (= z$4592 (not a_started_scheduler_1$next))))
(assert
 (=> p$16 z$4592))
(assert
 (=> p$17 (= z$4591 (not a_to_start_scheduler_1$next))))
(assert
 (=> p$17 z$4591))
(assert
 (=> p$18 (= z$4588 (not a_running_customer_1$next))))
(assert
 (=> p$18 z$4588))
(assert
 (=> p$19 (= z$4596 (not a_q_error_customer_2$next))))
(assert
 (=> p$19 z$4596))
(assert
 (=> p$20 (= z$4597 (not a_init_state_scheduler_2$next))))
(assert
 (=> p$20 z$4597))
(assert
 (=> p$21 (= z$4585 (not a_init_state_scheduler_0$next))))
(assert
 (=> p$21 z$4585))
(assert
 (=> p$22 (= z$4598 (not a_to_start_scheduler_2$next))))
(assert
 (=> p$22 z$4598))
(assert
 (=> p$23 (= z$4599 (not a_started_scheduler_2$next))))
(assert
 (=> p$23 z$4599))
(assert
 (=> p$24 (= z$4600 (not a_wait_scheduler_2$next))))
(assert
 (=> p$24 z$4600))
(assert
 (=> p$25 (= z$4601 (not a_finished_customer_3$next))))
(assert
 (=> p$25 z$4601))
(assert
 (=> p$26 (= z$4602 (not a_running_customer_3$next))))
(assert
 (=> p$26 z$4602))
(assert
 (=> p$27 (= z$4603 (not a_q_error_customer_3$next))))
(assert
 (=> p$27 z$4603))
(assert
 (=> p$28 (= z$4604 (not a_init_state_scheduler_3$next))))
(assert
 (=> p$28 z$4604))
(assert
 (=> p$29 (= z$4605 (not a_to_start_scheduler_3$next))))
(assert
 (=> p$29 z$4605))
(assert
 (=> p$30 (= z$4606 (not a_started_scheduler_3$next))))
(assert
 (=> p$30 z$4606))
(assert
 (=> p$31 (= z$4607 (not a_wait_scheduler_3$next))))
(assert
 (=> p$31 z$4607))
(assert
 (=> p$32 (= z$4608 (not a_finished_customer_4$next))))
(assert
 (=> p$32 z$4608))
(assert
 (=> p$33 (= z$4609 (not a_running_customer_4$next))))
(assert
 (=> p$33 z$4609))
(assert
 (=> p$34 (= z$4610 (not a_q_error_customer_4$next))))
(assert
 (=> p$34 z$4610))
(assert
 (=> p$35 (= z$4611 (not a_init_state_scheduler_4$next))))
(assert
 (=> p$35 z$4611))
(assert
 (=> p$36 (= z$4612 (not a_to_start_scheduler_4$next))))
(assert
 (=> p$36 z$4612))
(assert
 (=> p$37 (= z$4613 (not a_started_scheduler_4$next))))
(assert
 (=> p$37 z$4613))
(assert
 (=> p$38 (= z$4614 (not a_wait_scheduler_4$next))))
(assert
 (=> p$38 z$4614))
(assert
 (=> p$39 (= z$4615 (not a_finished_customer_5$next))))
(assert
 (=> p$39 z$4615))
(assert
 (=> p$40 (= z$4616 (not a_running_customer_5$next))))
(assert
 (=> p$40 z$4616))
(assert
 (=> p$41 (= z$4617 (not a_q_error_customer_5$next))))
(assert
 (=> p$41 z$4617))
(assert
 (=> p$42 (= z$4618 (not a_init_state_scheduler_5$next))))
(assert
 (=> p$42 z$4618))
(assert
 (=> p$43 (= z$4619 (not a_to_start_scheduler_5$next))))
(assert
 (=> p$43 z$4619))
(assert
 (=> p$44 (= z$4620 (not a_started_scheduler_5$next))))
(assert
 (=> p$44 z$4620))
(assert
 (=> p$45 (= z$4621 (not a_wait_scheduler_5$next))))
(assert
 (=> p$45 z$4621))
(assert
 (=> p$46 (= z$4622 (not a_finished_customer_6$next))))
(assert
 (=> p$46 z$4622))
(assert
 (=> p$47 (= z$4623 (not a_running_customer_6$next))))
(assert
 (=> p$47 z$4623))
(assert
 (=> p$48 (= z$4624 (not a_q_error_customer_6$next))))
(assert
 (=> p$48 z$4624))
(assert
 (=> p$49 (= z$4625 (not a_init_state_scheduler_6$next))))
(assert
 (=> p$49 z$4625))
(assert
 (=> p$50 (= z$4626 (not a_to_start_scheduler_6$next))))
(assert
 (=> p$50 z$4626))
(assert
 (=> p$51 (= z$4627 (not a_started_scheduler_6$next))))
(assert
 (=> p$51 z$4627))
(assert
 (=> p$52 (= z$4628 (not a_wait_scheduler_6$next))))
(assert
 (=> p$52 z$4628))
(assert
 (=> p$53 (= z$4629 (not a_finished_customer_7$next))))
(assert
 (=> p$53 z$4629))
(assert
 (=> p$54 (= z$4630 (not a_running_customer_7$next))))
(assert
 (=> p$54 z$4630))
(assert
 (=> p$55 (= z$4631 (not a_q_error_customer_7$next))))
(assert
 (=> p$55 z$4631))
(assert
 (=> p$56 (= z$4632 (not a_init_state_scheduler_7$next))))
(assert
 (=> p$56 z$4632))
(assert
 (=> p$57 (= z$4633 (not a_to_start_scheduler_7$next))))
(assert
 (=> p$57 z$4633))
(assert
 (=> p$58 (= z$4634 (not a_started_scheduler_7$next))))
(assert
 (=> p$58 z$4634))
(assert
 (=> p$59 (= z$4635 (not a_wait_scheduler_7$next))))
(assert
 (=> p$59 z$4635))
(assert
 (=> p$60 (= z$4636 (not a_finished_customer_8$next))))
(assert
 (=> p$60 z$4636))
(assert
 (=> p$61 (= z$4637 (not a_running_customer_8$next))))
(assert
 (=> p$61 z$4637))
(assert
 (=> p$62 (= z$4638 (not a_q_error_customer_8$next))))
(assert
 (=> p$62 z$4638))
(assert
 (=> p$63 (= z$4639 (not a_init_state_scheduler_8$next))))
(assert
 (=> p$63 z$4639))
(assert
 (=> p$64 (= z$4640 (not a_to_start_scheduler_8$next))))
(assert
 (=> p$64 z$4640))
(assert
 (=> p$65 (= z$4641 (not a_started_scheduler_8$next))))
(assert
 (=> p$65 z$4641))
(assert
 (=> p$66 (= z$4642 (not a_wait_scheduler_8$next))))
(assert
 (=> p$66 z$4642))
(assert
 (=> p$67 (= z$4643 (not a_finished_customer_9$next))))
(assert
 (=> p$67 z$4643))
(assert
 (=> p$68 (= z$4644 (not a_running_customer_9$next))))
(assert
 (=> p$68 z$4644))
(assert
 (=> p$69 (= z$4645 (not a_q_error_customer_9$next))))
(assert
 (=> p$69 z$4645))
(assert
 (=> p$70 (= z$4646 (not a_init_state_scheduler_9$next))))
(assert
 (=> p$70 z$4646))
(assert
 (=> p$71 (= z$4647 (not a_to_start_scheduler_9$next))))
(assert
 (=> p$71 z$4647))
(assert
 (=> p$72 (= z$4648 (not a_started_scheduler_9$next))))
(assert
 (=> p$72 z$4648))
(assert
 (=> p$73 (= z$4649 (not a_wait_scheduler_9$next))))
(assert
 (=> p$73 z$4649))
(assert
 (=> p$74 (= z$4650 (not a_finished_customer_10$next))))
(assert
 (=> p$74 z$4650))
(assert
 (=> p$75 (= z$4651 (not a_running_customer_10$next))))
(assert
 (=> p$75 z$4651))
(assert
 (=> p$76 (= z$4652 (not a_q_error_customer_10$next))))
(assert
 (=> p$76 z$4652))
(assert
 (=> p$77 (= z$4653 (not a_init_state_scheduler_10$next))))
(assert
 (=> p$77 z$4653))
(assert
 (=> p$78 (= z$4654 (not a_to_start_scheduler_10$next))))
(assert
 (=> p$78 z$4654))
(assert
 (=> p$79 (= z$4655 (not a_started_scheduler_10$next))))
(assert
 (=> p$79 z$4655))
(assert
 (=> p$80 (= z$4656 (not a_wait_scheduler_10$next))))
(assert
 (=> p$80 z$4656))
(assert
 (=> p$81 (= z$4657 (not a_finished_customer_11$next))))
(assert
 (=> p$81 z$4657))
(assert
 (=> p$82 (= z$4658 (not a_running_customer_11$next))))
(assert
 (=> p$82 z$4658))
(assert
 (=> p$83 (= z$4659 (not a_q_error_customer_11$next))))
(assert
 (=> p$83 z$4659))
(assert
 (=> p$84 (= z$4660 (not a_init_state_scheduler_11$next))))
(assert
 (=> p$84 z$4660))
(assert
 (=> p$85 (= z$4661 (not a_to_start_scheduler_11$next))))
(assert
 (=> p$85 z$4661))
(assert
 (=> p$86 (= z$4662 (not a_started_scheduler_11$next))))
(assert
 (=> p$86 z$4662))
(assert
 (=> p$87 (= z$4663 (not a_wait_scheduler_11$next))))
(assert
 (=> p$87 z$4663))
(assert
 (=> p$88 (= z$4665 (not a_running_customer_12$next))))
(assert
 (=> p$88 z$4665))
(assert
 (=> p$89 (= z$4669 (not a_started_scheduler_12$next))))
(assert
 (=> p$89 z$4669))
(assert
 (=> p$90 (= z$4670 (not a_wait_scheduler_12$next))))
(assert
 (=> p$90 z$4670))
(assert
 (=> p$91 (= z$4778 (not f01$next))))
(assert
 (=> p$91 z$4778))
(assert
 (=> p$92 (= z$4779 (not f02$next))))
(assert
 (=> p$92 z$4779))
(assert
 (=> p$93 (= z$4780 (not f03$next))))
(assert
 (=> p$93 z$4780))
(assert
 (=> p$94 (= z$4781 (not f04$next))))
(assert
 (=> p$94 z$4781))
(assert
 (=> p$95 (= z$4782 (not f05$next))))
(assert
 (=> p$95 z$4782))
(assert
 (=> p$96 (= z$4783 (not f06$next))))
(assert
 (=> p$96 z$4783))
(assert
 (=> p$97 (= z$4784 (not f07$next))))
(assert
 (=> p$97 z$4784))
(assert
 (=> p$98 (= z$4785 (not f08$next))))
(assert
 (=> p$98 z$4785))
(assert
 (=> p$99 (= z$4786 (not f09$next))))
(assert
 (=> p$99 z$4786))
(assert
 (=> p$100 (= z$4787 (not f10$next))))
(assert
 (=> p$100 z$4787))
(assert
 (=> p$101 (= z$4788 (not f11$next))))
(assert
 (=> p$101 z$4788))
(assert
 (=> p$102 (= z$4789 (not f12$next))))
(assert
 (=> p$102 z$4789))
(assert
 (=> p$103 (= z$4790 (not f13$next))))
(assert
 (=> p$103 z$4790))
(assert
 (=> p$104 (= z$4792 (not f15$next))))
(assert
 (=> p$104 z$4792))
(assert
 (=> p$105 (= z$4793 (not f16$next))))
(assert
 (=> p$105 z$4793))
(assert
 (=> p$106 (= z$4794 (not f17$next))))
(assert
 (=> p$106 z$4794))
(assert
 (=> p$107 (= z$4795 (not f18$next))))
(assert
 (=> p$107 z$4795))
(assert
 (=> p$108 (= z$4796 (not f19$next))))
(assert
 (=> p$108 z$4796))
(assert
 (=> p$109 (= z$4797 (not f20$next))))
(assert
 (=> p$109 z$4797))
(assert
 (=> p$110 (= z$4798 (not f21$next))))
(assert
 (=> p$110 z$4798))
(assert
 (=> p$111 (= z$4799 (not f22$next))))
(assert
 (=> p$111 z$4799))
(assert
 (=> p$112 (= z$4800 (not f23$next))))
(assert
 (=> p$112 z$4800))
(assert
 (=> p$113 (= z$4801 (not f24$next))))
(assert
 (=> p$113 z$4801))
(assert
 (=> p$114 (= z$4802 (not f25$next))))
(assert
 (=> p$114 z$4802))
(assert
 (=> p$115 (= z$4803 (not f26$next))))
(assert
 (=> p$115 z$4803))
(assert
 (=> p$116 (= z$4804 (not f27$next))))
(assert
 (=> p$116 z$4804))
(assert
 (=> p$117 (= z$4805 (not f28$next))))
(assert
 (=> p$117 z$4805))
(assert
 (=> p$118 (= z$4806 (not f29$next))))
(assert
 (=> p$118 z$4806))
(assert
 (=> p$119 (= z$4807 (not f30$next))))
(assert
 (=> p$119 z$4807))
(assert
 (=> p$120 (= z$4808 (not f31$next))))
(assert
 (=> p$120 z$4808))
(assert
 (=> p$121 (= z$4809 (not f32$next))))
(assert
 (=> p$121 z$4809))
(assert
 (=> p$122 (= z$4810 (not f33$next))))
(assert
 (=> p$122 z$4810))
(assert
 (=> p$123 (= z$4811 (not f34$next))))
(assert
 (=> p$123 z$4811))
(assert
 (=> p$124 (= z$4812 (not f35$next))))
(assert
 (=> p$124 z$4812))
(assert
 (=> p$125 (= z$4813 (not f36$next))))
(assert
 (=> p$125 z$4813))
(assert
 (=> p$126 (= z$4814 (not f37$next))))
(assert
 (=> p$126 z$4814))
(assert
 (=> p$127 (= z$4815 (not f38$next))))
(assert
 (=> p$127 z$4815))
(assert
 (=> p$128 (= z$4816 (not f39$next))))
(assert
 (=> p$128 z$4816))
(assert
 (=> p$129 (= z$4817 (not f40$next))))
(assert
 (=> p$129 z$4817))
(assert
 (=> p$130 (= z$4818 (not f41$next))))
(assert
 (=> p$130 z$4818))
(assert
 (=> p$131 (= z$4819 (not f42$next))))
(assert
 (=> p$131 z$4819))
(assert
 (=> p$132 (= z$4820 (not f43$next))))
(assert
 (=> p$132 z$4820))
(assert
 (=> p$133 (= z$4821 (not f44$next))))
(assert
 (=> p$133 z$4821))
(assert
 (=> p$134 (= z$4822 (not f45$next))))
(assert
 (=> p$134 z$4822))
(assert
 (=> p$135 (= z$4823 (not f46$next))))
(assert
 (=> p$135 z$4823))
(assert
 (=> p$136 (= z$4824 (not f47$next))))
(assert
 (=> p$136 z$4824))
(assert
 (=> p$137 (= z$4825 (not f48$next))))
(assert
 (=> p$137 z$4825))
(assert
 (=> p$138 (= z$4826 (not f49$next))))
(assert
 (=> p$138 z$4826))
(assert
 (=> p$139 (= z$4827 (not f50$next))))
(assert
 (=> p$139 z$4827))
(assert
 (=> p$140 (= z$4828 (not f51$next))))
(assert
 (=> p$140 z$4828))
(assert
 (=> p$141 (= z$4829 (not f52$next))))
(assert
 (=> p$141 z$4829))
(assert
 (=> p$142 (= z$4830 (not f53$next))))
(assert
 (=> p$142 z$4830))
(assert
 (=> p$143 (= z$4831 (not f54$next))))
(assert
 (=> p$143 z$4831))
(assert
 (=> p$144 (= z$4832 (not f55$next))))
(assert
 (=> p$144 z$4832))
(assert
 (=> p$145 (= z$4833 (not f56$next))))
(assert
 (=> p$145 z$4833))
(assert
 (=> p$146 (= z$4834 (not f57$next))))
(assert
 (=> p$146 z$4834))
(assert
 (=> p$147 (= z$4835 (not f58$next))))
(assert
 (=> p$147 z$4835))
(assert
 (=> p$148 (= z$4836 (not f59$next))))
(assert
 (=> p$148 z$4836))
(assert
 (=> p$149 (= z$4837 (not f60$next))))
(assert
 (=> p$149 z$4837))
(assert
 (=> p$150 (= z$4838 (not f61$next))))
(assert
 (=> p$150 z$4838))
(assert
 (=> p$151 (= z$4839 (not f62$next))))
(assert
 (=> p$151 z$4839))
(assert
 (=> p$152 (= z$4840 (not f63$next))))
(assert
 (=> p$152 z$4840))
(assert
 (=> p$153 (= z$4841 (not f64$next))))
(assert
 (=> p$153 z$4841))
(assert
 (=> p$154 (= z$4842 (not f65$next))))
(assert
 (=> p$154 z$4842))
(assert
 (=> p$155 (= z$4843 (not f66$next))))
(assert
 (=> p$155 z$4843))
(assert
 (=> p$156 (= z$4844 (not f67$next))))
(assert
 (=> p$156 z$4844))
(assert
 (=> p$157 (= z$4845 (not f68$next))))
(assert
 (=> p$157 z$4845))
(assert
 (=> p$158 (= z$4846 (not f69$next))))
(assert
 (=> p$158 z$4846))
(assert
 (=> p$159 (= z$4847 (not f70$next))))
(assert
 (=> p$159 z$4847))
(assert
 (=> p$160 (= z$4848 (not f71$next))))
(assert
 (=> p$160 z$4848))
(assert
 (=> p$161 (= z$4849 (not f72$next))))
(assert
 (=> p$161 z$4849))
(assert
 (=> p$162 (= z$4850 (not f73$next))))
(assert
 (=> p$162 z$4850))
(assert
 (=> p$163 (= z$4851 (not f74$next))))
(assert
 (=> p$163 z$4851))
(assert
 (=> p$164 (= z$4852 (not f75$next))))
(assert
 (=> p$164 z$4852))
(assert
 (=> p$165 (= z$4853 (not f76$next))))
(assert
 (=> p$165 z$4853))
(assert
 (=> p$166 (= z$4854 (not f77$next))))
(assert
 (=> p$166 z$4854))
(assert
 (=> p$167 (= z$4855 (not a_q_error_customer_0$next))))
(assert
 (=> p$167 z$4855))
(assert
 (=> p$168 (= z$4856 (not a_started_scheduler_0$next))))
(assert
 (=> p$168 z$4856))
(assert
 (=> p$169 (= z$4942 (not f14$next))))
(assert
 (=> p$169 z$4942))
(assert
 (=> p$170 (= z$4943 (= z$n1s8 v_ready_scheduler_0$next))))
(assert
 (=> p$170 z$4943))
(assert
 (=> p$171 (= z$4944 (= z$n1s8 v_done_scheduler_0$next))))
(assert
 (=> p$171 z$4944))
(check-sat)
(assert p$0)
