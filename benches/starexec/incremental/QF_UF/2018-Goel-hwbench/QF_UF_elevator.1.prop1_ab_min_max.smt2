...
(assert
 ...
 (= z$17 $x113)))
(assert
 (let (($x121 (not a_waiting_Person_0)))
 (= z$21 $x121)))
(assert
 (= z$25 (not dve_invalid)))
(assert
 (let (($x6367 (and a_out_Person_0 a_out_Person_1 a_q_Elevator z$17 z$21 z$25)))
 (= z$1984 $x6367)))
(assert
 (= z$1985 (not z$1984)))
(assert
 (= z$2088 (and a_in_elevator_Person_0 a_out_Person_1 a_q_Elevator z$25)))
(assert
 (= z$2089 (not z$2088)))
(assert
 (let (($x125 (not a_waiting_Person_1)))
 (= z$23 $x125)))
(assert
 (= z$2114 (and a_out_Person_0 a_out_Person_1 a_q_Elevator z$23 z$25)))
(assert
 (= z$2115 (not z$2114)))
(assert
 (let (($x109 (not a_q_Servis)))
 (= z$15 $x109)))
(assert
 (= z$2043 (and a_out_Person_0 a_out_Person_1 z$15 z$25)))
(assert
 (= z$2044 (not z$2043)))
(assert
 (= z$2177 (and a_in_elevator_Person_0 a_q_Elevator z$15 z$25)))
(assert
 (= z$2178 (not z$2177)))
(assert
 (= z$2186 (and a_choose_next a_in_elevator_Person_0 a_out_Person_1 z$25)))
(assert
 (= z$2187 (not z$2186)))
(assert
 (= z$2213 (and a_choose_next a_in_elevator_Person_1 a_out_Person_0 z$25)))
(assert
 (= z$2214 (not z$2213)))
(assert
 (= z$2222 (and a_out_Person_1 a_q_Elevator z$15 z$25)))
(assert
 (= z$2223 (not z$2222)))
(assert
 (= z$2230 (and a_in_elevator_Person_1 a_out_Person_0 a_q_Elevator z$25)))
(assert
 (= z$2231 (not z$2230)))
(assert
...
(assert
 (let (($x86 (not a_in_elevator_Person_0)))
 (= z$3 $x86)))
(assert
 (= z$430 (and z$3 z$413)))
(assert
...
(assert
 (let (($x89 (not a_in_elevator_Person_1)))
 (= z$5 $x89)))
(assert
 (= z$484 (and z$5 z$467)))
(assert
...
(assert
 ...
 (= z$381 $x4136)))
(assert
 (let (($x4589 (and z$1985 z$2089 z$2115 z$2044 z$2178 z$2187 z$2214 z$2223 z$2231 z$1753 prop z$280 z$285 z$397 z$408 z$428 z$451 z$462 z$482 z$505 z$536 z$556 z$587 z$623 z$664 z$709 z$1745 z$1806 z$275 z$226 z$381)))
 (= z$2244 $x4589)))
(assert
 z$2244)
(assert
...
(assert
 (=> p$4 z$1800))
(assert
 (=> p$5 (= z$1825 (not a_q_Servis$next))))
(assert
 (=> p$5 z$1825))
(assert
 (=> p$6 (= z$1826 (not a_r$next))))
(assert
 (=> p$6 z$1826))
(assert
 (=> p$7 (= z$1938 (not a_transporting$next))))
(assert
 (=> p$7 z$1938))
(check-sat)
(assert p$3)
