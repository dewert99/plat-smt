...
(assert
 (= z$240 (and z$238 L10)))
(assert
 (= z$242 (or z$236 z$240)))
(assert
 (= z$244 (= LoneHot$next z$242)))
(assert
 z$244)
(assert
 (let (($x42 (not L10$next)))
 (= z$257 $x42)))
(assert
...
(assert
 (=> p$3 z$257))
(assert
 (=> p$4 (= z$271 (not L3$next))))
(assert
 (=> p$4 z$271))
(assert
 (=> p$5 (= z$272 (not L4$next))))
(assert
 (=> p$5 z$272))
(assert
 (=> p$6 (= z$275 (not L5$next))))
(assert
 (=> p$6 z$275))
(assert
 (=> p$7 (= z$276 (not L6$next))))
(assert
 (=> p$7 z$276))
(assert
 (=> p$8 (= z$277 (not L7$next))))
(assert
 (=> p$8 z$277))
(assert
 (=> p$9 (= z$278 (not L8$next))))
(assert
 (=> p$9 z$278))
(assert
 (=> p$10 (= z$279 (not L9$next))))
(assert
 (=> p$10 z$279))
(assert
 (=> p$11 (= z$280 (= S$next z$n2s32))))
(assert
 (=> p$11 z$280))
(check-sat)
(assert p$0)
