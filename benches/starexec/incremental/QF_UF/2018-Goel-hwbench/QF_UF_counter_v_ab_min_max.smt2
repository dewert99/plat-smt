...
(assert
 ...
 (= z$1258 $x1889)))
(assert
 (= z$1265 (and z$1258 z$37 z$13)))
(assert
 (= z$1266 (not z$1265)))
(assert
 (= z$1279 (and (distinct X$next z$n12s4) true)))
(assert
 (= z$1303 (and en z$13 z$1114 z$1279)))
(assert
 (= z$1304 (not z$1303)))
(assert
 (let (($x1777 (and z$57 z$1174 z$17 prop z$13 z$28 z$45 z$44 z$78 z$124 z$152 z$208 z$237 z$303 z$333 z$399 z$430 z$502 z$534 z$612 z$645 z$729 z$763 z$853 z$888 z$984 z$1020 z$1122 z$1159 z$1266 z$1304)))
 (= z$1314 $x1777)))
(assert
 z$1314)
(assert
 (=> p$0 (= z$47 (and (distinct X$next z$n1s4) true))))
(assert
 (=> p$0 z$47))
(assert
...
(assert
 (=> p$10 z$1135))
(assert
 (let (($x2656 (= z$1279 (and (distinct X$next z$n12s4) true))))
 (=> p$11 $x2656)))
(assert
 (=> p$11 z$1279))
(check-sat)
