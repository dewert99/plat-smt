...
(declare-fun v_floor_queue_2_0$next () utt8)
...
(assert
 z$25)
(assert
 (let (($x128 (= v_at_floor_Person_0 z$n0s8)))
 (= z$28 $x128)))
(assert
 z$28)
(assert
 (let (($x132 (= v_at_floor_Person_1 z$n0s8)))
 (= z$30 $x132)))
(assert
 z$30)
(assert
 (let (($x136 (= v_caller z$n0s8)))
 (= z$32 $x136)))
(assert
 z$32)
(assert
...
(assert
 z$36)
(assert
 (let (($x148 (= v_floor_queue_0_0 z$n0s8)))
 (= z$38 $x148)))
(assert
 z$38)
(assert
 (let (($x152 (= v_floor_queue_0_1 z$n0s8)))
 (= z$40 $x152)))
(assert
 z$40)
(assert
...
(assert
 z$42)
(assert
 (let (($x160 (= v_floor_queue_1_0 z$n0s8)))
 (= z$44 $x160)))
(assert
 z$44)
(assert
 (let (($x164 (= v_floor_queue_1_1 z$n0s8)))
 (= z$46 $x164)))
(assert
 z$46)
(assert
...
(assert
 z$48)
(assert
 (let (($x172 (= v_floor_queue_2_0 z$n0s8)))
 (= z$50 $x172)))
(assert
 z$50)
(assert
 (let (($x176 (= v_floor_queue_2_1 z$n0s8)))
 (= z$52 $x176)))
(assert
 z$52)
(assert
...
(assert
 z$54)
(assert
 (let (($x184 (= v_floor_queue_3_0 z$n0s8)))
 (= z$56 $x184)))
(assert
 z$56)
(assert
 (let (($x188 (= v_floor_queue_3_1 z$n0s8)))
 (= z$58 $x188)))
(assert
 z$58)
(assert
...
(assert
 (= z$144 (and f02 z$54)))
(assert
 (let ((?x5966 (ite z$144 v_caller v_floor_queue_2_0)))
 (= z$146 ?x5966)))
(assert
 (let ((?x5124 (ite f16 v_floor_queue_2_1 z$146)))
 (= z$148 ?x5124)))
(assert
 (let (($x3956 (= v_floor_queue_2_0$next z$148)))
 (= z$150 $x3956)))
(assert
 z$150)
(assert
...
(assert
 z$185)
(assert
 (let ((?x3428 (Concat_32_8_24 v_floor_queue_3_act z$n0s24)))
 (= z$196 ?x3428)))
(assert
 (let ((?x5287 (Sub_32_32_32 z$196 z$n1s32)))
 (= z$198 ?x5287)))
(assert
 (let ((?x5758 (Extract_8_7_0_32 z$198)))
 (= z$200 ?x5758)))
(assert
 (let ((?x4496 (Add_32_32_32 z$n1s32 z$196)))
 (= z$202 ?x4496)))
(assert
 (let ((?x3678 (Extract_8_7_0_32 z$202)))
 (= z$204 ?x3678)))
(assert
 (let ((?x4007 (ite f03 z$204 v_floor_queue_3_act)))
 (= z$206 ?x4007)))
(assert
 (let ((?x5991 (ite f17 z$200 z$206)))
 (= z$208 ?x5991)))
(assert
 (let (($x5262 (= v_floor_queue_3_act$next z$208)))
 (= z$210 $x5262)))
(assert
 z$210)
(assert
...
(assert
 z$244)
(assert
 (let ((?x4879 (ite f20 v_at_floor_Person_0 v_floor)))
 (= z$248 ?x4879)))
(assert
 (let ((?x4104 (ite f26 v_at_floor_Person_1 z$248)))
 (= z$250 ?x4104)))
(assert
 (let (($x4628 (= v_floor$next z$250)))
 (= z$252 $x4628)))
(assert
 z$252)
(assert
...
(assert
 (=> p$5 z$1559))
(assert
 (=> p$6 (= z$2022 (and (distinct v_floor_queue_3_act$next z$n1s8) true))))
(assert
 (=> p$6 z$2022))
(assert
 (=> p$7 (= z$1580 (not a_waiting_Person_0$next))))
(assert
 (=> p$7 z$1580))
(assert
 (=> p$8 (= z$1581 (not a_waiting_Person_1$next))))
(assert
 (=> p$8 z$1581))
(assert
 (=> p$9 (= z$1584 (not a_move_next$next))))
(assert
 (=> p$9 z$1584))
(assert
 (=> p$10 (= z$1585 (not a_q_Elevator$next))))
(assert
 (=> p$10 z$1585))
(assert
 (=> p$11 (= z$1648 (not f25$next))))
(assert
 (=> p$11 z$1648))
(assert
 (=> p$12 (= z$1649 (not f31$next))))
(assert
 (=> p$12 z$1649))
(assert
 (=> p$13 (= z$1650 (not f00$next))))
(assert
 (=> p$13 z$1650))
(assert
 (=> p$14 (= z$1651 (not f01$next))))
(assert
 (=> p$14 z$1651))
(assert
 (=> p$15 (= z$1653 (not f03$next))))
(assert
 (=> p$15 z$1653))
(assert
 (=> p$16 (= z$1654 (not f04$next))))
(assert
 (=> p$16 z$1654))
(assert
 (=> p$17 (= z$1655 (not f05$next))))
(assert
 (=> p$17 z$1655))
(assert
 (=> p$18 (= z$1656 (not f06$next))))
(assert
 (=> p$18 z$1656))
(assert
 (=> p$19 (= z$1657 (not f07$next))))
(assert
 (=> p$19 z$1657))
(assert
 (=> p$20 (= z$1658 (not f08$next))))
(assert
 (=> p$20 z$1658))
(assert
 (=> p$21 (= z$1659 (not f09$next))))
(assert
 (=> p$21 z$1659))
(assert
 (=> p$22 (= z$1660 (not f10$next))))
(assert
 (=> p$22 z$1660))
(assert
 (=> p$23 (= z$1661 (not f11$next))))
(assert
 (=> p$23 z$1661))
(assert
 (=> p$24 (= z$1662 (not f12$next))))
(assert
 (=> p$24 z$1662))
(assert
 (=> p$25 (= z$1663 (not f13$next))))
(assert
 (=> p$25 z$1663))
(assert
 (=> p$26 (= z$1664 (not f14$next))))
(assert
 (=> p$26 z$1664))
(assert
 (=> p$27 (= z$1665 (not f15$next))))
(assert
 (=> p$27 z$1665))
(assert
 (=> p$28 (= z$1666 (not f16$next))))
(assert
 (=> p$28 z$1666))
(assert
 (=> p$29 (= z$1667 (not f17$next))))
(assert
 (=> p$29 z$1667))
(assert
 (=> p$30 (= z$1668 (not f18$next))))
(assert
 (=> p$30 z$1668))
(assert
 (=> p$31 (= z$1669 (not f19$next))))
(assert
 (=> p$31 z$1669))
(assert
 (=> p$32 (= z$1670 (not f20$next))))
(assert
 (=> p$32 z$1670))
(assert
 (=> p$33 (= z$1671 (not f21$next))))
(assert
 (=> p$33 z$1671))
(assert
 (=> p$34 (= z$1672 (not f22$next))))
(assert
 (=> p$34 z$1672))
(assert
 (=> p$35 (= z$1673 (not f23$next))))
(assert
 (=> p$35 z$1673))
(assert
 (=> p$36 (= z$1674 (not f24$next))))
(assert
 (=> p$36 z$1674))
(assert
 (=> p$37 (= z$1675 (not f26$next))))
(assert
 (=> p$37 z$1675))
(assert
 (=> p$38 (= z$1676 (not f27$next))))
(assert
 (=> p$38 z$1676))
(assert
 (=> p$39 (= z$1677 (not f28$next))))
(assert
 (=> p$39 z$1677))
(assert
 (=> p$40 (= z$1678 (not f29$next))))
(assert
 (=> p$40 z$1678))
(assert
 (=> p$41 (= z$1680 (not a_in_elevator_Person_1$next))))
(assert
 (=> p$41 z$1680))
(assert
 (=> p$42 (= z$1681 (not a_transporting$next))))
(assert
 (=> p$42 z$1681))
(assert
 (=> p$43 (= z$1682 (= z$n1s8 v_at_floor_Person_1$next))))
(assert
 (=> p$43 z$1682))
(assert
 (=> p$44 (= z$1706 (not f30$next))))
(assert
 (=> p$44 z$1706))
(assert
 (=> p$45 (= z$1741 (= z$n3s8 v_serving$next))))
(assert
 (=> p$45 z$1741))
(assert
 (=> p$46 (= z$1739 (= z$n3s8 v_current$next))))
(assert
 (=> p$46 z$1739))
(assert
 (=> p$47 (= z$1740 (= v_floor_queue_3_0$next z$n1s8))))
(assert
 (=> p$47 z$1740))
(assert
 (=> p$48 (= z$1795 (not a_out_Person_1$next))))
(assert
 (=> p$48 z$1795))
(assert
 (=> p$49 (= z$2021 (not a_choose_next$next))))
(assert
 (=> p$49 z$2021))
(assert
 (=> p$50 (= z$1945 (and (distinct v_floor_queue_3_act$next z$n0s8) true))))
(assert
 (=> p$50 z$1945))
(assert
 (=> p$51 (= z$1946 (and (distinct v_floor_queue_3_act$next z$n3s8) true))))
(assert
 (=> p$51 z$1946))
(assert
 (=> p$52 (= z$2029 (= z$n2s8 v_floor$next))))
(assert
 (=> p$52 z$2029))
(assert
 (=> p$53 (= z$2030 (and (distinct v_floor_queue_3_act$next z$n2s8) true))))
(assert
 (=> p$53 z$2030))
(check-sat)
(assert p$0)
