...
(assert
 (= z$332 (not z$331)))
(assert
 (let (($x1192 (and z$229 z$246 z$306 z$312 z$31 prop z$13 z$49 z$73 z$72 z$108 z$140 z$201 z$275 z$15 z$332)))
 (= z$336 $x1192)))
(assert
 z$336)
(assert
 (=> p$0 (= z$169 (and (distinct c$next z$n7s20) true))))
(assert
 (=> p$0 z$169))
(assert
 (=> p$1 (= z$211 (and (distinct c$next z$n1s20) true))))
(assert
 (=> p$1 z$211))
(assert
 (=> p$2 (= z$283 (and (distinct c$next z$n5s20) true))))
(assert
 (=> p$2 z$283))
(check-sat)
(assert p$2)
