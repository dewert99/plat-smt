...
(declare-fun diag_ld_cache_c_reg.out () Bool)
(declare-fun z$1 () Bool)
(declare-fun fourth_fill_cyc_flop.out () Bool)
(declare-fun z$3 () Bool)
(declare-fun ic_drty_reg.out () Bool)
(declare-fun z$5 () Bool)
(declare-fun icu_bypass_reg.out () Bool)
...
(declare-fun reset_reg.out () Bool)
(declare-fun z$18 () Bool)
(declare-fun set_stall_reg.out () Bool)
(declare-fun z$20 () Bool)
(declare-fun standby_d1_reg.out () Bool)
...
(assert
 (= z$1 (not diag_ld_cache_c_reg.out)))
(assert
 z$1)
(assert
...
(assert
 z$3)
(assert
 (= z$5 (not ic_drty_reg.out)))
(assert
 z$5)
(assert
 (= z$7 (not icu_bypass_reg.out)))
(assert
 z$7)
(assert
 (= z$9 (not iu_psr_ice_reg.mj_s_ff_snre_d_0.out)))
(assert
 z$9)
(assert
...
(assert
 z$14)
(assert
 (= z$16 (not qual_iu_psr_ice_reg.out)))
(assert
 z$16)
(assert
 (= z$18 (not reset_reg.out)))
(assert
 z$18)
(assert
 (= z$20 (not set_stall_reg.out)))
(assert
 z$20)
(assert
 (= z$22 (not standby_d1_reg.out)))
(assert
 z$22)
(assert
...
(assert
 ...
 (= z$342 $x102)))
(assert
 (= z$343 (or z$340 z$342)))
(assert
 (let (($x109 (= miss_state.miss_state_output z$n4s7)))
 (= z$145 $x109)))
(assert
 (= z$345 (or z$343 z$145)))
(assert
 (= z$347 (and z$322 z$345)))
(assert
 (= z$349 (or z$320 z$347)))
(assert
 (= z$351 (or z$349 z$325)))
(assert
 (= z$353 (or z$351 z$328)))
(assert
 (= z$355 (or z$353 z$331)))
(assert
 (= z$357 (or z$355 z$334)))
(assert
 (= z$359 (or z$357 z$337)))
(assert
 (= z$361 (and z$338 z$359)))
(assert
 (= z$364 (and (distinct tmp_ic_miss_state z$n4s7) true)))
(assert
 (= z$365 (or z$347 z$364)))
(assert
...
(assert
 ...
 (= z$143 $x163)))
(assert
 (= z$371 (or z$369 z$143)))
(assert
 (= z$373 (or z$371 z$145)))
(assert
...
(assert
 ...
 (= z$184 $x628)))
(assert
 (= z$186 (or z$184 valid_diag_c_reg.out)))
(assert
 (= z$188 (not z$186)))
(assert
...
(assert
 (= z$203 (and z$201 z$3)))
(assert
 (= z$205 (ite z$203 iu_psr_ice_reg.mj_s_ff_snre_d_0.out qual_iu_psr_ice_reg.out)))
(assert
 (= z$207 (not z$205)))
(assert
 (= z$209 (or z$207 iu_psr_bm8)))
(assert
 (= z$212 (not icu_hit)))
(assert
 (= z$213 (or z$209 z$212)))
(assert
...
(assert
 (= z$235 (ite z$233 z$n4s7 miss_state.miss_state_output)))
(assert
...
(assert
 ...
 (= z$265 ?x791)))
(assert
 (= z$267 (ite z$12 z$265 z$n0s7)))
(assert
 (let ((?x799 (ite z$32 z$n0s7 z$267)))
 (= z$269 ?x799)))
(assert
 (= z$271 (ite z$12 z$269 z$n0s7)))
(assert
...
(assert
 z$281)
(assert
 (=> p$0 (= z$549 (and (distinct miss_state.miss_state_output$next z$n0s7) true))))
(assert
 (=> p$0 z$549))
(assert
 (=> p$1 (= z$550 (and (distinct miss_state.miss_state_output$next z$n1s7) true))))
(assert
 (=> p$1 z$550))
(assert
 (=> p$2 (= z$551 (and (distinct miss_state.miss_state_output$next z$n2s7) true))))
(assert
 (=> p$2 z$551))
(assert
 (=> p$3 (= z$552 (and (distinct miss_state.miss_state_output$next z$n4s7) true))))
(assert
 (=> p$3 z$552))
(assert
 (=> p$4 (= z$553 (and (distinct miss_state.miss_state_output$next z$n8s7) true))))
(assert
 (=> p$4 z$553))
(assert
 (=> p$5 (= z$554 (and (distinct miss_state.miss_state_output$next z$n16s7) true))))
(assert
 (=> p$5 z$554))
(assert
 (=> p$6 (= z$555 (and (distinct miss_state.miss_state_output$next z$n32s7) true))))
(assert
 (=> p$6 z$555))
(assert
 (=> p$7 (= z$556 (and (distinct miss_state.miss_state_output$next z$n64s7) true))))
(assert
 (=> p$7 z$556))
(check-sat)
(assert p$0)
