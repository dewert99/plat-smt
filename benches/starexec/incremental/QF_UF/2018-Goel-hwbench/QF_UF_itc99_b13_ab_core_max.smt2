...
(declare-fun z$94 () utt10)
(declare-fun z$96 () utt10)
(declare-fun z$98 () utt10)
(declare-fun z$100 () utt10)
...
(declare-fun itfc_state$next () Bool)
...
(assert
 z$49)
(assert
 (= z$221 (Concat_32_1_31 error z$n0s31)))
(assert
 (= z$225 (and (distinct z$221 z$n1s32) true)))
(assert
 (= z$226 (Concat_32_1_31 tre z$n0s31)))
(assert
...
(assert
 ...
 (= z$231 $x674)))
(assert
 (= z$233 (Concat_32_1_31 z$231 z$n0s31)))
(assert
...
(assert
 (= z$247 (Concat_32_1_31 mpx z$n0s31)))
(assert
 (= z$251 (and (distinct z$247 z$n1s32) true)))
(assert
 (= z$252 (Concat_32_1_31 rdy z$n0s31)))
(assert
...
(assert
 (= z$268 (Concat_32_1_31 load z$n0s31)))
(assert
 (let (($x224 (= z$268 z$n0s32)))
 (= z$270 $x224)))
(assert
 (= z$271 (Concat_32_1_31 send z$n0s31)))
(assert
 (let (($x781 (= z$271 z$n0s32)))
 (= z$273 $x781)))
(assert
 (= z$274 (or z$270 z$273)))
(assert
 (= z$276 (and z$266 z$274)))
(assert
 (= z$278 (Concat_32_1_31 confirm z$n0s31)))
(assert
 (let (($x640 (= z$278 z$n0s32)))
 (= z$280 $x640)))
(assert
 (= z$281 (or z$270 z$280)))
(assert
...
(assert
 ...
 (= z$289 $x181)))
(assert
 (= z$290 (Concat_32_1_31 send_en z$n0s31)))
(assert
...
(assert
 (= z$301 (Concat_32_1_31 tx_end z$n0s31)))
(assert
...
(assert
 (= z$322 (Concat_4_1_3 next_bit z$n0s3)))
(assert
...
(assert
 (= z$330 (Concat_32_1_31 load_dato z$n0s31)))
(assert
 (= z$334 (and (distinct z$330 z$n1s32) true)))
(assert
 (= z$335 (Concat_32_1_31 soc z$n0s31)))
(assert
...
(assert
 (= z$342 (Concat_32_1_31 send_data z$n0s31)))
(assert
...
(assert
 (= z$352 (Concat_32_1_31 add_mpx2 z$n0s31)))
(assert
...
(assert
 (= z$365 (Concat_32_1_31 shot z$n0s31)))
(assert
...
(assert
 ...
 (= z$374 $x916)))
(assert
 (= z$375 (Concat_32_1_31 mux_en z$n0s31)))
(assert
...
(assert
 prop)
(assert
 (= z$399 (Concat_32_1_31 error$next z$n0s31)))
(assert
 (= z$401 (and (distinct z$399 z$n1s32) true)))
(assert
 (= z$402 (Concat_32_1_31 tre$next z$n0s31)))
(assert
...
(assert
 (= z$424 (Concat_32_1_31 rdy$next z$n0s31)))
(assert
...
(assert
 (= z$440 (Concat_32_1_31 load$next z$n0s31)))
(assert
 (let (($x896 (= z$440 z$n0s32)))
 (= z$442 $x896)))
(assert
 (= z$443 (Concat_32_1_31 send$next z$n0s31)))
(assert
...
(assert
 (= z$450 (Concat_32_1_31 confirm$next z$n0s31)))
(assert
...
(assert
 ...
 (= z$461 $x5020)))
(assert
 (= z$462 (Concat_32_1_31 send_en$next z$n0s31)))
(assert
...
(assert
 (= z$473 (Concat_32_1_31 tx_end$next z$n0s31)))
(assert
...
(assert
 (= z$497 (Concat_32_1_31 load_dato$next z$n0s31)))
(assert
...
(assert
 (= z$193 (ite S2 rdy z$191)))
(assert
 (= z$195 (= rdy$next z$193)))
(assert
 z$195)
(assert
 (= z$203 (= load_dato$next load_dato)))
(assert
 z$203)
(assert
 (= z$211 (ite S1 false true)))
(assert
 (= z$213 (= S1$next z$211)))
(assert
 z$213)
(assert
 (= z$89 (not tx_end$next)))
(assert
 z$89)
(assert
 (= z$104 (ite tx_end true tre)))
(assert
 (= z$106 (not z$104)))
(assert
 (= z$107 (ite z$106 true z$104)))
(assert
 (= z$109 (ite load z$107 false)))
(assert
 (= z$111 (ite load z$109 z$104)))
(assert
 (= z$113 (not z$111)))
(assert
 (= z$115 (not dsr)))
(assert
 (= z$116 (or z$113 z$115)))
(assert
 (= z$118 (ite z$116 true false)))
(assert
 (= z$120 (ite send z$118 false)))
(assert
 (= z$122 (ite z$106 false true)))
(assert
 (= z$124 (ite load z$122 false)))
(assert
 (= z$126 (ite load z$124 error)))
(assert
 (= z$128 (ite send z$120 z$126)))
(assert
 (= z$130 (= error$next z$128)))
(assert
 z$130)
(assert
 (= z$165 (ite itfc_state true send)))
(assert
 (= z$167 (= send$next z$165)))
(assert
 z$167)
(assert
 (= z$169 (ite shot true load)))
(assert
 (= z$171 (ite z$18 z$169 false)))
(assert
 (= z$173 (ite itfc_state false z$171)))
(assert
 (= z$175 (= load$next z$173)))
(assert
 z$175)
(assert
 (= z$142 (= tre$next z$111)))
(assert
 z$142)
(assert
 (= z$153 (ite shot true false)))
(assert
 (= z$155 (ite z$18 z$153 false)))
(assert
 (= z$157 (ite itfc_state false z$155)))
(assert
 (= z$159 (= itfc_state$next z$157)))
(assert
 z$159)
(assert
 (= z$161 (ite itfc_state confirm false)))
(assert
 (= z$163 (= confirm$next z$161)))
(assert
 z$163)
(assert
 (let ((?x3310 (Concat_32_10_22 tx_conta z$n0s22)))
 (= z$53 ?x3310)))
(assert
 (let (($x5497 (Gr_1_32_32 z$53 z$n104s32)))
 (= z$56 $x5497)))
(assert
 (let ((?x4130 (Add_32_32_32 z$53 z$n1s32)))
 (= z$92 ?x4130)))
(assert
 (let ((?x5655 (Extract_10_9_0_32 z$92)))
 (= z$94 ?x5655)))
(assert
 (let ((?x5490 (ite z$56 z$n0s10 z$94)))
 (= z$96 ?x5490)))
(assert
 (= z$98 (ite send_en z$96 z$n0s10)))
(assert
 (= z$100 (ite send_en z$98 tx_conta)))
(assert
 (let (($x5648 (= tx_conta$next z$100)))
 (= z$102 $x5648)))
(assert
 z$102)
(assert
 (= z$132 (ite tx_end false send_en)))
(assert
 (= z$134 (ite z$116 z$132 true)))
(assert
 (= z$136 (ite send z$134 false)))
(assert
 (= z$138 (ite send z$136 z$132)))
(assert
 (= z$140 (= send_en$next z$138)))
(assert
 z$140)
(assert
 (=> p$0 send_en$next))
(assert
 (let ((?x4386 (Extract_2_9_8_10 tx_conta$next)))
 (let (($x4944 (= z$414 ?x4386)))
 (=> p$1 $x4944))))
(assert
 (let ((?x3662 (Concat_32_2_30 z$414 z$n0s30)))
 (let (($x1284 (= z$416 ?x3662)))
 (=> p$1 $x1284))))
(assert
 (let (($x5592 (= z$416 z$n0s32)))
 (let (($x5150 (= z$418 $x5592)))
 (=> p$1 $x5150))))
(assert
 (=> p$1 z$418))
(assert
 (let ((?x2903 (Concat_32_10_22 tx_conta$next z$n0s22)))
 (let (($x5642 (= z$851 ?x2903)))
 (=> p$2 $x5642))))
(assert
 (let ((?x2640 (Add_32_32_32 z$851 z$n1s32)))
 (let (($x2752 (= z$858 ?x2640)))
 (=> p$2 $x2752))))
(assert
 (=> p$2 (= z$864 (and (distinct z$858 z$n1s32) true))))
(assert
 (=> p$2 z$864))
(assert
 (let ((?x2903 (Concat_32_10_22 tx_conta$next z$n0s22)))
...
(assert
 ...
 (=> p$3 $x2752))))
(assert
 (=> p$3 (= z$860 (and (distinct z$858 z$n104s32) true))))
(assert
 (=> p$3 z$860))
(assert
 (let ((?x2903 (Concat_32_10_22 tx_conta$next z$n0s22)))
 ...
 (=> p$4 $x5642))))
(assert
 (=> p$4 (= z$852 (Gr_1_32_32 z$851 z$n104s32))))
(assert
 (=> p$4 (= z$853 (not z$852))))
(assert
 (=> p$4 z$853))
(assert
 ...
 (=> p$5 $x5642))))
(assert
 (=> p$5 (= z$861 (and (distinct z$851 z$n104s32) true))))
(assert
 (=> p$5 z$861))
(assert
 (let ((?x2903 (Concat_32_10_22 tx_conta$next z$n0s22)))
 ...
 (=> p$6 $x5642))))
(assert
 (=> p$6 (= z$865 (and (distinct z$851 z$n0s32) true))))
(assert
 (=> p$6 z$865))
(assert
 (let ((?x2903 (Concat_32_10_22 tx_conta$next z$n0s22)))
...
(assert
 ...
 (=> p$7 $x2752))))
(assert
 (=> p$7 (= z$862 (and (distinct z$858 z$n0s32) true))))
(assert
 (=> p$7 z$862))
(assert
 (let ((?x2903 (Concat_32_10_22 tx_conta$next z$n0s22)))
 ...
 (=> p$8 $x5642))))
(assert
 (=> p$8 (= z$855 (Gr_1_32_32 z$851 z$n104s32))))
(assert
 (=> p$8 (= z$857 (not z$855))))
(assert
 (=> p$8 z$857))
...
(assert
 ...
 (=> p$9 $x2752))))
(assert
 (=> p$9 (= z$863 (and (distinct z$858 z$851) true))))
(assert
 (=> p$9 z$863))
(assert
 (let ((?x2903 (Concat_32_10_22 tx_conta$next z$n0s22)))
 ...
 (=> p$10 $x5642))))
(assert
 (=> p$10 (= z$866 (and (distinct z$851 z$n1s32) true))))
(assert
 (=> p$10 z$866))
(check-sat)
(assert p$0)
