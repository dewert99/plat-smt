...
(assert
 ...
 (= z$3 $x154)))
(assert
 (let (($x167 (not a_cage_opened_Measuring_0)))
 (= z$5 $x167)))
(assert
 (let (($x178 (not a_cage_opened_Measuring_1)))
 (= z$7 $x178)))
(assert
 (let (($x189 (not a_correct_value)))
 (= z$9 $x189)))
(assert
 (let (($x193 (not a_err7)))
 (= z$11 $x193)))
(assert
 (let (($x203 (not a_finished_measuring)))
 (= z$13 $x203)))
(assert
 (let (($x207 (not a_initial_Device_state)))
 (= z$15 $x207)))
(assert
 (let (($x217 (not a_initial_Measuring_0)))
 (= z$17 $x217)))
(assert
 (let (($x104 (not a_initial_Measuring_1)))
 (= z$19 $x104)))
(assert
 (let (($x355 (not a_large_resistance)))
 (= z$21 $x355)))
(assert
 (let (($x1876 (not a_measure_done_Measuring_0)))
 (= z$23 $x1876)))
(assert
 (let (($x655 (not a_measure_done_Measuring_1)))
 (= z$25 $x655)))
(assert
 (let (($x651 (not a_measure_in_progress_Measuring_0)))
 (= z$27 $x651)))
(assert
 (let (($x1326 (not a_measure_in_progress_Measuring_1)))
 (= z$29 $x1326)))
(assert
 (let (($x1866 (not a_measured)))
 (= z$31 $x1866)))
(assert
 (let (($x330 (not a_new_range)))
 (= z$33 $x330)))
(assert
 (let (($x1245 (not a_small_resistance)))
 (= z$35 $x1245)))
(assert
 (let (($x888 (not a_start)))
 (= z$37 $x888)))
(assert
 (let (($x1162 (not a_state0)))
 (= z$39 $x1162)))
(assert
 (let (($x1315 (not a_state1)))
 (= z$41 $x1315)))
(assert
 (let (($x1966 (not a_state_request)))
 (= z$43 $x1966)))
(assert
 (let (($x1735 (not a_too_large_resistance)))
 (= z$45 $x1735)))
(assert
 (let (($x1071 (not a_too_small_resistance)))
 (= z$47 $x1071)))
(assert
...
(assert
 (let ((?x1146 (ite a_measure_in_progress_Measuring_0 z$n1s32 z$n0s32)))
 (= z$1553 ?x1146)))
(assert
...
(assert
 (let (($x4156 (and z$1 z$3 z$5 z$7 z$9 z$11 z$13 z$15 z$17 z$19 z$21 z$23 z$25 z$27 z$29 z$31 z$33 z$35 z$37 z$39 z$41 z$43 z$45 z$47 z$49 z$52 z$54 z$56 z$1561 prop z$1627 z$1755 z$1754 z$1790 z$1789 z$188 z$200 z$212 z$217 z$241 z$253 z$265 z$270 z$287 z$307 z$318 z$327 z$344 z$353 z$362 z$373 z$388 z$401 z$410 z$424 z$436 z$447 z$460 z$467 z$1548)))
 (= z$1804 $x4156)))
(assert
 z$1804)
(assert
 (=> p$0 a_initial_Measuring_0$next))
(assert
 (=> p$1 a_initial_Measuring_1$next))
(assert
