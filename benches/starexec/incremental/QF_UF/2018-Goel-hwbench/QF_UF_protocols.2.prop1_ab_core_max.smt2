...
(assert
 z$7)
(assert
 (= z$9 (not a_got_msg_Consumer)))
(assert
 z$9)
(assert
 (= z$11 (not a_got_msg_Receiver)))
(assert
 z$11)
(assert
 (= z$13 (not a_produce0)))
...
(assert
 z$15)
(assert
 (= z$17 (not a_ready_Consumer)))
(assert
 z$17)
(assert
 (= z$19 (not a_ready_Producer)))
(assert
 z$19)
(assert
 (= z$21 (not a_ready_Sender)))
(assert
 z$21)
(assert
 (= z$23 (not a_ready_channel_K)))
(assert
 z$23)
(assert
 (= z$25 (not a_ready_channel_L)))
(assert
 z$25)
(assert
 (= z$27 (not a_sending)))
(assert
 z$27)
(assert
 (= z$29 (not a_tr_channel_K)))
(assert
 z$29)
(assert
 (= z$31 (not a_tr_channel_L)))
(assert
 z$31)
(assert
 (= z$33 (not a_wait_ack)))
...
(assert
 z$912)
(assert
 (let ((?x3586 (ite f11 v_v_channel_K v_value_Receiver)))
 (= z$102 ?x3586)))
(assert
 (let (($x3589 (= v_value_Receiver$next z$102)))
 (= z$104 $x3589)))
(assert
 z$104)
(assert
...
(assert
 (=> p$3 z$903))
(assert
 (let (($x68 (= z$904 (not a_consume0$next))))
 (=> p$4 $x68)))
(assert
 (=> p$4 z$904))
(assert
 (let (($x72 (= z$905 (not a_consume1$next))))
 (=> p$5 $x72)))
(assert
 (=> p$5 z$905))
(assert
 (=> p$6 (= z$921 (not a_ready_channel_L$next))))
(assert
 (=> p$6 z$921))
(assert
 (=> p$7 (= z$922 (not a_tr_channel_L$next))))
(assert
 (=> p$7 z$922))
(assert
 (=> p$8 (= z$923 (not a_dataOK$next))))
(assert
 (=> p$8 z$923))
(assert
 (=> p$9 (= z$920 (not a_data_lost$next))))
(assert
 (=> p$9 z$920))
(assert
 (=> p$10 (= z$925 (not a_produce0$next))))
(assert
 (=> p$10 z$925))
(assert
 (=> p$11 (= z$927 (not a_got_msg_Consumer$next))))
(assert
 (=> p$11 z$927))
(assert
 (=> p$12 (= z$928 (not a_ready_Sender$next))))
(assert
 (=> p$12 z$928))
(assert
 (=> p$13 (= z$926 (not a_produce1$next))))
(assert
 (=> p$13 z$926))
(assert
 (=> p$14 (= z$983 (not a_ready_Consumer$next))))
(assert
 (=> p$14 z$983))
(assert
 (=> p$15 (= z$984 (= v_value_Receiver$next z$n0s8))))
(assert
 (=> p$15 z$984))
(assert
 (=> p$16 (= z$924 (not a_ready_Producer$next))))
(assert
 (=> p$16 z$924))
(assert
 (=> p$17 (= z$919 (not a_tr_channel_K$next))))
(assert
 (=> p$17 z$919))
(assert
 (=> p$18 (= z$918 (not a_ready_channel_K$next))))
(assert
 (=> p$18 z$918))
(assert
 (=> p$19 (= z$929 (not a_sending$next))))
(assert
 (=> p$19 z$929))
(assert
 (=> p$20 (= z$930 (not a_wait_ack$next))))
(assert
 (=> p$20 z$930))
(assert
 (=> p$21 (= z$941 (not f06$next))))
(assert
 (=> p$21 z$941))
(assert
 (=> p$22 (= z$942 (not f00$next))))
(assert
 (=> p$22 z$942))
(assert
 (=> p$23 (= z$943 (not f01$next))))
(assert
 (=> p$23 z$943))
(assert
 (=> p$24 (= z$945 (not f05$next))))
(assert
 (=> p$24 z$945))
(assert
 (=> p$25 (= z$946 (not f07$next))))
(assert
 (=> p$25 z$946))
(assert
 (=> p$26 (= z$947 (not f08$next))))
(assert
 (=> p$26 z$947))
(assert
 (=> p$27 (= z$948 (not f09$next))))
(assert
 (=> p$27 z$948))
(assert
 (=> p$28 (= z$949 (not f10$next))))
(assert
 (=> p$28 z$949))
(assert
 (=> p$29 (= z$950 (not f11$next))))
(assert
 (=> p$29 z$950))
(assert
 (=> p$30 (= z$951 (not f12$next))))
(assert
 (=> p$30 z$951))
(assert
 (=> p$31 (= z$952 (not f13$next))))
(assert
 (=> p$31 z$952))
(assert
 (=> p$32 (= z$953 (not f14$next))))
(assert
 (=> p$32 z$953))
(assert
 (=> p$33 (= z$954 (not f15$next))))
(assert
 (=> p$33 z$954))
(assert
 (=> p$34 (= z$956 (not f02$next))))
(assert
 (=> p$34 z$956))
(assert
 (=> p$35 (= z$957 (not f03$next))))
(assert
 (=> p$35 z$957))
(assert
 (=> p$36 (= z$982 (not f04$next))))
(assert
 (=> p$36 z$982))
(check-sat)
(assert p$0)
