...
(assert
 (= z$243 (not z$228)))
(assert
 (let (($x929 (and z$2 z$4 z$6 z$8 z$10 z$12 z$14 z$16 z$18 z$20 z$22 z$24 z$108 prop z$123 z$157 z$156 z$51 z$80 z$90 z$94 z$229 z$243)))
 (= z$257 $x929)))
(assert
 z$257)
(assert
 (=> p$0 (= z$140 (= im.p2_c$next s2$next))))
(assert
 (=> p$0 z$140))
(assert
 (let ((?x183 (Sub_8_8_8 im.p2_m$next im.p2_c$next)))
 ...
 (=> p$1 $x182))))
(assert
 (=> p$1 (= z$190 (and (distinct z$142 im.p2_c$next) true))))
(assert
 (=> p$1 z$190))
(assert
 (=> p$2 (= z$263 (= im.p2_c$next im.p2_m$next))))
(assert
 (=> p$2 z$263))
(check-sat)
(assert p$2)
