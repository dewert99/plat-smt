...
(assert
 ...
 (= z$11 $x107)))
(assert
 (= z$2801 (and z$11 a_data_Receiver)))
(assert
 (= z$2803 (not z$2801)))
(assert
 (= z$49 (not dve_invalid)))
(assert
 (= z$2810 (and a_dataOk z$49)))
(assert
 (= z$2811 (not z$2810)))
(assert
 (= z$2821 (and a_put_data z$49)))
(assert
 (= z$2822 (not z$2821)))
(assert
 (= z$2830 (and z$11 a_data_Receiver z$49)))
(assert
 (= z$2831 (not z$2830)))
(assert
 (= z$2870 (and a_wait_Medium z$49)))
(assert
 (= z$2871 (not z$2870)))
(assert
 (= z$2924 (and a_data_Sender z$49)))
(assert
 (= z$2926 (not z$2924)))
(assert
 (= z$2934 (and (distinct v_recseq v_rack) true)))
(assert
 (= z$2997 (and z$39 z$2934)))
(assert
 (= z$2999 (not z$2997)))
(assert
 (= z$3083 (and (distinct v_rack v_sendseq) true)))
(assert
...
(assert
 (= z$3335 (and z$39 z$2543)))
(assert
 (= z$3336 (not z$3335)))
(assert
 (= z$3341 (and z$49 z$2543)))
(assert
 (= z$3343 (not z$3341)))
(assert
...
(assert
 ...
 (= z$13 $x111)))
(assert
 (= z$3429 (and z$9 z$11 z$13 z$2897)))
(assert
 (= z$3430 (not z$3429)))
(assert
...
(assert
 ...
 (= z$21 $x127)))
(assert
 (= z$3593 (and z$3 z$9 z$21 a_wait_Medium z$49)))
(assert
 (= z$3594 (not z$3593)))
(assert
...
(assert
 ...
 (= z$254 $x37)))
(assert
 (let (($x17127 (and z$2782 z$2803 z$2811 z$2822 z$2831 z$2871 z$2926 z$2999 z$3260 z$3327 z$3336 z$3343 z$3430 z$3586 z$3594 z$2250 prop z$223 z$320 z$352 z$359 z$490 z$660 z$672 z$679 z$693 z$705 z$772 z$793 z$808 z$827 z$835 z$843 z$851 z$898 z$905 z$915 z$925 z$935 z$970 z$981 z$989 z$996 z$1006 z$1014 z$1022 z$2244 z$2298 z$1136 z$3070 z$3181 z$3191 z$3213 z$3212 z$3242 z$3276 z$3281 z$3306 z$3311 z$3375 z$3374 z$3398 z$3397 z$3446 z$3445 z$254 z$259)))
 (= z$3624 $x17127)))
(assert
 z$3624)
(assert
...
(assert
 (=> p$0 z$2294))
(assert
 (=> p$1 (= z$2394 (not a_data_Medium$next))))
(assert
 (=> p$1 z$2394))
(assert
 (=> p$2 (= z$2397 (not a_dataOk$next))))
(assert
 (=> p$2 z$2397))
(assert
 (=> p$3 (= z$2407 (not a_corr_data$next))))
(assert
 (=> p$3 z$2407))
(assert
 (=> p$4 (= z$2636 (not a_wait_Consumer$next))))
(assert
 (=> p$4 z$2636))
(assert
...
(assert
 (=> p$5 z$2794))
(assert
 (=> p$6 (= z$2904 (and (distinct v_recseq$next v_sendseq$next) true))))
(assert
 (=> p$6 z$2904))
(assert
 (let ((?x4491 (BitWiseXor_8_8_8 z$n1s8 v_sendseq$next)))
