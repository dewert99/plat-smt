...
(assert
 (=> p$3 z$761))
(assert
 (let (($x71 (= z$762 (not a_consume0$next))))
 (=> p$4 $x71)))
(assert
 (=> p$4 z$762))
(assert
 (let (($x75 (= z$763 (not a_consume1$next))))
 (=> p$5 $x75)))
(assert
 (=> p$5 z$763))
(assert
 (=> p$6 (= z$779 (not a_ready_channel_L$next))))
(assert
 (=> p$6 z$779))
(assert
 (=> p$7 (= z$780 (not a_tr_channel_L$next))))
(assert
 (=> p$7 z$780))
(assert
 (=> p$8 (= z$781 (not a_dataOK$next))))
(assert
 (=> p$8 z$781))
(assert
 (=> p$9 (= z$778 (not a_data_lost$next))))
(assert
 (=> p$9 z$778))
(assert
 (=> p$10 (= z$782 (not a_ready_Producer$next))))
(assert
 (=> p$10 z$782))
(assert
 (=> p$11 (= z$783 (not a_produce0$next))))
(assert
 (=> p$11 z$783))
(assert
 (=> p$12 (= z$784 (not a_produce1$next))))
(assert
 (=> p$12 z$784))
(assert
 (=> p$13 (= z$884 (= v_value_Sender$next z$n1s8))))
(assert
 (=> p$13 z$884))
(assert
 (=> p$14 (= z$839 (not a_ready_Consumer$next))))
(assert
 (=> p$14 z$839))
(assert
 (=> p$15 (= z$838 (not f05$next))))
(assert
 (=> p$15 z$838))
(assert
 (=> p$16 (= z$777 (not a_tr_channel_K$next))))
(assert
 (=> p$16 z$777))
(assert
 (=> p$17 (= z$776 (not a_ready_channel_K$next))))
(assert
 (=> p$17 z$776))
(assert
 (=> p$18 (= z$785 (not a_got_msg_Consumer$next))))
(assert
 (=> p$18 z$785))
(assert
 (=> p$19 (= z$788 (not a_wait_msg$next))))
(assert
 (=> p$19 z$788))
(assert
 (=> p$20 (= z$789 (not a_got_msg_Receiver$next))))
(assert
 (=> p$20 z$789))
(assert
 (=> p$21 (= z$801 (not f00$next))))
(assert
 (=> p$21 z$801))
(assert
 (=> p$22 (= z$802 (not f01$next))))
(assert
 (=> p$22 z$802))
(assert
 (=> p$23 (= z$803 (not f04$next))))
(assert
 (=> p$23 z$803))
(assert
 (=> p$24 (= z$805 (not f06$next))))
(assert
 (=> p$24 z$805))
(assert
 (=> p$25 (= z$806 (not f07$next))))
(assert
 (=> p$25 z$806))
(assert
 (=> p$26 (= z$808 (not f09$next))))
(assert
 (=> p$26 z$808))
(assert
 (=> p$27 (= z$809 (not f10$next))))
(assert
 (=> p$27 z$809))
(assert
 (=> p$28 (= z$810 (not f11$next))))
(assert
 (=> p$28 z$810))
(assert
 (=> p$29 (= z$811 (not f12$next))))
(assert
 (=> p$29 z$811))
(assert
 (=> p$30 (= z$812 (not f02$next))))
(assert
 (=> p$30 z$812))
(assert
 (=> p$31 (= z$813 (not f03$next))))
(assert
 (=> p$31 z$813))
(check-sat)
(assert p$0)
