...
(assert
 (and (distinct z$n0s8 z$n1s8 z$n5s8) true))
(assert
 (and (distinct z$n2s32 z$n1s32 z$n0s32 z$n5s32) true))
(assert
 (= z$1 (not a_consume0)))
(assert
 z$1)
...
(assert
 ...
 (= z$68 ?x4282)))
(assert
 (let ((?x3173 (Mult_32_32_32 z$n2s32 z$68)))
 (= z$70 ?x3173)))
(assert
 (let ((?x4017 (Concat_32_8_24 v_sab z$n0s24)))
 (= z$72 ?x4017)))
(assert
 (let ((?x2524 (Add_32_32_32 z$70 z$72)))
 (= z$74 ?x2524)))
(assert
 (let ((?x3503 (Extract_8_7_0_32 z$74)))
 (= z$76 ?x3503)))
(assert
 (let ((?x4414 (ite f10 z$76 v_v_channel_K)))
 (= z$79 ?x4414)))
(assert
 (let ((?x3096 (ite f11 z$76 z$79)))
 (= z$81 ?x3096)))
(assert
 (let (($x3785 (= v_v_channel_K$next z$81)))
 (= z$83 $x3785)))
(assert
 z$83)
(assert
...
(assert
 ...
 (= z$88 ?x724)))
(assert
 (let (($x728 (GrEq_1_32_32 z$88 z$n0s32)))
 (= z$394 $x728)))
(assert
 (= z$396 (not z$394)))
(assert
...
(assert
 ...
 (= z$107 ?x749)))
(assert
 (let (($x753 (GrEq_1_32_32 z$107 z$n0s32)))
 (= z$403 $x753)))
(assert
 (= z$405 (not z$403)))
(assert
...
(assert
 ...
 (= z$151 ?x951)))
(assert
 (let (($x955 (GrEq_1_32_32 z$151 z$n5s32)))
 (= z$491 $x955)))
(assert
 (= z$493 (not z$491)))
(assert
...
(assert
 z$1094)
(assert
 (let ((?x3015 (ite f14 v_v_channel_L v_value_Sender)))
 (= z$133 ?x3015)))
(assert
 (let ((?x4360 (ite f15 z$n0s8 z$133)))
 (= z$135 ?x4360)))
(assert
 (let ((?x3378 (ite f16 z$n1s8 z$135)))
 (= z$137 ?x3378)))
(assert
 (let (($x4758 (= v_value_Sender$next z$137)))
 (= z$139 $x4758)))
(assert
 z$139)
(assert
 (let ((?x4385 (Sub_32_32_32 z$n1s32 z$72)))
 (= z$141 ?x4385)))
(assert
 (let ((?x3104 (Extract_8_7_0_32 z$141)))
 (= z$143 ?x3104)))
(assert
 (let ((?x4212 (ite f15 z$143 v_sab)))
 (= z$145 ?x4212)))
(assert
 (let ((?x3392 (ite f16 z$143 z$145)))
 (= z$147 ?x3392)))
(assert
 (let (($x4710 (= v_sab$next z$147)))
 (= z$149 $x4710)))
(assert
 z$149)
(assert
 (let ((?x4206 (Add_32_32_32 z$n1s32 z$151)))
 (= z$153 ?x4206)))
(assert
 (let ((?x3109 (Extract_8_7_0_32 z$153)))
 (= z$155 ?x3109)))
(assert
 (let ((?x4634 (ite f10 z$n1s8 v_retry)))
 (= z$157 ?x4634)))
(assert
 (let ((?x2714 (ite f11 z$155 z$157)))
 (= z$159 ?x2714)))
(assert
 (let (($x2953 (= v_retry$next z$159)))
 (= z$161 $x2953)))
(assert
 z$161)
(assert
...
(assert
 (=> p$10 z$1107))
(assert
 (=> p$11 (= z$1105 (not a_dataOK$next))))
(assert
 (=> p$11 z$1105))
(assert
 (=> p$12 (= z$1106 (not a_ready_Producer$next))))
(assert
 (=> p$12 z$1106))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
 (let (($x2554 (= z$1233 ?x2700)))
 (=> p$13 $x2554))))
(assert
 (let ((?x3256 (Concat_32_8_24 z$1233 z$n0s24)))
 (let (($x4224 (= z$1293 ?x3256)))
 (=> p$13 $x4224))))
(assert
 (let ((?x3831 (Sub_32_32_32 z$n1s32 z$1293)))
 (let (($x4390 (= z$1295 ?x3831)))
 (=> p$13 $x4390))))
(assert
 (let ((?x4081 (Extract_8_7_0_32 z$1295)))
 (let (($x3771 (= z$1297 ?x4081)))
 (=> p$13 $x3771))))
(assert
 (let ((?x4418 (ite f13$next z$1297 z$1233)))
 (let (($x3848 (= z$1299 ?x4418)))
 (=> p$13 $x3848))))
(assert
 (let ((?x3550 (BitWiseXor_8_8_8 z$n1s8 z$1299)))
 (let (($x3603 (= z$1301 ?x3550)))
 (=> p$13 $x3603))))
(assert
 (=> p$13 (= z$1473 (and (distinct v_value_Sender$next z$1301) true))))
(assert
 (=> p$13 z$1473))
(assert
 (=> p$14 (= z$1474 (and (distinct v_value_Sender$next v_retry$next) true))))
(assert
 (=> p$14 z$1474))
(assert
 (=> p$15 (= z$1475 (and (distinct v_value_Sender$next v_sab$next) true))))
(assert
 (=> p$15 z$1475))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
 ...
 (=> p$16 $x2554))))
(assert
 (=> p$16 (= z$1476 (and (distinct z$1233 v_retry$next) true))))
(assert
 (=> p$16 z$1476))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
 ...
 (=> p$17 $x2554))))
(assert
 (=> p$17 (= z$1477 (and (distinct z$1233 v_sab$next) true))))
(assert
 (=> p$17 z$1477))
(assert
 (=> p$18 (= z$1478 (and (distinct v_rab$next v_retry$next) true))))
(assert
 (=> p$18 z$1478))
(assert
 (=> p$19 (= z$1228 (not a_ready_Consumer$next))))
(assert
 (=> p$19 z$1228))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
 ...
 (=> p$20 $x2554))))
(assert
 (=> p$20 (= z$1237 (and (distinct z$1233 z$n0s8) true))))
(assert
 (=> p$20 z$1237))
(assert
 (=> p$21 (= z$1239 (and (distinct v_rab$next z$n0s8) true))))
(assert
 (=> p$21 z$1239))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
 ...
 (=> p$22 $x2554))))
(assert
 (=> p$22 (= z$1241 (and (distinct z$1233 z$n1s8) true))))
(assert
 (=> p$22 z$1241))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
 ...
 (=> p$23 $x2554))))
(assert
 (=> p$23 (= z$1242 (and (distinct z$1233 v_rab$next) true))))
(assert
 (=> p$23 z$1242))
(assert
 (=> p$24 (= z$1245 (and (distinct v_rab$next z$n1s8) true))))
(assert
 (=> p$24 z$1245))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$25 $x3603))))
(assert
 (=> p$25 (= z$1303 (and (distinct z$1301 z$n0s8) true))))
(assert
 (=> p$25 z$1303))
(assert
 (=> p$26 (= z$1101 (not a_tr_channel_K$next))))
(assert
 (=> p$26 z$1101))
(assert
 (=> p$27 (= z$1100 (not a_ready_channel_K$next))))
(assert
 (=> p$27 z$1100))
(assert
 (=> p$28 (= z$1109 (not a_got_msg_Consumer$next))))
(assert
 (=> p$28 z$1109))
(assert
 (=> p$29 (= z$1111 (not a_sending$next))))
(assert
 (=> p$29 z$1111))
(assert
 (=> p$30 (= z$1113 (not a_failed$next))))
(assert
 (=> p$30 z$1113))
(assert
 (=> p$31 (= z$1114 (not a_waiting$next))))
(assert
 (=> p$31 z$1114))
(assert
 (=> p$32 (= z$1115 (not a_got_msg_Receiver$next))))
(assert
 (=> p$32 z$1115))
(assert
 (=> p$33 (= z$1116 (not a_send_ack$next))))
(assert
 (=> p$33 z$1116))
(assert
 (=> p$34 (= z$1146 (not f06$next))))
(assert
 (=> p$34 z$1146))
(assert
 (=> p$35 (= z$1147 (not f00$next))))
(assert
 (=> p$35 z$1147))
(assert
 (=> p$36 (= z$1148 (not f01$next))))
(assert
 (=> p$36 z$1148))
(assert
 (=> p$37 (= z$1150 (not f05$next))))
(assert
 (=> p$37 z$1150))
(assert
 (=> p$38 (= z$1151 (not f07$next))))
(assert
 (=> p$38 z$1151))
(assert
 (=> p$39 (= z$1152 (not f08$next))))
(assert
 (=> p$39 z$1152))
(assert
 (=> p$40 (= z$1153 (not f09$next))))
(assert
 (=> p$40 z$1153))
(assert
 (=> p$41 (= z$1154 (not f10$next))))
(assert
 (=> p$41 z$1154))
(assert
 (=> p$42 (= z$1156 (not f12$next))))
(assert
 (=> p$42 z$1156))
(assert
 (=> p$43 (= z$1157 (not f13$next))))
(assert
 (=> p$43 z$1157))
(assert
 (=> p$44 (= z$1158 (not f14$next))))
(assert
 (=> p$44 z$1158))
(assert
 (=> p$45 (= z$1159 (not f15$next))))
(assert
 (=> p$45 z$1159))
(assert
 (=> p$46 (= z$1160 (not f16$next))))
(assert
 (=> p$46 z$1160))
(assert
 (=> p$47 (= z$1161 (not f17$next))))
(assert
 (=> p$47 z$1161))
(assert
 (=> p$48 (= z$1162 (not f02$next))))
(assert
 (=> p$48 z$1162))
(assert
 (=> p$49 (= z$1163 (not f03$next))))
(assert
 (=> p$49 z$1163))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$50 $x4224))))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
 (let (($x2397 (= z$1485 ?x4286)))
 (=> p$50 $x2397))))
(assert
 (let ((?x4863 (Mult_32_32_32 z$n2s32 z$1485)))
 (let (($x2641 (= z$1492 ?x4863)))
 (=> p$50 $x2641))))
(assert
 (=> p$50 (= z$1511 (and (distinct z$1293 z$1492) true))))
(assert
 (=> p$50 z$1511))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$51 $x2641))))
(assert
 (let ((?x4821 (Concat_32_8_24 v_sab$next z$n0s24)))
 (let (($x3537 (= z$1488 ?x4821)))
 (=> p$51 $x3537))))
(assert
 (let ((?x4097 (Add_32_32_32 z$1492 z$1488)))
 (let (($x4433 (= z$1495 ?x4097)))
 (=> p$51 $x4433))))
(assert
 (=> p$51 (= z$1512 (and (distinct z$1293 z$1495) true))))
(assert
 (=> p$51 z$1512))
(assert
 (let ((?x4331 (Concat_32_8_24 v_retry$next z$n0s24)))
 (let (($x4041 (= z$1460 ?x4331)))
 (=> p$52 $x4041))))
(assert
 (=> p$52 (= z$1513 (and (distinct z$1460 z$n5s32) true))))
(assert
 (=> p$52 z$1513))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$53 $x2641))))
(assert
 (=> p$53 (= z$1514 (and (distinct z$1492 z$n5s32) true))))
(assert
 (=> p$53 z$1514))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$54 $x4433))))
(assert
 (=> p$54 (= z$1515 (and (distinct z$1495 z$n5s32) true))))
(assert
 (=> p$54 z$1515))
(assert
 (let ((?x4331 (Concat_32_8_24 v_retry$next z$n0s24)))
...
(assert
 ...
 (=> p$55 $x2641))))
(assert
 (=> p$55 (= z$1516 (and (distinct z$1460 z$1492) true))))
(assert
 (=> p$55 z$1516))
(assert
 (let ((?x4331 (Concat_32_8_24 v_retry$next z$n0s24)))
...
(assert
 ...
 (=> p$56 $x4433))))
(assert
 (=> p$56 (= z$1517 (and (distinct z$1460 z$1495) true))))
(assert
 (=> p$56 z$1517))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$57 $x4433))))
(assert
 (=> p$57 (= z$1518 (and (distinct z$1492 z$1495) true))))
(assert
 (=> p$57 z$1518))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$58 $x3603))))
(assert
 (=> p$58 (= z$1308 (and (distinct z$1301 z$n1s8) true))))
(assert
 (=> p$58 z$1308))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$59 $x3603))))
(assert
 (=> p$59 (= z$1309 (and (distinct z$1301 z$1233) true))))
(assert
 (=> p$59 z$1309))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$60 $x3603))))
(assert
 (=> p$60 (= z$1310 (and (distinct z$1301 v_rab$next) true))))
(assert
 (=> p$60 z$1310))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$61 $x4224))))
(assert
 (=> p$61 (= z$1311 (and (distinct z$1293 z$n2s32) true))))
(assert
 (=> p$61 z$1311))
(assert
 (=> p$62 (= z$1227 (not f04$next))))
(assert
 (=> p$62 z$1227))
(assert
 (=> p$63 (= z$1479 (and (distinct v_rab$next v_sab$next) true))))
(assert
 (=> p$63 z$1479))
(assert
 (=> p$64 (= z$1480 (and (distinct v_retry$next z$n1s8) true))))
(assert
 (=> p$64 z$1480))
(assert
 (=> p$65 (= z$1481 (and (distinct v_sab$next z$n1s8) true))))
(assert
 (=> p$65 z$1481))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$66 $x3603))))
(assert
 (=> p$66 (= z$1482 (and (distinct z$1301 v_retry$next) true))))
(assert
 (=> p$66 z$1482))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$67 $x3603))))
(assert
 (=> p$67 (= z$1483 (and (distinct z$1301 v_sab$next) true))))
(assert
 (=> p$67 z$1483))
(assert
 (=> p$68 (= z$1484 (and (distinct v_retry$next v_sab$next) true))))
(assert
 (=> p$68 z$1484))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
 ...
 (=> p$69 $x2397))))
(assert
 (=> p$69 (= z$1487 (and (distinct z$1485 z$n2s32) true))))
(assert
 (=> p$69 z$1487))
(assert
 (let ((?x4821 (Concat_32_8_24 v_sab$next z$n0s24)))
 ...
 (=> p$70 $x3537))))
(assert
 (=> p$70 (= z$1490 (and (distinct z$1488 z$n2s32) true))))
(assert
 (=> p$70 z$1490))
(assert
 (let ((?x4331 (Concat_32_8_24 v_retry$next z$n0s24)))
 ...
 (=> p$71 $x4041))))
(assert
 (=> p$71 (= z$1491 (and (distinct z$1460 z$n2s32) true))))
(assert
 (=> p$71 z$1491))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$72 $x2641))))
(assert
 (=> p$72 (= z$1494 (and (distinct z$1492 z$n2s32) true))))
(assert
 (=> p$72 z$1494))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$73 $x4433))))
(assert
 (=> p$73 (= z$1503 (and (distinct z$1485 z$1495) true))))
(assert
 (=> p$73 z$1503))
(assert
 (let ((?x4821 (Concat_32_8_24 v_sab$next z$n0s24)))
...
(assert
 ...
 (=> p$74 $x4224))))
(assert
 (=> p$74 (= z$1504 (and (distinct z$1488 z$1293) true))))
(assert
 (=> p$74 z$1504))
(assert
 (let ((?x4821 (Concat_32_8_24 v_sab$next z$n0s24)))
 ...
 (=> p$75 $x3537))))
(assert
 (=> p$75 (= z$1505 (and (distinct z$1488 z$n5s32) true))))
(assert
 (=> p$75 z$1505))
(assert
 (let ((?x4821 (Concat_32_8_24 v_sab$next z$n0s24)))
...
(assert
 ...
 (=> p$76 $x4041))))
(assert
 (=> p$76 (= z$1506 (and (distinct z$1488 z$1460) true))))
(assert
 (=> p$76 z$1506))
(assert
 (let ((?x4821 (Concat_32_8_24 v_sab$next z$n0s24)))
...
(assert
 ...
 (=> p$77 $x2641))))
(assert
 (=> p$77 (= z$1507 (and (distinct z$1488 z$1492) true))))
(assert
 (=> p$77 z$1507))
(assert
 (let ((?x4821 (Concat_32_8_24 v_sab$next z$n0s24)))
...
(assert
 ...
 (=> p$78 $x4433))))
(assert
 (=> p$78 (= z$1508 (and (distinct z$1488 z$1495) true))))
(assert
 (=> p$78 z$1508))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$79 $x4224))))
(assert
 (=> p$79 (= z$1509 (and (distinct z$1293 z$n5s32) true))))
(assert
 (=> p$79 z$1509))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
...
(assert
 ...
 (=> p$80 $x4041))))
(assert
 (=> p$80 (= z$1510 (and (distinct z$1293 z$1460) true))))
(assert
 (=> p$80 z$1510))
(assert
 (let ((?x4331 (Concat_32_8_24 v_retry$next z$n0s24)))
 ...
 (=> p$81 $x4041))))
(assert
 (=> p$81 (= z$1461 (GrEq_1_32_32 z$1460 z$n5s32))))
(assert
 (=> p$81 (= z$1462 (not z$1461))))
(assert
 (=> p$81 z$1462))
(assert
 (let ((?x4331 (Concat_32_8_24 v_retry$next z$n0s24)))
 ...
 (=> p$82 $x4041))))
(assert
 (=> p$82 (= z$1464 (GrEq_1_32_32 z$1460 z$n5s32))))
(assert
 (=> p$82 (= z$1466 (not z$1464))))
(assert
 (=> p$82 z$1466))
(assert
 (=> p$83 (= z$1467 (and (distinct v_value_Sender$next z$n0s8) true))))
(assert
 (=> p$83 z$1467))
(assert
 (=> p$84 (= z$1468 (and (distinct v_retry$next z$n0s8) true))))
(assert
 (=> p$84 z$1468))
(assert
 (=> p$85 (= z$1469 (and (distinct v_sab$next z$n0s8) true))))
(assert
 (=> p$85 z$1469))
(assert
 (let ((?x2700 (BitWiseXor_8_8_8 z$n1s8 v_rab$next)))
 ...
 (=> p$86 $x2554))))
(assert
 (=> p$86 (= z$1470 (and (distinct v_value_Sender$next z$1233) true))))
(assert
 (=> p$86 z$1470))
(assert
 (=> p$87 (= z$1471 (and (distinct v_value_Sender$next v_rab$next) true))))
(assert
 (=> p$87 z$1471))
(assert
 (=> p$88 (= z$1472 (and (distinct v_value_Sender$next z$n1s8) true))))
(assert
 (=> p$88 z$1472))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$89 $x4433))))
(assert
 (=> p$89 (= z$1497 (and (distinct z$1495 z$n2s32) true))))
(assert
 (=> p$89 z$1497))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$90 $x3537))))
(assert
 (=> p$90 (= z$1498 (and (distinct z$1485 z$1488) true))))
(assert
 (=> p$90 z$1498))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$91 $x4224))))
(assert
 (=> p$91 (= z$1499 (and (distinct z$1485 z$1293) true))))
(assert
 (=> p$91 z$1499))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
 ...
 (=> p$92 $x2397))))
(assert
 (=> p$92 (= z$1500 (and (distinct z$1485 z$n5s32) true))))
(assert
 (=> p$92 z$1500))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$93 $x4041))))
(assert
 (=> p$93 (= z$1501 (and (distinct z$1485 z$1460) true))))
(assert
 (=> p$93 z$1501))
(assert
 (let ((?x4286 (Concat_32_8_24 v_value_Sender$next z$n0s24)))
...
(assert
 ...
 (=> p$94 $x2641))))
(assert
 (=> p$94 (= z$1502 (and (distinct z$1485 z$1492) true))))
(assert
 (=> p$94 z$1502))
(check-sat)
(assert p$0)
