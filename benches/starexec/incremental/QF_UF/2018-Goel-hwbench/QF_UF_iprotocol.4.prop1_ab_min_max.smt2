...
(assert
 ...
 (= z$1 $x84)))
(assert
 (let (($x88 (not a_ack_Medium)))
 (= z$3 $x88)))
(assert
 (let (($x92 (not a_ack_Sender)))
 (= z$5 $x92)))
(assert
 (let (($x95 (not a_consume)))
 (= z$7 $x95)))
(assert
 (let (($x99 (not a_corr_data)))
 (= z$9 $x99)))
(assert
 (let (($x103 (not a_dataOk)))
 (= z$11 $x103)))
(assert
 (let (($x107 (not a_data_Medium)))
 (= z$13 $x107)))
(assert
 (let (($x111 (not a_data_Receiver)))
 (= z$15 $x111)))
(assert
 (let (($x115 (not a_data_Sender)))
 (= z$17 $x115)))
(assert
 (let (($x119 (not a_nakOk)))
 (= z$19 $x119)))
(assert
 (let (($x123 (not a_nak_Medium)))
 (= z$21 $x123)))
(assert
 (let (($x127 (not a_nak_Sender)))
 (= z$23 $x127)))
(assert
 (let (($x131 (not a_on_timeout)))
 (= z$25 $x131)))
(assert
 (let (($x135 (not a_produce)))
 (= z$27 $x135)))
(assert
 (let (($x139 (not a_put_data)))
 (= z$29 $x139)))
(assert
 (let (($x143 (not a_send_naks)))
 (= z$31 $x143)))
(assert
 (= z$33 (not a_tick)))
(assert
 (let (($x151 (not a_timeout)))
 (= z$35 $x151)))
(assert
 (let (($x155 (not a_timeout_ack)))
 (= z$37 $x155)))
(assert
 (let (($x159 (not a_wait_Consumer)))
 (= z$39 $x159)))
(assert
 (let (($x163 (not a_wait_Medium)))
 (= z$41 $x163)))
(assert
 (let (($x167 (not a_wait_Producer)))
 (= z$43 $x167)))
(assert
 (let (($x171 (not a_wait_Receiver)))
 (= z$45 $x171)))
(assert
 (let (($x175 (not a_wait_Sender)))
 (= z$47 $x175)))
(assert
...
(assert
 ...
 (= z$1111 ?x1729)))
(assert
 (let ((?x1733 (ite z$52 v_nakd_0 z$1111)))
 (= z$1113 ?x1733)))
(assert
...
(assert
 ...
 (= z$1172 ?x1898)))
(assert
 (let ((?x1902 (ite z$100 v_nakd_0 z$1172)))
 (= z$1174 ?x1902)))
(assert
...
(assert
 ...
 (= z$261 $x72692)))
(assert
 (let (($x74138 (and z$1 z$3 z$5 z$7 z$9 z$11 z$13 z$15 z$17 z$19 z$21 z$23 z$25 z$27 z$29 z$31 z$33 z$35 z$37 z$39 z$41 z$43 z$45 z$47 z$49 z$52 z$54 z$56 z$58 z$60 z$62 z$64 z$66 z$68 z$70 z$72 z$74 z$76 z$78 z$80 z$82 z$84 z$86 z$88 z$90 z$92 z$94 z$96 z$98 z$100 z$102 z$2170 prop z$215 z$312 z$344 z$351 z$456 z$592 z$604 z$611 z$625 z$637 z$704 z$725 z$740 z$759 z$767 z$775 z$783 z$830 z$837 z$847 z$857 z$867 z$902 z$913 z$921 z$928 z$938 z$946 z$954 z$2164 z$2218 z$246 z$251 z$1068 z$2945 z$3057 z$3056 z$3087 z$3092 z$3119 z$3155 z$3160 z$3186 z$3185 z$3253 z$3252 z$3276 z$3275 z$3322 z$3321 z$261)))
 (= z$3457 $x74138)))
(assert
 z$3457)
(assert
