...
(assert (= y$w$16_op (Concat_32_1_31 y$OutCtrl.MdoEn y$n0s31)))
(assert (= y$680 (not (= y$n1s32 y$w$16_op))))
(assert (= y$s$94_op (or y$RStatStart y$WCtrlDataStart)))
(assert (= y$s$95_op (or y$SyncStatMdcEn y$s$94_op)))
(assert (= y$s$96_op (or y$EndBusy y$s$95_op)))
(assert (= y$s$97_op (or y$InProgress y$s$96_op)))
(assert (= y$Busy_op (or y$InProgress_q3 y$s$97_op)))
(assert (= y$w$1_op (Concat_32_1_31 y$Busy_op y$n0s31)))
(assert (= y$693 (= y$n1s32 y$w$1_op)))
(assert (= y$prop0_op (or y$680 y$693)))
(assert (= y$696 (= y$prop y$prop0_op)))
...
(assert (= (= y$n1s32 y$w$16_op) y$678))
(assert (= y$837 (and y$34 y$678)))
(assert (= y$837 (not y$839)))
(assert (= y$OutCtrl.MdoEn$next (not y$777)))
(assert (= (= y$n1s32 y$w$16$next_op) y$806))
(assert (= y$836 (and y$777 y$806)))
(assert (= y$836 (not y$838)))
(assert (= y$847 (and y$prop y$696 y$673 y$738 y$719 y$839 y$838)))
(assert y$847)
(assert (distinct y$n0s2 y$n2s2 y$n1s2))
(assert (distinct y$n0s5 y$n31s5 y$n1s5))
(assert (distinct y$n0s6 y$n33s6 y$n1s6 y$n55s6 y$n63s6 y$n40s6 y$n32s6 y$n48s6 y$n56s6))
...
(assert (= y$874 (and y$17 y$OutCtrl.MdoEn_d2)))
(assert (= y$874 (not y$876)))
(assert y$876)
(check-sat)
(exit)
