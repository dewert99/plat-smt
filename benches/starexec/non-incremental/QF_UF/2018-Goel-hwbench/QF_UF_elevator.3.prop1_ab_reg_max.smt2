...
(assert (= y$34 (= y$n0s8 y$v_at_floor_Person_0)))
(assert (= y$36 (= y$n0s8 y$v_at_floor_Person_1)))
(assert (= y$38 (= y$n0s8 y$v_at_floor_Person_2)))
(assert (= y$40 (= y$n0s8 y$v_caller)))
(assert (= y$42 (= y$n0s8 y$v_current)))
(assert (= y$44 (= y$n0s8 y$v_floor)))
(assert (= y$46 (= y$n0s8 y$v_floor_queue_0_0)))
(assert (= y$48 (= y$n0s8 y$v_floor_queue_0_1)))
(assert (= y$50 (= y$n0s8 y$v_floor_queue_0_2)))
(assert (= y$52 (= y$n0s8 y$v_floor_queue_0_act)))
(assert (= y$54 (= y$n0s8 y$v_floor_queue_1_0)))
(assert (= y$56 (= y$n0s8 y$v_floor_queue_1_1)))
(assert (= y$58 (= y$n0s8 y$v_floor_queue_1_2)))
(assert (= y$60 (= y$n0s8 y$v_floor_queue_1_act)))
(assert (= y$62 (= y$n0s8 y$v_floor_queue_2_0)))
(assert (= y$64 (= y$n0s8 y$v_floor_queue_2_1)))
(assert (= y$66 (= y$n0s8 y$v_floor_queue_2_2)))
(assert (= y$68 (= y$n0s8 y$v_floor_queue_2_act)))
(assert (= y$70 (= y$n0s8 y$v_floor_queue_3_0)))
(assert (= y$72 (= y$n0s8 y$v_floor_queue_3_1)))
(assert (= y$74 (= y$n0s8 y$v_floor_queue_3_2)))
(assert (= y$76 (= y$n0s8 y$v_floor_queue_3_act)))
(assert (= y$78 (= y$n0s8 y$v_floor_queue_4_0)))
(assert (= y$80 (= y$n0s8 y$v_floor_queue_4_1)))
(assert (= y$82 (= y$n0s8 y$v_floor_queue_4_2)))
(assert (= y$84 (= y$n0s8 y$v_floor_queue_4_act)))
(assert (= y$86 (= y$n0s8 y$v_floor_queue_5_0)))
(assert (= y$88 (= y$n0s8 y$v_floor_queue_5_1)))
(assert (= y$90 (= y$n0s8 y$v_floor_queue_5_2)))
...
(assert (= y$2503 (and y$1 y$3 y$5 y$7 y$9 y$11 y$13 y$15 y$17 y$19 y$21 y$23 y$25 y$27 y$29 y$31 y$34 y$36 y$38 y$40 y$42 y$44 y$46 y$48 y$50 y$52 y$54 y$56 y$58 y$60 y$62 y$64 y$66 y$68 y$70 y$72 y$74 y$76 y$78 y$80 y$82 y$84 y$86 y$88 y$90 y$92 y$94 y$96 y$98 y$2494 y$2435)))
(assert y$2503)
(check-sat)
(exit)
