...
(assert (distinct y$n0s5 y$n6s5 y$n31s5 y$n30s5))
(assert (not (= y$n2s32 y$n0s32)))
...
(assert (= y$138 (and y$2 y$5 y$52 y$51 y$25 y$40 y$37 y$111 y$110 y$131 y$130)))
(assert y$138)
(check-sat)
(exit)
