...
(assert (= y$s$21_op (Add_8_8_8 y$a y$b)))
(assert (= y$s$23_op (Sub_8_8_8 y$a y$b)))
(assert (= y$sp.m_op (ite y$ctl_1 y$s$21_op y$s$23_op)))
(assert (= y$s$22_op (Add_8_8_8 y$sp.m_op y$c)))
(assert (= y$s$24_op (Sub_8_8_8 y$sp.m_op y$c)))
(assert (= y$s_out_op (ite y$ctl_2 y$s$22_op y$s$24_op)))
...
(assert (= y$s$20_op (ite y$im.p2_ctl_2 y$s$14_op y$s$18_op)))
...
(assert (= y$144 (not (= y$s2$next y$s$18$next_op))))
...
(assert (= y$138 (not (= y$s2 y$s$18_op))))
