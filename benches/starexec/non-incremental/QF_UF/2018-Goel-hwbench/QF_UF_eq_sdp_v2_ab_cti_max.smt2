...
(assert (= y$im.p2_c$next (not y$142)))
(assert (= y$im.p2_m$next (not y$149)))
(assert (= y$s$17$next_op (Sub_1_1_1 y$im.p2_m$next y$im.p2_c$next)))
(assert (= y$158 (and y$142 y$149 y$s$17$next_op)))
(assert (= y$158 (not y$160)))
(assert (= y$im.p2_c (not y$11)))
(assert (= y$im.p2_m (not y$15)))
(assert (= y$157 (and y$11 y$15 y$s$17_op)))
(assert (= y$157 (not y$159)))
(assert (= y$167 (and y$prop y$107 y$104 y$122 y$120 y$160 y$159)))
(assert y$167)
(check-sat)
(exit)
