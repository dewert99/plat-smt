...
(assert (distinct y$n1s4 y$n15s4 y$n0s4 y$n14s4))
(assert (= y$s$1_op (Add_4_4_4 y$X y$n1s4)))
(assert (= (not (= y$n15s4 y$s$1_op)) y$57))
(assert (= y$16 (not (= y$n15s4 y$X))))
(assert (= y$17 (= y$prop y$16)))
...
(assert (= y$77 (and y$2 y$13 y$37)))
(assert (= y$77 (not y$78)))
(assert (= y$93 (and y$prop y$17 y$prop$next y$28 y$45 y$44 y$78 y$57)))
(assert y$93)
(assert (= y$s$1$next_op (Add_4_4_4 y$X$next y$n1s4)))
(assert (= y$37 (= y$n15s4 y$s$1$next_op)))
(assert y$37)
