...
(assert (= y$182 (= y$n0s8 y$v_count_Lift_0)))
(assert (= y$184 (= y$n0s8 y$v_count_Lift_1)))
(assert (= y$186 (= y$n0s8 y$v_count_Lift_2)))
(assert (= y$188 (= y$n0s8 y$v_count_Lift_3)))
(assert (= y$190 (= y$n0s8 y$v_count_Wheels)))
(assert (= y$192 (= y$n0s8 y$v_j)))
(assert (= y$194 (= y$n0s8 y$v_m_Bus)))
(assert (= y$196 (= y$n0s8 y$v_m_Lift_0)))
(assert (= y$198 (= y$n0s8 y$v_m_Lift_1)))
(assert (= y$200 (= y$n0s8 y$v_m_Lift_2)))
(assert (= y$202 (= y$n0s8 y$v_m_Lift_3)))
(assert (= y$204 (= y$n0s8 y$v_nos_Lift_0)))
(assert (= y$206 (= y$n0s8 y$v_nos_Lift_1)))
(assert (= y$208 (= y$n0s8 y$v_nos_Lift_2)))
(assert (= y$210 (= y$n0s8 y$v_nos_Lift_3)))
(assert (= y$212 (= y$n0s8 y$v_pos_Lift_0)))
(assert (= y$214 (= y$n0s8 y$v_pos_Lift_1)))
(assert (= y$216 (= y$n0s8 y$v_pos_Lift_2)))
(assert (= y$218 (= y$n0s8 y$v_pos_Lift_3)))
(assert (= y$220 (= y$n0s8 y$v_relay_0)))
(assert (= y$222 (= y$n0s8 y$v_relay_1)))
(assert (= y$224 (= y$n0s8 y$v_relay_2)))
(assert (= y$226 (= y$n0s8 y$v_relay_3)))
(assert (= y$228 (= y$n0s8 y$v_sender)))
