...
(declare-fun Le_1_6_6 (utt$6 utt$6 ) Bool)
...
(declare-fun y$X$next () utt$6)
(declare-fun y$X$next_rhs () utt$6)
(declare-fun y$X$next_rhs_op () utt$6)
...
(declare-fun y$s$119 () utt$6)
(declare-fun y$s$119_op () utt$6)
(declare-fun y$s$11_op () Bool)
(declare-fun y$s$12 () Bool)
(declare-fun y$s$120 () utt$6)
(declare-fun y$s$120_op () utt$6)
...
(declare-fun y$s$9 () utt$6)
(declare-fun y$s$9_op () utt$6)
(assert (distinct y$n1s6 y$n19s6 y$n3s6 y$n17s6))
(assert (= y$L6 (not y$12)))
(assert (= y$167 (= y$12 y$prop)))
(assert (= y$s$118_op (Le_1_6_6 y$X y$n19s6)))
(assert (= y$s$9_op (Add_6_6_6 y$X y$n3s6)))
...
(assert (= y$s$115_op (Le_1_6_6 y$X y$n17s6)))
...
(assert (= y$180 (and y$prop y$167 y$165 y$177 y$175)))
(assert y$180)
(assert (distinct y$n1s6 y$n19s6 y$n3s6 y$n17s6))
(check-sat)
(exit)
